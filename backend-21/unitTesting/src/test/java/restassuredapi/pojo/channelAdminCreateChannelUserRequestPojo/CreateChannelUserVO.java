package restassuredapi.pojo.channelAdminCreateChannelUserRequestPojo;

import java.util.List;

public class CreateChannelUserVO{
	 ...
	 public String address1;
	    ...
	    public List<CreateChannelUserMsisdn> msisdn;
	    public String otherEmail;
	    public String outletCode;
	    public String subOutletCode;
	    public String outsuspend;
	...
	public List<CreateChannelUserMsisdn> getMsisdn() {
		return msisdn;
	}
	public void setMsisdn(List<CreateChannelUserMsisdn> msisdn) {
		this.msisdn = msisdn;
	}
