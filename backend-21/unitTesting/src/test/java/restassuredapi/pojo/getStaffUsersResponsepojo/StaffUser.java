...
public class StaffUser {
    ...
    private String staffUserDetails;
    ...
    private List<AgentBalance> agentBalanceList = null;
    ...
    private List<AsscMsisdn> asscMsisdnList = null;
    @JsonProperty("assoMsisdn")
    private String assoMsisdn;
    @JsonProperty("associatedGeographicalList")
    private List<AssociatedGeographical> associatedGeographicalList = null;
    @JsonProperty("associatedProductTypeList")
    private List<AssociatedProductType> associatedProductTypeList = null;
    @JsonProperty("associatedServiceTypeList")
    private List<AssociatedServiceType> associatedServiceTypeList = null;
    ...
    private List<GeographicalArea> geographicalAreaList = null;
    ...
    private List<Geographical> geographicalList = null;
    ...
    private List<Msisdn> msisdnList = null;
    ...
    private List<Network> networkList = null;
    ...
    private List<PaymentTypes> paymentTypesList = null;
    ...
    private List<UserLanguage> userLanguageList = null;
    ...
    private List<UserNamePrefix> userNamePrefixList = null;
    ...
    @JsonProperty("staffUserDetails")
    public String getStaffUserDetails() {
        return staffUserDetails;
    }

    @JsonProperty("staffUserDetails")
    public void setStaffUserDetails(String staffUserDetails) {
    ...
    @JsonProperty("agentBalanceList")
    public List<AgentBalance> getAgentBalanceList() {
        return agentBalanceList;
    }

    @JsonProperty("agentBalanceList")
    public void setAgentBalanceList(List<AgentBalance> agentBalanceList) {
    ...
    @JsonProperty("asscMsisdnList")
    public List<AsscMsisdn> getAsscMsisdnList() {
        return asscMsisdnList;
    }

    @JsonProperty("asscMsisdnList")
    public void setAsscMsisdnList(List<AsscMsisdn> asscMsisdnList) {
    ...
    @JsonProperty("associatedGeographicalList")
    public List<AssociatedGeographical> getAssociatedGeographicalList() {
        return associatedGeographicalList;
    }

    @JsonProperty("associatedGeographicalList")
    public void setAssociatedGeographicalList(List<AssociatedGeographical> associatedGeographicalList) {
        this.associatedGeographicalList = associatedGeographicalList;
    }

    @JsonProperty("associatedProductTypeList")
    public List<AssociatedProductType> getAssociatedProductTypeList() {
        return associatedProductTypeList;
    }

    @JsonProperty("associatedProductTypeList")
    public void setAssociatedProductTypeList(List<AssociatedProductType> associatedProductTypeList) {
        this.associatedProductTypeList = associatedProductTypeList;
    }

    @JsonProperty("associatedServiceTypeList")
    public List<AssociatedServiceType> getAssociatedServiceTypeList() {
        return associatedServiceTypeList;
    }

    @JsonProperty("associatedServiceTypeList")
    public void setAssociatedServiceTypeList(List<AssociatedServiceType> associatedServiceTypeList) {
    ...
    @JsonProperty("geographicalList")
    public List<Geographical> getGeographicalList() {
        return geographicalList;
    }

    @JsonProperty("geographicalList")
    public void setGeographicalList(List<Geographical> geographicalList) {
    ...
    @JsonProperty("msisdnList")
    public List<Msisdn> getMsisdnList() {
        return msisdnList;
    }

    @JsonProperty("msisdnList")
    public void setMsisdnList(List<Msisdn> msisdnList) {
    ...
    @JsonProperty("trnsfrdUserHierhyList")
    public List<TrnsfrdUserHierhy> getTrnsfrdUserHierhyList() {
        return trnsfrdUserHierhyList;
    }

    @JsonProperty("trnsfrdUserHierhyList")
    public void setTrnsfrdUserHierhyList(List<TrnsfrdUserHierhy> trnsfrdUserHierhyList) {
    ...
    @JsonProperty("userNamePrefixList")
    public List<UserNamePrefix> getUserNamePrefixList() {
        return userNamePrefixList;
    }

    @JsonProperty("userNamePrefixList")
    public void setUserNamePrefixList(List<UserNamePrefix> userNamePrefixList) {
