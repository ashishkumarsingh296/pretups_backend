...
public class C2STotalNumberOfTransactionRequestPojo {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("reqGatewayLoginId", reqGatewayLoginId).append("data", data).append("sourceType", sourceType).append("reqGatewayType", reqGatewayType).append("reqGatewayPassword", reqGatewayPassword).append("servicePort", servicePort).append("reqGatewayCode", reqGatewayCode).append("additionalProperties", additionalProperties).toString();
    }
*/
}
