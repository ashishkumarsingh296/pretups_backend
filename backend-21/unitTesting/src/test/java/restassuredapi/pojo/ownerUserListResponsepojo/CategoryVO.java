...
public class CategoryVO {
    ...
    private int agentMaxLoginCount;
    ...
    private int geographicalDomainSeqNo;
    @JsonProperty("grphDomainSequenceNo")
    private int grphDomainSequenceNo;
    ...
    private int numberOfCategoryForDomain;
    ...
    @JsonProperty("agentMaxLoginCount")
    public int getAgentMaxLoginCount() {
        return agentMaxLoginCount;
    }

    @JsonProperty("agentMaxLoginCount")
    public void setAgentMaxLoginCount(int agentMaxLoginCount) {
