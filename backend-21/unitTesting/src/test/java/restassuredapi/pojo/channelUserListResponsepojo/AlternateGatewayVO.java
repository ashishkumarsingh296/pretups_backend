...
public class AlternateGatewayVO {
    ...
    private ModifiedOnTimestamp modifiedOnTimestamp;
    ...
    @JsonProperty("modifiedOnTimestamp")
    public ModifiedOnTimestamp getModifiedOnTimestamp() {
        return modifiedOnTimestamp;
    }

    @JsonProperty("modifiedOnTimestamp")
    public void setModifiedOnTimestamp(ModifiedOnTimestamp modifiedOnTimestamp) {
