...
public class MessageGatewayVO {
    ...
    private ModifiedOnTimestamp_ modifiedOnTimestamp;
    ...
    @JsonProperty("modifiedOnTimestamp")
    public ModifiedOnTimestamp_ getModifiedOnTimestamp() {
        return modifiedOnTimestamp;
    }

    @JsonProperty("modifiedOnTimestamp")
    public void setModifiedOnTimestamp(ModifiedOnTimestamp_ modifiedOnTimestamp) {
