...
public class C2STransferCommissionReportResponsePojo {

    @JsonProperty("c2stransferCommissionList")
    private List<C2stransferCommission> c2stransferCommissionList = null;
    ...
    @JsonProperty("c2stransferCommissionList")
    public List<C2stransferCommission> getC2stransferCommissionList() {
        return c2stransferCommissionList;
    }

    @JsonProperty("c2stransferCommissionList")
    public void setC2stransferCommissionList(List<C2stransferCommission> c2stransferCommissionList) {
