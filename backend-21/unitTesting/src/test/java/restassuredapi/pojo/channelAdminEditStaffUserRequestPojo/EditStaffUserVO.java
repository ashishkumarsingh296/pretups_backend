package restassuredapi.pojo.channelAdminEditStaffUserRequestPojo;

import java.util.ArrayList;

public final class EditStaffUserVO {
	...
	private ArrayList<EditStaffUserMsisdn> msisdn;
	...
	public ArrayList<EditStaffUserMsisdn> getMsisdn() {
		return msisdn;
	}
	public void setMsisdn(ArrayList<EditStaffUserMsisdn> msisdn) {
		this.msisdn = msisdn;
	}
