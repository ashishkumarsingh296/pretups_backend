...
public class BatchApprovalDetails {
    ...
    @JsonProperty("batchO2CItemsVO")
    private BatchO2CItemsVO batchO2CItemsVO;
    ...
    @JsonProperty("downLoadDataMap")
    private DownLoadDataMap downLoadDataMap;
    @JsonProperty("geographyList")
    private List<GeographyList> geographyList = null;
    ...
    public BatchO2CItemsVO getBatchO2CItemsVO() {
        return batchO2CItemsVO;
    }

    @JsonProperty("batchO2CItemsVO")
    public void setBatchO2CItemsVO(BatchO2CItemsVO batchO2CItemsVO) {
        this.batchO2CItemsVO = batchO2CItemsVO;
    }
    ...
    @JsonProperty("downLoadDataMap")
    public DownLoadDataMap getDownLoadDataMap() {
        return downLoadDataMap;
    }

    @JsonProperty("downLoadDataMap")
    public void setDownLoadDataMap(DownLoadDataMap downLoadDataMap) {
        this.downLoadDataMap = downLoadDataMap;
    }

    @JsonProperty("geographyList")
    public List<GeographyList> getGeographyList() {
        return geographyList;
    }

    @JsonProperty("geographyList")
    public void setGeographyList(List<GeographyList> geographyList) {
