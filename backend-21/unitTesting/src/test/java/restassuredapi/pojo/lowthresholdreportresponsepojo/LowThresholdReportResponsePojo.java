...
public class LowThresholdReportResponsePojo {

    @JsonProperty("LowThreshHoldDataList")
    private List<LowThreshHoldData> lowThreshHoldDataList = null;
    ...
    @JsonProperty("LowThreshHoldDataList")
    public List<LowThreshHoldData> getLowThreshHoldDataList() {
        return lowThreshHoldDataList;
    }

    @JsonProperty("LowThreshHoldDataList")
    public void setLowThreshHoldDataList(List<LowThreshHoldData> lowThreshHoldDataList) {
