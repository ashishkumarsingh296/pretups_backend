...
public class PinPasswordHistorySearchResponsePojo {
    ...
    private List<PinPassHistSearchVO> pinPassHistSearchVOList = null;
    ...
    @JsonProperty("pinPassHistSearchVOList")
    public List<PinPassHistSearchVO> getPinPassHistSearchVOList() {
        return pinPassHistSearchVOList;
    }

    @JsonProperty("pinPassHistSearchVOList")
    public void setPinPassHistSearchVOList(List<PinPassHistSearchVO> pinPassHistSearchVOList) {
