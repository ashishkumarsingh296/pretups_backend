...
private List<BonusTypeList_> bonusTypeList = null;
...
@JsonProperty("bonusTypeList")
public List<BonusTypeList_> getBonusTypeList() {
return bonusTypeList;
}

@JsonProperty("bonusTypeList")
public void setBonusTypeList(List<BonusTypeList_> bonusTypeList) {
