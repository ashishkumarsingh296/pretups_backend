...
private List<BonusTypeList> bonusTypeList = null;
...
@JsonProperty("bonusTypeList")
public List<BonusTypeList> getBonusTypeList() {
return bonusTypeList;
}

@JsonProperty("bonusTypeList")
public void setBonusTypeList(List<BonusTypeList> bonusTypeList) {
