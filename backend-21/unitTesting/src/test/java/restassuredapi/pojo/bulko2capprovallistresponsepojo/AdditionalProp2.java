...
private FocBatchItemsVO_ focBatchItemsVO;
@JsonProperty("geographyList")
private List<GeographyList_> geographyList = null;
...
@JsonProperty("focBatchItemsVO")
public FocBatchItemsVO_ getFocBatchItemsVO() {
return focBatchItemsVO;
}

@JsonProperty("focBatchItemsVO")
public void setFocBatchItemsVO(FocBatchItemsVO_ focBatchItemsVO) {
this.focBatchItemsVO = focBatchItemsVO;
}

@JsonProperty("geographyList")
public List<GeographyList_> getGeographyList() {
return geographyList;
}

@JsonProperty("geographyList")
public void setGeographyList(List<GeographyList_> geographyList) {
