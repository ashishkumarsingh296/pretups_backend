...
public class FocBatchItemsVO__ {
...
@JsonProperty("bonusTypeList")
private List<BonusTypeList__> bonusTypeList = null;
...
@JsonProperty("bonusTypeList")
public List<BonusTypeList__> getBonusTypeList() {
return bonusTypeList;
}

@JsonProperty("bonusTypeList")
public void setBonusTypeList(List<BonusTypeList__> bonusTypeList) {
