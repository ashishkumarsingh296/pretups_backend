...
import restassuredapi.api.CommissionSubServiceAPI;
import restassuredapi.api.oauthentication.OAuthenticationAPI;
import restassuredapi.pojo.commissionProfile.SubServicePOJO;
import restassuredapi.pojo.oauthenticationrequestpojo.OAuthenticationRequestPojo;
import restassuredapi.pojo.oauthenticationresponsepojo.OAuthenticationResponsePojo;

@ModuleManager(name = Module.COM4)
public class SubServiceTest extends BaseTest {
	static String moduleCode;

	SubServicePOJO viewListResponsePOJO = new SubServicePOJO();
	...
	public void A_01_Test_InvalidService(String loginID, String password, String msisdn, String PIN, String parentName,
		...
		CommissionSubServiceAPI commissionProfileAPI = new CommissionSubServiceAPI(
		...
		commissionProfileAPI.setServiceCode("HELLO");
		...
		viewListResponsePOJO = commissionProfileAPI.getAPIResponseAsPOJO(SubServicePOJO.class);
	...
	@Test(dataProvider = "userData")
	@TestManager(TestKey = "PRETUPS-15667")
	public void A_02_Test_ValidService(String loginID, String password, String msisdn, String PIN, String parentName,
			String categoryName, String categorCode, String externalCode) throws Exception {
		...
		commissionProfileAPI.setServiceCode("RC");
		String str = new RandomGeneration().randomAlphaNumeric(4);
	...
	@Test(dataProvider = "userData")
	@TestManager(TestKey = "PRETUPS-15667")
	public void A_03_Test_BlankService(String loginID, String password, String msisdn, String PIN, String parentName,
			String categoryName, String categorCode, String externalCode) throws Exception {
		final String methodName = "A_03_Test_BlankService";
		Log.startTestCase(methodName);
		if (_masterVO.getProperty("identifierType").equals("loginid"))
			BeforeMethod(loginID, password, categoryName);
		else if (_masterVO.getProperty("identifierType").equals("msisdn"))
