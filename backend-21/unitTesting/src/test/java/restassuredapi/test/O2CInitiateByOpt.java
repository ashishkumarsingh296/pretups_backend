...
public class O2CInitiateByOpt extends BaseTest {
	...
	public void getExcelData(){
		...
		for (int i = 1; i < channelRowCount; i++) {
			...
			if (CategoryName.equals("DIST") && (!LoginID.equals(null) || !LoginID.equals(""))) {
				transferDetails.put("TO_MSISDN", ExcelUtility.getCellData(0, ExcelI.MSISDN, i));
				break;
			}
		}
	}
	...
	public void setupData() {
		...
		for (int i = 1; i <= rowCount; i++) {
			...
			String userBalance = DBHandler.AccessHandler.getUserBalance(
					productCode, transferDetails.get("TO_MSISDN"));
	...
	@Test
	@TestManager(TestKey="PRETUPS-9797")
	public void A_01_Test_success() throws Exception {
		...
		currentNode.assignCategory("REST");
		setupData();
		o2CInitiateByOptRequest.getData().get(0).setLanguage("1");
		o2CInitiateByOptRequest.getData().get(0).setMsisdn(transferDetails.get("TO_MSISDN"));
		o2CInitiateByOptRequest.getData().get(0).setPin(transferDetails.get("PIN"));
		o2CInitiateByOptRequest.getData().get(0).getProducts().get(0).setQty("10");
		o2CInitiateByOptRequest.getData().get(0).getProducts().get(1).setQty("10");
		o2CInitiateByOptRequest.getData().get(0).setRemarks("o2cReturnMultTest");
	...
	public void A_02_Test_invalid_token() throws Exception {
		...
		CaseMaster CaseMaster = _masterVO.getCaseMasterByID("O2CINIOPT2");
		moduleCode = CaseMaster.getModuleCode();
		...
		o2CInitiateByOptRequest.getData().get(0).getProducts().get(1).setQty("10");
		o2CInitiateByOptRequest.getData().get(0).setRemarks("o2cReturnMultTest");
		O2CInitiateByOptAPI o2CInitiateByOptAPI = new O2CInitiateByOptAPI(_masterVO.getMasterValue(MasterI.WEB_URL_REST_SWAGGER), accessToken + (new RandomGeneration().randomAlphabets(4)));
		o2CInitiateByOptAPI.setContentType(_masterVO.getProperty("contentType"));
		o2CInitiateByOptAPI.addBodyParam(o2CInitiateByOptRequest);
		o2CInitiateByOptAPI.perform();
		c2CTransferStockResponsepojo = o2CInitiateByOptAPI
	...
	public void A_03_Test_invalid_pin() throws Exception {
		...
		o2CInitiateByOptRequest.getData().get(0).setLanguage("1");
		o2CInitiateByOptRequest.getData().get(0).setMsisdn(transferDetails.get("TO_MSISDN"));
		o2CInitiateByOptRequest.getData().get(0).setPin("7364");
		o2CInitiateByOptRequest.getData().get(0).setRemarks("o2cReturnMultTest");
		O2CInitiateByOptAPI o2CInitiateByOptAPI = new O2CInitiateByOptAPI(_masterVO.getMasterValue(MasterI.WEB_URL_REST_SWAGGER), accessToken);
		o2CInitiateByOptAPI.setContentType(_masterVO.getProperty("contentType"));
		o2CInitiateByOptAPI.addBodyParam(o2CInitiateByOptRequest);
	...
	public void A_05_Test_invalid_product() throws Exception {
		...
		o2CInitiateByOptRequest.getData().get(0).setMsisdn(transferDetails.get("TO_MSISDN"));
		o2CInitiateByOptRequest.getData().get(0).setPin(transferDetails.get("PIN"));
		o2CInitiateByOptRequest.getData().get(0).getProducts().get(0).setProductcode("106");
		o2CInitiateByOptRequest.getData().get(0).setRemarks("o2cReturnMultTest");
		O2CInitiateByOptAPI o2CInitiateByOptAPI = new O2CInitiateByOptAPI(_masterVO.getMasterValue(MasterI.WEB_URL_REST_SWAGGER), accessToken);
		o2CInitiateByOptAPI.setContentType(_masterVO.getProperty("contentType"));
		o2CInitiateByOptAPI.addBodyParam(o2CInitiateByOptRequest);
	...
	public void A_06_Test_invalid_quantity() throws Exception {
		...
		o2CInitiateByOptRequest.getData().get(0).setMsisdn(transferDetails.get("TO_MSISDN"));
		o2CInitiateByOptRequest.getData().get(0).setPin(transferDetails.get("PIN"));
		o2CInitiateByOptRequest.getData().get(0).getProducts().get(0).setQty("-3");
		o2CInitiateByOptRequest.getData().get(0).setRemarks("o2cReturnMultTest");
		O2CInitiateByOptAPI o2CInitiateByOptAPI = new O2CInitiateByOptAPI(_masterVO.getMasterValue(MasterI.WEB_URL_REST_SWAGGER), accessToken);
		o2CInitiateByOptAPI.setContentType(_masterVO.getProperty("contentType"));
		o2CInitiateByOptAPI.addBodyParam(o2CInitiateByOptRequest);
