...
public class O2CStockInitiateCUAndApproval extends BaseTest{
    ...
    public Object[][] TestDataFeed() {
        String O2CInititateCode = _masterVO.getProperty("O2CInitiateCode");
        ...
        for (int i = 1; i <= rowCount; i++) {
            ...
            if (aList.contains(O2CInititateCode)) {
                ExcelUtility.setExcelFile(MasterSheetPath, ExcelI.TRANSFER_RULE_SHEET);
	 ...
	 Map<String, Object> headerMap = new HashMap<String, Object>();
		...
		@Test(dataProvider = "userData")
		@TestManager(TestKey="PRETUPS-9798")
		public void A_03_Test_invalid_pin_O2C_initiate(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
			final String methodName = "A_03_Test_invalid_pin_O2C_initiate";
			Log.startTestCase(methodName);
			if(_masterVO.getProperty("identifierType").equals("loginid"))
				BeforeMethod(chLoginId, chPassword,chCategoryName);
			else if(_masterVO.getProperty("identifierType").equals("msisdn"))
			...
			o2CInitiateByCURequest.getData().get(0).setPin(new RandomGeneration().randomNumeric(4));
			O2CInitiateByCUAPI o2CInitiateByCUAPI = new O2CInitiateByCUAPI(_masterVO.getMasterValue(MasterI.WEB_URL_REST_SWAGGER), accessToken);
			o2CInitiateByCUAPI.setContentType(_masterVO.getProperty("contentType"));
			o2CInitiateByCUAPI.addBodyParam(o2CInitiateByCURequest);
			o2CInitiateByCUAPI.perform();
			...
			String errorcode = o2CInitiateByCUResponse.getErrorMap().getRowErrorMsgLists().get(0).getMasterErrorList().get(0).getErrorCode();
		...
		public void A_04_Test_empty_remarks_O2C_initiate(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
			final String methodName = "A_04_Test_empty_remarks_O2C_initiate";
			Log.startTestCase(methodName);
			if(_masterVO.getProperty("identifierType").equals("loginid"))
				BeforeMethod(chLoginId, chPassword,chCategoryName);
			else if(_masterVO.getProperty("identifierType").equals("msisdn"))
		...
		public void A_05_Test_invalid_product_O2C_initiate(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
			final String methodName = "A_05_Test_invalid_product_O2C_initiate";
			Log.startTestCase(methodName);
			if(_masterVO.getProperty("identifierType").equals("loginid"))
				BeforeMethod(chLoginId, chPassword,chCategoryName);
			else if(_masterVO.getProperty("identifierType").equals("msisdn"))
			...
			o2CInitiateByCURequest.getData().get(0).getProducts().get(0).setProductcode(new RandomGeneration().randomAlphabets(3));
			O2CInitiateByCUAPI o2CInitiateByCUAPI = new O2CInitiateByCUAPI(_masterVO.getMasterValue(MasterI.WEB_URL_REST_SWAGGER), accessToken);
			o2CInitiateByCUAPI.setContentType(_masterVO.getProperty("contentType"));
			o2CInitiateByCUAPI.addBodyParam(o2CInitiateByCURequest);
			o2CInitiateByCUAPI.perform();
			...
			String errorcode = o2CInitiateByCUResponse.getErrorMap().getRowErrorMsgLists().get(0).getRowErrorMsgList().get(0).getRowErrorMsgLists().get(0).getMasterErrorList().get(0).getErrorCode();
		...
		public void A_06_Test_invalid_quantity_O2C_initiate(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
			final String methodName = "A_06_Test_invalid_quantity_O2C_initiate";
			Log.startTestCase(methodName);
			if(_masterVO.getProperty("identifierType").equals("loginid"))
				BeforeMethod(chLoginId, chPassword,chCategoryName);
			else if(_masterVO.getProperty("identifierType").equals("msisdn"))
			...
			o2CInitiateByCURequest.getData().get(0).getProducts().get(0).setQty(_masterVO.getProperty("negativeValue"));
			O2CInitiateByCUAPI o2CInitiateByCUAPI = new O2CInitiateByCUAPI(_masterVO.getMasterValue(MasterI.WEB_URL_REST_SWAGGER), accessToken);
			o2CInitiateByCUAPI.setContentType(_masterVO.getProperty("contentType"));
			o2CInitiateByCUAPI.addBodyParam(o2CInitiateByCURequest);
			o2CInitiateByCUAPI.perform();
		...
		@Test(dataProvider = "userData")
		@TestManager(TestKey="PRETUPS-9801")
		public void B_02_Test_success_Approval_Level_2(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
		...
		@Test(dataProvider = "userData")
		@TestManager(TestKey="PRETUPS-9801")
		public void B_03_Test_success_status_reject(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
		...
		@Test(dataProvider = "userData")
		@TestManager(TestKey="PRETUPS-9798")
		public void B_04_Invalid_Status_O2CApproval(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
		...
		@Test(dataProvider = "userData")
		@TestManager(TestKey="PRETUPS-9798")
		public void B_05_Invalid_TxnId_O2CApproval(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
		...
		@Test(dataProvider = "userData")
		@TestManager(TestKey="PRETUPS-9798")
		public void B_06_Invalid_Msisdn_O2CApproval(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
		...
		@Test(dataProvider = "userData")
		@TestManager(TestKey="PRETUPS-9798")
		public void B_07_Invalid_Status_O2CApproval(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
		...
		@Test(dataProvider = "userData")
		@TestManager(TestKey="PRETUPS-9798")
		public void B_08_Invalid_PaymentDetails_O2CApproval(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
		...
		@Test(dataProvider = "userData")
		@TestManager(TestKey="PRETUPS-9798")
		public void B_09_blank_Status_O2CApproval(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
		...
		@Test(dataProvider = "userData")
		@TestManager(TestKey="PRETUPS-9798")
		public void B_10_blank_TxnId_O2CApproval(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
			...
			currentNode.assignCategory("REST");
			setupO2cApproval(chMsisdn, productCode, txnId);
			o2CStockApprovalRequestPojo.getO2cStockAppRequests().get(0).setTxnId("");
			O2CStockApprovalResponsePojo response = performO2cStockApproval();
		...
		@Test(dataProvider = "userData")
		@TestManager(TestKey="PRETUPS-9798")
		public void B_11_blank_Msisdn_O2CApproval(String opCategoryName,String opLoginId,String opPassword,String opPin,String cpParentName,String chCategoryName,String chMsisdn, String productCode,String chPin,String chLoginId, String chPassword) throws Exception {
