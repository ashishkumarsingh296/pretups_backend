...
@ModuleManager(name = Module.DVD_TEMPLATE)
public class DvdDownloadTemplate extends BaseTest {
	...
	public void A_01_Test_success(String loginID, String password, String msisdn, String PIN, String parentName, String categoryName, String categorCode)throws Exception {
		...
		dvdTemplateResponsePojo = dvdTemplateApi
				.getAPIResponseAsPOJO(DvdTemplateResponsePojo.class);

		long statusCode = dvdTemplateResponsePojo.getStatus();
	...
	public void A_02_Test_invalid_token(String loginID, String password, String msisdn, String PIN, String parentName, String categoryName, String categorCode) throws Exception {
		...
		currentNode = test.createNode(MessageFormat.format(CaseMaster.getExtentCase(),categoryName));
		currentNode.assignCategory("REST");
		DvdTemplateApi dvdTemplateApi = new DvdTemplateApi(_masterVO.getMasterValue(MasterI.WEB_URL_REST_SWAGGER), accessToken+new RandomGeneration().randomAlphabets(4));
		dvdTemplateApi.setContentType(_masterVO.getProperty("contentType"));
		dvdTemplateApi.setExpectedStatusCode(401);
		dvdTemplateApi.perform();
		dvdTemplateResponsePojo = dvdTemplateApi
				.getAPIResponseAsPOJO(DvdTemplateResponsePojo.class);
		String status = dvdTemplateResponsePojo.getMessageCode();
