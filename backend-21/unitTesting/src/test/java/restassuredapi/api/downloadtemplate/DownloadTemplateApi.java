...
public class DownloadTemplateApi extends BaseAPI {

	String apiPath = "/v1/channelUserServices/downloadUsersBatch";
	String contentType;
	...
	public DownloadTemplateApi(String baseURI, String accessToken) {
		super(baseURI);
