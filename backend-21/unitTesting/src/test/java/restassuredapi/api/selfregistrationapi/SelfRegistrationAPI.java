package restassuredapi.api.selfregistrationapi;
...
public class SelfRegistrationAPI extends BaseAPI {
	String apiPath="SystemReceiver";
	String contentType;
	...
	public SelfRegistrationAPI(String baseURI) {
		super(baseURI);
	}
