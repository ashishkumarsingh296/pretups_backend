...
public class CommissionGeoGradeAPI extends BaseAPI {

	String apiPath = "v1/networkadmin/commissionProfile/geoGradeList";
	...
	public CommissionGeoGradeAPI(String baseURI, String accessToken) {
		super(baseURI);
