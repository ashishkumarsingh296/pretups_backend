package restassuredapi.api.c2cfileupload;
...
public class C2CFileUploadApi extends BaseAPI {

	String apiPath = "/v1/c2cFileServices/uploadFile";
	String contentType;
	String category;
	...
	public C2CFileUploadApi(String baseURI, String accessToken) {
		super(baseURI);
	...
	public void addBodyParam(C2CFileUploadApiRequestPojo c2CFileUploadApiRequestPojo) {
