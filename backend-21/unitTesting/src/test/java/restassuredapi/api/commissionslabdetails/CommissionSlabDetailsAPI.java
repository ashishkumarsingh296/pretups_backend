package restassuredapi.api.commissionslabdetails;
...
public class CommissionSlabDetailsAPI extends BaseAPI {
	
	String apiPath = "/v1/pretupsUIReports/getCommissionSlabDetails";
	String contentType;
	String accessToken;
	String categoryCode;
	String domainCode;
	...
	public CommissionSlabDetailsAPI(String baseURI, String accessToken) {
		super(baseURI);
		this.accessToken = accessToken;
	}
		
	public CommissionSlabDetailsAPI(String baseURI) {
		super(baseURI);
	}
