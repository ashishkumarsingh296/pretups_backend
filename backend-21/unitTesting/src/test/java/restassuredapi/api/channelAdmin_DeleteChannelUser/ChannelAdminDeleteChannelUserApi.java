package restassuredapi.api.channelAdmin_DeleteChannelUser;
...
public class ChannelAdminDeleteChannelUserApi extends BaseAPI {
	...
	public ChannelAdminDeleteChannelUserApi(String baseURI, String accessToken) {
		super(baseURI);
