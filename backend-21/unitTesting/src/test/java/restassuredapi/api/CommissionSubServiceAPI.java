...
public class CommissionSubServiceAPI extends BaseAPI {

	String apiPath = "v1/networkadmin/commissionProfile/getSubServiceList";
	...
	public CommissionSubServiceAPI(String baseURI, String accessToken) {
		super(baseURI);
	...
	protected void createRequest() {
		...
		requestSpecBuilder.addQueryParam("serviceCode", serviceCode);
		requestSpecBuilder.addHeader("Authorization", "");
		requestSpecification = requestSpecBuilder.build();
		HashMap<String, String> queryParams = new HashMap<String, String>();
		HashMap<String, String> pathParams = new HashMap<String, String>();
		queryParams.put("serviceCode", serviceCode);
