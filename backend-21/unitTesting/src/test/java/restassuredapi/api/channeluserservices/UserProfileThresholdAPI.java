...
public class UserProfileThresholdAPI extends BaseAPI{
	String apiPath="/v1/channelUsers/userthreshold";
	String contentType;
	String userId;
	String accessToken;
	...
	public UserProfileThresholdAPI(String baseURI, String accessToken) {
		super(baseURI);
