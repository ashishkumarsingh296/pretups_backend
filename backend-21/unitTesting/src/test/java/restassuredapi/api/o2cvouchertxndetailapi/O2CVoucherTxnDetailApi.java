package restassuredapi.api.o2cvouchertxndetailapi;
...
public class O2CVoucherTxnDetailApi extends BaseAPI {

	String apiPath = "/v1/c2sReceiver/o2cvoucherdetails";
	String contentType;
	...
	public O2CVoucherTxnDetailApi(String baseURI,String accessToken) {
		super(baseURI);
