package restassuredapi.api.o2cstocktxndetailapi;
...
public class O2CStockTxnDetailApi extends BaseAPI {

	String apiPath = "/v1/c2sReceiver/o2cstockdetails";
	String contentType;
	...
	public O2CStockTxnDetailApi(String baseURI,String accessToken) {
		super(baseURI);
