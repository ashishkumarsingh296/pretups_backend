package restassuredapi.api.c2cstocktxndetailapi;
...
public class C2CStockTxnDetailApi extends BaseAPI {

	String apiPath = "/v1/c2sReceiver/c2cstockdetails";
	String contentType;
	...
	public C2CStockTxnDetailApi(String baseURI,String accessToken) {
		super(baseURI);
