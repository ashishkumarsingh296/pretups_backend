...
import com.Features.mapclasses.PostpaidBillPaymentMap;
...
@ModuleManager(name = Module.SIT_Postpaid_Bill_Payment)
public class SIT_PostpaidBillPayment extends BaseTest {
	...
	PostpaidBillPaymentMap c2strfMap1;
	...
	String type;
	_parser parser;
	String[] caseIDs = new String[]{"SITPPB1","SITPPB2","SITPPB3","SITPPB4","SITPPB5",
			"SITPPB6","SITPPB7","SITPPB8","SITPPB9","SITPPB10","SITPPB11","SITPPB12"};
	String moduleCode;
	...
	public void dataC2SPost(){
		...
		c2strfMap1 = new PostpaidBillPaymentMap();
		...
		c2strfMap = c2strfMap1.getC2SPostpaidMap();
	}
	
	
	@Test
	@TestManager(TestKey = "PRETUPS-395") // TO BE UNCOMMENTED WITH JIRA TEST ID
	public void a_C2Srecharge()	throws Exception {
		final String methodName = "Test_PostpaidBillPayment";
        Log.startTestCase(methodName);
		currentNode = test.createNode(_masterVO.getCaseMasterByID(caseIDs[0]).getExtentCase());
		currentNode.assignCategory("SIT");
		String amount = "121";

		String subsmsisdn =UniqueChecker.generate_subscriber_MSISDN("Postpaid");
	...
	@Test
	@TestManager(TestKey = "PRETUPS-414") // TO BE UNCOMMENTED WITH JIRA TEST ID
	...
	@Test
	@TestManager(TestKey = "PRETUPS-415") // TO BE UNCOMMENTED WITH JIRA TEST ID
	public void c_C2Srecharge()	throws IOException, InterruptedException {
		...
		String actual;
		String expected = MessagesDAO.getC2SLabelByKey("9972");
		try{
		c2STransfer.performC2STransfer(c2strfMap.get("parentCategory"), c2strfMap.get("fromCategory"), c2strfMap.get("fromPIN"),c2strfMap.get("service"),"100",UniqueChecker.generate_subscriber_MSISDN("Postpaid"));
		actual = getMessage.getActualMessage();
		Assertion.assertEquals(actual, expected);
		}
		catch(Exception e){
	...
	@Test
	@TestManager(TestKey = "PRETUPS-416") // TO BE UNCOMMENTED WITH JIRA TEST ID
	public void d_C2Srecharge(){
		...
		String actual; 
		String expected = MessagesDAO.getC2SLabelByKey("9970");
		try{
			c2STransfer.performC2STransfer(c2strfMap.get("parentCategory"), c2strfMap.get("fromCategory"), c2strfMap.get("fromPIN"),c2strfMap.get("service"),"100",UniqueChecker.generate_subscriber_MSISDN("Postpaid"));
			actual = getMessage.getActualMessage();
			Assertion.assertEquals(actual, expected);	
	...
	@Test
	@TestManager(TestKey = "PRETUPS-419") // TO BE UNCOMMENTED WITH JIRA TEST ID
	...
	@Test
	@TestManager(TestKey = "PRETUPS-422") // TO BE UNCOMMENTED WITH JIRA TEST ID
	public void f_C2Srecharge()	throws IOException, InterruptedException {
		...
		try{
			c2STransfer.performC2STransfer(c2strfMap.get("parentCategory"), c2strfMap.get("fromCategory"), c2strfMap.get("fromPIN"),c2strfMap.get("service"),"60",UniqueChecker.generate_subscriber_MSISDN("Postpaid"));
			actual = getMessage.getActualMessage();
			Assertion.assertEquals(actual, expected);	
		}
			catch(Exception e){
	...
	@Test
	@TestManager(TestKey = "PRETUPS-424") // TO BE UNCOMMENTED WITH JIRA TEST ID
	public void g_C2Srecharge()	throws IOException, InterruptedException {
		...
		try{
			c2STransfer.performC2STransfer(c2strfMap.get("parentCategory"), c2strfMap.get("fromCategory"), c2strfMap.get("fromPIN"),c2strfMap.get("service"),"101",UniqueChecker.generate_subscriber_MSISDN("Postpaid"));
			actual = getMessage.getActualMessage();
			Assertion.assertEquals(actual, expected);	
		}
			catch(Exception e){
	...
	@Test
	@TestManager(TestKey = "PRETUPS-433") // TO BE UNCOMMENTED WITH JIRA TEST ID
	...
	@Test
	@TestManager(TestKey = "PRETUPS-453") // TO BE UNCOMMENTED WITH JIRA TEST ID
	...
	@Test
	@TestManager(TestKey = "PRETUPS-501") // TO BE UNCOMMENTED WITH JIRA TEST ID
	...
	@Test
	@TestManager(TestKey = "PRETUPS-504") // TO BE UNCOMMENTED WITH JIRA TEST ID
	public void k_PrivatePostPaidBillpayment()	throws Exception {
		final String methodName = "Test_PostpaidBillPayment";
        Log.startTestCase(methodName);
		PrivateRecharge prvtRc = new PrivateRecharge(driver);
		C2STransfer c2STransfer = new C2STransfer(driver);
		//PostpaidBillPaymentMap c2strfMap = new PostpaidBillPaymentMap();
		currentNode = test.createNode(_masterVO.getCaseMasterByID(caseIDs[11]).getExtentCase());
		currentNode.assignCategory("SIT");
		String amount = "121";
		
		String subsmsisdn=UniqueChecker.UC_MSISDN_ALIAS("POST");
		String SID = UniqueChecker.UC_SubsSID();
		prvtRc.privateRechargeRegistration(true,subsmsisdn,SID);
		c2STransfer.performC2STransfer(c2strfMap.get("parentCategory"), c2strfMap.get("fromCategory"), c2strfMap.get("fromPIN"),c2strfMap.get("service"),amount,SID);
