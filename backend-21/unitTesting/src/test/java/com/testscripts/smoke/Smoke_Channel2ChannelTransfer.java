...
@ModuleManager(name = Module.SMOKE_C2C_TRANSFER)
public class Smoke_Channel2ChannelTransfer extends BaseTest {

    private HashMap<String, String> c2cMap = new HashMap<String, String>();
    private HashMap<String, String> channelMap = new HashMap<>();

    @Test(dataProvider = "categoryData")
    @TestManager(TestKey = "PRETUPS-443") // TO BE UNCOMMENTED WITH JIRA TEST CASE ID
    public void Test_C2CTransfer(String FromCategory, String ToCategory, String toMSISDN, String FromPIN, String Domain, String ParentCategory, String geoType, String catCode, int RowNum) throws InterruptedException, ParseException, SQLException {
