...
public class Smoke_C2STransferSpring extends BaseTest {
	...
	public void C2Srecharge(String FromParent, String FromCategory, String PIN,String service)
		...
		currentNode = test.createNode("To verify that Category(Parent category): " + FromCategory +"("+FromParent+ ") is able to perform C2S Recharge");
		...
		map1.put("parentCategory", FromParent);
