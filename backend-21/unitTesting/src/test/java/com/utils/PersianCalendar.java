...
public class PersianCalendar {
	...
	public String getIranianDate() {
		return BTSLDateUtil.getTwoDigit(irYear) + PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irMonth) + PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irDay);
	}
	 ...
	 * @return
	 */
	public String getIranianDate(String format) {
		if(PretupsI.DATE_FORMAT_DDMMYYYY.equalsIgnoreCase(format)) {
			return BTSLDateUtil.getTwoDigit(irDay) + PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irMonth) + 
					PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irYear);
		} else if(PretupsI.DATE_FORMAT_YYMMDD.equalsIgnoreCase(format)) {
			return BTSLDateUtil.getTwoDigit(irYear).substring(2) + PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irMonth) + 
					PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irDay);
		} else if(PretupsI.DATE_FORMAT_DDMMYY.equalsIgnoreCase(format)) {
			return BTSLDateUtil.getTwoDigit(irDay) + PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irMonth) + 
					PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irYear).substring(2);
		} else if(PretupsI.DATE_FORMAT_DDMMYYYY_HYPHEN.equalsIgnoreCase(format)) {
			return BTSLDateUtil.getTwoDigit(irDay) + PretupsI.HYPHEN + BTSLDateUtil.getTwoDigit(irMonth) + 
					PretupsI.HYPHEN + BTSLDateUtil.getTwoDigit(irYear);
			...
			return BTSLDateUtil.getTwoDigit(irYear) + PretupsI.HYPHEN + BTSLDateUtil.getTwoDigit(irMonth) + 
					PretupsI.HYPHEN + BTSLDateUtil.getTwoDigit(irDay);
			...
			return BTSLDateUtil.getTwoDigit(irYear) + PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irMonth) + 
					PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irDay);
		}/*  else if(PretupsI.DATE_FORMAT_YYYYMMMDD.equalsIgnoreCase(format)) {
			return BTSLDateUtil.getMonDate(BTSLDateUtil.getTwoDigit(irYear) + PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irMonth) + 
					PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irDay));
		}*/
		return BTSLDateUtil.getTwoDigit(irYear) + PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irMonth) + 
				PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(irDay);
	...
	public String getGregorianDate() {
		...
		/*return (BTSLDateUtil.getTwoDigit(gYear) + PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(gMonth) + 
				PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(gDay));*/
		try {
			gregorianDate = BTSLDateUtil.getStringDateInDDMMYY(BTSLDateUtil.getTwoDigit(gDay) + PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(gMonth) + 
					PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(gYear));
	...
	public String getJulianDate() {
		return (BTSLDateUtil.getTwoDigit(juYear) + PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(juMonth)
				+ PretupsI.FORWARD_SLASH + BTSLDateUtil.getTwoDigit(juDay));
	}
