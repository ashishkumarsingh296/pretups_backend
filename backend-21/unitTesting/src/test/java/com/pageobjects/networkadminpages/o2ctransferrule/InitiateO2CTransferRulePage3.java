...
public class InitiateO2CTransferRulePage3 {
	
	@FindBy(name = "toCategory")
	WebElement tocategory;
	
	@FindBy(xpath = "//*[@id='transferAllowedRule' and @value='Y']")
	WebElement transferallowedyes;
	
	@FindBy(xpath = "//*[@id='transferAllowedRule' and @value='N']")
	WebElement transferallowedno;
	...
	public InitiateO2CTransferRulePage3(WebDriver driver) {
		this.driver = driver;
	...
	public void clickTransferAllowed_Yes()
	{
		...
		transferallowedyes.click();
		Log.info("Yes option selected successfully for Transfer Allowed");
	}
	
	public void clickTransferAllowed_No()
	{
		Log.info("Trying to select No option of Transfer Allowed");
		transferallowedno.click();
		Log.info("No option selected successfully for Transfer Allowed");
	}
	...
	public void inputFirstApprovalLimit(String approvallimit)
	{
		...
		Log.info("First Approval Limit entered successfully");
	}
	...
	public void inputSecondApprovalLimit(String approvallimit)
	{
		...
		Log.info("Second Approval Limit entered successfully");
	}
