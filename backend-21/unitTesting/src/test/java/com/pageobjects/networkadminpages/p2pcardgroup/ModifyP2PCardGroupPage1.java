...
public class ModifyP2PCardGroupPage1 {
	...
	public ModifyP2PCardGroupPage1(WebDriver driver) {
		this.driver = driver;
	...
	public boolean getErrorMessagestatus() {
		boolean msg =errormessage.isDisplayed();
		return msg;
	}
