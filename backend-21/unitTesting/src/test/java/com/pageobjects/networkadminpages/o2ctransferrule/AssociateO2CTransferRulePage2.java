...
public class AssociateO2CTransferRulePage2 {
	...
	public AssociateO2CTransferRulePage2(WebDriver driver) {
		this.driver = driver;
	...
	public void selectTransferRule(String category) {
		Log.info("Trying to select Tranfer Rule for : " + category + " category");
		driver.findElement(By.xpath("//tr/td[normalize-space() = '"+category+"']/ancestor::tr/td/input[@type='radio']")).click();
