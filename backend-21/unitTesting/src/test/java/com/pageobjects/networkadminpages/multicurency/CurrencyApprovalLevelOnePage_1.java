...
public class CurrencyApprovalLevelOnePage_1 {
	
	WebDriver driver= null;
	
	@FindBy(name = "approval1confirm")
	...
	public CurrencyApprovalLevelOnePage_1(WebDriver driver) {
		this.driver = driver;
	...
	public void selectCurrencyForApproval() {
		...
		radio.click();
		Log.info("Successfully selected currency for approval1");
	...
	public String getErrorMeassage() {
		Log.info("Trying to get error message");
