...
public class ChangePinSelectionPage {
	...
	@FindBy(xpath = "//label[@for='eventRemarks' and @class='error']")
	private WebElement remarksFieldError;
	
	
	WebDriver driver = null;

	public ChangePinSelectionPage(WebDriver driver) {
		this.driver = driver;
	...
	public void enterEventRemarks(String remarks){
		...
		eventRemarks.sendKeys(remarks);
		Log.info("Entered Remarks: "+remarks);
	}
	
	public void enterLoginIdRemarks(String remarks){
		Log.info("Trying to enter Remarks");
		List<WebElement> eventRemarks = driver.findElements(By.xpath("//textarea[@id='eventRemarks']"));
		eventRemarks.get(1).clear();
		eventRemarks.get(1).sendKeys(remarks);
		Log.info("Entered Remarks: "+remarks);
	}
	
	public void enterUserNameRemarks(String remarks){
		Log.info("Trying to enter Remarks");
		List<WebElement> eventRemarks = driver.findElements(By.xpath("//textarea[@id='eventRemarks']"));
		eventRemarks.get(2).clear();
		eventRemarks.get(2).sendKeys(remarks);
		Log.info("Entered Remarks: "+remarks);
	}
	...
	public String getRemarksError(){
		Log.info("Trying to get Login ID field error");
		String errorMessage = remarksFieldError.getText();
		Log.info("Login ID field error: ");
		return errorMessage;
	}
}
