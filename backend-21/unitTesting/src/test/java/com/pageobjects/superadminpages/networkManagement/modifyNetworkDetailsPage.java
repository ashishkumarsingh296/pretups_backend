...
public class modifyNetworkDetailsPage {
	...
	public modifyNetworkDetailsPage(WebDriver driver) {
		this.driver = driver;
...
public void selectserviceSetID(String SetID){
		SetID="1";
...
public void enterLanguage1Message(String Language1Msg){

	language1Message.sendKeys(Language1Msg);
	Log.info("User entered Language1Msg as:" +Language1Msg);
}

public void enterLanguage2Message(String Language2Msg){

	language2Message.sendKeys(Language2Msg);
	Log.info("User entered Language2Msg as:" +Language2Msg);
}
