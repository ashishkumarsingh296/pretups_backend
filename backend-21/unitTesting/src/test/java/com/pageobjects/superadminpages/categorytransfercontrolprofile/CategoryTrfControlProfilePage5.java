...
public class CategoryTrfControlProfilePage5 {
	...
	public CategoryTrfControlProfilePage5(WebDriver driver) {
		this.driver = driver;
	 ...
	 */
	public void enterMaximumResidualBalance(String maximumBalance, String alertingBalance, String productCode) {
		Log.info("Trying to enter maximum balance for "+productCode+".");
		WebElement maxResBalance= driver.findElement(By.xpath("//form/table//table/tbody/tr/td[text()='"+productCode+"']/following-sibling::td[input[@name[contains(.,'maxBalance')]]]/input"));
		maxResBalance.clear();
		maxResBalance.sendKeys(maximumBalance);
		Log.info("Balance Preference 'Maximum Residual Balance' entered: "+ maximumBalance);
		Log.info("Trying to enter alerting balance for "+productCode+".");
		int alertBal = Integer.parseInt(alertingBalance);
		WebElement alertingBal = driver.findElement(By.xpath("//form/table//table/tbody/tr/td[text()='"+productCode+"']/following-sibling::td[input[@name[contains(.,'altBalance')]]]/input"));
		alertingBal.clear();
		alertingBal.sendKeys(String.valueOf(alertBal));
		Log.info("Alerting Balance entered: " + alertBal);	
	
	}

	public void enterMinimumResidualBalance(String minimumBalance, String allowedmaxpercentage, String productCode) {
		Log.info("Trying to enter minimum residual balance for "+productCode+".");
		WebElement minResBalance= driver.findElement(By.xpath("//form/table//table/tbody/tr/td[text()='"+productCode+"']/following-sibling::td[input[@name[contains(.,'minBalance')]]]/input"));
		minResBalance.clear();
		minResBalance.sendKeys(minimumBalance);
		Log.info("Balance Preference 'Minimum Residual Balance' entered: "+ minimumBalance);
		Log.info("Trying to enter allowed maximum percentage for "+productCode+".");
		int allowedmax = Integer.parseInt(allowedmaxpercentage);
		WebElement alertingBal = driver.findElement(By.xpath("//form/table//table/tbody/tr/td[text()='"+productCode+"']/following-sibling::td[input[@name[contains(.,'altBalance')]]]/input"));
		alertingBal.clear();
		alertingBal.sendKeys(String.valueOf(allowedmax));
		Log.info("Allowed max percentage entered: " + allowedmax);	
	
	}
	
	public void enterPerC2SMinimumAmt(String perC2SminimumAmt, String allowedmaxpercentage, String productCode) {
		Log.info("Trying to enter Per C2S Minimum amount for "+productCode+".");
		WebElement perC2SminAmt= driver.findElement(By.xpath("//form/table//table/tbody/tr/td[text()='"+productCode+"']/following-sibling::td[input[@name[contains(.,'c2sMinTxnAmt')]]]/input"));
		perC2SminAmt.clear();
		perC2SminAmt.sendKeys(perC2SminimumAmt);
		Log.info("Preference 'Per C2S Minimum Amount' entered: "+ perC2SminimumAmt);
		Log.info("Trying to enter allowed maximum percentage for "+productCode+".");
		int allowedmax = Integer.parseInt(allowedmaxpercentage);
		WebElement alertingBal = driver.findElement(By.xpath("//form/table//table/tbody/tr/td[text()='"+productCode+"']/following-sibling::td[input[@name[contains(.,'allowedMaxPercentage')]]]/input"));
		alertingBal.clear();
		alertingBal.sendKeys(String.valueOf(allowedmax));
		Log.info("Allowed max percentage entered: " + allowedmax);	
	}
	
	public void enterPerC2SMaximumAmt(String perC2SmaximumAmt, String allowedmaxpercentage, String productCode) {
		Log.info("Trying to enter Per C2S maximum amount for "+productCode+".");
		WebElement perC2SmaxAmt= driver.findElement(By.xpath("//form/table//table/tbody/tr/td[text()='"+productCode+"']/following-sibling::td[input[@name[contains(.,'c2sMaxTxnAmt')]]]/input"));
		perC2SmaxAmt.clear();
		perC2SmaxAmt.sendKeys(perC2SmaximumAmt);
		Log.info("Preference 'Per C2S maximum Amount' entered: "+ perC2SmaximumAmt);
		Log.info("Trying to enter allowed maximum percentage for "+productCode+".");
		int allowedmax = Integer.parseInt(allowedmaxpercentage);
		WebElement alertingBal = driver.findElement(By.xpath("//form/table//table/tbody/tr/td[text()='"+productCode+"']/following-sibling::td[input[@name[contains(.,'allowedMaxPercentage')]]]/input"));
		alertingBal.clear();
	...
	public void enterProductValues(String[] parameter, String productCode,String[] value) {
		for(int paramCount=0;paramCount<parameter.length;paramCount++){
		Log.info("Trying to enter ["+parameter[paramCount]+"] for "+productCode+".");
		WebElement vElement= driver.findElement(By.xpath("//form/table//table/tbody/tr/td[text()='"+productCode+"']/following-sibling::td[input[@name[contains(.,'"+parameter[paramCount]+"')]]]/input"));
		vElement.clear();
		vElement.sendKeys(value[paramCount]);
		Log.info("Value for ["+parameter[paramCount]+"] entered: "+ value[paramCount]);}
	}
}
