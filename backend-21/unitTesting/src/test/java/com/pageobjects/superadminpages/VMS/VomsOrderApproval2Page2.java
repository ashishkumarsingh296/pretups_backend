...
public class VomsOrderApproval2Page2 {

    WebDriver driver = null;
	public VomsOrderApproval2Page2(WebDriver driver) {
		this.driver = driver;
	...
	public boolean checkParticularProfileAvailable(String mrp, String quantity) {
		boolean elementDisplayed = false;
		WebElement element = null;
		StringBuilder TransferRuleX = new StringBuilder();
		TransferRuleX.append("//tr/td[normalize-space() = '"+ mrp +"']/following-sibling::td[normalize-space() = '"+ quantity +"']");
		element= driver.findElement(By.xpath(TransferRuleX.toString()));
		elementDisplayed = element.isDisplayed();
		return elementDisplayed;
	}
	
	public boolean checkParticularProfileAvailableNegative(String mrp) {
		boolean elementDisplayed = false;
		WebElement element = null;
		StringBuilder TransferRuleX = new StringBuilder();
