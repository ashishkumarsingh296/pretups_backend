...
public class ModifyVoucherProfile {

	WebDriver driver = null;
	public ModifyVoucherProfile(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(name = "selectSubmitGreater" )
	private WebElement selectSubmitGreater;
