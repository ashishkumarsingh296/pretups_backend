...
public class VomsOrderApproval3Page1 {

	WebDriver driver = null;
	public VomsOrderApproval3Page1(WebDriver driver) {
		this.driver = driver;
	...
	public boolean UpdatedQuanityavialble(String value){
		boolean elementDisplayed = false;
		WebElement element = null;
		StringBuilder TransferRuleX = new StringBuilder();
		TransferRuleX.append("//td[normalize-space()= '" + value + "']");
