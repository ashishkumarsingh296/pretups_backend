...
public class ApproveLevel3Page {
	...
	public ApproveLevel3Page(WebDriver driver) {
		this.driver = driver;
	...
	public String getMessage() {
		new WebDriverWait(driver, 5).until(ExpectedConditions.visibilityOf(SuccessMessage));
