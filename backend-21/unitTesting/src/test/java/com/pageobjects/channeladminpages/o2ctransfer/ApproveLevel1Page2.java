...
public class ApproveLevel1Page2 {
	...
	public ApproveLevel1Page2(WebDriver driver) {
		this.driver = driver;
	...
	public boolean isVisibleTransferNumber(String TransferNumber) {
		Log.info("Trying to check visibility Radio Button for specific Transaction ID");
		return driver.findElement(By.xpath("//tr/td[normalize-space() = '"+ TransferNumber +"']/ancestor::tr/td/input[@type='radio']")).isDisplayed();
	}
