...
public class SuspendChannelUserHierarchy {
	
	WebDriver driver = null;
	public SuspendChannelUserHierarchy(WebDriver driver) {
		this.driver = driver;
	...
	public void SelectGeoDomain(String geoDomain){
		...
		select.selectByValue(geoDomain);
		Log.info("Geographical Domain selected  successfully as:"+ geoDomain);
		}
