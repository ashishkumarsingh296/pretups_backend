...
import com.apicontrollers.ussd.Transfer.USSDPlain_TRANSFER_API;
...
public class USSDPlain_SETPIN extends BaseTest {
	...
	public void A1_SetPinAPI() throws SQLException, ParseException {
		...
		HashMap<String, String> apiData = USSDPlain_SETPIN_DP.getAPIdata();
		...
		USSDPlain_SETPIN_DP.setPIN(APIResponse[2]);
	}
	...
	public void H8_setPin() throws SQLException, ParseException, InterruptedException {
		...
		USSDPlain_TRANSFER_API C2CTransferAPI = new USSDPlain_TRANSFER_API();
	...
	public HashMap<String, String> c2ctransferData(){
		...
		USSDPlain_SETPIN_API chngPIN = new USSDPlain_SETPIN_API();
		
		HashMap<String, String> c2capiDATA = USSDPlain_TRANSFER_DP.getAPIdata();
		HashMap<String, String> apiDATA = USSDPlain_SETPIN_DP.getAPIdata();
