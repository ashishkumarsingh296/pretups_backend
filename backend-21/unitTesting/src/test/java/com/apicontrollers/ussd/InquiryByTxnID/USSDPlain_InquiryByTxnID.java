...
import com.apicontrollers.extgw.c2ctransfer.EXTGWPlainC2CAPI;
import com.apicontrollers.extgw.c2ctransfer.EXTGWPlainC2CDP;
...
import com.apicontrollers.ussd.Transfer.USSDPlain_TRANSFER_DP;
import com.apicontrollers.ussd.Transfer.USSD_TRANSFER_API;
import com.apicontrollers.ussd.c2stransfer.USSDC2SAPI;
import com.apicontrollers.ussd.c2stransfer.USSDPlainC2SDP;
...
public class USSDPlain_InquiryByTxnID extends BaseTest {
    ...
    public void TCA1_PositiveINQAPI() throws Exception {
        ...
        USSDPlain_Inquiry_API inquiryAPI = new USSDPlain_Inquiry_API();
        ...
        HashMap<String, String> apiData = USSDPlain_Inquiry_DP.getAPIdata();
    ...
    public void TCI9_NegativeINQAPI() throws Exception {
        ...
        String[] APIResponse_o2c = _APIUtil.executePlainAPI(GatewayI.EXTGW, ServicesControllerI.C2SReceiver, API_o2c);
    ...
    public void TCJ10_PositiveINQAPI() throws Exception {
        ...
        String[] APIResponse_C2S = _APIUtil.executePlainAPI(GatewayI.EXTGW, ServicesControllerI.C2SReceiver, API_C2S);
    ...
    public void TCK11_PositiveINQAPI() throws Exception {
        ...
        HashMap<String, String> apiDataC2S = USSDPlainC2SDP.getAPIdata();
        String API_C2S = C2STransferAPI.prepareAPI(apiDataC2S);
        String[] APIResponse_C2S = _APIUtil.executePlainAPI(GatewayI.USSD, ServicesControllerI.C2SReceiver, API_C2S);
        _APIUtil.addExecutionRecord(CaseMaster, APIResponse_C2S);
        XmlPath xmlPath_c2s = new XmlPath(CompatibilityMode.HTML, APIResponse_C2S[1]);
    ...
    public void TCL12_NegativeINQAPI() throws Exception {
        ...
        HashMap<String, String> apiDataC2C = USSDPlain_TRANSFER_DP.getAPIdata();
        String API_C2C = transferAPI.prepareAPI(apiDataC2C);
        String[] APIResponse_C2C = _APIUtil.executePlainAPI(GatewayI.USSD, ServicesControllerI.C2SReceiver, API_C2C);
    ...
    public void TCL13_NegativeINQAPI() throws Exception {
        ...
        HashMap<String, String> apiDataC2C = EXTGWPlainC2CDP.getAPIdata();
        String API_C2C = C2CTransferAPI.prepareAPI(apiDataC2C);
        String[] APIResponse_C2C = _APIUtil.executePlainAPI(GatewayI.USSD, ServicesControllerI.C2SReceiver, API_C2C);
        _APIUtil.addExecutionRecord(CaseMaster, APIResponse_C2C);
        XmlPath xmlPath_c2c = new XmlPath(CompatibilityMode.HTML, APIResponse_C2C[1]);
        String txnID = xmlPath_c2c.get(EXTGWPlainC2CAPI.TXNID).toString();
        currentNode = test.createNode(CaseMaster.getDescription());
        currentNode.assignCategory(extentCategory);
        HashMap<String, String> apiData = USSDPlain_Inquiry_DP.getAPIdata();
        apiData.put("TXNID", txnID);
