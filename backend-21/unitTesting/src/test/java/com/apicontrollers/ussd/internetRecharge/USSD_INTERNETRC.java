...
public class USSD_INTERNETRC extends BaseTest {
    ...
    public void TC_InternetRC01_Positive() throws Exception {
        ...
        USSD_INTERNETRCAPI USSDINTRCAPI = new USSD_INTERNETRCAPI();
        ...
        Object[] dataObject = USSD_INTERNETRCDP.getAPIdataWithAllUsers();

        for (int i = 0; i < dataObject.length; i++) {

            USSD_INTERNETRCDAO APIDAO = (USSD_INTERNETRCDAO) dataObject[i];
            ...
            Validator.messageCompare(xmlPath.get(USSD_INTERNETRCAPI.TXNSTATUS).toString(), CaseMaster.getErrorCode());
        }
    }
    ...
    public void TC_InternetRC02_NegativeInternetRCAPI_BlankPin() throws Exception {
        ...
        HashMap<String, String> dataMap = USSD_INTERNETRCDP.getAPIdata();
...
//Case commented because EXTNWCODE does not exist in InternetRCAPI
  //  @Test
    ...
    public void TC_InternetRC16_suspendAdditionalCommProfile()
        ...
        long time2 = CommissionProfile.suspendAdditionalCommProfileForGivenService(USSD_INTERNETRCDP.Domain, USSD_INTERNETRCDP.CUCategory, USSD_INTERNETRCDP.grade, USSD_INTERNETRCDP.CPName, service,_masterVO.getProperty("InternetRechargeCode"));
        ...
        _APIUtil.addExecutionRecord(CaseMaster, APIResponse);
        XmlPath xmlPath = new XmlPath(CompatibilityMode.HTML, APIResponse[1]);
        Log.info("The Txn status is " + xmlPath.get(USSD_INTERNETRCAPI.TXNSTATUS).toString());


        Transfer_ID = xmlPath.get(USSD_INTERNETRCAPI.TXNID);
 ...
 @Test
    public void TC_InternetRC17_resumeAdditionalCommProfile()
        ...
        long time = CommissionProfile.resumeAdditionalCommProfileForGivenService(USSD_INTERNETRCDP.Domain, USSD_INTERNETRCDP.CUCategory, USSD_INTERNETRCDP.grade, USSD_INTERNETRCDP.CPName, service,_masterVO.getProperty("InternetRechargeCode"));
        ...
        Transfer_ID1 = xmlPath.get(USSD_INTERNETRCAPI.TXNID);
    ...
    public void TC_InternetRC18_NegativeSuspendTCP() throws Exception {
        ...
        currentNode = test.createNode(CaseMaster.getExtentCase());
        currentNode.assignCategory(extentCategory);
        HashMap<String, String> apiData = USSD_INTERNETRCDP.getAPIdata();
        String API = USSDINTRCAPI.prepareAPI(apiData);

        TCPObj.channelLevelTransferControlProfileSuspend(0, USSD_INTERNETRCDP.Domain, USSD_INTERNETRCDP.CUCategory, USSD_INTERNETRCDP.TCPName, null);

        String[] APIResponse = null;

        try {
            APIResponse = _APIUtil.executeAPI(GatewayI.USSD, ServicesControllerI.C2SReceiver, API);
            _APIUtil.addExecutionRecord(CaseMaster, APIResponse);
        } catch (Exception e) {
        ...
        TCPObj.channelLevelTransferControlProfileActive(0, USSD_INTERNETRCDP.Domain, USSD_INTERNETRCDP.CUCategory, USSD_INTERNETRCDP.TCPName, null);
    ...
    public void TC_InternetRC19_Negative_SenderOutSuspended() throws Exception {
        ...
        ChannelUser.modifyChannelUserDetails(USSD_INTERNETRCDP.CUCategory, channelMap);
    ...
    public void TC_InternetRC20_Negative__MinResidualBalance() throws Exception {
        ...
        String balance = DBHandler.AccessHandler.getUserBalance(USSD_INTERNETRCDP.ProductCode, USSD_INTERNETRCDP.LoginID);
        ...
        trfCntrlProf.modifyProductValuesInTCP(USSD_INTERNETRCDP.Domain, USSD_INTERNETRCDP.CUCategory, USSD_INTERNETRCDP.TCPID, parameters, values, USSD_INTERNETRCDP.ProductName, true);
    ...
    public void TC_InternetRC21_Negative__C2SMinAmount() throws Exception {
        ...
        trfCntrlProf.modifyTCPPerC2SminimumAmt(USSD_INTERNETRCDP.Domain, USSD_INTERNETRCDP.CUCategory, USSD_INTERNETRCDP.TCPID, "100", "100", USSD_INTERNETRCDP.ProductName);
        ...
        trfCntrlProf.modifyTCPPerC2SminimumAmt(USSD_INTERNETRCDP.Domain, USSD_INTERNETRCDP.CUCategory, USSD_INTERNETRCDP.TCPID, _masterVO.getProperty("MinimumBalance"), _masterVO.getProperty("AllowedMaxPercentage"), USSD_INTERNETRCDP.ProductName);
    ...
    public void TC_InternetRC22_C2STaxAdditionalCommProfile()
        ...
        String actual = CommissionProfile.getCommissionSlabCount(USSD_INTERNETRCDP.Domain, USSD_INTERNETRCDP.CUCategory, USSD_INTERNETRCDP.grade);
        Log.info(actual);
        ...
        long time2 = CommissionProfile.modifyAdditionalCommissionProfile_SITService(AddCommMap, USSD_INTERNETRCDP.Domain, USSD_INTERNETRCDP.CUCategory, USSD_INTERNETRCDP.grade, USSD_INTERNETRCDP.CPName, service,_masterVO.getProperty("InternetRechargeCode"));
        ...
        CommissionProfile.modifyAdditionalCommissionProfile_SITService(slabMap, USSD_INTERNETRCDP.Domain, USSD_INTERNETRCDP.CUCategory, USSD_INTERNETRCDP.grade, USSD_INTERNETRCDP.CPName, service,_masterVO.getProperty("InternetRechargeCode"));
 ...
 @Test
    ...
    public void TC_InternetRC24_C2STimeSlabAdditionalCommProfile()
        ...
        long time2 = CommissionProfile.modifyAdditionalCommissionProfile_TimeSlab_ParticularService(slabMap, USSD_INTERNETRCDP.Domain, USSD_INTERNETRCDP.CUCategory, USSD_INTERNETRCDP.grade, USSD_INTERNETRCDP.CPName, service,_masterVO.getProperty("InternetRechargeCode"));
        ...
        ExtentI.Markup(ExtentColor.TEAL, "Reverting changed values Additional Commission Profile slab");
        CommissionProfile.modifyAdditionalCommissionProfile_SITService(AddCommMap, USSD_INTERNETRCDP.Domain, USSD_INTERNETRCDP.CUCategory, USSD_INTERNETRCDP.grade, USSD_INTERNETRCDP.CPName, service,_masterVO.getProperty("InternetRechargeCode"));
        ExtentI.Markup(ExtentColor.TEAL, "Reverted values Additional Commission Profile slab");
    ...
    @Test
    public void TC_InternetRC27_Negative() throws Exception {

        CaseMaster CaseMaster = _masterVO.getCaseMasterByID("USSDINTRC27");
        USSD_INTERNETRCAPI USSDINTRCAPI = new USSD_INTERNETRCAPI();
        ...
        if (TestCaseCounter == false) {
           ...
           HashMap<String, String> apiData = USSD_INTERNETRCDP.getAPIdata();
            ...
            ExtentI.Markup(ExtentColor.TEAL, "Barring Channel User");
             BarUnbar.barringUser("C2S", "SENDER", apiData.get(USSDINTRCAPI.MSISDN1));
            ...
            XmlPath xmlPath = new XmlPath(CompatibilityMode.HTML, APIResponse[1]);
            Validator.messageCompare(xmlPath.get(USSD_INTERNETRCAPI.TXNSTATUS).toString(), CaseMaster.getErrorCode());
             BarUnbar.unBarringUser("C2S", "SENDER", apiData.get(USSDINTRCAPI.MSISDN1));
        }
    @Test
    public void TC_InternetRC28_Negative() throws Exception {

        CaseMaster CaseMaster = _masterVO.getCaseMasterByID("USSDINTRC28");
        USSD_INTERNETRCAPI USSDINTRCAPI = new USSD_INTERNETRCAPI();
        ...
        BarUnbar BarUnbar = new BarUnbar(driver);
        ExtentI.Markup(ExtentColor.TEAL, "Barring Channel User");
        BarUnbar.barringUser("C2S", "RECEIVER", apiData.get(USSDINTRCAPI.MSISDN1));
        ...
        XmlPath xmlPath = new XmlPath(CompatibilityMode.HTML, APIResponse[1]);
        Validator.messageCompare(xmlPath.get(USSD_INTERNETRCAPI.TXNSTATUS).toString(), CaseMaster.getErrorCode());
        BarUnbar.unBarringUser("C2S", "RECEIVER", apiData.get(USSDINTRCAPI.MSISDN1));
    }
    @Test
    public void TC_InternetRC29_Negative() throws Exception {

        CaseMaster CaseMaster = _masterVO.getCaseMasterByID("USSDINTRC29");
        USSD_INTERNETRCAPI USSDINTRCAPI = new USSD_INTERNETRCAPI();
        ...
        BarUnbar BarUnbar = new BarUnbar(driver);
        ExtentI.Markup(ExtentColor.TEAL, "Barring Channel User");
        BarUnbar.barringUser("C2S", "RECEIVER", apiData.get(USSDINTRCAPI.MSISDN2));
        ...
        XmlPath xmlPath = new XmlPath(CompatibilityMode.HTML, APIResponse[1]);
        Validator.messageCompare(xmlPath.get(USSD_INTERNETRCAPI.TXNSTATUS).toString(), CaseMaster.getErrorCode());
        BarUnbar.unBarringUser("C2S", "RECEIVER", apiData.get(USSDINTRCAPI.MSISDN2));
    }
    }
