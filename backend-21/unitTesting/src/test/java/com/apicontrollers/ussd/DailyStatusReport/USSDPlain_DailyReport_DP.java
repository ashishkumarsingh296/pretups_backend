...
public class USSDPlain_DailyReport_DP extends CaseMaster{
	...
	public static HashMap<String, String> getAPIdata() {
		...
		for (int i = 0; i<=dataRowCounter;i++) {
			...
			{
				apiData.put(dailyStatusAPI.MSISDN1, ExcelUtility.getCellData(0, ExcelI.MSISDN, i));
				apiData.put(dailyStatusAPI.PIN, ExcelUtility.getCellData(0, ExcelI.PIN, i));
				break;
			}
