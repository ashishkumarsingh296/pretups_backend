...
public class EXTGW_LastTransactionAPI {
	 ...
	 */
	private final String API_LastTransaction_RMP = "<?xml version=\"1.0\"?><COMMAND>"
			+ "<TYPE>EXLSTTRFREQ</TYPE>"
			+ "<DATE></DATE>"
			+ "<EXTNWCODE></EXTNWCODE>"
			+ "<MSISDN></MSISDN>"
			+ "<PIN></PIN>"
	...
	private String getAPI() {
		return API_LastTransaction_RMP;
	}
