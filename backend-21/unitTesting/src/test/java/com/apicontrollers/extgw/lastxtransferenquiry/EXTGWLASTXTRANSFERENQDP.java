...
public class EXTGWLASTXTRANSFERENQDP extends CaseMaster{
	...
	public static HashMap<String, String> getAPIdata(String serviceCode) throws Exception {
		...
		EXTGWLASTXTRANSFERENQAPI C2STransferAPI = new EXTGWLASTXTRANSFERENQAPI();
		//c2stransferStatusAPI c2stransferStatusAPI = new c2stransferStatusAPI();
		GenerateMSISDN gnMsisdn = new GenerateMSISDN();
		String CustomerRechargeCode = serviceCode;
				//_masterVO.getProperty("MVDRechargeCode");
		...
		for (int i = 0; i<=dataRowCounter;i++) {
			...
			if (excelCategory.equals(channelUserCategory)) {
				apiData.put(EXTGWLASTXTRANSFERENQAPI.MSISDN, ExcelUtility.getCellData(0, ExcelI.MSISDN, i));
				apiData.put(EXTGWLASTXTRANSFERENQAPI.PIN, _APIUtil.implementEncryption(ExcelUtility.getCellData(0, ExcelI.PIN, i)));
				...
				apiData.put(EXTGWLASTXTRANSFERENQAPI.LOGINID, ExcelUtility.getCellData(0, ExcelI.LOGIN_ID, i));
				apiData.put(EXTGWLASTXTRANSFERENQAPI.PASSWORD, _APIUtil.implementEncryption(ExcelUtility.getCellData(0, ExcelI.PASSWORD, i)));
