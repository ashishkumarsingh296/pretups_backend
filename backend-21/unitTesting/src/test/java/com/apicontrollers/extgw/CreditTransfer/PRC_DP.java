...
public class PRC_DP {
	...
	apiData.put(CreditTransAPI.INFO1,"Credit Transfer Request");
	apiData.put(CreditTransAPI.INFO2,"Credit Transfer Request");
	apiData.put(CreditTransAPI.INFO3,"Credit Transfer Request");
	apiData.put(CreditTransAPI.INFO4,"Credit Transfer Request");
	apiData.put(CreditTransAPI.INFO5,"Credit Transfer Request");
