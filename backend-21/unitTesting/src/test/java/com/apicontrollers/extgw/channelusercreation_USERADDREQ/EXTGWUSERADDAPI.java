...
public class EXTGWUSERADDAPI {
	...
	public final String GEOGRAPHYCODE="GEOGRAPHYCODE";
	public final String PARENTMSISDN="PARENTMSISDN";
	public final String PARENTEXTERNALCODE="PARENTEXTERNALCODE";
	public final String USERCATCODE="USERCATCODE";
	...
	private static String USERADDAPI ="<?xml version=\"1.0\"?>"
			...
			+ "<PARENTEXTERNALCODE></PARENTEXTERNALCODE>"
			+ "<USERCATCODE></USERCATCODE>"
			+ "<USERNAME></USERNAME>"
			+ "<SHORTNAME></SHORTNAME>"
