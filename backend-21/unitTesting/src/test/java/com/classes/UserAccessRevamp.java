...
public class UserAccessRevamp extends BaseTest{
...
/*    @Override
    ...
    public static Map<String, String> getUserWithAccess(String RoleCode) {
    	...
    	for (int i = 0; i<CONSTANT.USERACCESSDAOREVAMP.length; i++) {
    		if (CONSTANT.USERACCESSDAOREVAMP[i][3].equals(RoleCode)) {
    			Array.add(CONSTANT.USERACCESSDAOREVAMP[i][4].toString());
    		}
    	}
    ...
    public static Map<String, String> getUserWithAccessRevamp(String RoleCode, String EventCode) {
    	Log.info("Trying to get User with Access: " + RoleCode + "," + EventCode);
    	ArrayList<String> Array = new ArrayList<String>();
    	Map<String, String> resultMap = new HashMap<String, String>();
    	for (int i = 0; i<CONSTANT.USERACCESSDAOREVAMP.length; i++) {
    		if (CONSTANT.USERACCESSDAOREVAMP[i][3].equals(RoleCode) && CONSTANT.USERACCESSDAOREVAMP[i][2].equals(EventCode)) {
    			Array.add(CONSTANT.USERACCESSDAOREVAMP[i][4].toString());
    		}
    	}
    ...
    public static Map<String, String> getUserWithAccessRevampChannel(String RoleCode, String EventCode,String CategoryCode) {
    	Log.info("Trying to get User with Access: " + RoleCode + "," + EventCode);
    	ArrayList<String> Array = new ArrayList<String>();
    	Map<String, String> resultMap = new HashMap<String, String>();
    	for (int i = 0; i<CONSTANT.USERACCESSDAOREVAMP.length; i++) {
    	...
    	for (int i = 0; i <= excelLimit; i++) {
    		String loginID = ExcelUtility.getCellData(0, ExcelI.LOGIN_ID, i);
    		if (Array.contains(CategoryCode) && !loginID.equals(null) && !loginID.equals("")) {
    			resultMap.put("PARENT_NAME", ExcelUtility.getCellData(0, ExcelI.PARENT_NAME, i));
    			resultMap.put("CATEGORY_NAME", ExcelUtility.getCellData(0, ExcelI.CATEGORY_NAME, i));
    			resultMap.put("LOGIN_ID", ExcelUtility.getCellData(0, ExcelI.LOGIN_ID, i));
    			resultMap.put("PASSWORD", ExcelUtility.getCellData(0, ExcelI.PASSWORD, i));
...
public static Map<String, String> getUserWithAccesswithCategoryOtherNetworkAdmin(String RoleCode,String categoryCode) {
    ...
    public static Map<String, String> getUserWithAccessForVMSVoucherTypeCategory(String RoleCode, String voucherType,String categoryCode) {
    	Log.info("Trying to get User with Access: " + RoleCode);
    	ArrayList<String> Array = new ArrayList<String>();
    	Map<String, String> resultMap = new HashMap<String, String>();
    	for (int i = 0; i<CONSTANT.USERACCESSDAO.length; i++) {
    ...
    public static ArrayList<String> getCategoryWithAccessRevamp(String RoleCode, String EventCode) {
    	Log.info("Trying to get Category with Access: " + RoleCode + EventCode);
    	ArrayList<String> Array = new ArrayList<String>();
    	Map<String, String> resultMap = new HashMap<String, String>();
    	for (int i = 0; i<CONSTANT.USERACCESSDAOREVAMP.length; i++) {
    		if (CONSTANT.USERACCESSDAOREVAMP[i][2].equals(RoleCode) && CONSTANT.USERACCESSDAOREVAMP[i][4].equals(EventCode)) {
    			Array.add(CONSTANT.USERACCESSDAOREVAMP[i][3].toString());
    		}
    	}
    	return Array;
    }
