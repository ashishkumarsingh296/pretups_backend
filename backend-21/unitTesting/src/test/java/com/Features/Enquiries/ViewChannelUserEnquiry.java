...
public class ViewChannelUserEnquiry {
	...
	com.pageobjects.channeladminpages.channelenquiries.ViewChannelUser ViewChannelUser;
	...
	public ViewChannelUserEnquiry(WebDriver driver) {
		this.driver = driver;
		//Page Initialization
		...
		ViewChannelUser = new com.pageobjects.channeladminpages.channelenquiries.ViewChannelUser(driver);
	}
	
	public HashMap<String, String> prepareChannelUserEnquiryDAO(HashMap<String, String> ChannelUserMap) {
	...
	public String validateViewChannelUserEnquiry(HashMap<String, String> ChannelUserMap) {
		
		HashMap<String, String> ChannelUsersEnquiryDAO = new HashMap<String, String>();
				
		//Operator User Access Implementation by Krishan.
		userAccessMap = UserAccess.getUserWithAccess(RolesI.VIEW_CHANNEL_USERS_ENQUIRY_ROLECODE); //Getting User with Access to View Stock Transactions
		...
		ChannelEnquirySubCategory.clickViewChannelUser();
		ViewChannelUser.enterMSISDN(ChannelUserMap.get("MSISDN"));
		ViewChannelUser.clickSubmitButton();
		
		String Screenshot = GetScreenshot.getFullScreenshot(driver);
		//Enquiry Validator Begins
		ChannelUsersEnquiryDAO = prepareChannelUserEnquiryDAO(ChannelUserMap);
