...
public class FixedRechargeMap {
	...
	public Object[][] TestDataFeed1() {
		String CustomerRechargeCode = _masterVO.getProperty("FixedRechargeMap.java");
 ...
 */
	...
	public HashMap<String, String> getC2SFixedMap() {	
		/*Map<String, String> instanceMap = defaultMap();
		return instanceMap.get(Key);*/
		return defaultMap();
}
	
	public Map<String, String> setC2SFixedMap(String Key, String Value) {	
		Map<String, String> instanceMap = defaultMap();
