...
public class ChangeSelfPinMap {
	...
	public Map<String, String> defaultMap() {
		...
		String oldPin= ExcelUtility.getCellData(0, ExcelI.PIN, 1);
	...
	public Map<String, String> getChangeSelfPinMap(String Key, String Value) {	
