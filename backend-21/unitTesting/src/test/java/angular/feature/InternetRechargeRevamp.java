...
public class InternetRechargeRevamp extends BaseTest{
	...
	public InternetRechargeRevamp(WebDriver driver) {
		this.driver = driver;
	...
	public void performC2STransferInternet(String ParentCategory, String FromCategory,String PIN,String service) {
		...
		for(int i=1;i<=totalRow;i++){
			...
			if(ExcelUtility.getCellData(0,ExcelI.SERVICE_TYPE,i).equals(service)) {
				...
				recharges.clickInternetRechargeButton();
...
//						ExtentI.attachCatalinaLogsForSuccess();
	...
	public void performC2STransferInternetBlankAmount(String ParentCategory, String FromCategory,String PIN,String service) {
		final String methodname = "performC2STransferInternetBlankAmount";
		Log.methodEntry(methodname, ParentCategory, FromCategory, PIN, service);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
	...
	public void performC2STransferInternetBlankSubservice(String ParentCategory, String FromCategory,String PIN,String service) {
		final String methodname = "performC2STransferInternetBlankSubservice";
		Log.methodEntry(methodname, ParentCategory, FromCategory, PIN, service);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
		ExcelUtility.setExcelFile(MasterSheetPath, ExcelI.CHANNEL_USERS_HIERARCHY_SHEET);
		login.UserLogin(driver, "ChannelUser", ParentCategory, FromCategory);
	...
	public void performC2STransferInternetAlphaNumericAmount(String ParentCategory, String FromCategory,String PIN,String service) {
		final String methodname = "performC2STransferInternetAlphaNumericAmount";
		Log.methodEntry(methodname, ParentCategory, FromCategory, PIN, service);
	...
	public void performC2STransferInternetNegativeAmount(String ParentCategory, String FromCategory,String PIN,String service) {
	...
	public void performC2STransferInternetZeroAmount(String ParentCategory, String FromCategory,String PIN,String service) {
	...
	public void performC2STransferInternetBlankPIN(String ParentCategory, String FromCategory,String PIN,String service) {
	...
	public void performC2STransferInternetCloseEnterPINPopup(String ParentCategory, String FromCategory,String PIN,String service) {
		final String methodname = "performC2STransferInternetCloseEnterPINPopup";
		Log.methodEntry(methodname, ParentCategory, FromCategory, PIN, service);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
		ExcelUtility.setExcelFile(MasterSheetPath, ExcelI.CHANNEL_USERS_HIERARCHY_SHEET);
		login.UserLogin(driver,"ChannelUser",ParentCategory, FromCategory);
	...
	public void performC2STransferInternetInvalidPIN(String ParentCategory, String FromCategory,String PIN,String service) {
	...
	public void performC2STransferInternetAlphanumericPIN(String ParentCategory, String FromCategory,String PIN,String service) {
		final String methodname = "performC2STransferInternetAlphanumericPIN";
		Log.methodEntry(methodname, ParentCategory, FromCategory, PIN, service);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
		ExcelUtility.setExcelFile(MasterSheetPath, ExcelI.CHANNEL_USERS_HIERARCHY_SHEET);
		login.UserLogin(driver,"ChannelUser",ParentCategory, FromCategory);
	...
	public void performC2STransferInternetBlankNotificationMSISDN(String ParentCategory, String FromCategory,String PIN,String service) {
		final String methodname = "performC2STransferInternetBlankNotificationMSISDN";
		Log.methodEntry(methodname, ParentCategory, FromCategory, PIN, service);
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
		...
		for(int i=1;i<=totalRow;i++)
		{
			...
			if(ExcelUtility.getCellData(0,ExcelI.SERVICE_TYPE,i).equals(service)) {
				...
				recharges.enterNotificationNumber("");

				recharges.clickRechargeIcon();

				List<WebElement> errorMessageCaptured = recharges.blankErrorMessages();
				String actualMessage = null;
				String expectedMessage = "Notification mobile number is required.";
				boolean flag = false ;
				for (WebElement ele : errorMessageCaptured) {
					actualMessage = ele.getText();
					if (expectedMessage.equals(actualMessage)) {
	...
	public void performC2STransferInternetBlankMSISDN(String ParentCategory, String FromCategory, String PIN, String service) {
	...
	public void performC2STransferInternetInvalidMSISDN(String ParentCategory, String FromCategory, String PIN, String service) {
		final String methodname = "performC2STransfer";
		Log.methodEntry(methodname, ParentCategory, FromCategory, PIN, service);
		RandomGeneration RandomGeneration = new RandomGeneration();
		String MasterSheetPath = _masterVO.getProperty("DataProvider");
	...
	public void performC2STransferInternetAlphaNumericMSISDN(String ParentCategory, String FromCategory, String PIN, String service) {
	...
	public void performC2STransferInternetResetButton(String ParentCategory, String FromCategory, String PIN, String service) {
	...
	public void performC2STransferInternetCopyButton(String ParentCategory, String FromCategory, String PIN, String service) {
...
/*
	public void performC2STransferInternetPrint(String ParentCategory, String FromCategory, String PIN, String service) {
