...
function rechargeMenu(rechMode)
{
	...
	{
		formPage += "<div class='c3lMenuGroup' width='100%' style='margin:0 17 0 20'><input  id='mobilenu' 	name='mobilenu' type='mobileno' value='' maxLength='" + MSISDN_LENGTH + "' class='inputBg3' emptyok='false' title='" + STR_MSISDN_TITLE + "' width='78%' /><a class='c3lMenuGroup buttonBg1'   width='20%' height='50px' href='qrcode://scan?delimiter=;&s1=$orderid$&s2=$rechid$&s3=$orderValue$&s4=$mobilenu$&s5=$amount$'><span class='redColor' align='center'>"+STR_SCANQR+"</span></a></div>";
	}
	formPage += "<input  id='amount' 	name='amount' type='decimal' maxLength='" + AMOUNT_LENGTH + "' class='inputBg2' emptyok='false' value='' title='" + STR_AMOUNT_TITLE + "'  />";
	formPage += "<input id='pin' name='pin' class='c3lMenuGroup' type='numpassword' class='inputBg2' maxLength='" + PIN_LENGTH + "' emptyok='false' title='"+STR_PIN_TITLE+"' encrypt='true' />";
	

	formPage += "<a id='gprsbut' class='c3lMenuGroup buttonBg' href=\"sendRechargeReq($mobilenu,$amount,$pin);\" althref='sms://inapp?to=+919986027668&text=PRC $mobilenu$:$amount$:$pin$' althref='tel://call=*123#'><span class='buttonText'  align='center'>"+STR_RECHARGE+"</span></a>";
	formPage += "<a id='smsbut' style='visibility:hidden' class='c3lMenuGroup buttonBg' href='sms://inapp?to=+919986027668&text=PRC $mobilenu$:$amount$:$pin$' ><span class='buttonText'  align='center'>"+STR_RECHARGE_SMS+"</span></a>";
	formPage += "<a id='ussdbut' class='c3lMenuGroup buttonBg' style='visibility:hidden' href='tel://call=*123*$mobilenu$*$amount$*$pin$#'><span class='buttonText' align='center'>"+STR_RECHARGE_USSD+"</span></a>";
...
function title()
{
	...
	}else
	{
		...
		{
			str += "<div width='100%' class='c3lTitle marginBottom20'><a  align='left' style='padding:10% 0% 10% 0%' href='keypad://clearall?target=$mobilenu$;$pin$;$amount$;$txnid$;$payeemobilenu$;$Giftermobilenu$&action=Menulist:menulist'><img   width='8%'  valign='middle' resimg='menu.png' src='menu.png'/></a><img width='50%' src='pretups_logo.png' resimg='pretups_logo.png'/>";
