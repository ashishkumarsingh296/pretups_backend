...
{	
	...
	else
	{
		...
		if(SEND_ENCRYPTREQ)
		{
			postData ="TYPE="+BILLPAY_TYPE+"&MSISDN="+mobile+"&Message="+getEncrypt("IMEI="+imei+"&PIN="+Pin+"&MSISDN2="+mobNumber+"&AMOUNT="+Amount+"&SELECTOR="+SELECTOR+"&LANGUAGE1="+LANGUAGE1);
			
		}else
		{
			postData ="TYPE="+BILLPAY_TYPE+"&MSISDN="+mobile+"&IMEI="+imei+"&PIN="+Pin+"&MSISDN2="+mobNumber+"&AMOUNT="+Amount+"&SELECTOR="+SELECTOR+"&LANGUAGE1="+LANGUAGE1;
		}
