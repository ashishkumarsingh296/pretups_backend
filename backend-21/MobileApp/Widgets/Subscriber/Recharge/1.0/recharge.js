...
function pretupsHome() {
	...
	{
		str += "<div width='100%' class='c3lTitle'><a class='c3lMenuGroup' valign='middle' align='left' style='padding:10% 10% 10% -10%' href='#menulist'><img   width='8%'  valign='middle' src='" + imagePath + "menu.png'/></a><img width='50%' src='"+imagePath+"pretups_logo.png' resimg='pretups_logo.png'/><hr/></div>";//<span class='topSize'  id='pretitle'>" + STR_PRETUPS_TITLE + "</span>
    ...
    //input mobile-- start
    //topmerechAnother
    str += "<div id='rechmobileip' class='c3lMenuGroup marginLeft20' style='margin-right:17%;visibility:hidden'>";
    str += "<input  id='mdef' name='mdef' type='text'	title='" + COUNTRY_CODE + "' class='inputBg1 countryCode' value='' readonly /><input  align='right' emptyok='false' maxlength='" + MSISDN_LENGTH + "' id='msisdn' class='inputBg1 inputMobile' name='msisdn' type='mobileno' title='' value='' encrypt='true'  />";
    str += "</div>";
    //input mobile-- end
    //input amount --start
    str += "<div id='amountinput'><input  id='amount' 	name='amount' type='decimal' maxLength='" + AMOUNT_LENGTH + "' class='inputBg' emptyok='false' title='" + STR_AMOUNT + "' encrypt='true'  /></div>";
    //input amount --end
    //input pin -- start
    ...
    // submit button-- start
    str += "<a id='rechbut' class='c3lMenuGroup buttonBg' 	href=\"paySelf($amount,$pin,'1');\"	><span class='buttonText'  align='center'>" + STR_RECHARGENOW + "</span></a>";

    str += "<a id='rechanobut' class='c3lMenuGroup buttonBg' style='visibility:hidden'	href=\"javascript:payOption($msisdn,$amount,$pin,'2');\"	><span class='buttonText' id='rechnow' name='rechnow' align='center'>" + STR_RECHARGENOW + "</span></a>";

    str += "<a id='sendrechbut' class='c3lMenuGroup buttonBg' style='visibility:hidden'	href=\"wgt:950181717/1.0:sendRequest($msisdn,$amount,'','3');\"	><span class='buttonText' id='rechnow' name='rechnow' align='center'>" + STR_SENDREQUEST + "</span></a>";
    ...
    str += "<a id='qrself' class='c3lMenuGroup buttonBg' href=\"generateQrCode($amount);\"	><span class='buttonText' id='rechnow' name='rechnow' align='center'>Generate QR</span></a>";
    
    str += "<a id='qranother' style='visibility:hidden' class='c3lMenuGroup buttonBg' href=\"generateQrCode($amount,$msisdn);\"	><span class='buttonText' id='rechnow' name='rechnow' align='center'>Generate QR</span></a>";
...
function voucherQRCode()
{
	...
	str += "<div  class='c3lTitle bgColor marginBottom20'><a  class='c3lMenuGroup' href='#pretupsHome'>"+BackImage+"</a><span class='topSize'  id='pretitle' align='center' style='margin-left:-"+backImgWidth+"px'>"+STR_VOUCHER_QR_RECHARGE+"</span><hr/></div>";
	str += "<div class='c3lMenuGroup marginLeft20' style='margin-right:17%'>";
    str += "<input  id='mdef' name='mdef' type='text'	title='" + COUNTRY_CODE + "' class='inputBg1 countryCode' value='' readonly /><input  align='right' emptyok='false' maxlength='" + MSISDN_LENGTH + "' id='msisdn' class='inputBg1 inputMobile' name='msisdn' type='mobileno' title='' value=''  />";
    str += "</div>";
	str += "<input  id='qrVoucherId' name='qrVoucherId' type='text' style='visibility:hidden'	title='" + COUNTRY_CODE + "' class='inputBg1 countryCode' value='' />"; 
    str += "<a href=\"validate://targetid=$msisdn$&action=qrcode://scan?text=$qrVoucherId$&action=$qrVoucherRecharge($msisdn,$qrVoucherId)$\" class='c3lMenuGroup buttonBg' 	><span class='buttonText' id='rechnow' name='rechnow' align='center'>"+ STR_SCANQR +"</span></a>";
	str +="<span class='c3lMenuGroup' align='center' valign='middle' width='20%' style='font-size:14px;font-weight:bold;background-image:url("+imagePath+"circle_red.9.png);color:white;padding:16 10 16 20;margin-top:10' align='center'>"+STR_OR+"</span>";
	str += "<div id='amountinput'><input  id='voucherCode' 	name='voucherCode' type='decimal' maxLength='" + AMOUNT_LENGTH + "' class='inputBg' emptyok='false' title='" + STR_VOUCHERCODE_TITLE + "'  /></div>";
	str += "<a  class='c3lMenuGroup buttonBg' href=\"qrVoucherRecharge($voucherCode);\"	><span class='buttonText'  align='center'>"+ STR_RECHARGE +"</span></a>";
	str = [str, "<specialcache name='pretupsHome' url='pretupsHome()' type='screen'/>"].join("");
