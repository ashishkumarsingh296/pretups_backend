...
function sendElevoucherReq(mobNumber,RechargeAmount,Pin)
{
	...
	{		
		postData = "TYPE="+EVOUCHER_TYPE+"&MSISDN="+mobile+"&IMEI="+imei+"&PIN="+Pin+"&MSISDN2="+mobNumber+"&AMOUNT="+RechargeAmount+"&LANGUAGE1="+langCode+"&LANGUAGE2="+langCode+"&SELECTOR="+SELECTOR;
	}
