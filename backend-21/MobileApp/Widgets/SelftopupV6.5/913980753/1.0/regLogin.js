...
function login()
{
	...
	else
	{
		...
		str +="<div class='c3lMenuGroup marginBottom10' style='margin-top:-20px' valign='top'><hr id='hr1' valign='top' width='49%' align='left' class='c3lMenuGroup'/><hr id='hr2' valign='top' align='right' style='visibility:hidden' width='49%' class='c3lMenuGroup'/></div>";
		...
		str += "<div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><input  id='mobile' name='mobile' type='numeric' maxLength='" + MSISDN_LENGTH + "' class='inputBg' emptyok='false' title='Email or Mobile' /></div>";
		str += "<div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><input id='ppin' name='ppin'  type='numpassword' class='inputBg' maxLength='" + PIN_LENGTH + "' emptyok='false' title='PreTUPS PIN' encrypt='true' /></div>";
		...
		str += "<div id='mobileip' class='c3lMenuGroup' style='visibility:hidden'>";
	    str += "<div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><input  id='mdef' name='mdef' type='text'	title='" + COUNTRY_CODE + "' class='inputBg1 countryCode' value='' readonly /><input  align='right' emptyok='false' maxlength='" + MSISDN_LENGTH + "' id='mobilenu' name='mobilenu' isFocus='true' class='inputBg1 inputMobile'  type='mobileno' title='' value=''  /></div>";
	    str += "</div>";
		//signup += "<input  id='mobilenu' style='visibility:hidden'	name='mobilenu' type='numeric' maxLength='" + MSISDN_LENGTH + "' class='inputBg' emptyok='false' title='" + STR_MSISDN_TITLE + "' alt='"+MSISDN_TT+"'  /></div>";
		signup += "<div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><input  id='email' style='visibility:hidden'	name='email' type='email' maxLength='50' class='inputBg' emptyok='false' title='Email'  /></div>";
		signup += "<div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><input id='pin' name='pin' style='visibility:hidden'  type='numpassword' class='inputBg' maxLength='" + PIN_LENGTH + "' emptyok='false' title='Create PreTUPS PIN' encrypt='true' alt='"+PIN_TT+"' /></div>";
		...
		signup += "<div class='c3lMenuGroup' style='margin:3% 4% 3% 8%'><span style='color:rgb(94,94,96)'>"+TERMS_TEXT1+"</span><a style='color:red' href='#termsPage'><br/><span align='center'>"+TERMS_TEXT2+"</span></a></div>";
		...
		document.getElementById("login").innerHTML = title+ str +signup+"<setvar name='tokenID' value=''/>";
...
function createPIN(smspin)
{
	...
	str +="<div  align='left' width='100%' class='c3lMenuGroup bgColor'><a href='javascript:terms();'><img  width='"+backImgWidth+"px' height='"+backImgWidth+"px' align='left' resimg='icon_back.9.png' src='"+imagePath+"icon_back.9.png'/></a><span class='topText' id='paytitle' valign='middle' align='center' style='margin-left:-"+backImgWidth+"px'>"+STR_CREATEPIN+"</span><hr></div>";
	str +="<div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><input  class='inputBg' id='pin' name='pin' type='numpassword'	maxLength='"+PIN_LENGTH+"' encrypt='true' emptyok='false' title='"+STR_PIN+"' /></div>";
	str +="<div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><input  	class='inputBg' id='cpin' name='cpin' type='numpassword'	maxLength='"+PIN_LENGTH+"' encrypt='true' emptyok='false' title='"+STR_CONFIRMPIN+"' /></div>";
