...
function addbudd()
{
	...
	str +="<setvar name='pin' value=''/>";
	str +="<div  class='c3lTitle marginBottom20'><a class='c3lMenuGroup' href=\"close://action=keypad://clearall?target=$buddyName$;$buddyNo$;$buddyAmount$;$buddyName$\" >"+BackImage+"</a><span class='topText' id='paytitle' valign='middle' align='center' style='margin-left:-"+backImgWidth+"px'>"+STR_ADDBUDDY_TITLE+"</span><hr/></div>";
	str +="<input  id='buddyName'	name='buddyName' type='text' class='inputBg' emptyok='false' maxLength='"+NAME_LENTH+"'	title='Name' />";
	str +="<div  class='c3lMenuGroup marginLeft20' style='margin-right:17%'><input  id='mdef' name='mdef' type='text'	title='"+COUNTRY_CODE+"' class='inputBg1 countryCode' value='' readonly /><input  emptyok='false' maxlength='"+MSISDN_LENGTH+"'	id='buddyNo' class='inputBg1 inputMobile' name='buddyNo' type='mobileno' title='' value='' /></div>";
	
	str +="<input  id='buddyAmount' name='buddyAmount' type='decimal' maxLength='"+AMOUNT_LENGTH+"' class='inputBg' emptyok='false' title='Amount' />";
