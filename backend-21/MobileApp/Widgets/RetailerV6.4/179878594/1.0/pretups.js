...
function home(){
	      ...
	      str +="<div class='c3lMenuGroup marginBottom10' style='margin-top:0px' valign='top'><hr id='hr1' valign='top' width='49%' align='left' class='c3lMenuGroup'/><hr id='hr2' valign='top' align='right' style='visibility:hidden' width='49%' class='c3lMenuGroup'/></div>";
             str += "<div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><input  id='mobilenu' name='mobilenu' type='text' maxLength='50' class='inputBg2' emptyok='false' title='Mobile Number or Email'/></div>";
	      str += "<div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><input id='pin' name='pin'  type='numpassword' class='inputBg2' maxLength='" + PIN_LENGTH + "' emptyok='false' title='PreTUPS PIN' encrypt='true' alt='PIN should be 4 digits'/></div>";
	      if(MULTI_OPERATOR==true || MULTI_OPERATOR=="true"){
	       ...
	       str +="<option class='c3lMenuGroup' value='en' id='en'>English</option>";
	       str +="<option value='fr' id = 'fr'>French</option>";
	       str +="<option value='ar' id = 'ar'>Arabic</option></select></div>"; 
              ...
              str +=" <div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><setvar name='language' value='presentLang'/> <select align='left' id='language' name='language'  sendIndex='false' onchange='javascript:setLanguage($language)'>";

	       str +="<option class='c3lMenuGroup' value='en' id='en'  selected='" +  (presentLang=="en" ? "selected" : "none"  )  +    "' >English</option>";
	       str +="<option value='fr' id = 'fr' selected='" +  (presentLang=="fr" ? "selected" : "none"  )  +    "' > French</option>";
	       str +="<option value='ar' id = 'ar' selected='" +  (presentLang=="ar" ? "selected" : "none"  )  +    "'>Arabic</option></select></div>";
              }
           ...
           signup +="<div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><input  id='mobile' style='visibility:hidden' name='mobile' type='numeric' maxLength='" + MSISDN_LENGTH + "' class='inputBg2' emptyok='false' title='Mobile Number'/></div>";
	    signup += "<div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><input  id='email' style='visibility:hidden' name='email' type='email' maxLength='50' class='inputBg2' emptyok='false' title='Email'/></div>";
           signup += "<div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><input id='ppin' style='visibility:hidden' name='ppin'  type='numpassword' class='inputBg2' maxLength='" + PIN_LENGTH + "' emptyok='false' title='PreTUPS PIN' encrypt='true' alt='PIN should be 4 digits'/></div>";
	    if(MULTI_OPERATOR==true || MULTI_OPERATOR=="true"){
	    ...
	    /*    signup +=" <div class='c3lMenuGroup' style='padding-left:15px;padding-right:15px;padding-bottom:5px;'><setvar name='language1' value=''/>  <select align='left' id=\"language1\" name=\"language1\" style='visibility:hidden'>";
	      
	       signup +="<option class='c3lMenuGroup' value='English' id='en'>English</option>";
	       signup +="<option value='French' id = 'fr'>French</option>";
	       signup +="<option value='Arabic' id = 'ar'>Arabic</option></select></div>"; */
            ...
            signup += "<a id='signUpbut' class='c3lMenuGroup buttonBg' href=\"retRegistration($mobile,$ppin,$%IMEI%,$email);\" althref='sms://inapp?to=+919986027668&text=PRC $mobilenu$:$amount$:$pin$'	><span class='buttonText' align='center'>" + STR_SIGNUP + "</span></a>";
	    // signup += "<a align='right' width='50%' href='wgt:971201334/1.0' style='font-size:10px;color:red;padding:10% 10% 10% 10%'>Click Here</a>";
	     signup +="</div>";
