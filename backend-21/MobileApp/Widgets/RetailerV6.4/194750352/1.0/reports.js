...
function lasttrans(pin)
{
	...
	{
		postData = "TYPE="+LASTTRANS_TYPE+"&MSISDN="+mobile+"&IMEI="+imei+"&PIN="+pinNum+"&LANGUAGE1="+LANGUAGE1;
	}
...
function last5transac(pin)
{
	...
	{
		postData = "TYPE="+LAST5TRANS_TYPE+"&MSISDN="+mobile+"&IMEI="+imei+"&PIN="+pinNum+"&LANGUAGE1="+LANGUAGE1;
	}
...
function stockbalreq(pin)
{
	...
	if( "" != nullorUndefCheck(pin))
	{
		...
		{
			postData = "TYPE="+BALANCEENQ_TYPE+"&MSISDN="+mobile+"&IMEI="+imei+"&PIN="+pinNum+"&LANGUAGE1="+LANGUAGE1;
		}
...
function dailyreports(pin)
{
	...
	{
		postData = "TYPE="+DAILYREPORT_TYPE+"&MSISDN="+mobile+"&IMEI="+imei+"&PIN="+pinNum+"&LANGUAGE1="+LANGUAGE1;;
	}
