...
function addCard(type)
{
	...
	str +="<div class='c3lTitle marginBottom20'>";
	...
	str +="<input  id='cardName' name='cardName'  type='text' class='inputBg' emptyok='false' maxLength='"+NAME_LENTH+"'	title='"+STR_CARDNAME_TITLE+"' /> ";
	str +="<input  id='cardNum' name='cardNum'  type='numeric' class='inputBg' emptyok='false' maxLength='"+CARDNO_LENGTH+"' 	title='"+STR_CARDNUM_TITLE+"' alt='"+CARDNO_TT+"' /> ";
	...
	if (type ==1 || type == '1')
	{
		str +="<div class='c3lMenuGroup marginLeft20' style='margin-right:17%'><input  id='cvv'name='cvv' type='numeric' class='inputBg1 cvvdim' maxLength='"+CVV_LENGTH+"' emptyok='false' title='"+STR_CVV_TITLE+"'/><div><input emptyok='false' id='expiry' name='expiry' class='inputBg1 expirydim'  type='text' title='Expiry' value='' href='datepicker://targetid=$date$&format=MM/YYYY' readonly/><a name='expact' id='expact' href='datepicker://targetid=$expiry$&format=MM/YYYY'><img class='contactPicker'  id='contacts' name='contacts' resimg='button_datepicker.9.png' src='"+imagePath+"button_datepicker.9.png'/></a></div></div>";
	}else
	{
		if(CVV_CONFIG)
		{
		...
		{
			str +="<div class='c3lMenuGroup marginLeft20' style='margin-right:17%'><div><input emptyok='false' id='expiry' name='expiry' class='inputBg1 expirydimNewcard'  type='text' title='Expiry' value='' href='datepicker://targetid=$date$&format=MM/YYYY' readonly/><a name='expact' id='expact' href='datepicker://targetid=$expiry$&format=MM/YYYY'><img class='contactPicker'  id='contacts' name='contacts' resimg='button_datepicker.9.png' src='"+imagePath+"button_datepicker.9.png'/></a></div></div>"; 
		}
	}
	str +="<input id='nickName'name='nickName' type='text' class='inputBg' emptyok='false' maxLength='"+NAME_LENTH+"' title='"+STR_NICKNAME_TITLE+"' /></div>";
	if (type ==1 || type == '1')
	{
