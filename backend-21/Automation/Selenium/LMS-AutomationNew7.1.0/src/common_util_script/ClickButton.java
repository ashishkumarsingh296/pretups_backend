...
public class ClickButton {
	...
	public static boolean clickonxpath(String xpath ) throws Exception{
		try{
			Assert.assertTrue(Launchdriver.driver.findElement(By.xpath(xpath)).isDisplayed());
			Launchdriver.driver.findElement(By.xpath(xpath)).click();
		} catch (Exception e) {
			System.out.println("You button does not exists or you xpath is wrong");
			return false;
		} catch (AssertionError ae) {
