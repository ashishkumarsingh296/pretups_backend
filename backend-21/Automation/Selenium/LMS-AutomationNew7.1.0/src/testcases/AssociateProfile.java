...
public class AssociateProfile extends ExtentReportMultipleClasses{
	...
	public static void Associateprofile (String des,String loginid, String Profilename, String controlgroup) throws Exception {
		// TODO Auto-generated method stub
		
		test = extent.createTest("To verify that channel user "+loginid+" is successfully associate with LMS profile "+Profilename+"");
	...
	public void teardown() throws Exception {
  	...
  	@DataProvider(name = "DP")
  	 public static String[][] excelRead() throws Exception {		
  		...
  		return Read_file.excelRead("demo_data.xlsx","AssociateProfile");
  	}	
