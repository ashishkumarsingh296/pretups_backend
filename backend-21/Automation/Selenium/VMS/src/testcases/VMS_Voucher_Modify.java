...
public class VMS_Voucher_Modify extends common_util_script.ExtentReportMultipleClasses

{
	...
	@DataProvider(name = "DP")
 	 public static String[][] excelRead() throws Exception {		
		...
		return Read_Excel_file.excelRead(cacheMap.get("inputfile"),cacheMap.get("adddenomprofsheet1"));
	...
	public void modifydeno () throws Exception{
		test = extent.createTest("Modify denomination:  " , "User should be able to modify voucher denomination by entering valid details");
		String vouchertype="physical";
		testcases.Modify_Denomination.modifyvoucher(, cacheMap.get("inputfile"),cacheMap.get("adddenomprofsheet"));
		}	*/
	
	@Test(priority = 15,dataProvider = "DP", dependsOnMethods = { "login" })
	public void modifydeno (String Scenario, String vouchertype, String servicetype, String subservicetype, String denominationname, String shortname, String mrp, String payableamnt, String description, String profilename, String Minq, String Perfq, String tt, String validity, String expiryp, String applicablefrom, String totalvouchers ) throws Exception {
    	...
    	testcases.Modify_Denomination.modifyvoucher(Scenario, vouchertype, servicetype, subservicetype, denominationname, shortname, mrp, payableamnt, description, profilename, Minq, Perfq, tt, validity, expiryp, applicablefrom); 
    		}
