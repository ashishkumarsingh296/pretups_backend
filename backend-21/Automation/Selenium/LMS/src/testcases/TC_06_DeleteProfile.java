...
public class TC_06_DeleteProfile extends ExtentReportMultipleClasses{
	...
	public static void delete(String Scenario,String profile, String version) throws Exception {
			// TODO Auto-generated method stub
			
		test = extent.createTest("To verify that user is able to Delete LMS profile "+profile+" with version "+ version, "User should be able to login with valid credentials");
        ...
        if(Scenario.equalsIgnoreCase("Positive")){
    		...
    		System.out.println("now clicking on delete profile to delete detail");
    		...
    		common_util_script.Get_screenshot.success("deleted", profile + "deleted"+ "");
	...
	public void teardown() throws Exception
	{
  	...
  	@DataProvider(name = "DP")
  	 public static String[][] excelRead() throws Exception {  		
  		...
  		return Read_file.excelRead("BaseFile.xlsx","DeleteProfile");
  	}	
