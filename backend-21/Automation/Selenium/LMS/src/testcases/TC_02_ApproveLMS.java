...
public class TC_02_ApproveLMS extends ExtentReportMultipleClasses{
	...
	public static void approvelmsprofile (String profile, String version) throws Exception {       
        
		test = extent.createTest("To verify that user is able to aprove LMS profile "+profile+" with version "+ version, "User should be able to login with valid credentials");
	...
	public void teardown() throws Exception
	{
  	...
  	@DataProvider(name = "DP")
  	 public static String[][] excelRead() throws Exception {		
  		...
  		return Read_file.excelRead("BaseFile.xlsx","Approve");
  	}	
