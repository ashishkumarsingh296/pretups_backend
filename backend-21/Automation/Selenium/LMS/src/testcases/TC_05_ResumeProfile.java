...
public class TC_05_ResumeProfile extends ExtentReportMultipleClasses{
	...
	public static void resume(String profile, String version) throws Exception {
			// TODO Auto-generated method stub
			
		test = extent.createTest("To verify that user is able to Resume suspened LMS profile "+profile+" with version "+ version, "User should be able to login with valid credentials");
	...
	public void teardown() throws Exception
	{
  	...
  	@DataProvider(name = "DP")
  	 public static String[][] excelRead() throws Exception {		
  		...
  		return Read_file.excelRead("BaseFile.xlsx","ResumeProfile");
  	}	
