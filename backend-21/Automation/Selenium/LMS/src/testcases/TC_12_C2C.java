...
public class TC_12_C2C extends ExtentReportMultipleClasses {
	@BeforeClass
	...
	public static void c2c(String login, String pass, String mobileno,
		...
		test = extent.createTest("To verify that channel user" + login
				+ " is able to C2C " + mobileno);
		...
		String expectedsuccessmessage = "Transfer is successful with transaction ID ";

		Boolean isTrue;
		if (actualsuccessmessage.getText().contains(expectedsuccessmessage)) {
			isTrue = true;
		} else {
			isTrue = false;
		}
		...
		common_util_script.Get_screenshot.success("c2c", mobileno
				+ "c2c recharge");
		Login.logout();
	...
	public static String[][] excelRead() throws Exception {
		...
		return Read_file.excelRead("Basefile2.xlsx", "C2CTransfer");
	}
