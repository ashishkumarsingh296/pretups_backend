...
public class PreRequisite_C2CTransferRuleCreation extends BaseTest {
	...
	public void c2cTrfRuleCreation(String ToDomain, String ToCategory, String Services, String FromCategory, String FromDomain) {
		...
		if (TestCaseCounter == false) {
			test = extent.createTest("[Pre-Requisite]C2C Transfer Rule Creation");
			TestCaseCounter = true;
		}
		
		C2CTransferRule c2ctrfrule=new C2CTransferRule(driver);
		
		currentNode=test.createNode("To verify that Operator is able to create C2C Transfer Rule from " + FromCategory
