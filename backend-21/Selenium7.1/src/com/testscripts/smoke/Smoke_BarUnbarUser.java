...
public class Smoke_BarUnbarUser extends BaseTest{
	...
	public void channelUserCreation( String Domain, String Parent, String Category, String geotype,String module, String userType, String barringType) throws InterruptedException {
		...
		if (TestCaseCounter == false) { 
			test = extent.createTest("[Smoke]Bar-Unbar Channel User");
		...
		HashMap<String, String> dataMap=barUser.barringUser(module, userType, barringType, Domain, Parent, Category, geotype, msisdn);
		...
		String actual2= unBarUser.unBarringUser(module, userType, barringType, Category, msisdn);
