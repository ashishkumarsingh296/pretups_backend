...
static boolean TestCaseCounter = false;	
	...
	public void C2CWithdraw1(String ToCategory, String FromCategory, String fromMSISDN, String toPIN) throws InterruptedException {
		C2CWithdraw c2cWithdraw= new C2CWithdraw(driver);
		if(TestCaseCounter == false){
		test=extent.createTest("[Smoke]C2C Withdraw");
