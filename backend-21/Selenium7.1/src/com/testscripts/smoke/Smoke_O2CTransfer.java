...
public class Smoke_O2CTransfer extends BaseTest{
	...
	public void o2cTransferTC(String parentCategory, String category, String userMSISDN, String productType) throws InterruptedException	{
		...
		if (TestCaseCounter == false) {
			test=extent.createTest("[Smoke]O2C Transfer");
		...
		currentNode = test.createNode("To verify that proper message appears on WEB after successful O2C transfer for product "+productType+".");
		currentNode.assignCategory("Smoke");
		...
		currentNode = test.createNode("To verify that proper message appears on WEB after successful O2C Approval level 1 for product "+productType+".");
		currentNode.assignCategory("Smoke");
		...
		if(netPayableAmount>firstApprov){
			...
			currentNode = test.createNode("To verify that proper message appears on WEB after successful O2C Appproval level 2 for product "+productType+".");
			currentNode.assignCategory("Smoke");
		...
		if((netPayableAmount>secondApprov)){
			...
			currentNode = test.createNode("To verify that proper message appears on WEB after successful O2C Appproval level 3 for product "+productType+".");
			currentNode.assignCategory("Smoke");
