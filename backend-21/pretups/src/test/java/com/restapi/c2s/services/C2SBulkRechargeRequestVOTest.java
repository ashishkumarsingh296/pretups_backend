...
public class C2SBulkRechargeRequestVOTest {
    /**
     * Method under test: {@link C2SBulkRechargeRequestVO#getData()}
     */
    @Test
    public void testGetData() {
        assertNull((new C2SBulkRechargeRequestVO()).getData());
    }
     ...
     *
     * <ul>
     *   <li>default or parameterless constructor of {@link C2SBulkRechargeRequestVO}
     *   <li>{@link C2SBulkRechargeRequestVO#setData(C2SBulkRechargeDetails)}
     *   <li>{@link C2SBulkRechargeRequestVO#toString()}
     * </ul>
     */
    @Test
    public void testConstructor() {
        C2SBulkRechargeRequestVO actualC2sBulkRechargeRequestVO = new C2SBulkRechargeRequestVO();
        ...
        actualC2sBulkRechargeRequestVO.setData(data);
        String actualToStringResult = actualC2sBulkRechargeRequestVO.toString();
        assertSame(data, actualC2sBulkRechargeRequestVO.getData());
