...
@ContextConfiguration(classes = {ChannelUserApprovalAddorEdit.class})
@RunWith(SpringJUnit4ClassRunner.class)
public class ChannelUserApprovalAddorEditTest {
    @Autowired
    private ChannelUserApprovalAddorEdit channelUserApprovalAddorEdit;

    /**
     * Method under test: {@link ChannelUserApprovalAddorEdit#ChannelUserApprovalAddOrEdit(HttpServletResponse, MultiValueMap, ChannelUserApprovalReqVO)}
     */
    @Test
   //@Ignore("TODO: Complete this test")
    public void testChannelUserApprovalAddOrEdit() throws Exception {
       com.btsl.util.JUnitConfig.init();
        ...
        MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders
                .post("/v1/channelUsers/channelUserApproval", uriVars)
                .contentType(MediaType.APPLICATION_JSON);

        ChannelUserApprovalReqVO channelUserApprovalReqVO = new ChannelUserApprovalReqVO();
        channelUserApprovalReqVO.setApprovalLevel("Approval Level");
        channelUserApprovalReqVO.setApproveUserID("Approve User ID");
        ...
        channelUserApprovalReqVO.setData(data);
        channelUserApprovalReqVO.setUserAction("User Action");

        ObjectMapper objectMapper = new ObjectMapper();
        MockHttpServletRequestBuilder requestBuilder = contentTypeResult
                .content(objectMapper.writeValueAsString(channelUserApprovalReqVO));
        Object[] controllers = new Object[]{channelUserApprovalAddorEdit};
