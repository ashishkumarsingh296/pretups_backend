...
@ContextConfiguration(classes = {BarUnbarUserServiceImpl.class})
@RunWith(SpringJUnit4ClassRunner.class)
public class BarUnbarUserServiceImplTest {


    @Rule
    public ExpectedException thrown = ExpectedException.none();

    private static final Log _log = LogFactory.getLog(BarUnbarUserServiceImplTest.class);

    @Autowired
    private BarUnbarUserServiceImpl barUnbarUserServiceImpl;
    ...
    private void initConfig() {
...

        {
            ...
            String serverHomePath = "C:\\temp_tomcat";
            try {
                ...
                try {
                    ...
                    if (QueryConstants.DB_POSTGRESQL.equals(dbConnected))
                        ...
                        try {
                            ...
                            QueryConstants.load("D:/GitCode/pretups-backend/pretups/src/main/webapp//WEB-INF/classes/configfiles/queryConstants/oraclequeryconstants.props");
    ...
    /**
     * Method under test: {@link BarUnbarUserServiceImpl#addBarredUser(BarUnbarRequestVO, UserVO)}
     */
    @Test
    ////@Ignore("TODO: Complete this test")
    public void testAddBarredUser() throws BTSLBaseException {
...
//        Mockito.mockStatic(PreferenceCache.class);
        ...
        prefixVO.setNetworkCode("Network ID");
...
/*
        ...
        BarUnbarRequestVO barUnbarRequestVO = new BarUnbarRequestVO();

        List<Bar> bars = new ArrayList<>();
        Bar bar = new Bar();
        bar.setBarringReason("Test");
        bar.setBarringType("Test");

        bars.add(bar);

        barUnbarRequestVO.setBar(bars);

        barUnbarRequestVO.setModule("Module");
        barUnbarRequestVO.setMsisdn("9999999999");
        barUnbarRequestVO.setUserName("janedoe");
        barUnbarRequestVO.setUserType("User Type");
        ...
        barUnbarUserServiceImpl.addBarredUser(barUnbarRequestVO, userVO);
    }

    /**
     * Method under test: {@link BarUnbarUserServiceImpl#unBarredUser(BarUnbarRequestVO, UserVO)}
     */
    @Test
    //  //@Ignore("TODO: Complete this test")
    public void testUnBarredUser() throws BTSLBaseException {
        com.btsl.util.JUnitConfig.init(); //Auto replace
...
//        Mockito.mockStatic(PreferenceCache.class);
        ...
        BarUnbarRequestVO barUnbarRequestVO = new BarUnbarRequestVO();
        barUnbarRequestVO.setBar(new ArrayList<>());
        barUnbarRequestVO.setModule("Module");
        barUnbarRequestVO.setMsisdn("Msisdn");
        barUnbarRequestVO.setUserName("janedoe");
        barUnbarRequestVO.setUserType("User Type");
        ...
        UserPhoneVO phoneVO = UserPhoneVO.getInstance();
        phoneVO.setPhoneLanguage("en");
        phoneVO.setCountry("US");


        userVO.setUserPhoneVO(phoneVO);
        ...
        barUnbarUserServiceImpl.unBarredUser(barUnbarRequestVO, userVO);
    }

    /**
     * Method under test: {@link BarUnbarUserServiceImpl#vaidateBarUserRequest(Connection, BarUnbarRequestVO, ErrorMap, UserVO)}
     */
    @Test
   //@Ignore("TODO: Complete this test")
    public void testVaidateBarUserRequest() throws BTSLBaseException {
        ...
        //       at com.restapi.user.service.BarUnbarUserServiceImpl.vaidateBarUserRequest(BarUnbarUserServiceImpl.java:634)
        //   See https://diff.blue/R013 to resolve this issue.
        ...
        BarUnbarUserServiceImpl barUnbarUserServiceImpl = new BarUnbarUserServiceImpl();
        Connection con = mock(Connection.class);
        BarUnbarRequestVO barUnbarRequestVO = mock(BarUnbarRequestVO.class);
        ErrorMap errorMap = mock(ErrorMap.class);
        UserVO userVO = mock(UserVO.class);
        when(userVO.getUserPhoneVO()).thenReturn(UserPhoneVO.getInstance());
        barUnbarUserServiceImpl.vaidateBarUserRequest(con, barUnbarRequestVO, errorMap, userVO);
    }
    ...
    @Test
   //@Ignore("TODO: Complete this test")
    public void testVaidateBarUserRequest2() throws BTSLBaseException {
        //   Diffblue Cover was unable to write a Spring test,
        //   so wrote a non-Spring test instead.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        ...
        //       at java.util.Locale.<init>(Locale.java:648)
        //       at java.util.Locale.<init>(Locale.java:677)
        //       at com.restapi.user.service.BarUnbarUserServiceImpl.vaidateBarUserRequest(BarUnbarUserServiceImpl.java:637)
        //   See https://diff.blue/R013 to resolve this issue.
        ...
        ErrorMap errorMap = mock(ErrorMap.class);
        UserVO userVO = mock(UserVO.class);
        when(userVO.getUserPhoneVO()).thenReturn(null);
        barUnbarUserServiceImpl.vaidateBarUserRequest(con, barUnbarRequestVO, errorMap, userVO);
    }
    ...
    @Test
   //@Ignore("TODO: Complete this test")
    public void testVaidateBarUserRequest3() throws BTSLBaseException {
        //   Diffblue Cover was unable to write a Spring test,
        //   so wrote a non-Spring test instead.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        ...
        when(userPhoneVO.getLocale()).thenReturn(Locale.getDefault());
        UserVO userVO = mock(UserVO.class);
        when(userVO.getUserPhoneVO()).thenReturn(userPhoneVO);
        barUnbarUserServiceImpl.vaidateBarUserRequest(con, barUnbarRequestVO, errorMap, userVO);
    }
     ...
     */
    @Test
    public void testVaidateBarUserRequest4() throws BTSLBaseException {
        //   Diffblue Cover was unable to write a Spring test,
        //   so wrote a non-Spring test instead.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        ...
        Connection con = mock(Connection.class);
        BarUnbarRequestVO barUnbarRequestVO = mock(BarUnbarRequestVO.class);
        when(barUnbarRequestVO.getModule()).thenReturn("Module");
        when(barUnbarRequestVO.getMsisdn()).thenReturn("Msisdn");
        ErrorMap errorMap = mock(ErrorMap.class);
        UserPhoneVO userPhoneVO = mock(UserPhoneVO.class);
        when(userPhoneVO.getCountry()).thenReturn("GB");
        when(userPhoneVO.getPhoneLanguage()).thenReturn("6625550144");
        when(userPhoneVO.getLocale()).thenReturn(null);
        UserVO userVO = mock(UserVO.class);
        when(userVO.getUserType()).thenReturn("User Type");
        when(userVO.getUserPhoneVO()).thenReturn(userPhoneVO);
        thrown.expect(BTSLBaseException.class);
        barUnbarUserServiceImpl.vaidateBarUserRequest(con, barUnbarRequestVO, errorMap, userVO);
        verify(barUnbarRequestVO, atLeast(1)).getModule();
        verify(barUnbarRequestVO).getMsisdn();
        verify(userVO, atLeast(1)).getUserPhoneVO();
        verify(userVO).getUserType();
        verify(userPhoneVO).getCountry();
        verify(userPhoneVO).getPhoneLanguage();
        verify(userPhoneVO).getLocale();
    }
     ...
     */
    @Test
    public void testVaidateBarUserRequest5() throws BTSLBaseException {
        //   Diffblue Cover was unable to write a Spring test,
        //   so wrote a non-Spring test instead.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        ...
        Connection con = mock(Connection.class);
        BarUnbarRequestVO barUnbarRequestVO = mock(BarUnbarRequestVO.class);
        when(barUnbarRequestVO.getModule()).thenReturn("vaidateBarUserRequest");
        when(barUnbarRequestVO.getMsisdn()).thenReturn("Msisdn");
        ErrorMap errorMap = mock(ErrorMap.class);
        UserPhoneVO userPhoneVO = mock(UserPhoneVO.class);
        when(userPhoneVO.getCountry()).thenReturn("GB");
     ...
     */
    @Test
    public void testVaidateBarUserRequest6() throws BTSLBaseException {
        //   Diffblue Cover was unable to write a Spring test,
        //   so wrote a non-Spring test instead.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        ...
        Connection con = mock(Connection.class);
        BarUnbarRequestVO barUnbarRequestVO = mock(BarUnbarRequestVO.class);
        when(barUnbarRequestVO.getModule()).thenReturn(null);
        when(barUnbarRequestVO.getMsisdn()).thenReturn("Msisdn");
        ErrorMap errorMap = mock(ErrorMap.class);
        UserPhoneVO userPhoneVO = mock(UserPhoneVO.class);
        when(userPhoneVO.getCountry()).thenReturn("GB");
        ...
        thrown.expect(BTSLBaseException.class);
        barUnbarUserServiceImpl.vaidateBarUserRequest(con, barUnbarRequestVO, errorMap, userVO);
        verify(barUnbarRequestVO).getModule();
        verify(barUnbarRequestVO).getMsisdn();
        verify(userVO, atLeast(1)).getUserPhoneVO();
        verify(userPhoneVO).getCountry();
        verify(userPhoneVO).getPhoneLanguage();
     ...
     */
    @Test
    public void testVaidateBarUserRequest7() throws BTSLBaseException {
        //   Diffblue Cover was unable to write a Spring test,
        //   so wrote a non-Spring test instead.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        ...
        BarUnbarRequestVO barUnbarRequestVO = mock(BarUnbarRequestVO.class);
        when(barUnbarRequestVO.getModule()).thenReturn("Module");
        when(barUnbarRequestVO.getMsisdn()).thenReturn(null);
        when(barUnbarRequestVO.getUserType()).thenReturn("User Type");
        ErrorMap errorMap = mock(ErrorMap.class);
        UserPhoneVO userPhoneVO = mock(UserPhoneVO.class);
        when(userPhoneVO.getCountry()).thenReturn("GB");
        when(userPhoneVO.getPhoneLanguage()).thenReturn("6625550144");
        ...
        barUnbarUserServiceImpl.vaidateBarUserRequest(con, barUnbarRequestVO, errorMap, userVO);
        verify(barUnbarRequestVO, atLeast(1)).getModule();
        verify(barUnbarRequestVO, atLeast(1)).getMsisdn();
        verify(barUnbarRequestVO, atLeast(1)).getUserType();
        verify(userVO, atLeast(1)).getUserPhoneVO();
        verify(userVO, atLeast(1)).getUserType();
        verify(userPhoneVO).getCountry();
        verify(userPhoneVO).getPhoneLanguage();
        verify(userPhoneVO).getLocale();
    }
     ...
     */
    @Test
    public void testVaidateBarUserRequest8() throws BTSLBaseException {
        //   Diffblue Cover was unable to write a Spring test,
        //   so wrote a non-Spring test instead.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        ...
        BarUnbarRequestVO barUnbarRequestVO = mock(BarUnbarRequestVO.class);
        when(barUnbarRequestVO.getModule()).thenReturn("Module");
        when(barUnbarRequestVO.getMsisdn()).thenReturn(UserPropertiesListsController.QRY_PARAM_NOT_PRESENT);
        when(barUnbarRequestVO.getUserType()).thenReturn("User Type");
        ErrorMap errorMap = mock(ErrorMap.class);
        UserPhoneVO userPhoneVO = mock(UserPhoneVO.class);
        when(userPhoneVO.getCountry()).thenReturn("GB");
     ...
     */
    @Test
    public void testVaidateBarUserRequest9() throws BTSLBaseException {
        //   Diffblue Cover was unable to write a Spring test,
        //   so wrote a non-Spring test instead.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        ...
        when(userPhoneVO.getLocale()).thenReturn(null);
        UserVO userVO = mock(UserVO.class);
        when(userVO.getUserType()).thenReturn("CHANNEL");
        when(userVO.getUserPhoneVO()).thenReturn(userPhoneVO);
        thrown.expect(BTSLBaseException.class);
        barUnbarUserServiceImpl.vaidateBarUserRequest(con, barUnbarRequestVO, errorMap, userVO);
        verify(barUnbarRequestVO, atLeast(1)).getModule();
     ...
     */
    @Test
    public void testVaidateBarUserRequest10() throws BTSLBaseException {
        //   Diffblue Cover was unable to write a Spring test,
        //   so wrote a non-Spring test instead.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        ...
        when(userPhoneVO.getLocale()).thenReturn(null);
        UserVO userVO = mock(UserVO.class);
        when(userVO.getUserType()).thenReturn(null);
        when(userVO.getUserPhoneVO()).thenReturn(userPhoneVO);
        thrown.expect(BTSLBaseException.class);
        barUnbarUserServiceImpl.vaidateBarUserRequest(con, barUnbarRequestVO, errorMap, userVO);
        verify(barUnbarRequestVO).getModule();
    ...
    /**
     * Method under test: {@link BarUnbarUserServiceImpl#processGetUserInfoForBarring(Connection, String, UserVO, BarUserInfoResponseVO)}
     */
    @Test
   //@Ignore("TODO: Complete this test")
    public void testProcessGetUserInfoForBarring() throws BTSLBaseException {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        //   java.lang.NullPointerException
        //       at com.btsl.util.BTSLUtil.isValidMSISDN(BTSLUtil.java:706)
        //       at com.restapi.user.service.BarUnbarUserServiceImpl.processGetUserInfoForBarring(BarUnbarUserServiceImpl.java:908)
        //   See https://diff.blue/R013 to resolve this issue.
        ...
        barUserInfoResponseVO.setCategory("Category");
        barUserInfoResponseVO.setDomain("Domain");
        barUserInfoResponseVO.setErrorMap(errorMap);
        barUserInfoResponseVO.setMessage("Not all who wander are lost");
        barUserInfoResponseVO.setMessageCode("Message Code");
        barUserInfoResponseVO.setMsisdn("Msisdn");
        barUserInfoResponseVO.setSenderAllowed(true);
        barUserInfoResponseVO.setStatus(1);
        barUserInfoResponseVO.setTransactionId("42");
        barUserInfoResponseVO.setUserName("janedoe");
        barUserInfoResponseVO.setUserType("User Type");
        barUnbarUserServiceImpl.processGetUserInfoForBarring(p_con, "P msisdn", userVO, barUserInfoResponseVO);
    }
}
