...
@ContextConfiguration(classes = {DownloadTemplateServiceImpl.class})
...
public class DownloadTemplateServiceImplTest {
    ...
    @Autowired
    private DownloadTemplateServiceImpl downloadTemplateServiceImpl;

    /**
     * Method under test: {@link DownloadTemplateServiceImpl#downloadC2CBatchTemplate(FileDownloadResponse)}
     */
    @Test
   //@Ignore("TODO: Complete this test")
    public void testDownloadC2CBatchTemplate() throws BTSLBaseException, IOException, WriteException {
        ...
        //       at com.restapi.user.service.DownloadTemplateServiceImpl.downloadC2CBatchTemplate(DownloadTemplateServiceImpl.java:74)
        ...
        // Act
        this.downloadTemplateServiceImpl.downloadC2CBatchTemplate(fileDownloadResponse);
    ...
    /**
     * Method under test: {@link DownloadTemplateServiceImpl#downloadGiftTemplate(FileDownloadResponse)}
     */
    @Test
    public void testDownloadGiftTemplate() throws BTSLBaseException, IOException, WriteException {
        ...
        fileDownloadResponse.setFileName("foo.txt");
        fileDownloadResponse.setFileType("File Type");
        fileDownloadResponse.setFileattachment("Fileattachment");
        fileDownloadResponse.setMessage("Not all who wander are lost");
        fileDownloadResponse.setMessageCode("Message Code");
        fileDownloadResponse.setStatus(1);
        fileDownloadResponse.setTransactionId("42");
        thrown.expect(BTSLBaseException.class);
        downloadTemplateServiceImpl.downloadGiftTemplate(fileDownloadResponse);
    }
     ...
     */
    @Test
    public void testDownloadGiftTemplate2() throws BTSLBaseException, IOException, WriteException {
        ErrorMap errorMap = new ErrorMap();
        errorMap.setMasterErrorList(new ArrayList<>());
        errorMap.setRowErrorMsgLists(new ArrayList<>());
        FileDownloadResponse fileDownloadResponse = mock(FileDownloadResponse.class);
        doNothing().when(fileDownloadResponse).setErrorMap(Mockito.<ErrorMap>any());
        doNothing().when(fileDownloadResponse).setMessage(Mockito.<String>any());
        doNothing().when(fileDownloadResponse).setMessageCode(Mockito.<String>any());
        doNothing().when(fileDownloadResponse).setStatus(anyInt());
        doNothing().when(fileDownloadResponse).setTransactionId(Mockito.<String>any());
        doNothing().when(fileDownloadResponse).setFileName(Mockito.<String>any());
        doNothing().when(fileDownloadResponse).setFileType(Mockito.<String>any());
        doNothing().when(fileDownloadResponse).setFileattachment(Mockito.<String>any());
        fileDownloadResponse.setErrorMap(errorMap);
        fileDownloadResponse.setFileName("foo.txt");
        fileDownloadResponse.setFileType("File Type");
        fileDownloadResponse.setFileattachment("Fileattachment");
        ...
        thrown.expect(BTSLBaseException.class);
        downloadTemplateServiceImpl.downloadGiftTemplate(fileDownloadResponse);
        verify(fileDownloadResponse).setErrorMap(Mockito.<ErrorMap>any());
        verify(fileDownloadResponse).setMessage(Mockito.<String>any());
        verify(fileDownloadResponse).setMessageCode(Mockito.<String>any());
        verify(fileDownloadResponse).setStatus(anyInt());
        verify(fileDownloadResponse).setTransactionId(Mockito.<String>any());
        verify(fileDownloadResponse).setFileName(Mockito.<String>any());
        verify(fileDownloadResponse).setFileType(Mockito.<String>any());
        verify(fileDownloadResponse).setFileattachment(Mockito.<String>any());
    }

    /**
     * Method under test: {@link DownloadTemplateServiceImpl#downloadRechargeTemplate(FileDownloadResponse)}
     */
    @Test
    public void testDownloadRechargeTemplate() throws BTSLBaseException, IOException, WriteException {
        ErrorMap errorMap = new ErrorMap();
        errorMap.setMasterErrorList(new ArrayList<>());
        errorMap.setRowErrorMsgLists(new ArrayList<>());
        ...
        fileDownloadResponse.setTransactionId("42");
        thrown.expect(BTSLBaseException.class);
        downloadTemplateServiceImpl.downloadRechargeTemplate(fileDownloadResponse);
    }
     ...
     */
    @Test
    public void testDownloadRechargeTemplate2() throws BTSLBaseException, IOException, WriteException {
        ErrorMap errorMap = new ErrorMap();
        errorMap.setMasterErrorList(new ArrayList<>());
        errorMap.setRowErrorMsgLists(new ArrayList<>());
        FileDownloadResponse fileDownloadResponse = mock(FileDownloadResponse.class);
    ...
    /**
     * Method under test: {@link DownloadTemplateServiceImpl#downloadInternetTemplate(FileDownloadResponse)}
     */
    @Test
    public void testDownloadInternetTemplate() throws BTSLBaseException, IOException, WriteException {
        ErrorMap errorMap = new ErrorMap();
        errorMap.setMasterErrorList(new ArrayList<>());
        errorMap.setRowErrorMsgLists(new ArrayList<>());
        ...
        fileDownloadResponse.setTransactionId("42");
        thrown.expect(BTSLBaseException.class);
        downloadTemplateServiceImpl.downloadInternetTemplate(fileDownloadResponse);
    }
     ...
     */
    @Test
    public void testDownloadInternetTemplate2() throws BTSLBaseException, IOException, WriteException {
        ErrorMap errorMap = new ErrorMap();
        errorMap.setMasterErrorList(new ArrayList<>());
        errorMap.setRowErrorMsgLists(new ArrayList<>());
        FileDownloadResponse fileDownloadResponse = mock(FileDownloadResponse.class);
    ...
    /**
     * Method under test: {@link DownloadTemplateServiceImpl#downloadDvdMasterSheet(Connection, FileDownloadResponse, String, String)}
     */
    @Test
    public void testDownloadDvdMasterSheet() throws BTSLBaseException, IOException, WriteException {
        ...
        fileDownloadResponse.setTransactionId("42");
        thrown.expect(BTSLBaseException.class);
        downloadTemplateServiceImpl.downloadDvdMasterSheet(con, fileDownloadResponse, "User ID", "Network ID");
    }
     ...
     */
    @Test
    public void testDownloadDvdMasterSheet2() throws BTSLBaseException, IOException, WriteException {
    ...
    /**
     * Method under test: {@link DownloadTemplateServiceImpl#downloadO2CWithdrawTemplate(FileDownloadResponse)}
     */
    @Test
   //@Ignore("TODO: Complete this test")
    public void testDownloadO2CWithdrawTemplate() throws BTSLBaseException, IOException, WriteException {
        // TODO: Complete this test.
        ...
        //       at com.restapi.user.service.DownloadTemplateServiceImpl.downloadO2CWithdrawTemplate(DownloadTemplateServiceImpl.java:572)
        ...
        fileDownloadResponse.setStatus(1);
        fileDownloadResponse.setTransactionId("42");
        downloadTemplateServiceImpl.downloadO2CWithdrawTemplate(fileDownloadResponse);
    }
    ...
    @Test
   //@Ignore("TODO: Complete this test")
    public void testDownloadO2CWithdrawTemplate2() throws BTSLBaseException, IOException, WriteException {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
    ...
    /**
     * Method under test: {@link DownloadTemplateServiceImpl#downloadO2CPurchaseTemplate(FileDownloadResponse)}
     */
    @Test
   //@Ignore("TODO: Complete this test")
    public void testDownloadO2CPurchaseTemplate() throws BTSLBaseException, IOException, WriteException {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        //       at java.util.Locale.<init>(Locale.java:648)
        //       at java.util.Locale.<init>(Locale.java:677)
        //       at com.restapi.user.service.DownloadTemplateServiceImpl.downloadO2CPurchaseTemplate(DownloadTemplateServiceImpl.java:665)
        //   See https://diff.blue/R013 to resolve this issue.
        ...
        fileDownloadResponse.setStatus(1);
        fileDownloadResponse.setTransactionId("42");
        downloadTemplateServiceImpl.downloadO2CPurchaseTemplate(fileDownloadResponse);
    }
    ...
    @Test
   //@Ignore("TODO: Complete this test")
    public void testDownloadO2CPurchaseTemplate2() throws BTSLBaseException, IOException, WriteException {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
    ...
    /**
     * Method under test: {@link DownloadTemplateServiceImpl#downloadBulkUserTemplate(Connection, UserVO, String, String, FileDownloadResponse, HttpServletResponse)}
     */
    @Test
   //@Ignore("TODO: Complete this test")
    public void testDownloadBulkUserTemplate() throws BTSLBaseException, IOException, SQLException, ParseException {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        //       at java.util.Locale.<init>(Locale.java:648)
        //       at java.util.Locale.<init>(Locale.java:677)
        //       at com.restapi.user.service.DownloadTemplateServiceImpl.downloadBulkUserTemplate(DownloadTemplateServiceImpl.java:746)
        //   See https://diff.blue/R013 to resolve this issue.
        ...
        fileDownloadResponse.setStatus(1);
        fileDownloadResponse.setTransactionId("42");
        downloadTemplateServiceImpl.downloadBulkUserTemplate(con, userVO, "Domain Code", "Geography Code",
                fileDownloadResponse, new CustomResponseWrapper(new Response()));
    }

    /**
     * Method under test: {@link DownloadTemplateServiceImpl#downloadC2SBulkReversalTemplate(FileDownloadResponse)}
     */
    @Test
   //@Ignore("TODO: Complete this test")
    public void testDownloadC2SBulkReversalTemplate() throws BTSLBaseException, IOException, WriteException {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        //       at java.util.Locale.<init>(Locale.java:648)
        //       at java.util.Locale.<init>(Locale.java:677)
        //       at com.restapi.user.service.DownloadTemplateServiceImpl.downloadC2SBulkReversalTemplate(DownloadTemplateServiceImpl.java:926)
        //   See https://diff.blue/R013 to resolve this issue.
        ...
        fileDownloadResponse.setStatus(1);
        fileDownloadResponse.setTransactionId("42");
        downloadTemplateServiceImpl.downloadC2SBulkReversalTemplate(fileDownloadResponse);
    }
    ...
    @Test
   //@Ignore("TODO: Complete this test")
    public void testDownloadC2SBulkReversalTemplate2() throws BTSLBaseException, IOException, WriteException {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
