...
public class AddCardGroupTest {
    @Rule
    public ExpectedException thrown = ExpectedException.none();

    /**
     * Method under test: {@link AddCardGroup#addCardGroup(String)}
     */
    @Test
    ...
    public void testAddCardGroup() throws BTSLBaseException, IOException, SQLException, ParseException {
        ...
        //       at com.restapi.cardgroup.service.AddCardGroup.addCardGroup(AddCardGroup.java:108)

        // Arrange
        // TODO: Populate arranged inputs
        AddCardGroup addCardGroup = new AddCardGroup();
        String requestData = "";

        // Act
        PretupsResponse<JsonNode> actualAddCardGroupResult = addCardGroup.addCardGroup(requestData);
    ...
    /**
     * Method under test: {@link AddCardGroup#add(CardGroupSetVO, Date, Connection, List, JsonNode, ObjectMapper)}
     */
    @Test
    public void testAdd() throws BTSLBaseException, IOException {
        ...
        addCardGroup.add(cardGroupSetVO, currentDate, com.btsl.util.JUnitConfig.getConnection(), new ArrayList<>(), mock(JsonNode.class),
    ...
    /**
     * Method under test: {@link AddCardGroup#loadData(Connection, CardGroupSetVO)}
     */
    @Test
...
*/
        ...
        addCardGroup.loadData(JUnitConfig.getConnection(), cardGroupSetVO);
    ...
    public void testLoadData2() throws BTSLBaseException, SQLException {
        ...
        *///Connection con = mock(Connection.class);
        ...
        cardGroupSetVO.setValidityTypeList(new ArrayList<>());
        cardGroupSetVO.setVersion("1.0.2");
        addCardGroup.loadData(com.btsl.util.JUnitConfig.getConnection(), cardGroupSetVO);
       /* verify(con).prepareStatement(Mockito.<String>any());
        verify(preparedStatement).executeQuery();
        verify(preparedStatement, atLeast(1)).setString(anyInt(), Mockito.<String>any());
        verify(preparedStatement).close();
...
//        assertTrue(cardGroupSetVO.getAmountTypeList().isEmpty());
 //       assertTrue(cardGroupSetVO.getValidityTypeList().isEmpty());
    ...
    /**
     * Method under test: {@link AddCardGroup#loadVoucherData(Connection, CardGroupSetVO, CardGroupDetailsVO)}
     */
    @Test
    public void testLoadVoucherData() throws BTSLBaseException, SQLException {
       ...
       // when(con.prepareStatement(Mockito.<String>any())).thenReturn(preparedStatement);
        ...
        thrown.expect(BTSLBaseException.class);
        addCardGroup.loadVoucherData(com.btsl.util.JUnitConfig.getConnection(), cardGroupSetVO, cardDetailVO);
       /* verify(con).prepareStatement(Mockito.<String>any());
        verify(preparedStatement).executeQuery();
        verify(preparedStatement).close();
        verify(resultSet, atLeast(1)).next();
    ...
    public void testLoadVoucherData2() throws BTSLBaseException, SQLException {
        ...
        //       at com.restapi.cardgroup.service.AddCardGroup.loadVoucherData(AddCardGroup.java:361)
...
//        when(cardDetailVO.getVoucherTypeDesc()).thenThrow(new NumberFormatException("loadVoucherData"));
        addCardGroup.loadVoucherData(JUnitConfig.getConnection(), cardGroupSetVO, cardDetailVO);
    }

    /**
     * Method under test: {@link AddCardGroup#modifyCardGroup(String)}
     */
    @Test
    //@Ignore("TODO: Complete this test")
    public void testModifyCardGroup() throws Exception {
        ...
        //       at com.btsl.util.OracleUtil.<clinit>(OracleUtil.java:256)
        //       at com.btsl.db.util.MComConnection.<init>(MComConnection.java:22)
        //       at com.restapi.cardgroup.service.AddCardGroup.modifyCardGroup(AddCardGroup.java:415)
        ...
        // Act
        PretupsResponse<JsonNode> actualModifyCardGroupResult = addCardGroup.modifyCardGroup(requestData);
    ...
    /**
     * Method under test: {@link AddCardGroup#validation(CardGroupSetVO, JsonNode, ObjectMapper, Connection)}
     */
    @Test
    public void testValidation() throws BTSLBaseException {
        ...
        thrown.expect(BTSLBaseException.class);
        addCardGroup.validation(cardGroupSetVO, cardGroupSetListNode, new ObjectMapper(), mock(Connection.class));
    }
    ...
    /**
     * Method under test: {@link AddCardGroup#checkDeleteVersionAllowed(String, String, StringBuffer)}
     */
    @Test
    //@Ignore("TODO: Complete this test")
    public void testCheckDeleteVersionAllowed() {
        ...
        // Act
        boolean actualCheckDeleteVersionAllowedResult = addCardGroup.checkDeleteVersionAllowed(p_cardGroupSetID,
    ...
    /**
     * Method under test: {@link AddCardGroup#getReversalModifiedDate(JsonNode)}
     */
    @Test
    public void testGetReversalModifiedDate() {
        com.btsl.util.JUnitConfig.init(); //Auto replace
        //   Diffblue AI was unable to find a test

        AddCardGroup addCardGroup = new AddCardGroup();
        addCardGroup.getReversalModifiedDate(MissingNode.getInstance());
    }
}
