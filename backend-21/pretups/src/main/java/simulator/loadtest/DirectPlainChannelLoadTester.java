...
public class DirectPlainChannelLoadTester
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			DirectPlainChannelFireRequest fireRequest = null;
			int totalRequests = 0;
			if(args[3]!=null)
			{
			...
			while(counter<=totalRequests)
			{
				for (int ct = 0; ct < msisdnArr.length; ct++)
				{
					...
					fireRequest = new DirectPlainChannelFireRequest(sender,propMessage,user,pass,requestGCode,requestGType,servicePort,sourceType,ct,args[2],url);
					fireRequest.start();
...
class DirectPlainChannelFireRequest extends Thread
{
	...
	public DirectPlainChannelFireRequest(String msisdn,String p_message,String login,String password,String requestGCode,String requestGType,String servicePort,String sourceType,int p_ct,String p_service,String p_url )
	{
