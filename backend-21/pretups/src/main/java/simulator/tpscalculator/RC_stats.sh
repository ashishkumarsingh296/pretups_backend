...
JAVA_HOME=$HOME/JAVA_SMSR1; export JAVA_HOME
CATALINA_HOME=$HOME/apache-tomcat-8.0.30_smsr1; export CATALINA_HOME
...
java simulator/tpscalculator/RCPPTCalculator /pretupsvar/pretups_smsr1/85RC_10BAL_5O2C_8hr_22mar16 ChannelRequestDailyLog
