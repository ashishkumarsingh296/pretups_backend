package com.inter.cs3bangladesh.cs3bangladeshscheduler;
 ...
 * ------------------------------------------------------------------------------
 * -------------------
 * Shashank Shukla 11-Apr-2011 Initial Creation
 * ------------------------------------------------------------------------------
 * ------------------
 */
...
public class NodeCloser {
    ...
    public synchronized void checkExpiry(NodeVO p_nodeVO) throws BTSLBaseException {
        ...
        if (_log.isDebugEnabled())
            _log.debug("checkExpiry", "Entered p_nodeVO:" + p_nodeVO);
    ...
    public synchronized void updateCountersOnAmbiguousResp(NodeVO p_nodeVO) {
        if (_log.isDebugEnabled())
            _log.debug("updateCountersOnAmbiguousResp", "Entered printNodeVO:" + printNodeVO(p_nodeVO));
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug("updateCountersOnAmbiguousResp", "Exited printNodeVO:" + printNodeVO(p_nodeVO));
        }
    ...
    public synchronized void resetCounters(NodeVO p_nodeVO) {
        ...
        if (_log.isDebugEnabled())
            _log.debug("resetCounters", "Entered printNodeVO:" + printNodeVO(p_nodeVO));
        try {
            if (p_nodeVO.isSuspended())
                p_nodeVO.setProcessSingleReqFlag(false);
            ...
            if (_log.isDebugEnabled())
                _log.debug("resetCounters", "Exited printNodeVO:" + printNodeVO(p_nodeVO));
        }
     ...
     * {
     * if(_log.isDebugEnabled())
     * _log.debug("updateCountersOnConnectTimeOut","Entered printNodeVO:"
     * +printNodeVO(p_nodeVO));
     * try
     * {
     ...
     * {
     * if(_log.isDebugEnabled())
     * _log.debug("updateCountersOnConnectTimeOut","Exited printNodeVO:"
     * +printNodeVO(p_nodeVO));
     * }
     * 
     * }
