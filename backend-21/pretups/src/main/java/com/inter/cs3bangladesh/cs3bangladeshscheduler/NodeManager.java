 ...
 *                 ------------------------------------------------------------
 *                 -------------------------------------
 *                 Shashank Shukla 11-Apr-2010 Initial Creation
 *                 ------------------------------------------------------------
 *                 ------------------------------------
...
public class NodeManager {
    ...
    private static HashMap _cs3NodeSchedulerMap = null;// Contains the instance
    ...
    public static void initialize(String p_interfaceIDs) throws BTSLBaseException {
        ...
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug("initialize", "Exited _cs3ObjectMap::" + _cs3NodeSchedulerMap);
        }// end of finally
    }// end of initialize
