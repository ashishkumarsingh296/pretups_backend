...
public interface OLORechargeI
{
	...
	public String RESPONSE_SUCCESS="IE000";
	public String RESPONSE_INVALID_KEY="IE005";
	public String APPLICATION_FAIL="IE100";
	public String CUSTOMER_NOT_EXIST="IE200";
	public String DUPLICATE_ENTRY="IE500";
	public String EXT_REF_CODE_LENGTH_EXCEEDS="IE700";
	public String BANK_CODE_NOT_EXIST="IE800";
	public String BANK_CODE_LENGTH_EXCEEDS="IE900";
	public String DATE_LENGTH_EXCEEDS="IE990";
