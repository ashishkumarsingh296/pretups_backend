...
/***
 * @(#)AlcatelOBO452UrlConnection.java
...
public class AlcatelOBO452UrlConnection extends BTSLConnection {
    private HttpURLConnection _urlConnection = null;
    public static Log _log = LogFactory.getLog("AlcatelOBO452UrlConnection".getClass().getName());
     ...
     * @throws Exception
     */
    public AlcatelOBO452UrlConnection(String p_url, int p_connecttimeout, int p_readtimeout, String p_keepAlive) throws Exception {
        if (_log.isDebugEnabled())
            _log.debug("AlcatelOBO452UrlConnection ", "Entered p_url: " + p_url + "p_connecttimeout=" + p_connecttimeout + " p_readtimeout=" + p_readtimeout + " p_keepAlive=" + p_keepAlive);
        try {
            ...
            e.printStackTrace();
            _log.error("AlcatelOBO452UrlConnection", " Exception: " + e.getMessage());
            throw e;
        }
        if (_log.isDebugEnabled())
            _log.debug("AlcatelOBO452UrlConnection ", "Exiting ");
    }
