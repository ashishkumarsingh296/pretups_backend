 ...
 *                      --------------------------------------------------------
 *                      ----------------------------------------
 *                      This Servlet is responsible to initialize the node
 *                      details at server start up.
 */
...
public class NodeServlet extends HttpServlet {
    private static final long serialVersionUID = 2813147777985962339L;
    ...
    public void initialize() {
        ...
        try {
            ...
            schINIDs = Constants.getProperty("CS3_AIR22_MOBILECOM_SCH_IN_IDS");
            if (_log.isDebugEnabled())
                _log.debug("initialize", "schINIDs = " + schINIDs);
