 ...
 *                            --------------------------------------------------
 *                            ----------------------------------------------
 *                            Handler class for the CS3 Air2.2 IN interface.
 */
...
import com.inter.cs3mobilecom.scheduler.NodeManager;
import com.inter.cs3mobilecom.scheduler.NodeScheduler;
import com.inter.cs3mobilecom.scheduler.NodeVO;

public class CS3Air22INHandler implements InterfaceHandler {
    private static Log _log = LogFactory.getLog(CS3Air22INHandler.class.getName());
    ...
    private static CS3Air22RequestFormatter _cs3AirReqFor = null;

    static {
        if (_log.isDebugEnabled())
            _log.debug("CS3Air22INHandler[static]", "Entered");
        try {
            _cs3AirReqFor = new CS3Air22RequestFormatter();
        } catch (Exception e) {
            _log.error("CS3Air22INHandler[static]", "While instantiation of CS3Air22RequestFormatter get Exception e::" + e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[static]", "", "", "", "While instantiation of CS3Air22RequestFormatter get Exception e::" + e.getMessage());
        } finally {
            if (_log.isDebugEnabled())
                _log.debug("CS3Air22INHandler[static]", "Exited");
        }
    }
    ...
    public void validate(HashMap<String, String> p_requestMap) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            if (InterfaceUtil.isNullString(multFactor)) {
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[validate]", _referenceID, _msisdn + " INTERFACE ID::" + _interfaceID, _requestMap.get("NETWORK_CODE"), "Multiplication factor is not defined in IN File");
            ...
            if (InterfaceUtil.isNullString(firstFlagStr)) {
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[validate]", _referenceID, _msisdn + " INTERFACE ID::" + _interfaceID, _requestMap.get("NETWORK_CODE"), "FIRST_FLAG is not defined in IN File");
                throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
            ...
            // validate request.
            String inStr = _cs3AirReqFor.generateRequest(CS3Air22I.ACTION_ACCOUNT_INFO, p_requestMap);
            // sending the AccountInfo request to IN
            sendRequestToIN(inStr, CS3Air22I.ACTION_ACCOUNT_INFO);
            ...
            String firstIVRCallFlag = _responseMap.get("firstIVRCallFlag");
            ...
            String amountStr = _responseMap.get("accountValue1");
            ...
            if (InterfaceUtil.isNullString(noOfAcntFlagBitsStr) || !InterfaceUtil.isNumeric(noOfAcntFlagBitsStr)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "EricssionINHandler[validate]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "ACNT_STATUS_BIT_CNT is not defined in the INFile.");
            ...
            String accountFlags = _responseMap.get("accountFlags");
            if (InterfaceUtil.isNullString(accountFlags)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "EricssionINHandler[validate]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "Account Fag value is not present in response");
            ...
            _requestMap.put("SERVICE_CLASS", _responseMap.get("serviceClassCurrent"));
            _requestMap.put("OLD_EXPIRY_DATE", InterfaceUtil.getInterfaceDateFromDateString(_responseMap.get("supervisionDate"), "yyyyMMdd"));
            _requestMap.put("OLD_GRACE_DATE", InterfaceUtil.getInterfaceDateFromDateString(_responseMap.get("serviceFeeDate"), "yyyyMMdd"));
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[validate]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "Exception while validate e::" + e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
    ...
    public void credit(HashMap<String, String> p_requestMap) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            try {
                ...
                interfaceAmount = Long.parseLong(_requestMap.get("INTERFACE_AMOUNT"));
            } catch (Exception e) {
                e.printStackTrace();
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[credit]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), "Requested Amount[INTERFACE_AMOUNT] is not Numeric");
                throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
            // set the interface specific parameters
            // origin_host_type,origin_node_type into _requestMap
            ...
            // Put the system amount in request map after dividing it to
            ...
            if (InterfaceUtil.isNullString(roundFlag)) {
                roundFlag = "N";
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.MAJOR, "CS3Air22INHandler[credit]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), "ROUND_FLAG is not defined in IN File hence system taken the default value=N.");
            }
            ...
            if ("Y".equals(superRefillT))
                action = CS3Air22I.ACTION_SUPER_REFILLT_CREDIT;
            else
                action = CS3Air22I.ACTION_CREDIT;
            // Generate the request XML from the CS3Air22RequestFormatter class.
            String inStr = _cs3AirReqFor.generateRequest(action, _requestMap);
            ...
            // Put new grace date after crediting the subscriber.
            ...
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[credit]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "Exception while processing ambiguous case in credit");
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[credit]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "Exception while credit Exception e::" + e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
        }// end of catch-Exception
        finally {
            if (_log.isDebugEnabled())
    ...
    public void creditAdjust(HashMap<String, String> p_requestMap) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            if (!InterfaceUtil.isNullString(_requestMap.get("INTERFACE_AMOUNT"))) {
                try {
                    // For debiting the amount,make negative value for the
                    // interface amount.
                    amount = Long.parseLong(_requestMap.get("INTERFACE_AMOUNT"));
                } catch (Exception e) {
                    e.printStackTrace();
                    _log.error("creditAdjust", "Exception e::" + e.getMessage());
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[creditAdjust]", _referenceID, _msisdn + " INTERFACE ID::" + _interfaceID, _requestMap.get("NETWORK_CODE"), "Requested Amount[INTERFACE_AMOUNT] is not Numeric");
                    throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
                }
                // Get the multiplication factor from File Cache.
                ...
                if (InterfaceUtil.isNullString(multFactor)) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[creditAdjust]", _referenceID, _msisdn + " INTERFACE ID::" + _interfaceID, _requestMap.get("NETWORK_CODE"), "Multiplication factor is not defined in IN File");
                    throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
                }
                ...
                if (InterfaceUtil.isNullString(roundFlag)) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.MAJOR, "CS3Air22INHandler[creditAdjust]", _referenceID, _msisdn + " INTERFACE ID::" + _interfaceID, _requestMap.get("NETWORK_CODE"), "ROUND_FLAG is not defined in IN File");
                }
            ...
            if (!InterfaceUtil.isNullString(_requestMap.get("VALIDITY_DAYS"))) {
                try {
                    // For the adjustment make validity days as negative.
                    validityDays = Integer.parseInt((_requestMap.get("VALIDITY_DAYS")).trim());
                    if (_log.isDebugEnabled())
            ...
            if (!InterfaceUtil.isNullString(_requestMap.get("GRACE_DAYS"))) {
                try {
                    // For the adjustment make grace days as negative.
                    graceDays = Integer.parseInt((_requestMap.get("GRACE_DAYS")).trim());
             ...
             // Generate the request XML from the CS3Air22RequestFormatter
             // class--->ACTION will be same or different???.
            String inStr = _cs3AirReqFor.generateRequest(CS3Air22I.ACTION_DEBIT, _requestMap);
            // Send the request XML to IN.-->ACTION will be same or different???
            sendRequestToIN(inStr, CS3Air22I.ACTION_DEBIT);
            ...
            try {
                ...
                e.printStackTrace();
                _log.error("creditAdjust ::", "Exception e:" + e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[debitAdjust]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "Exception while processing ambiguous case in creditAdjust");
            ...
            e.printStackTrace();
            _log.error("creditAdjust", "Exception e::" + e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[credit]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "Exception while credit adjust Exception e::" + e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
        }// end of catch-Exception
        finally {
            if (_log.isDebugEnabled())
        ...
        try {
            ...
            if (!InterfaceUtil.isNullString(_requestMap.get("INTERFACE_AMOUNT"))) {
                try {
                    // For debiting the amount,make negative value for the
                    // interface amount.
                    amount = amount - Long.parseLong((_requestMap.get("INTERFACE_AMOUNT")).trim());
                    if (_log.isDebugEnabled())
                        _log.debug("debitAdjust", "amount::" + amount);
                } catch (Exception e) {
                    e.printStackTrace();
                    _log.error("debitAdjust ::", "Exception e::" + e.getMessage());
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[debitAdjust]", _referenceID, _msisdn + " INTERFACE ID::" + _interfaceID, _requestMap.get("NETWORK_CODE"), "Requested Amount[INTERFACE_AMOUNT] is not Numeric");
                    throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
                }
                String multFactor = (String) FileCache.getValue(_interfaceID, "MULTIPLICATION_FACTOR");
                if (InterfaceUtil.isNullString(multFactor)) {
                    _log.error("debitAdjust ::", "MULTIPLICATION_FACTOR is not defined into IN File interfaceID::" + _interfaceID);
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[debitAdjust]", _referenceID, _msisdn + " INTERFACE ID::" + _interfaceID, _requestMap.get("NETWORK_CODE"), "Multiplication factor is not defined in IN File");
                    throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
                }
                // Based on the INFiles ROUND_FLAG flag, we have to decide to
                // round the transfer amount or not.
                ...
                if (InterfaceUtil.isNullString(roundFlag)) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.MAJOR, "CS3Air22INHandler[debitAdjust]", _referenceID, _msisdn + " INTERFACE ID::" + _interfaceID, _requestMap.get("NETWORK_CODE"), "ROUND_FLAG is not defined in IN File");
                }
            ...
            if (!InterfaceUtil.isNullString(_requestMap.get("VALIDITY_DAYS"))) {
                try {
                    // For the adjustment make validity days as negative.
                    validityDays = validityDays - Integer.parseInt((_requestMap.get("VALIDITY_DAYS")).trim());
                    if (_log.isDebugEnabled())
            ...
            if (!InterfaceUtil.isNullString(_requestMap.get("GRACE_DAYS"))) {
                try {
                    // For the adjustment make grace days as negative.
                    graceDays = graceDays - Integer.parseInt((_requestMap.get("GRACE_DAYS")).trim());
                    // Set the grace days into request map with key as
                    // 'relative_date_adjustment_supervision'
                    _requestMap.put("relative_date_adjustment_supervision", String.valueOf(graceDays));
                } catch (Exception e) {
            ...
            try {
                ...
                e.printStackTrace();
                _log.error("debitAdjust ::", "Exception e:" + e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[debitAdjust]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "Exception while processing ambiguous case in debitAdjust");
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[debitAdjust]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "Exception while credit Exception e=" + e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
        }// end of catch-Exception
        finally {
            if (_log.isDebugEnabled())
     ...
     * after parsing.
     * This method also take care about to handle the erroneous situation to
     ...
     * CS3Air22UrlConnection class and get connection.
    ...
    private void sendRequestToIN(String p_inRequestStr, int p_action) throws BTSLBaseException {
        ...
        TransactionLog.log(_inTXNID, _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), String.valueOf(p_action), PretupsI.TXN_LOG_REQTYPE_REQ, "Request string::" + p_inRequestStr, PretupsI.TXN_LOG_STATUS_UNDERPROCESS, "action::" + p_action);
        String responseStr = "";
        NodeVO cs3NodeVO = null;
        NodeScheduler cs3NodeScheduler = null;
        CS3Air22UrlConnection cs3Air22UrlConnection = null;
        long startTime = 0;
        long endTime = 0;
        int retryNumber = 0;
        long warnTime = 0;
        ...
        try {
            ...
            try {
                ...
                for (loop = 1; loop <= retryNumber; loop++) {
                    try {
                        ...
                        if (CS3Air22I.ACTION_ACCOUNT_INFO == p_action)
                        ...
                        // construction whether URL will be specified in INFile
                        // or IP,PORT and ServletName.
                        cs3Air22UrlConnection = new CS3Air22UrlConnection(cs3NodeVO.getUrl(), cs3NodeVO.getConnectionTimeOut(), readTimeOut, cs3NodeVO.getKeepAlive(), p_inRequestStr.length(), hostName, userAgent);
                        // break the loop on getting the successful connection
                        // for the node;
                        if (_log.isDebugEnabled())
                        ...
                        EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "Exception while getting the connection for CS3Air22IN with INTERFACE_ID=[" + _interfaceID + "]and Node Number=[" + cs3NodeVO.getNodeNumber() + "]");
                        ...
                        if (loop == retryNumber) {
                            EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "MAXIMUM SHIFTING OF NODE IS REACHED");
                ...
                e.printStackTrace();
                EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "Error while getting the scheduled Node for INTERFACE_ID=[" + _interfaceID + "]and Node Number=[" + cs3NodeVO.getNodeNumber() + "]" + " Exception ::" + e.getMessage());
            ...
            try {
                PrintWriter out = cs3Air22UrlConnection.getPrintWriter();
                out.flush();
                ...
                EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "While sending request to CS3 IN INTERFACE_ID=[" + _interfaceID + "]and Node Number=[" + cs3NodeVO.getNodeNumber() + "] Exception::" + e.getMessage());
            ...
            try {
                ...
                try {
                    ...
                    cs3Air22UrlConnection.setBufferedReader();
                    BufferedReader in = cs3Air22UrlConnection.getBufferedReader();
                    ...
                    if (warnTime <= (endTime - startTime)) {
                        ...
                        EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.MAJOR, "CS3Air22INHandler[sendRequestToIN]", _inTXNID, _msisdn, _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Stage = " + p_action, "CS3Air22IN is taking more time than the warning threshold. Time: " + (endTime - startTime) + "INTERFACE_ID=[" + _interfaceID + "]and Node Number=[" + cs3NodeVO.getNodeNumber() + "]");
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    _log.error("sendRequestToIN", "Exception e::" + e.getMessage());
                    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "While getting the response from the CS3Air22IN for INTERFACE_ID=[" + _interfaceID + "]and Node Number=[" + cs3NodeVO.getNodeNumber() + "]" + "Exception=" + e.getMessage());
                ...
                TransactionLog.log(_inTXNID, _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), String.valueOf(p_action), PretupsI.TXN_LOG_REQTYPE_RES, "Response string:" + responseStr, PretupsI.TXN_LOG_STATUS_UNDERPROCESS, "action=" + p_action);
                if (_log.isDebugEnabled())
                    _log.debug("sendRequestToIN", "responseStr::" + responseStr);
                // TransactionLog.log(_inTXNID,_referenceID,_msisdn,_requestMap.get("NETWORK_CODE"),String.valueOf(p_action),PretupsI.TXN_LOG_REQTYPE_RES,"Response string:"+responseStr,PretupsI.TXN_LOG_STATUS_UNDERPROCESS,"action="+p_action);
                String httpStatus = cs3Air22UrlConnection.getResponseCode();
                _requestMap.put("PROTOCOL_STATUS", httpStatus);
                if (!CS3Air22I.HTTP_STATUS_200.equals(httpStatus))
                ...
                if (InterfaceUtil.isNullString(responseStr)) {
                    EventHandler.handle(EventIDI.INTERFACE_INVALID_RESPONSE, _interfaceID, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Stage = " + p_action, "Blank response from CS3Air22IN");
                    _log.error("sendRequestToIN", "NULL response from interface");
                    _requestMap.put("INTERFACE_STATUS", InterfaceErrorCodesI.AMBIGOUS);
                    throw new BTSLBaseException(InterfaceErrorCodesI.AMBIGOUS);
                }
                // Parse the response string and get the response Map.
                _responseMap = _cs3AirReqFor.parseResponse(p_action, responseStr);
                ...
                if (!InterfaceUtil.isNullString(faultCode)) {
                    // Log the value of executionStatus for corresponding MSISDN
                    ...
                    EventHandler.handle(EventIDI.INTERFACE_INVALID_RESPONSE, _interfaceID, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Stage = " + p_action, (String) _responseMap.get("faultString"));
                ...
                if (!CS3Air22I.RESULT_OK.equals(responseCode)) {
                    if (CS3Air22I.SUBSCRIBER_NOT_FOUND.equals(responseCode)) {
                        _log.error("sendRequestToIN", "Subscriber not found with MSISDN::" + _msisdn);
                        EventHandler.handle(EventIDI.INTERFACE_INVALID_RESPONSE, _interfaceID, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Stage = " + p_action, "Subscriber is not found at IN");
            ...
            try {
                ...
                if (cs3Air22UrlConnection != null)
                    cs3Air22UrlConnection.close();
                if (cs3NodeVO != null) {
                ...
                e.printStackTrace();
                _log.error("sendRequestToIN", "While closing CS3Air22IN Connection Exception e::" + e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Stage = " + p_action, "Not able to close connection:" + e.getMessage() + "INTERFACE_ID=[" + _interfaceID + "]and Node Number=[" + cs3NodeVO.getNodeNumber() + "]");
            }
            if (_log.isDebugEnabled())
    ...
    private void setInterfaceParameters() throws Exception, BTSLBaseException {
        ...
        try {
            ...
            String instanceID = FileCache.getValue(_requestMap.get("INTERFACE_ID"), "INSTANCE_ID");
            if (InterfaceUtil.isNullString(instanceID)) {
                _log.error("getINReconTxnID", "Parameter INSTANCE_ID is not defined in the INFile");
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[setInterfaceParameters]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), "Instance id[INSTANCE_ID] is not defined in IN File");
            ...
            if (!InterfaceUtil.isNullString(externalData2Required) && "Y".equals(externalData2Required)) {
                ...
                if (!InterfaceUtil.isNullString(externalData2))
                    ...
                    externalData2 = _requestMap.get("TRANSACTION_ID") + "." + _requestMap.get("SENDER_MSISDN");
            ...
            if (InterfaceUtil.isNullString(originNodeType)) {
                EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), " NODE_TYPE is not defined for INTERFACE_ID=" + _interfaceID);
                throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_BAD_REQUEST);
            }
            _requestMap.put("origin_node_type", originNodeType.trim());
            originHostName = FileCache.getValue(_interfaceID, "HOST_NAME");
            if (InterfaceUtil.isNullString(originNodeType)) {
                EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), " HOST_NAME is not defined for INTERFACE_ID=" + _interfaceID);
                throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_BAD_REQUEST);
            }
            _requestMap.put("origin_host_name", originHostName.trim());
            transactionCurrency = FileCache.getValue(_interfaceID, "CURRENCY1");
            if (InterfaceUtil.isNullString(originNodeType)) {
                EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), " CURRENCY1 is not defined for INTERFACE_ID=" + _interfaceID);
                throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_BAD_REQUEST);
            }
            ...
            if (InterfaceUtil.isNullString(cancelTxnAllowed)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "CANCEL_TXN_ALLOWED is not defined in the INFile.");
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingCr)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_CREDIT is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_BAD_REQUEST);
            }
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingCrAdj)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_CREDIT_ADJ is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_BAD_REQUEST);
            }
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingDbtAdj)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_DEBIT_ADJ is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_BAD_REQUEST);
            }
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingCrBck)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_CREDIT_BCK is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_BAD_REQUEST);
            }
            ...
            if (InterfaceUtil.isNullString(cancelCommandStatusMapping)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "CANCEL_COMMAND_STATUS_MAPPING is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_BAD_REQUEST);
            }
            ...
            if (InterfaceUtil.isNullString(cancelNA)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "CANCEL_NA is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_BAD_REQUEST);
            }
            ...
            EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "CS3Air22INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "INTERFACE_ID=" + _interfaceID + " Getting exception e=" + e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
        }// end of catch-Exception
        finally {
            if (_log.isDebugEnabled())
    ...
    private void setLanguageFromMapping() throws Exception {
        ...
        try {
            ...
            if (mappingNotFound)
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.MAJOR, "CS3Air22INHandler[setLanguageFromMapping]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "Mapping for language received from IN =  " + langFromIN + " is not defined in IN file Hence setting the Default language");
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "CS3Air22INHandler[setLanguageFromMapping]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "While mapping the IN Language with the system Language getting the Exception =" + e.getMessage());
        }// end of catch-Exception
        finally {
            if (_log.isDebugEnabled())
