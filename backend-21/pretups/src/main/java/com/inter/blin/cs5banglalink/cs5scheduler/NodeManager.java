...
public class NodeManager {
    ...
    private static HashMap<String, NodeScheduler> _cs3NodeSchedulerMap = null;// Contains
                                                                              // the
                                                                              // instance
                                                                              // of
                                                                              // NodeScheduler
    ...
    public static void initialize(String p_interfaceIDs) throws BTSLBaseException {
        ...
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_interfaceIDs::" + p_interfaceIDs);
        String strINId = null;
        ...
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug(METHOD_NAME, "Exited _cs3ObjectMap::" + _cs3NodeSchedulerMap);
        }
    }
    ...
    public static NodeScheduler getScheduler(String p_interfaceID) throws BTSLBaseException {
    	final String METHOD_NAME="getScheduler";
        if (_log.isDebugEnabled())
        ...
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug(METHOD_NAME, "Exited cs3NodeScheduler::" + cs3NodeScheduler);
        }
