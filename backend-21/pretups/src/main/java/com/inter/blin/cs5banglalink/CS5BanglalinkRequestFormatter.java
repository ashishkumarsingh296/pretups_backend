...
public class CS5BanglalinkRequestFormatter {
    public static Log _log = LogFactory.getLog(CS5BanglalinkRequestFormatter.class);
    ...
    public CS5BanglalinkRequestFormatter() throws Exception {
    	final String METHOD_NAME="CS5BanglalinkRequestFormatter[constructor]";
    ...
    protected String generateRequest(int p_action, HashMap<String, String> p_map) throws Exception {
    	final String METHOD_NAME="generateRequest";
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_action=" + p_action + " map=" + p_map);
        String str = null;
        p_map.put("action", String.valueOf(p_action));
        try {
            switch (p_action) {
            case CS5BanglalinkI.ACTION_ACCOUNT_INFO: {
                str = generateGetAccountInfoRequest(p_map);
                break;
            }
            case CS5BanglalinkI.ACTION_ACCOUNT_DETAILS: {
                str = generateGetAccountDetailRequest(p_map);
                break;
            }
            case CS5BanglalinkI.ACTION_RECHARGE_CREDIT: {
                str = generateRechargeCreditRequest(p_map);
                break;
            }
            case CS5BanglalinkI.ACTION_IMMEDIATE_DEBIT: {
                str = generateImmediateDebitRequest(p_map);
                break;
            }
            case CS5BanglalinkI.ACTION_DEDICATED_ACCOUNT_CD: {
            ...
            if (_log.isDebugEnabled())
                _log.debug(METHOD_NAME, "Exited Request String: str=" + str);
        }
        return str;
    }
    ...
    public HashMap<String, String> parseResponse(int p_action, String p_responseStr, HashMap<String, String> p_responseMap) throws Exception {
        ...
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_action=" + p_action + " p_responseStr=" + p_responseStr);
        ...
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug(METHOD_NAME, "Exiting map::" + map);
        }
        return map;
    }
    ...
    private String generateGetAccountInfoRequest(HashMap<String, String> p_requestMap) throws Exception {
    	final String METHOD_NAME="generateGetAccountInfoRequest";
        if (_log.isDebugEnabled())
    ...
    private String generateRechargeCreditRequest(HashMap p_requestMap) throws Exception {
    	final String METHOD_NAME="generateRechargeCreditRequest";
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_requestMap::" + p_requestMap);
        String requestStr = null;
        StringBuffer stringBuffer = null;
        try {
            ...
            stringBuffer.append("</member>");
            //Set ExternalData1 as Sender MSISDN
            stringBuffer.append("<member>");
            stringBuffer.append("<name>ExternalData1</name>");
            stringBuffer.append("<value><string>" + p_requestMap.get("SENDER_MSISDN") + "</string></value>");
            stringBuffer.append("</member>");
            //Set ExtenalDaat2 as Grade Code
            stringBuffer.append("<member>");
            stringBuffer.append("<name>ExternalData2</name>");
            stringBuffer.append("<value><string>" + p_requestMap.get("GRADE") + "</string></value>");
            stringBuffer.append("</member>");
            //Set ExternalData3 as Transaction ID
            stringBuffer.append("<member>");
            stringBuffer.append("<name>ExternalData3</name>");
            stringBuffer.append("<value><string>" + p_requestMap.get("TRANSACTION_ID") + "</string></value>");
            stringBuffer.append("</member>");
            //Set ExternalData4 as User Geography
            stringBuffer.append("<member>");
            stringBuffer.append("<name>ExternalData4</name>");
            stringBuffer.append("<value><string>" + p_requestMap.get("GRPH_DOMAIN_CODE") + "</string></value>");
            stringBuffer.append("</member>");
            stringBuffer.append(endRequestTag());
            stringBuffer.append("</methodCall>");
            requestStr = stringBuffer.toString();
            ...
            if (_log.isDebugEnabled())
                _log.debug(METHOD_NAME, "Exiting Request requestStr::" + requestStr);
        }
        return requestStr;
    }
    ...
    private String generateImmediateDebitRequest(HashMap<String, String> p_requestMap) throws Exception {
    	final String METHOD_NAME="generateImmediateDebitRequest";
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_requestMap::" + p_requestMap);
        String requestStr = null;
        StringBuffer stringBuffer = null;
    ...
    private HashMap<String, String> parseGetAccountInfoResponse(String p_responseStr) throws Exception {
    	final String METHOD_NAME="parseGetAccountInfoResponse";
        if (_log.isDebugEnabled())
    ...
    public HashMap<String, String> parseRechargeCreditResponse(String p_responseStr) throws Exception {
    	final String METHOD_NAME="parseRechargeCreditResponse";
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_responseStr=" + p_responseStr);
        HashMap<String, String> responseMap = null;
        int indexStart = 0;
    ...
    private HashMap<String, String> parseImmediateDebitResponse(String p_responseStr) throws Exception {
    	final String METHOD_NAME="parseImmediateDebitResponse";
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_responseStr=" + p_responseStr);
        HashMap<String, String> responseMap = null;
        int indexStart = 0;
        ...
        try {
            ...
            if (tempIndex > 0) {
                ...
                responseMap.put("responseCode", responseCode.trim());
                Object[] successList = CS5BanglalinkI.RESULT_OK.split(",");
                // if(!CS5BanglalinkI.RESULT_OK.equals(responseCode))
                if (!Arrays.asList(successList).contains(responseCode))
                    return responseMap;
            }
            indexStart = p_responseStr.indexOf("<member><name>originTransactionID", indexEnd);
    ...
    private String getCS5TransDateTime() throws Exception {
    	final String METHOD_NAME="getCS5TransDateTime";
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered");
        ...
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug(METHOD_NAME, "Exited transDateTime: " + transDateTime);
        }
    ...
    public String getDateString(String p_dateStr) throws Exception {
    	final String METHOD_NAME="getDateString";
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_dateStr::" + p_dateStr);
        String dateStr = "";
        try {
    ...
    private String generateGetAccountDetailRequest(HashMap p_requestMap) throws Exception {
    	final String METHOD_NAME="generateGetAccountDetailRequest";
        if (_log.isDebugEnabled())
    ...
    private HashMap<String, String> parseGetAccountDetailResponse(String p_responseStr) throws Exception {
    	final String METHOD_NAME="parseGetAccountDetailResponse";
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_responseStr::" + p_responseStr);
        HashMap<String, String> responseMap = null;
        int indexStart = 0;
    ...
    /**
     * This method will be used for generating the credit or debit request for
     * dedicated account.
     * 
     * @param map
     * @return
    ...
    private String generateDedicatedAccountCDRequest(HashMap<String, String> p_requestMap) throws Exception {
    	final String METHOD_NAME="generateDedicatedAccountCDRequest";
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_requestMap::" + p_requestMap);
        String requestStr = null;
        StringBuffer stringBuffer = null;
        ...
        try {
            ...
            // Card group selector value will be dedicated account id in the
            // request
    ...
    private HashMap<String, String> parseDedicatedAccountCDRequest(String p_responseStr) throws Exception {
    	final String METHOD_NAME="parseDedicatedAccountCDRequest";
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_responseStr::" + p_responseStr);
        HashMap<String, String> responseMap = null;
        int indexStart = 0;
    ...
    private void parseDedicatedAccountInfo(HashMap<String, String> p_responseMap, String p_responseString) throws Exception {
    	final String METHOD_NAME="parseDedicatedAccountInfo";
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered");
        String dedicatedID = "";
    ...
    private String getDedicatedAccExpiryDate(HashMap<String, String> p_requestMap) throws Exception {
    	final String METHOD_NAME="getDedicatedAccExpiryDate";
        if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered");
        ...
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug(METHOD_NAME, "Exited with dedicatedExpiry=" + dedicatedExpiry);
        }
