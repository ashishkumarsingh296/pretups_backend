...
public class CS5BanglalinkUrlConnection extends BTSLConnection {
    private HttpURLConnection _urlConnection = null;

    public CS5BanglalinkUrlConnection(String p_url, String p_username, String p_password, int p_connectTimeout, int p_readTimeout, String p_keepAlive, long p_contentLength, String p_hostName, String p_userAgent) throws Exception {
        final String METHOD_NAME="CS5BanglalinkUrlConnection";
    	if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_url: " + p_url + "p_connecttimeout=" + p_connectTimeout + " p_readtimeout=" + p_readTimeout + " p_keepAlive=" + p_keepAlive + " p_hostName=" + p_hostName + " p_userAgent=" + p_userAgent);
        try {
    ...
    protected void setPrintWriter() throws Exception {
    	final String METHOD_NAME="setPrintWriter";
        try {
    ...
    protected void setBufferedReader() throws Exception {
    	final String METHOD_NAME="setBufferedReader";
        try {
    ...
    private void setRequestHeader(String p_username, String p_password, long p_contenetLength, String p_host, String p_userAgent, String p_keepAlive) throws Exception {
        final String METHOD_NAME="setRequestHeader";
    	if (_log.isDebugEnabled())
            _log.debug(METHOD_NAME, "Entered p_username::" + p_password + "p_password::" + p_password + "p_contenetLength::" + p_contenetLength + " p_host::" + p_host + " p_userAgent::" + p_userAgent);
