 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public interface CRMWebServiceI
{
	public int ACTION_ACCOUNT_DETAILS=1;
	public int ACTION_RECHARGE_CREDIT=2;
	public int ACTION_RECHARGE_DEBIT=8;
	public int ACTION_VAS_CREDIT=7;
	public int ACTION_QUERY_TOPUP=3;
	public int ACTION_IMMEDIATE_CREDIT=4;
	public int ACTION_ACCOUNT_DETAILS_OTHER=5;
	public int ACTION_ACCOUNT_DETAILS_BALANCE=6;
