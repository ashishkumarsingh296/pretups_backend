...
public class ZTEINStatus {
	...
	public boolean isFailCountReached(String fileCacheId,String airStr){
		...
		if(airFailCount==null){	
			...
			count++;
			//	System.out.println("AirStatus:isFailCountReached():: Fail count is ::::"+count +" and fail count in prop is :"+failCount);
			if(count<=failCount){
	...
	public void unbarredAirAfterSucces(String airStr){
		...
		}catch(Exception ex){System.out.println("AirStatus:unbarredAirAfterSucces():: EXCEPTION:::::::Barred AIR has not been unbarred after successful request ::::"+airStr);}
