package com.inter.righttel.paymentgateway.scheduler;
...
public class NodeManager {
    ...
    public static void initialize(String p_interfaceIDs) throws BTSLBaseException
    {
		...
		{
		    if(_log.isDebugEnabled()) _log.debug("initialize","Exited _cs5ObjectMap::"+_cs5NodeSchedulerMap);
		}//end of finally
    }//end of initialize
    /**
    ...
    public static NodeScheduler getScheduler(String p_interfaceID) throws BTSLBaseException
    {
    	...
    	{
    		if(_log.isDebugEnabled()) _log.debug("getScheduler","Exited cs5NodeScheduler::"+cs5NodeScheduler);
    	}//end of finally
		    ...
		    if(_cs5NodeSchedulerMap!=null)
		    {
				...
				NodeScheduler cs5NodeScheduler=null;
				 while(iter.hasNext())
				 {
					 ...
					 _log.info("destroy","Destroying cs5NodeScheduler object from _cs5NodeSchedulerMap for Interface ID="+key);
					try
					{
