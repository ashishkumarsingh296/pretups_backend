...
public class AdvanceFlatFile {
    private static Log _log = LogFactory.getLog(AdvanceFlatFile.class.getName());
    List<String> results = new ArrayList<String>();
    FileWriter write = null;

    public boolean createFlatFile(HashMap data) {
        ...
        try {
            ...
            if (InterfaceUtil.isNullString(filePath)) {
                _log.error("createFlatFile", "File Path for advance is not defined in the Constant.props");
            ...
            if (InterfaceUtil.isNullString(fileName)) {
                _log.error("createFlatFile", "File name for advance is not defined in the Constant.props");
                throw new BTSLBaseException(this, "createFlatFile", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
            try {
