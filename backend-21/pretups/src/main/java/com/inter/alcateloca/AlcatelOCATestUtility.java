 ...
 *                                ----------------------------------------------
 *                                ----
 *                                This class is a test program to verify the
 *                                interface.
 */
import java.util.HashMap;

public class AlcatelOCATestUtility {
    ...
    public AlcatelOCATestUtility() {

    }

    public AlcatelOCATestUtility(String p_action, String p_interfaceID, String p_cardGroupSelector) {
    ...
    public void executeINMethods(String p_action) {
        try {
            ...
            AlcatelOCAINHandler inHandler = null;
            ...
            if (_action.equals(_validate)) {
                ...
                _requestMap.put("INTERFACE_HANDLER", "com.btsl.pretups.inter.AlcatelOCA.AlcatelOCAINHandler");
            ...
            inHandler = new AlcatelOCAINHandler();
