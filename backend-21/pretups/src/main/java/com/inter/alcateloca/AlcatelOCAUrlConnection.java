...
public class AlcatelOCAUrlConnection extends BTSLConnection {
    private HttpURLConnection _urlConnection = null;
    public static Log _log = LogFactory.getLog("AlcatelOCAUrlConnection".getClass().getName());
     ...
     * @throws Exception
     */
    public AlcatelOCAUrlConnection(String p_url, int p_connecttimeout, int p_readtimeout, String p_keepAlive) throws Exception {
        if (_log.isDebugEnabled())
            _log.debug("AlcatelOCAUrlConnection ", "Entered p_url: " + p_url + "p_connecttimeout=" + p_connecttimeout + " p_readtimeout=" + p_readtimeout + " p_keepAlive=" + p_keepAlive);
        try {
            ...
            e.printStackTrace();
            _log.error("AlcatelOCAUrlConnection", " Exception: " + e.getMessage());
            throw e;
        }
        if (_log.isDebugEnabled())
            _log.debug("AlcatelOCAUrlConnection ", "Exiting ");
    }
