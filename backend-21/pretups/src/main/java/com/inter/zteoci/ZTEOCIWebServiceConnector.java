...
/**
 * @(#)ZTEOCIWebServiceConnector.java
...
public class ZTEOCIWebServiceConnector {

    private Log _log = LogFactory.getLog(ZTEOCIWebServiceConnector.class.getName());

    public ZTEOCIWebServiceConnector() {
    }

    public Call callService(HashMap p_map) throws Exception {
