 ...
 * 
 */
public class FTPPoolLoaderServlet extends HttpServlet {
    private Log _log = LogFactory.getLog(FTPPoolLoaderServlet.class.getName());
    private FTPPoolManager _poolManager = null;

    /**
     * Constructor of the object.
     */
    public FTPPoolLoaderServlet() {
        super();
    }
    ...
    public void destroy() {
        ...
        String poolIDs = Constants.getProperty("FTP_POOL_IN_IDS");
        if (_log.isDebugEnabled())
    ...
    public void initialize() {
        ...
        try {
            _poolManager = new FTPPoolManager();
            poolINIDs = Constants.getProperty("FTP_POOL_IN_IDS");
            if (_log.isDebugEnabled())
