package com.inter.vodafoneghana.locationservice.scheduler;
...
public class NodeScheduler {
    ...
    public NodeScheduler(String p_iNId) throws BTSLBaseException {
        if (_log.isDebugEnabled())
            _log.debug("NodeScheduler[constructor]", "Entered p_iNId::" + p_iNId);
        String url = null;
    ...
    public synchronized NodeVO getNodeVO(String p_transId) throws BTSLBaseException {
        ...
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug("getNodeVO", p_transId, "Exited nodeVO::" + nodeVO);
        }// end of finally
        return nodeVO;
    }// end of getNodeVO
            ...
            while (isNext) {
                try {
                    if (tempCount > _maxAllowedNum) {
                        ...
                        // throw new
                        // BTSLBaseException(InterfaceErrorCodesI.ERROR_MAX_NODE_CHECK_REACH);
