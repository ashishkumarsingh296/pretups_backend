...
public class NodeManager {
    ...
    private static HashMap _nodeSchedulerMap = null;// Contains the instance of
    ...
    public static void initialize(String p_interfaceIDs) throws BTSLBaseException {
        ...
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug("initialize", "Exited _comObjectMap::" + _nodeSchedulerMap);
        }// end of finally
    }// end of initialize
    ...
    public static NodeScheduler getScheduler(String p_interfaceID) throws BTSLBaseException {
        ...
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug("getScheduler", "Exited comNodeScheduler::" + nodeScheduler);
        }// end of finally
