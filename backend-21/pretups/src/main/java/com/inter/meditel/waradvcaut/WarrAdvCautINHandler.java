 ...
 *                               ----------------------------------------------
 *                               --
 *                               This IN handler is used for
 *                               Warranty,Advance,Caution Recharge in Meditel
 *                               using web services.
 */
...
public class WarrAdvCautINHandler implements InterfaceHandler {
    ...
    protected static synchronized String getINTransactionID(HashMap p_requestMap) throws BTSLBaseException {
        ...
        try {
            ...
            _log.errorTrace("getINTransactionID", e);
        } finally {
            _log.debug("methodName", "Exititng: transactionId=" + transactionId);
        }
