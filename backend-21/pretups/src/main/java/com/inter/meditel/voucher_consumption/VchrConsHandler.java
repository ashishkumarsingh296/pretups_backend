...
public class VchrConsHandler implements InterfaceHandler {
    ...
    public void credit(HashMap p_map) throws BTSLBaseException, Exception {
         ...
         * "CS5MobililINHandler[credit]",_referenceID,_msisdn
         ...
         * "CS5MobililINHandler[credit]",_referenceID+"MSISDN = "+_msisdn
         ...
         * EventHandler.handle(EventIDI.SYSTEM_ERROR,
         * EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL,
         * "CS5MobililINHandler[credit]","REFERENCE ID = "+_referenceID,_msisdn
         * +" INTERFACE ID = "+_interfaceID, (String)
         ...
         * //key value of requestMap is formatted into XML string for the
         * validate request.
         * String inStr = _VchrConsRequestFormatter.generateRequest(CS5MobinilI.
         * ACTION_RECHARGE_CREDIT,_requestMap);
         * try
         * {
         * _ambgMaxRetryCount =
         ...
         * _responseMap.get("supervisionExpiryDate"), "yyyyMMdd"));
         * _requestMap.put("NEW_GRACE_DATE",
         * InterfaceUtil.getInterfaceDateFromDateString((String)
         * _responseMap.get("serviceFeeExpiryDate"), "yyyyMMdd"));
         * //set INTERFACE_POST_BALANCE into request map as obtained thru
         * response map.
         * try
         * {
         ...
         * "CS5MobililINHandler[credit]",_referenceID,_msisdn
         * +" INTERFACE ID = "+_interfaceID, (String)
         * _requestMap.get("NETWORK_CODE"), "NEWBALANCE  is not Numeric");
         * throw new
         ...
         * "CS5MobililINHandler[credit]", _referenceID,_msisdn, (String)
         * _requestMap.get("NETWORK_CODE"),
