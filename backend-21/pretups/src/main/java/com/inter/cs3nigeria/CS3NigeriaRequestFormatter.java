...
public class CS3NigeriaRequestFormatter {
    public static Log _log = LogFactory.getLog(CS3NigeriaRequestFormatter.class);
    ...
    public CS3NigeriaRequestFormatter() throws Exception {
        if (_log.isDebugEnabled())
            _log.debug("CS3NigeriaRequestFormatter[constructor]", "Entered");
        try {
            ...
            e.printStackTrace();
            _log.error("CS3NigeriaRequestFormatter[constructor]", "Exception e::" + e.getMessage());
            throw e;
        }// end of catch-Exception
        finally {
            if (_log.isDebugEnabled())
                _log.debug("CS3NigeriaRequestFormatter[constructor]", "Exited");
        }// end of finally
    }// end of CS3NigeriaRequestFormatter[constructor]
    ...
    protected String generateRequest(int p_action, HashMap p_map) throws Exception {
        ...
        try {
            switch (p_action) {
            case CS3NigeriaI.ACTION_ACCOUNT_INFO: {
                str = generateGetAccountInfoRequest(p_map);
                break;
            }
            case CS3NigeriaI.ACTION_ACCOUNT_DETAILS: {
                str = generateGetAccountDetailRequest(p_map);
                break;
            }
            case CS3NigeriaI.ACTION_RECHARGE_CREDIT: {
                str = generateRechargeCreditRequest(p_map);
                break;
            }
            case CS3NigeriaI.ACTION_IMMEDIATE_DEBIT: {
