...
public class AplicaRecargaResponse  implements java.io.Serializable {
    private com.inter.claroca.dth.payment.AplicaRecargaResponseAplicaRecargaResult aplicaRecargaResult;

    public AplicaRecargaResponse() {
    }

    public AplicaRecargaResponse(
           com.inter.claroca.dth.payment.AplicaRecargaResponseAplicaRecargaResult aplicaRecargaResult) {
     ...
     */
    public com.inter.claroca.dth.payment.AplicaRecargaResponseAplicaRecargaResult getAplicaRecargaResult() {
        return aplicaRecargaResult;
    }
     ...
     */
    public void setAplicaRecargaResult(com.inter.claroca.dth.payment.AplicaRecargaResponseAplicaRecargaResult aplicaRecargaResult) {
        this.aplicaRecargaResult = aplicaRecargaResult;
    }
