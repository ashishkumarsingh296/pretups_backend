...
public class ProPagoPostpagoFijaResponse  implements java.io.Serializable {
    private com.inter.claroca.dth.payment.ProPagoPostpagoFijaResponseProPagoPostpagoFijaResult proPagoPostpagoFijaResult;

    public ProPagoPostpagoFijaResponse() {
    }

    public ProPagoPostpagoFijaResponse(
           com.inter.claroca.dth.payment.ProPagoPostpagoFijaResponseProPagoPostpagoFijaResult proPagoPostpagoFijaResult) {
     ...
     */
    public com.inter.claroca.dth.payment.ProPagoPostpagoFijaResponseProPagoPostpagoFijaResult getProPagoPostpagoFijaResult() {
        return proPagoPostpagoFijaResult;
    }
     ...
     */
    public void setProPagoPostpagoFijaResult(com.inter.claroca.dth.payment.ProPagoPostpagoFijaResponseProPagoPostpagoFijaResult proPagoPostpagoFijaResult) {
        this.proPagoPostpagoFijaResult = proPagoPostpagoFijaResult;
    }
