...
public class ConClienteResponse  implements java.io.Serializable {
    private com.inter.claroca.dth.payment.ConClienteResponseConClienteResult conClienteResult;

    public ConClienteResponse() {
    }

    public ConClienteResponse(
           com.inter.claroca.dth.payment.ConClienteResponseConClienteResult conClienteResult) {
     ...
     */
    public com.inter.claroca.dth.payment.ConClienteResponseConClienteResult getConClienteResult() {
        return conClienteResult;
    }
     ...
     */
    public void setConClienteResult(com.inter.claroca.dth.payment.ConClienteResponseConClienteResult conClienteResult) {
        this.conClienteResult = conClienteResult;
    }
