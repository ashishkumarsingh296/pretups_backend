...
public class ConSinPagarFacturasResponse  implements java.io.Serializable {
    private com.inter.claroca.dth.enquiry.ConSinPagarFacturasResponseConSinPagarFacturasResult conSinPagarFacturasResult;

    public ConSinPagarFacturasResponse() {
    }

    public ConSinPagarFacturasResponse(
           com.inter.claroca.dth.enquiry.ConSinPagarFacturasResponseConSinPagarFacturasResult conSinPagarFacturasResult) {
     ...
     */
    public com.inter.claroca.dth.enquiry.ConSinPagarFacturasResponseConSinPagarFacturasResult getConSinPagarFacturasResult() {
        return conSinPagarFacturasResult;
    }
     ...
     */
    public void setConSinPagarFacturasResult(com.inter.claroca.dth.enquiry.ConSinPagarFacturasResponseConSinPagarFacturasResult conSinPagarFacturasResult) {
        this.conSinPagarFacturasResult = conSinPagarFacturasResult;
    }
