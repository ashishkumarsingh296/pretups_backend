...
public class ConPlanesContratadosResponse  implements java.io.Serializable {
    private com.inter.claroca.dth.enquiry.ConPlanesContratadosResponseConPlanesContratadosResult conPlanesContratadosResult;

    public ConPlanesContratadosResponse() {
    }

    public ConPlanesContratadosResponse(
           com.inter.claroca.dth.enquiry.ConPlanesContratadosResponseConPlanesContratadosResult conPlanesContratadosResult) {
     ...
     */
    public com.inter.claroca.dth.enquiry.ConPlanesContratadosResponseConPlanesContratadosResult getConPlanesContratadosResult() {
        return conPlanesContratadosResult;
    }
     ...
     */
    public void setConPlanesContratadosResult(com.inter.claroca.dth.enquiry.ConPlanesContratadosResponseConPlanesContratadosResult conPlanesContratadosResult) {
        this.conPlanesContratadosResult = conPlanesContratadosResult;
    }
