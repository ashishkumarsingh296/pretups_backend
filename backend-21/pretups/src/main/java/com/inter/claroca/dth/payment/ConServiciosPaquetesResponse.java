...
public class ConServiciosPaquetesResponse  implements java.io.Serializable {
    private com.inter.claroca.dth.payment.ConServiciosPaquetesResponseConServiciosPaquetesResult conServiciosPaquetesResult;

    public ConServiciosPaquetesResponse() {
    }

    public ConServiciosPaquetesResponse(
           com.inter.claroca.dth.payment.ConServiciosPaquetesResponseConServiciosPaquetesResult conServiciosPaquetesResult) {
     ...
     */
    public com.inter.claroca.dth.payment.ConServiciosPaquetesResponseConServiciosPaquetesResult getConServiciosPaquetesResult() {
        return conServiciosPaquetesResult;
    }
     ...
     */
    public void setConServiciosPaquetesResult(com.inter.claroca.dth.payment.ConServiciosPaquetesResponseConServiciosPaquetesResult conServiciosPaquetesResult) {
        this.conServiciosPaquetesResult = conServiciosPaquetesResult;
    }
