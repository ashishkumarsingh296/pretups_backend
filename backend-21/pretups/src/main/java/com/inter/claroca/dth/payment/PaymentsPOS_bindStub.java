...
public class PaymentsPOS_bindStub extends org.apache.axis.client.Stub implements com.inter.claroca.dth.payment.PaymentsPOS {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://esb.claro.com.gt/Payment", "Payment_Rq"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://esb.claro.com.gt/Payment", "PaymentRequest"), com.inter.claroca.dth.payment.PaymentRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://esb.claro.com.gt/Payment", "PaymentResponse"));
        oper.setReturnClass(com.inter.claroca.dth.payment.PaymentResponse.class);
    ...
    public PaymentsPOS_bindStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = com.inter.claroca.dth.payment.PaymentRequest.class;
            ...
            cachedSerQNames.add(qName);
            cls = com.inter.claroca.dth.payment.PaymentResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public com.inter.claroca.dth.payment.PaymentResponse paymentsPOS(com.inter.claroca.dth.payment.PaymentRequest INPUT) throws java.rmi.RemoteException, com.inter.claroca.dth.payment.PaymentResponse {
        if (super.cachedEndpoint == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {INPUT});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            System.out.println("Request : " +_call.getMessageContext().getRequestMessage().getSOAPPartAsString());
 			System.out.println("Response : " +_call.getMessageContext().getResponseMessage().getSOAPPartAsString());
            try {
                return (com.inter.claroca.dth.payment.PaymentResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.inter.claroca.dth.payment.PaymentResponse) org.apache.axis.utils.JavaUtils.convert(_resp, com.inter.claroca.dth.payment.PaymentResponse.class);
            }
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof com.inter.claroca.dth.payment.PaymentResponse) {
              throw (com.inter.claroca.dth.payment.PaymentResponse) axisFaultException.detail;
         }
   }
