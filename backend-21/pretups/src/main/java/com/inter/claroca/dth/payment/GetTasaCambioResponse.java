...
public class GetTasaCambioResponse  implements java.io.Serializable {
    private com.inter.claroca.dth.payment.GetTasaCambioResponseGetTasaCambioResult getTasaCambioResult;

    public GetTasaCambioResponse() {
    }

    public GetTasaCambioResponse(
           com.inter.claroca.dth.payment.GetTasaCambioResponseGetTasaCambioResult getTasaCambioResult) {
     ...
     */
    public com.inter.claroca.dth.payment.GetTasaCambioResponseGetTasaCambioResult getGetTasaCambioResult() {
        return getTasaCambioResult;
    }
     ...
     */
    public void setGetTasaCambioResult(com.inter.claroca.dth.payment.GetTasaCambioResponseGetTasaCambioResult getTasaCambioResult) {
        this.getTasaCambioResult = getTasaCambioResult;
    }
