...
public class PaymentsPOS_bindQSServiceLocator extends org.apache.axis.client.Service implements com.inter.claroca.dth.paymentgt.PaymentsPOS_bindQSService {
 ...
 */
    ...
    public com.inter.claroca.dth.paymentgt.PaymentsPOS getPaymentsPOS_bindQSPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.inter.claroca.dth.paymentgt.PaymentsPOS getPaymentsPOS_bindQSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.inter.claroca.dth.paymentgt.PaymentsPOS_bindStub _stub = new com.inter.claroca.dth.paymentgt.PaymentsPOS_bindStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.inter.claroca.dth.paymentgt.PaymentsPOS.class.isAssignableFrom(serviceEndpointInterface)) {
                com.inter.claroca.dth.paymentgt.PaymentsPOS_bindStub _stub = new com.inter.claroca.dth.paymentgt.PaymentsPOS_bindStub(new java.net.URL(PaymentsPOS_bindQSPort_address), this);
                _stub.setPortName(getPaymentsPOS_bindQSPortWSDDServiceName());
                return _stub;
            }
        }
