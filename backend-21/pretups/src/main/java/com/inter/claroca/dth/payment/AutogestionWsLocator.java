...
public class AutogestionWsLocator extends org.apache.axis.client.Service implements com.inter.claroca.dth.payment.AutogestionWs {
    ...
    public com.inter.claroca.dth.payment.AutogestionWsSoap_PortType getAutogestionWsSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.inter.claroca.dth.payment.AutogestionWsSoap_PortType getAutogestionWsSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.inter.claroca.dth.payment.AutogestionWsSoap12Stub _stub = new com.inter.claroca.dth.payment.AutogestionWsSoap12Stub(portAddress, this);
    ...
    public com.inter.claroca.dth.payment.AutogestionWsSoap_PortType getAutogestionWsSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.inter.claroca.dth.payment.AutogestionWsSoap_PortType getAutogestionWsSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.inter.claroca.dth.payment.AutogestionWsSoap_BindingStub _stub = new com.inter.claroca.dth.payment.AutogestionWsSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.inter.claroca.dth.payment.AutogestionWsSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.inter.claroca.dth.payment.AutogestionWsSoap12Stub _stub = new com.inter.claroca.dth.payment.AutogestionWsSoap12Stub(new java.net.URL(AutogestionWsSoap12_address), this);
                _stub.setPortName(getAutogestionWsSoap12WSDDServiceName());
                return _stub;
            }
            if (com.inter.claroca.dth.payment.AutogestionWsSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.inter.claroca.dth.payment.AutogestionWsSoap_BindingStub _stub = new com.inter.claroca.dth.payment.AutogestionWsSoap_BindingStub(new java.net.URL(AutogestionWsSoap_address), this);
                _stub.setPortName(getAutogestionWsSoapWSDDServiceName());
                return _stub;
            }
        }
