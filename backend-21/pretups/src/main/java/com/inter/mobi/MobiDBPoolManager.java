 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class MobiDBPoolManager {
    private Log _log = LogFactory.getLog(MobiDBPoolManager.class.getName());
    ...
    public void initialize(String p_interfaceIDs) throws BTSLBaseException {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "MobiDBPoolManager[initialize]", "INTERFACEID:" + interfaceId, "", "", "While instantiation of MobiDBUTility instance of MobiDBUTility objects got the Exception " + e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_OBJECT_POOL_INITIALIZATION);
        } finally {
            if (_log.isDebugEnabled())
     ...
     */
    private Object getNewDBUtilityObj(String p_interfaceID) throws BTSLBaseException {
        if (_log.isDebugEnabled())
        ...
        try {
            ...
            dbUtilityClass = FileCache.getValue(p_interfaceID, "MOBI_DBUTILITY_HANDLER_CLASS");
            if (_log.isDebugEnabled())
            ...
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "MobiDBPoolManager[getNewDBUtilityObj]", "INTERFACEID:" + p_interfaceID, "", "", "While getting the instance of Client objects got the Exception " + e.getMessage());
            ...
            e.printStackTrace();
            _log.error("getNewDBUtilityObj", "Exception e::" + e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "MobiDBPoolManager[getNewDBUtilityObj]", "INTERFACEID:" + p_interfaceID, "", "", "While getting the instance of MobiDBUtility objects got the Exception " + e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_GETTIN_NEW_CLIENT_OBJECT);// Confirm
                                                                                             // for
                                                                                             // the
                                                                                             // new
    ...
    public void destroy(String p_interfaceId) {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "MobiDBPoolManager[destroy]", "", "", "", "While destorying the Client objects got the Exception " + e.getMessage());
