...
/**
 * @(#)ZTEOGNWebServiceConnector.java
 ...
 *                                    ------------------------------------------
 *                                    ------------
 *                                    This class will stablish the HTTP
...
public class ZTEOGNWebServiceConnector {

    private Log _log = LogFactory.getLog(ZTEOGNWebServiceConnector.class.getName());

    public ZTEOGNWebServiceConnector() {
    }

    public Call callService(HashMap<String, String> p_map) throws Exception {
        if (_log.isDebugEnabled())
            _log.debug("callService", "Entered");
