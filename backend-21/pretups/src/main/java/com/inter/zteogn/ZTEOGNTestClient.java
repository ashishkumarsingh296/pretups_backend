...
public class ZTEOGNTestClient {
    ...
    public static void main(String[] args) {
        ZTEOGNTestClient zteobj = new ZTEOGNTestClient();
        try {
    ...
    /*
     * private HashMap<String,String> parseRechargeCreditResponse(String
     * responseStr)
     * {
     * HashMap<String,String> responseMap=null;
     * try
     ...
     * int index=responseStr.indexOf("<returnCode>");
     * String
     * returnCode=responseStr.substring(index+"<returnCode>".length(),responseStr
     * .indexOf("</returnCode>",index));
     * responseMap.put("resp_returnCode",returnCode);
     * if(_str.equals((returnCode)))
     * {
     * int end = responseStr.indexOf("<AccountResCode>0</AccountResCode>");//0
     * is for main account on test env.
     ...
     * {
     * String
     * actionId=responseStr.substring(index+"<ACTION_ID>".length(),responseStr
     * .indexOf("</ACTION_ID>",index));
     * responseMap.put("resp_action_id",actionId);
     * }
     * index=responseStr.indexOf("<REQUEST_ID>");
     * if(index!=-1)
     * {
     * String
     * reqId=responseStr.substring(index+"<REQUEST_ID>".length(),responseStr
     * .indexOf("</REQUEST_ID>",index));
     * responseMap.put("resp_req_id",reqId);
     * }
     * 
     ...
     * {
     * String
     * grossBalance=responseStr.substring(index+"<GrossBalance>".length(),
     * responseStr.indexOf("</GrossBalance>",index));
     * responseMap.put("resp_grossBalance",grossBalance);
     * }
     * index=responseStr.lastIndexOf("<ValidBalance>", end);
     * if(index!=-1)
     * {
     * String
     * validBalance=responseStr.substring(index+"<ValidBalance>".length(),
     * responseStr.indexOf("</ValidBalance>",index));
     * responseMap.put("resp_validBalance",validBalance);
     * }
     * index=responseStr.lastIndexOf("<EffDate>", end);
     * if(index!=-1)
     * {
     * String
     * effDate=responseStr.substring(index+"<EffDate>".length(),responseStr
     * .indexOf("</EffDate>",index));
     ...
     * {
     * String
     * expDate=responseStr.substring(index+"<ExpDate>".length(),responseStr
     * .indexOf("</ExpDate>",index));
     ...
     * {
     * String
     * balanceID=responseStr.substring(index+"<BalanceID>".length(),responseStr
     * .indexOf("</BalanceID>",index));
     ...
     * {
     * String
     * accountResCode=responseStr.substring(index+"<AccountResCode>".length
     * (),responseStr.indexOf("</AccountResCode>",index));
     ...
     * {
     * String
     * accountResName=responseStr.substring(index+"<AccountResName>".length
     * (),responseStr.indexOf("</AccountResName>",index));
     ...
     * {
     * String
     * transactionSN=responseStr.substring(index+"<TransactionSN>".length(
     * ),responseStr.indexOf("</TransactionSN>",index));
