...
public class ZTEOGBSimulatorINHandler implements InterfaceHandler {
    private Log _log = LogFactory.getLog(ZTEOGBSimulatorINHandler.class.getName());
     ...
     * Constructor
     */
    public ZTEOGBSimulatorINHandler() {
    ...
    public void debitAdjust(HashMap<String, String> p_requestMap) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            if (InterfaceUtil.isNullString(multFactor)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "OCIZteINHandler[debitAdjust]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "MULT_FACTOR  is not defined in the INFile");
    ...
    private void sendRequestToIN(int p_action, String p_requestStr) throws BTSLBaseException {
        ...
        try {
            ...
            try {
                // ZTEOGBWebServiceConnector serviceConnection = new
                // ZTEOGBWebServiceConnector();
                ...
                try {
                    ...
                    else if (p_action == ZTEOGBI.ACTION_RECHARGE_CREDIT)
                        responseStr = properties.getProperty("ACCOUNT_RECHARGE");
                    else if (p_action == ZTEOGBI.ACTION_IMMEDIATE_DEBIT)
