...
/**
 * @(#)ZTEOGBIRequestResponseFormatter.java
 ...
 *                                          ------------------------------------
 *                                          -------------------------
 *                                          Shashank Shukla Sep 15, 2011 Initial
 *                                          Creation
 *                                          ------------------------------------
 *                                          ------------------------------------
 *                                          ------------------------
 *                                          This class can be used as a parser
 *                                          class for both request(before
 *                                          sending the request to IN) and
...
public class ZTEOGBRequestResponseFormatter {
    private static Log _log = LogFactory.getLog(ZTEOGBRequestResponseFormatter.class.getName());
     ...
     * Constructor
     */
    public ZTEOGBRequestResponseFormatter() {
        super();
