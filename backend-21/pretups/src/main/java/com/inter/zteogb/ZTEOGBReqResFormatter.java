 ...
 *                                ----------------------------------------------
 *                                -----
 *                                Vinay Kumar Singh July 09, 2009 Initial
 *                                Creation
 *                                ----------------------------------------------
 *                                ----------------------------------------------
 *                                ----
...
public class ZTEOGBReqResFormatter {
    private static Log _log = LogFactory.getLog(ZTEOGBReqResFormatter.class.getName());
    ...
    protected String generateRequest(int action, HashMap<String, String> p_requestMap) throws Exception {
        ...
        switch (action) {
        case ZTEOGBI.ACTION_ACCOUNT_INFO: {
            requestStr = generateGetAccountInfoRequest(p_requestMap);
            break;
        }
        case ZTEOGBI.ACTION_RECHARGE_CREDIT: {
        ...
        case ZTEOGBI.ACTION_IMMEDIATE_DEBIT: {
