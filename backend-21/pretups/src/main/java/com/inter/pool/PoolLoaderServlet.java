 ...
 *                --------------------------------------------------------------
 *                ----------------------------------
 *                This class is responsible to instantiate the PoolManager
 *                either at the server start-up or
 *                when a corresponding URL is submitted through browser.
 * 
 * 
 */
public class PoolLoaderServlet extends HttpServlet {
    private Log _log = LogFactory.getLog(PoolLoaderServlet.class.getName());
    private PoolManager _poolManager = null;

    /**
     * Constructor of the object.
     */
    public PoolLoaderServlet() {
        super();
    }
