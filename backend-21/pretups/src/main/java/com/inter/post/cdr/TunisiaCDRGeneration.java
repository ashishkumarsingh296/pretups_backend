/*
 * TunisiaCDRGeneration.java
 * Name Date History
 * ------------------------------------------------------------------------
 * Sanjeew 25/11/2009 Initial Creation
 * ------------------------------------------------------------------------
...
public class TunisiaCDRGeneration implements CDRRecordGeneratorI {
    ...
    private String _otherInfo1;// = "_otherInfo1";
    private String _otherInfo2;// = "_otherInfo2";
    ...
    public void loadConstants(String p_interfaceID) {
        _cdrFieldSeperator = FileCache.getValue(p_interfaceID, "REC_DELIMETER");
        _headerName = FileCache.getValue(p_interfaceID, "CDR_HEADER_NAME");
        _otherInfo1 = FileCache.getValue(p_interfaceID, "OTHER_INFO_1");
        _otherInfo2 = FileCache.getValue(p_interfaceID, "OTHER_INFO_2");
    }
    ...
    private String generateCDRRecordString(QueueTableVO p_queueVO) throws BTSLBaseException {
        ...
        if (BTSLUtil.isNullString(p_queueVO.getImsi()))
            throw new BTSLBaseException("CDRRecordGeneration", "generateCDRRecordString", "Mandatory field getImsi is missing");
        if (BTSLUtil.isNullString(p_queueVO.getTransferID()))
            throw new BTSLBaseException("CDRRecordGeneration", "generateCDRRecordString", "Mandatory field getTransferID is missing");
        if (BTSLUtil.isNullString(p_queueVO.getProductCode()))
            throw new BTSLBaseException("CDRRecordGeneration", "generateCDRRecordString", "Mandatory field ProductCode is missing");
        if (BTSLUtil.isNullString(p_queueVO.getEntryType()))
            throw new BTSLBaseException("CDRRecordGeneration", "generateCDRRecordString", "Mandatory field EntryType is missing");
        if (BTSLUtil.isNullString(p_queueVO.getEntryFor()))
            throw new BTSLBaseException("CDRRecordGeneration", "generateCDRRecordString", "Mandatory field EntryFor is missing");
        ...
        if (BTSLUtil.isNullString(p_queueVO.getAccountID()))
            throw new BTSLBaseException("CDRRecordGeneration", "generateCDRRecordString", "Mandatory field AccountID is missing");
        if (BTSLUtil.isNullString(p_queueVO.getServiceClass()))
            throw new BTSLBaseException("CDRRecordGeneration", "generateCDRRecordString", "Mandatory field ServiceClass is missing");
        // amount <0 checks for mandatory fields
        if (p_queueVO.getInterfaceAmount() < 0)
            throw new BTSLBaseException("CDRRecordGeneration", "generateCDRRecordString", "Mandatory field getInterfaceAmount() < 0 ");
        if (p_queueVO.getAccessFee() < 0)
            throw new BTSLBaseException("CDRRecordGeneration", "generateCDRRecordString", "Mandatory field getAccessFee() < 0 ");
        ...
        try {
            ...
            cdrBuff.append(_cdrFieldSeperator);
            cdrBuff.append(_otherInfo1);
            cdrBuff.append(_cdrFieldSeperator);
            cdrBuff.append(_otherInfo2);
