...
/**
 * AircelCDRGeneration.java
 * Copyright (c) 2008 Bharti Telesoft Ltd.
 * All Rights Reserved
 * -----------------------------------------------------------------------
 * Name Date History
 * ------------------------------------------------------------------------
 * Ashish Kumar Srivastav 08/02/2008 Initial Creation
 * ------------------------------------------------------------------------
 * This class is used to generate the CDR Record For Kolkata Networks. This
 * class implements CDRRecordGeneratorI
 */
import java.io.File;
...
public class AircelCDRGeneration implements CDRRecordGeneratorI {
    ...
    private String generateFileName(String p_interfaceID, String p_networkCode) throws BTSLBaseException {
        ...
        try {
            ...
            strBuffFileName.append(p_networkCode + "_");
            SimpleDateFormat callDate = new SimpleDateFormat("ddmmyyyyhhmmss");
            Date date = Calendar.getInstance().getTime();
            SimpleDateFormat callDateStr = new SimpleDateFormat("ddMMyyyy");
    ...
    private String generateCDRRecordString(QueueTableVO p_queueVO) throws BTSLBaseException {
        ...
        try {
            ...
            // New field Transaction Id is added to the cdr
    ...
    public String generateHeaderRecord(String p_headerName, long p_numOfRecords) throws BTSLBaseException {
        // Not implemented for PreTUPS Aircel CDR
        return null;
    }
