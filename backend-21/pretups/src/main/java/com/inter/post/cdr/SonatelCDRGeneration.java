...
public class SonatelCDRGeneration implements CDRRecordGeneratorI {
    private static Log _log = LogFactory.getLog(SonatelCDRGeneration.class.getName());
    ...
    public String _switchType; // fix value always T [1]
    public String _callRecordType;// fix value always 1 [1]
    public String _subscriptionType; // fix value always 1 [1]
    public String _callTerminationType; // fix value always 1 [1]
    public String _callTerminationErrCode; // fix value always 1 [1]
    public String _mobileSubscriberID; // IMSI of the payer from the whitelist
                                       // [15]
    public String _callerMsisdnType; // fix value always 1 [1]
    ...
    public String[] generateCDRRecords(ArrayList p_queueVOList, String p_interfaceID) throws BTSLBaseException {
        ...
        try {
            ...
            if (BTSLUtil.isNullString(fileSizeRecord))
                throw new BTSLBaseException("SonatelCDRGeneration", "generateCDRRecords", "FILE_SIZE_RECORD should be Y or N");
            try {
                recordSize = Integer.parseInt(FileCache.getValue(p_interfaceID, "RECORD_SIZE"));
            } catch (Exception e) {
                throw new BTSLBaseException("SonatelCDRGeneration", "generateCDRRecords", "RECORD_SIZE is invalid in IN file");
            }
            try {
                ...
                if (fileSize < 1) // the size of the file should be at least 1
                                  // MB
                {
                    throw new BTSLBaseException("SonatelCDRGeneration", "generateCDRRecords", "FILE_SIZE should be greater than or equal to 1");
                }
            } catch (Exception e) {
                throw new BTSLBaseException("SonatelCDRGeneration", "generateCDRRecords", "Invalid FILE_SIZE in IN File");
            }
            ...
            e.printStackTrace();
            throw new BTSLBaseException("SonatelCDRGeneration", "generateCDRRecords", "Exception e:" + e.getMessage());
        } finally {
            if (_log.isDebugEnabled())
    ...
    public String generateTrailerRecord(String p_fileName, long p_numOfRecs) throws BTSLBaseException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new BTSLBaseException("SonatelCDRGeneration", "generateTrailerRecord", "Exception e:" + e.getMessage());
        } finally {
            if (_log.isDebugEnabled())
    ...
    private String padCharactersWithValue(char p_paddingChar, String p_strValue, int p_strLength, boolean p_leftDir) throws BTSLBaseException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new BTSLBaseException("SonatelCDRGeneration", "padCharactersWithValue", "Exception e:" + e.getMessage());
        } finally {
            if (_log.isDebugEnabled())
    ...
    private String generateFileName(String p_interfaceID) throws BTSLBaseException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new BTSLBaseException("SonatelCDRGeneration", "generateFileName", "Exception e:" + e.getMessage());
        } finally {
            if (_log.isDebugEnabled())
    ...
    private String generateCDRRecordString(QueueTableVO p_queueVO) throws BTSLBaseException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new BTSLBaseException("SonatelCDRGeneration", "generateCDRRecordString", "Exception e:" + e.getMessage());
        } finally {
            if (_log.isDebugEnabled())
    ...
    private String writeCDRData(List p_queueVOList, String p_fileName, String p_interfaceID, int p_recordSize) throws BTSLBaseException {
        ...
        try {
            ...
            multFactor = FileCache.getValue(p_interfaceID, "MULTIPLICATION_FACTOR_CDR");
            ...
            if (p_queueVOList != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    String amountStr = InterfaceUtil.getDisplayAmount((long) queueVO.getInterfaceAmount(), mulFactor);
                    ...
                    if (cdrStr.length() != p_recordSize)
                        throw new BTSLBaseException("SonatelCDRGeneration", "writeCDRData", PretupsErrorCodesI.CDR_RCRD_FORMAT_IMPROPER);
                ...
                if (trailerStr.length() != p_recordSize)
                    throw new BTSLBaseException("SonatelCDRGeneration", "writeCDRData", PretupsErrorCodesI.CDR_TRAILER_RCRD_FORMAT_IMPROPER);
                pw.print(trailerStr);
                pw.flush();
            }
        } catch (BTSLBaseException be) {
            ...
            throw new BTSLBaseException("SonatelCDRGeneration", "writeCDRData", "Exception e:" + e.getMessage());
        } finally {
            file = null;
            if (pw != null) {
                try {
