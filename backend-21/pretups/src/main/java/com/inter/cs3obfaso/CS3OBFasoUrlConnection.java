...
public class CS3OBFasoUrlConnection extends BTSLConnection{
    private HttpURLConnection _urlConnection=null;
    public CS3OBFasoUrlConnection(String p_url,String p_username,String p_password,int p_connectTimeout,int p_readTimeout,String p_keepAlive,long p_contentLength, String p_hostName,String p_userAgent) throws Exception
    {
    	final String methodName="CS3OBFasoUrlConnection";
		if(_log.isDebugEnabled())_log.debug(methodName,"Entered p_url: "+p_url+"p_connecttimeout="+p_connectTimeout+" p_readtimeout="+p_readTimeout+" p_keepAlive="+p_keepAlive+" p_hostName="+p_hostName+" p_userAgent="+p_userAgent);
		try
		{
   ...
   public String getResponseCode() throws IOException {
	...
	private void setRequestHeader(String p_username,String p_password,long p_contenetLength,String p_host,String p_userAgent,String p_keepAlive) throws Exception
	{
	    ...
	    if(_log.isDebugEnabled()) _log.debug(methodName,"Entered p_username::"+p_password+"p_password::"+p_password+"p_contenetLength::"+p_contenetLength+" p_host::"+p_host+" p_userAgent::"+p_userAgent);
