package com.inter.cs3obfaso.cs3scheduler;
 ...
 * Author               Date            History
 *-------------------------------------------------------------------------------------------------
 * Ved Prakash         11-Nov-2010     Initial Creation
 * ------------------------------------------------------------------------------------------------
 *
    ...
    public NodeScheduler(String p_cs3INId) throws BTSLBaseException
    {
		...
		try
		{
	        ...
	        try
			{
				...
				if(_log.isDebugEnabled())_log.debug(methodName,"MAX_NODE::"+_totalNodes);
				
			}
			catch(Exception e)
			{
			     _log.errorTrace(methodName,e);
			    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "check the value of MAX_NODE in IN File Exception e::"+e.getMessage());
			...
			try
			{
			    ...
			    if(_log.isDebugEnabled()) _log.debug(methodName,"MAX_ALWD_NO::"+_maxAllowedNum);
			}
			catch(Exception e)
			{
			     _log.errorTrace(methodName,e);
			    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of MAX_ALWD_NO in INFile Exception e::"+e.getMessage());
			    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
			}
			try
			{
			    _retryNum = Integer.parseInt(FileCache.getValue(p_cs3INId,"RETRY_NUM").trim());
			    if(_log.isDebugEnabled()) _log.debug(methodName,"RETRY_NUM::"+_retryNum);
			    //setRetryNum(_retryNum);
			}
			catch(Exception e)
			{
			     _log.errorTrace(methodName,e);
			    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of RETRY_NUM in INFile Exception e::"+e.getMessage());
			    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
			}
			try
			{
				...
				{
				    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "HEADER_HOST_NAME is not defined into IN File");
				    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
				}
			    if(_log.isDebugEnabled()) _log.debug(methodName,"HEADER_HOST_NAME::"+_headerHostName);
			}
			catch(Exception e)
			{
			     _log.errorTrace(methodName,e);
			    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "check the value of HEADER_HOST_NAME in IN File Exception e::"+e.getMessage());
			    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
			}
			try
			{
				...
				{
				    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "HOST_NAME is not defined into IN File");
				    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
				}
			    if(_log.isDebugEnabled()) _log.debug(methodName,"HOST_NAME::"+_hostName);
			}
			catch(Exception e)
			{
			     _log.errorTrace(methodName,e);
			    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "check the value of HOST_NAME in IN File Exception e::"+e.getMessage());
			    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
			}
			try
			{
			    ...
			    if(_log.isDebugEnabled()) _log.debug(methodName,"USER_AGENT::"+_userAgent);
			}
			catch(Exception e)
			{
			     _log.errorTrace(methodName,e);
			    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.MAJOR, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "check the value of USER_AGENT in IN File Exception e::"+e.getMessage());
			}
			...
			for(int l=1;l<=_totalNodes;l++)
			{
			   try
			   {
				    ...
				    if(_log.isDebugEnabled()) _log.debug(methodName,"url_"+l+"::"+url);
					if(InterfaceUtil.isNullString(url))
					{
					    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of URL_"+l +" in INFile "+p_cs3INId);
					    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}   
					...
					try
					{
					    ...
					    if(_log.isDebugEnabled()) _log.debug(methodName,"CONN_TIMEOUT_"+l+"::"+connectionTimeOut);
					    cs3NodeVO.setConnectionTimeOut(connectionTimeOut);
					}
					catch(Exception e)
					{
					     _log.errorTrace(methodName,e);
					    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of CONN_TIMEOUT_"+l +" in INFile "+p_cs3INId);
					    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{
						maxConPerNode = Integer.parseInt(FileCache.getValue(p_cs3INId,"MAX_CON_NODE_"+l).trim());
						if(_log.isDebugEnabled()) _log.debug(methodName,"MAX_CON_NODE_"+l+"::"+maxConPerNode);
						cs3NodeVO.setMaxConPerNode(maxConPerNode);
					}
					catch(Exception e)
					{
					     _log.errorTrace(methodName,e);
					    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "check the value of MAX_CON_NODE_"+l+" for interface id p_cs3INId ::"+p_cs3INId);
					    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{
					    ...
					    if(_log.isDebugEnabled()) _log.debug(methodName,"VAL_READ_TIMEOUT_"+l+"::"+readTimeOutVal);
					    cs3NodeVO.setValReadTimeOut(readTimeOutVal);
					}
					catch(Exception e)
					{
					     _log.errorTrace(methodName,e);
					    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of VAL_READ_TIMEOUT_"+l +" in INFile "+p_cs3INId);
					    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{
					    ...
					    if(_log.isDebugEnabled()) _log.debug(methodName,"TOP_READ_TIMEOUT_"+l+"::"+readTimeOutTop);
					    cs3NodeVO.setTopReadTimeOut(readTimeOutTop);
					}
					catch(Exception e)
					{
					     _log.errorTrace(methodName,e);
					    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of TOP_READ_TIMEOUT_"+l +" in INFile "+p_cs3INId);
					    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{
					    ...
					    if(_log.isDebugEnabled()) _log.debug(methodName,"WARN_TIME_"+l+"::"+readTimeOutVal);
					    cs3NodeVO.setWarnTime(warnTime);
					}
					catch(Exception e)
					{
					     _log.errorTrace(methodName,e);
					    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of WARN_TIME_"+l +" in INFile "+p_cs3INId);
					    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{
					    String expiryTimeStr = FileCache.getValue(p_cs3INId,"EXPIRY_TIME_"+l).trim();
					    if(_log.isDebugEnabled()) _log.debug(methodName,"EXPIRY_TIME_"+l+"::"+expiryTimeStr);
					...
					{
					     _log.errorTrace(methodName,e);
					    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of EXPIRY_TIME_"+l +" in INFile "+p_cs3INId);
					    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{ 
						keepAlive = FileCache.getValue(p_cs3INId,"KEEP_ALIVE_"+l).trim();
						if(_log.isDebugEnabled()) _log.debug(methodName,"KEEP_ALIVE_"+l+"::"+keepAlive);
						cs3NodeVO.setKeepAlive(keepAlive);
					}
					catch(Exception e)
					{
					     _log.errorTrace(methodName,e);
					    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of KEEP_ALIVE_"+l +" in INFile "+p_cs3INId);
					    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{ 
						userName = FileCache.getValue(p_cs3INId,"USERNAME_"+l).trim();
						if(_log.isDebugEnabled()) _log.debug(methodName,"USERNAME_"+l+"::"+userName);
						cs3NodeVO.setUsername(userName);
					}
					catch(Exception e)
					{
					     _log.errorTrace(methodName,e);
					    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of USERNAME_"+l +" in INFile "+p_cs3INId);
					    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{ 
						password = FileCache.getValue(p_cs3INId,"PASSWORD_"+l).trim();
						if(_log.isDebugEnabled()) _log.debug(methodName,"PASSWORD_"+l+"::"+password);
						cs3NodeVO.setPassword(password);
					}
					catch(Exception e)
					{
					     _log.errorTrace(methodName,e);
					    EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of PASSWORD_"+l +" in INFile "+p_cs3INId);
					    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
...
//					Fetch the number of ambiguous transaction allowed for certain duration from the INFile.
		            ...
		            if(InterfaceUtil.isNullString(numberOfAmbguousTxnAllowedStr)|| !InterfaceUtil.isNumeric(numberOfAmbguousTxnAllowedStr.trim()))
		            {
		            	...
		            	EventHandler.handle(EventIDI.SYSTEM_ERROR,EventComponentI.INTERFACES,EventStatusI.RAISED,EventLevelI.FATAL,methodName,"","_interfaceID:"+_interfaceID,"","NO_ALLWD_AMB_TXN is either not defined in the INFile or its value is not numeric");
		            ...
		            if(InterfaceUtil.isNullString(thresholdTimeStr)||!InterfaceUtil.isNumeric(thresholdTimeStr.trim()))
		            {
		            	...
		            	EventHandler.handle(EventIDI.SYSTEM_ERROR,EventComponentI.INTERFACES,EventStatusI.RAISED,EventLevelI.FATAL,methodName,"","_interfaceID:"+_interfaceID,"","THRESHOLD_TIME is either not defined in the INFile or its value is not numeric");
		                throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_INIT_INTERFACE_CLOSER);
		            }
			   ...
			   {
			        _log.errorTrace(methodName,e);
			       EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, methodName, "INTERFACE_ID::"+_interfaceID,"", "","Exception while initializing the Node details of interfaceID = "+p_cs3INId +" Exception e="+e.getMessage());
			       throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
			   }
			}
		}
		...
		{
		    if(_log.isDebugEnabled()) _log.debug(methodName,"Exiting _nodeTable::"+_nodeTable);
		}//end of finally
    }//end of constructor
    ...
    public synchronized NodeVO getNodeVO(String p_transId) throws BTSLBaseException
    {
        ...
        if(_log.isDebugEnabled()) _log.debug(methodName,p_transId,"Entered p_transId"+p_transId);
        ...
        try
        {
            ...
            if(nodeNumStr==null)
            {
                _log.error(methodName,p_transId,"There is no scheduled node to process the request for p_transId::"+p_transId);
                throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_SCHEDULING);
            }
            cs3NodeVO = (NodeVO)_nodeTable.get(nodeNumStr);
            if(cs3NodeVO==null)
            {
                _log.error(methodName,p_transId,"No detail found for the Node number::"+nodeNumStr);
                throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_SCHEDULING);
            }
        }
        catch(BTSLBaseException be)
        {
            _log.error(methodName,p_transId,"while processing the request for p_transId::"+p_transId+ " get BTSLBaseException  be::"+be.getMessage());
            throw be;
        }
        catch(Exception e)
        {
            ...
            _log.error(methodName,p_transId,"Exception  e::"+e.getMessage()+" p_transId::"+p_transId);
            throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_SCHEDULING);
        }//end of catch-Exception
        finally
        {
            if(_log.isDebugEnabled()) _log.debug(methodName,p_transId,"Exited cs3NodeVO::"+cs3NodeVO);
        }//end of finally
        return cs3NodeVO;
    }//end of getNodeVO
    /**
    ...
    private synchronized String getNode(String p_transId) throws BTSLBaseException
    {
        ...
        try
        {
	        ...
	        while(isNext)
	        {
	            try
	            {
		            ...
		            if(_log.isDebugEnabled()) _log.debug(methodName,p_transId,"tempCount::"+tempCount);
	                ...
	                if(_log.isDebugEnabled()) _log.debug(methodName,p_transId,"NodeNumber ["+_nodeNumber+"] is blocked"+ "p_transId::"+p_transId);
	                ...
	                _log.info(methodName,p_transId,"Node number ::"+_nodeNumber+" of interfaceID::"+_interfaceID+"is blocked and its expiry is not reached");
	                incrementNodeNumber();
	            }
	            catch(BTSLBaseException be)
	            {
	            ...
	            catch(Exception e)
	            {
	                //decrement the connection counter if any error occurs after incrementing the connection number.
	                 _log.errorTrace(methodName,e);
	                _log.error(methodName,p_transId,"_interfaceID"+_interfaceID+" p_transId ::"+p_transId+" Exception e::"+e.getMessage());
	                if(connIncremented)
        ...
        {
            _log.error(methodName,p_transId,"p_transId::"+p_transId+" BTSLBaseException  be::"+be.getMessage());
            throw be;
        }
        catch(Exception e)
        {
            ...
            _log.error(methodName,p_transId,"p_transId::"+p_transId+" Exception e::"+e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_SCHEDULING);
        }//end of catch-Exception
        finally
        {
            if(_log.isDebugEnabled()) _log.debug(methodName,p_transId,"Exited nodeNumStr::"+nodeNumStr);
        }//end of finally
        return nodeNumStr;
    }//end of 
    /**
    ...
    public boolean isExpired(long p_blockedAt,long p_expiryDuration)throws BTSLBaseException
    {
        ...
        if(_log.isDebugEnabled()) _log.debug(methodName,"Entered p_blockedAt::"+p_blockedAt+" p_expiryDuration::"+p_expiryDuration);
        boolean isExp=false;
        try
        {
            long currentTime = System.currentTimeMillis();
            if(_log.isDebugEnabled())_log.debug(methodName,"currentTime::"+currentTime);
        ...
        {
             _log.errorTrace(methodName,e);
            _log.error(methodName,"While checking the expiry of blocked node get the Exception e::"+e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_SCHEDULING);
        }//end of catch-Exception
        finally
        {
            if(_log.isDebugEnabled())_log.debug(methodName,"isExp::"+isExp);
        }//end of finally
        return isExp;
    }//end of isExpired
