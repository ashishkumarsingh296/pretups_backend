...
public class NodeManager {
    ...
    private static HashMap _cs3NodeSchedulerMap=null;//Contains the instance of NodeScheduler with key as interface id.
    /**
    ...
    public static void initialize(String p_interfaceIDs) throws BTSLBaseException
    {
        ...
        if(_log.isDebugEnabled()) _log.debug(methodName,"Entered p_interfaceIDs::"+p_interfaceIDs);
        String strINId = null;
		NodeScheduler cs3NodeController = null;
		String[] inStrArray = null;
		try 
		{
		    _cs3NodeSchedulerMap = new HashMap();
		...
		{
		    if(_log.isDebugEnabled()) _log.debug(methodName,"Exited _cs3ObjectMap::"+_cs3NodeSchedulerMap);
		}//end of finally
    }//end of initialize
    /**
    ...
    public static NodeScheduler getScheduler(String p_interfaceID) throws BTSLBaseException
    {
        ...
        if(_log.isDebugEnabled()) _log.debug(methodName,"Entered p_interfaceID::"+p_interfaceID);
        ...
        {
            if(_log.isDebugEnabled()) _log.debug(methodName,"Exited cs3NodeScheduler::"+cs3NodeScheduler);
        }//end of finally
	...
	private static void destroy()
	{
		...
		try 
		{
		    ...
		    {
				map =new HashMap(_cs3NodeSchedulerMap);
				...
				NodeScheduler cs3NodeScheduler=null;
				 while(iter.hasNext())
				 {
					 ...
					 _log.info(methodName,"Destroying cs3NodeScheduler object from _cs3NodeSchedulerMap for Interface ID="+key);
					try
					{
