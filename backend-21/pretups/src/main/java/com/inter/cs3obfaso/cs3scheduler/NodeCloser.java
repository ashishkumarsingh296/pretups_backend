...
public class NodeCloser {
    ...
    public synchronized void checkExpiry(NodeVO p_nodeVO) throws BTSLBaseException
    {
        ...
        if(_log.isDebugEnabled()) _log.debug(methodName,"Entered p_nodeVO:"+p_nodeVO);
        ...
        try
        {
            ...
            _log.error(methodName,"IcurrentRequestTime = " +currentRequestTime);
            ...
            {
            	_log.error(methodName,"Interface Suspended and expiry time has not been expired.So not sending request to IN");
        		throw new BTSLBaseException(this,methodName,InterfaceErrorCodesI.INTERFACE_SUSPENDED);
            }
        }
        ...
        {
            if(_log.isDebugEnabled()) _log.debug(methodName,"Exited isSuspensionExpired:"+isSuspensionExpired);
        }        
    ...
    public synchronized void updateCountersOnAmbiguousResp(NodeVO p_nodeVO)
    {
    	...
    	if(_log.isDebugEnabled()) _log.debug(methodName,"Entered printNodeVO:"+printNodeVO(p_nodeVO));   
        try
        {
        ...
        {
            if(_log.isDebugEnabled()) _log.debug(methodName,"Exited printNodeVO:"+printNodeVO(p_nodeVO));
        }
