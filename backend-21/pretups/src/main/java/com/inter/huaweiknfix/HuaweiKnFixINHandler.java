...
public class HuaweiKnFixINHandler implements InterfaceHandler {

    private Log _log = LogFactory.getLog(HuaweiKnFixINHandler.class.getName());
    ...
    private String _referenceID = null;// Used to store the reference of
                                       // transaction id.
    private HuaweiKnFixRequestFormatter _formatter = null;
    ...
    public HuaweiKnFixINHandler() {
        _formatter = new HuaweiKnFixRequestFormatter();
    }
    ...
    public void validate(HashMap p_requestMap) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            setInterfaceParameters(HuaweiKnFixI.ACTION_ACCOUNT_INFO);
            // sending the AccountInfo request to IN along with validate action
            // defined in HuaweiI interface
            sendRequestToIN(HuaweiKnFixI.ACTION_ACCOUNT_INFO);
            ...
            String amountStr = (String) _responseMap.get("ACCLEFT");// changed
                                                                    // by abhay
            try {
            ...
            _requestMap.put("ACCOUNT_STATUS", (String) _responseMap.get("SUBSTATE"));// changed
                                                                                     // by
                                                                                     // abhay

            // set OLD_EXPIRY_DATE in request map as returned from _responseMap.
            // _requestMap.put("OLD_EXPIRY_DATE",
            // InterfaceUtil.getInterfaceDateFromDateString((String)_responseMap.get("ACTIVESTOP"),
            // "yyyyMMdd"));
            _requestMap.put("OLD_EXPIRY_DATE", InterfaceUtil.getInterfaceDateFromDateString((String) _responseMap.get("VALDATE"), "yyyyMMdd"));// changed
                                                                                                                                               // by
                                                                                                                                               // abhay
            // _requestMap.put("OLD_GRACE_DATE",
            // InterfaceUtil.getInterfaceDateFromDateString((String)_responseMap.get("SUSPENDSTOP"),
            // "yyyyMMdd"));
    ...
    public void credit(HashMap p_requestMap) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            // Set the interface parameters into requestMap
            setInterfaceParameters(HuaweiKnFixI.ACTION_RECHARGE_CREDIT);
            ...
            // defined in HuaweiI interface
            sendRequestToIN(HuaweiKnFixI.ACTION_RECHARGE_CREDIT);
            // set TRANSACTION_STATUS as Success in request map
            _requestMap.put("TRANSACTION_STATUS", InterfaceErrorCodesI.SUCCESS);
            // set NEW_EXPIRY_DATE into request map
            // _requestMap.put("NEW_EXPIRY_DATE",
            // InterfaceUtil.getInterfaceDateFromDateString((String)
            // _responseMap.get("NEWACTIVESTOP"), "yyyyMMdd"));
            _requestMap.put("NEW_EXPIRY_DATE", InterfaceUtil.getInterfaceDateFromDateString((String) _responseMap.get("AFTERVALIDITY"), "yyyyMMdd"));// changed
                                                                                                                                                     // by
                                                                                                                                                     // abhay
            // set INTERFACE_POST_BALANCE into request map as obtained thru
            // response map.
            try {
                // String postBalanceStr = (String)
                // _responseMap.get("NEWBALANCE");
                String postBalanceStr = (String) _responseMap.get("AFTERBALANCE");// changed
                                                                                  // by
                                                                                  // abhay
    ...
    public void creditAdjust(HashMap p_requestMap) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            huaweiMultiplicationFactor = huaweiMultiplicationFactor.trim();
            // Set the interface parameters into requestMap
            setInterfaceParameters(HuaweiKnFixI.ACTION_IMMEDIATE_DEBIT);
            ...
            sendRequestToIN(HuaweiKnFixI.ACTION_IMMEDIATE_DEBIT);
            // set TRANSACTION_STATUS as Success in request map
            _requestMap.put("TRANSACTION_STATUS", InterfaceErrorCodesI.SUCCESS);
            // set INTERFACE_POST_BALANCE into request map as obtained thru
            // response map.
            try {
                // String postBalanceStr = (String)
                // _responseMap.get("LASTBALANCE");
                String postBalanceStr = (String) _responseMap.get("AFTERBALANCE");// chnaged
                                                                                  // by
                                                                                  // abhay
    ...
    public void validityAdjust(HashMap p_requestMap) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            // Set the interface parameters into requestMap
            setInterfaceParameters(HuaweiKnFixI.ACTION_VALIDITY_ADJUST);
            ...
            if (InterfaceUtil.isNullString(validityDays) || !InterfaceUtil.isNumeric(validityDays)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiINHandler[validityAdjust]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "EXT_VALIDITY_DAYS received from map  is either null or non-numeric");
                throw new BTSLBaseException(this, "validityAdjust", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }

            // sending the Re-charge request to IN along with re-charge action
            // defined in HuaweiI interface
            sendRequestToIN(HuaweiKnFixI.ACTION_VALIDITY_ADJUST);
            // set TRANSACTION_STATUS as Success in request map
            _requestMap.put("TRANSACTION_STATUS", InterfaceErrorCodesI.SUCCESS);
            // set NEW_EXPIRY_DATE into request map
            // _requestMap.put("NEW_EXPIRY_DATE",
            // InterfaceUtil.getInterfaceDateFromDateString((String)
            // _responseMap.get("ACTIVESTOP"), "yyyyMMdd"));
            _requestMap.put("NEW_EXPIRY_DATE", InterfaceUtil.getInterfaceDateFromDateString((String) _responseMap.get("AFTERVALIDITY"), "yyyyMMdd"));// changed
                                                                                                                                                     // by
                                                                                                                                                     // abhay
            ...
            // InterfaceUtil.getInterfaceDateFromDateString((String)
            // _responseMap.get("SUSPENDSTOP"), "yyyyMMdd"));
            // set INTERFACE_POST_BALANCE into request map as obtained thru
            // response map.
            try {
                // Fetching the HUAWEI_MULT_FACTOR from the INFile.
                ...
                if (InterfaceUtil.isNullString(huaweiMultiplicationFactor)) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiINHandler[validityAdjust]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "HUAWEI_MULT_FACTOR  is not defined in the INFile");
                    throw new BTSLBaseException(this, "validityAdjust", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
                }
                huaweiMultiplicationFactor = huaweiMultiplicationFactor.trim();
                _requestMap.put("HUAWEI_MULT_FACTOR", huaweiMultiplicationFactor);
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiINHandler[validityAdjust]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "BALANCE  is not Numeric");
            ...
            try {
                ...
                e.printStackTrace();
                _log.error("validityAdjust", "Exception e:" + e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiINHandler[validityAdjust]", _referenceID, _msisdn, (String) _requestMap.get("NETWORK_CODE"), "Exception while processing ambiguous case in validityAdjust");
                throw new BTSLBaseException(this, "validityAdjust", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
        } catch (Exception e) {
            e.printStackTrace();
            _log.error("validityAdjust", "Exception e:" + e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiINHandler[validityAdjust]", _referenceID, _msisdn, (String) _requestMap.get("NETWORK_CODE"), "While validityAdjust get the Exception e:" + e.getMessage());
            throw new BTSLBaseException(this, "validityAdjust", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled())
    ...
    private void sendRequestToIN(int p_action) throws BTSLBaseException {
        ...
        HuaweiKnFixSocketWrapper socketConnection = null;
        long startTime = 0;
        boolean isC2S = false;
        ...
        try {
            ...
            try {
                ...
                socketConnection = HuaweiKnFixPoolManager.getClientObject(_interfaceID, isC2S);
                if (_log.isDebugEnabled())
                ...
                busyList = (Vector) HuaweiKnFixPoolManager._busyBucket.get(_interfaceID);// get
                                                                                         // busy
                                                                                         // and
                                                                                         // free
                                                                                         // pool
                                                                                         ...
                                                                                         // pool
                                                                                         // mgr.
                freeList = (Vector) HuaweiKnFixPoolManager._freeBucket.get(_interfaceID);
                ...
                if (HuaweiKnFixI.MAX_TXN_REACH.equals(txnID)) {
                    try {
                        ...
                        HuaweiKnFixSocketWrapper newSocketConnection = HuaweiKnFixPoolManager.getNewClientObject(_interfaceID);
            ...
            while (retryCount++ <= retryCountConInvalid) {
                ...
                if (InterfaceUtil.isNullString(responseStr)) {
                    ...
                    EventHandler.handle(EventIDI.INTERFACE_INVALID_RESPONSE, _interfaceID, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiINHandler[sendRequestToIN]", _referenceID, _msisdn, (String) _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Action = " + p_action, "Blank response from Huawei IN");
                    _log.error("sendRequestToIN", "NULL response from interface");
                    _requestMap.put("INTERFACE_STATUS", InterfaceErrorCodesI.AMBIGOUS);
                    // commented code may be used in future to support on line
                    // cancel request
                    /*
                     * if(HuaweiKnFixI.ACTION_TXN_CANCEL == p_stage)
                ...
                if (!HuaweiKnFixI.RESULT_OK.equals(status)) {
                    if (HuaweiKnFixI.SUBSCRIBER_NOT_FOUND.equals(status)) {
                    ...
                    else if (HuaweiKnFixI.SUBSCRIBER_BARRED.equals(status)) {
                        _log.error("sendRequestToIN", "Error in response SUBSCRIBER_BARRED");
                        EventHandler.handle(EventIDI.SYSTEM_INFO, _interfaceID, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "HuaweiINHandler[sendRequestToIN]", _referenceID, _msisdn, (String) _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Action = " + p_action, " SUBSCRIBER_BARRED AT IN");
                        throw new BTSLBaseException(this, "sendRequestToIN", InterfaceErrorCodesI.INTERFACE_MSISDN_BARRED);// MSISDN
                                                                                                                           // Barred
                    } else if (HuaweiKnFixI.SUBSCRIBER_BAL_INSUFFIC.equals(status)) {
                        _log.error("sendRequestToIN", "Error in response SUBSCRIBER_BAL_INSUFFIC");
                        EventHandler.handle(EventIDI.SYSTEM_INFO, _interfaceID, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "HuaweiINHandler[sendRequestToIN]", _referenceID, _msisdn, (String) _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Action = " + p_action, " SUBSCRIBER_BAL_INSUFFIC AT IN");
                        throw new BTSLBaseException(this, "sendRequestToIN", InterfaceErrorCodesI.ERROR_INSUFFCIENT_CREDIT);// MSISDN
                                                                                                                            // Balance
                                                                                                                            // Insufficient
                    } else if (HuaweiKnFixI.SUBSCRIBER_AC_EXPIRED.equals(status)) {
                        _log.error("sendRequestToIN", "Error in response INTERFACE_MSISDN_EXPIRED");
                        EventHandler.handle(EventIDI.SYSTEM_INFO, _interfaceID, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "HuaweiINHandler[sendRequestToIN]", _referenceID, _msisdn, (String) _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Action = " + p_action, " SUBSCRIBER_AC_EXPIRED AT IN");
                        throw new BTSLBaseException(this, "sendRequestToIN", InterfaceErrorCodesI.INTERFACE_MSISDN_EXPIRED);// MSISDN
                                                                                                                            // Expired
                    }// end mark
    ...
    public void setInterfaceParameters(int p_action) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            if (HuaweiKnFixI.ACTION_ACCOUNT_INFO == p_action) {
                ...
                if ("R".equals(_userType)) {
                    ...
                    if (InterfaceUtil.isNullString(valExtAcStatus)) {
                        ...
                        EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "VAL_EXT_ACNT_STATUS is not defined in the INFile.");
                        throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_BAD_REQUEST);
                    }
            ...
            } else if (HuaweiKnFixI.ACTION_RECHARGE_CREDIT == p_action) {
                ...
                if (InterfaceUtil.isNullString(batchNo)) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "BATCH_NO is not defined in the INFile.");
                    throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_BAD_REQUEST);
                }
            ...
            } else if (HuaweiKnFixI.ACTION_IMMEDIATE_DEBIT == p_action) {
            ...
            } else if (HuaweiKnFixI.ACTION_VALIDITY_ADJUST == p_action) {
                ...
                if (InterfaceUtil.isNullString(modifyValidityCommand)) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "MODIFY_VALIDITY_COMMAND is not defined in the INFile.");
                    throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_BAD_REQUEST);
                }
                ...
                if (InterfaceUtil.isNullString(modifyValidityService)) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "MODIFY_VALIDITY_SERIVICE is not defined in the INFile.");
                    throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_BAD_REQUEST);
                }
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingActiveStop)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_VALIDITY_ADJ is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_BAD_REQUEST);
            }
    ...
    private void setLanguageFromMapping() throws Exception {
        ...
        try {
            ...
            langFromIN = (String) _responseMap.get("LAGTYPE");// changed by
                                                              // abhay
            if (_log.isDebugEnabled())
    ...
    private void checkInterfaceB4SendingRequest() throws BTSLBaseException {
        ...
        try {
            ...
            String _interfaceLiveStatus = (String) _requestMap.get("INT_ST_TYPE");
