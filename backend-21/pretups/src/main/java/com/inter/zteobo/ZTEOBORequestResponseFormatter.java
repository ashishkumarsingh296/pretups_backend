...
public class ZTEOBORequestResponseFormatter {
    private static Log _log = LogFactory.getLog(ZTEOBORequestResponseFormatter.class.getName());
     ...
     * Constructor
     */
    public ZTEOBORequestResponseFormatter() {
        super();
