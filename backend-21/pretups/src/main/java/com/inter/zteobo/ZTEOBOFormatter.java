...
public class ZTEOBOFormatter {
    private static Log _log = LogFactory.getLog(ZTEOBOFormatter.class.getName());
    ...
    protected String generateRequest(int action, HashMap<String, String> p_map) throws Exception {
        ...
        switch (action) {
        case ZTEOBOI.ACTION_ACCOUNT_INFO: {
            str = generateGetAccountInfoRequest(p_map);
            break;
        }
        case ZTEOBOI.ACTION_RECHARGE_CREDIT: {
        ...
        case ZTEOBOI.ACTION_IMMEDIATE_DEBIT: {
    ...
    private String generateCreditAdjustRequest(HashMap<String, String> p_map) throws Exception {
        ...
        try {
            ...
            if ("S".equals((String) p_map.get("USER_TYPE"))) {
                ...
                if (_explicitRecharge || _combinedRecharge) {
                    if (_log.isDebugEnabled())
                        _log.debug("generateCreditAdjustRequest", "Entered IF Block  " + _explicitRecharge + _combinedRecharge);
    ...
    public HashMap<String, String> parseImmediateDebitResponse(String responseStr) throws Exception {
        ...
        try {
            ...
            if (_str.equals((returnCode))) {
                ...
                int end = responseStr.indexOf("<AccountResCode>0</AccountResCode>");// 1
                                                                                    // is
                                                                                    // for
                                                                                    // main
                                                                                    // account
