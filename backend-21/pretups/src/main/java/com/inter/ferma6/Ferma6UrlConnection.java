...
public class Ferma6UrlConnection extends BTSLConnection {
    ...
    public Ferma6UrlConnection(String p_url, int p_connecttimeout, int p_readtimeout, String p_keepAlive) throws Exception {
        if (_log.isDebugEnabled())
            _log.debug("Ferma6UrlConnection", "Entered p_url: " + p_url + " p_connecttimeout: " + p_connecttimeout + " p_readtimeout: " + p_readtimeout + " p_keepAlive=" + p_keepAlive);
        try {
            ...
            _log.error("Ferma6UrlConnection", "Exception e:" + e.getMessage());
            // e.printStackTrace(); //commented because done where this method
            // has been used
            throw e;
        } finally {
            if (_log.isDebugEnabled())
                _log.debug("Ferma6UrlConnection", "Exiting ");
        }
    }
