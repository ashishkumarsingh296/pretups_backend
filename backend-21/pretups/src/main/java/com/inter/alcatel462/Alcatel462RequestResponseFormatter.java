 ...
 *                                             reserved.
 *                                             COMVIVA PROPRIETARY/CONFIDENTIAL.
 ...
 *                                             --------------------------------
 *                                             -------------------------------
 *                                             Vinay Kumar Singh January 25,
 *                                             2011 Initial Creation
 *                                             --------------------------------
 *                                             --
 *                                             --------------------------------
 *                                             ------------------------------
...
public class Alcatel462RequestResponseFormatter {
    // Get the logger object, which is used to write different types of logs.
    public static Log _log = LogFactory.getLog("Alcatel462RequestResponseFormatter".getClass().getName());
    ...
    protected String generateRequest(int p_action, HashMap<String, String> p_map) throws Exception {
        ...
        try {
            ...
            switch (p_action) {
            case Alcatel462I.ACTION_GET_ACCOUNT_INFO: {
                str = generateGetAccountInfoRequest(p_map);
                break;
            }
            case Alcatel462I.ACTION_IMMEDIATE_CREDIT: {
            ...
            case Alcatel462I.ACTION_IMMEDIATE_DEBIT: {
    ...
    private String generateGetAccountInfoRequest(HashMap<String, String> map) throws Exception {
        ...
        try {
            ...
            sbf.append(InterfaceUtil.getFilterMSISDN(map.get("INTERFACE_ID"), map.get("MSISDN")));
            sbf.append("</user_id>");
    ...
    private HashMap<String, String> parseGetAccountInfoResponse(String p_responseStr, String p_interfaceID) throws Exception {
        ...
        try {
            ...
            if (Alcatel462I.RESULT_OK.equals(result)) {
                 ...
                 */
                if (!(Alcatel462I.RESULT_ERROR_MALFORMED_REQUEST.equals(result)) || !(Alcatel462I.RESULT_ERROR_XML_PARSE.equals(result))) {
                    index = p_responseStr.indexOf("<cp_id>");
                    if (index != -1) {
                        String cp_id = p_responseStr.substring(index + "<cp_id>".length(), p_responseStr.indexOf("</cp_id>", index));
                        responseMap.put("cp_id", cp_id);
    ...
    private String generateCreditAdjustRequest(HashMap<String, String> p_map) throws Exception {
        ...
        try {
            ...
            interfaceID = p_map.get("INTERFACE_ID");
            ...
            // be filtered before setting in the request
            sbf.append("<user_id type=\"MSISDN\">");
            sbf.append(InterfaceUtil.getFilterMSISDN(p_map.get("INTERFACE_ID"), p_map.get("MSISDN")));
            sbf.append("</user_id>");
            ...
            if (_implicitRecharge) {
                ...
                if (!_selectorBundleId.equals("1")) {
                    ...
                    grace = p_map.get("GRACE_DAYS");
                    // If VALIDITY_DAYS is NULL set user_validity equal to 0,
                    // else set same user_validity.
                ...
                if (_combinedRecharge) {
                    ...
                    amtStr = p_map.get("transfer_amount");
    ...
    private String generateImmediateCreditRequest(HashMap<String, String> p_map) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            if (_implicitRecharge) {
                ...
                // Get the value of GRACE_DAYS from requestMap
                String grace = p_map.get("GRACE_DAYS");
        ...
        try {
            if (!InterfaceUtil.isNullString(p_map.get("BONUS_BUNDLE_IDS"))) {
                ...
                for (int i = 0; i < bonusBundleCount; i++) {
                    ...
                    if (InterfaceUtil.isNullString(bundleCode) || (!bundleIds[i].equalsIgnoreCase("1") && _combinedRecharge))
                        continue;
                    ...
                    if (bundleValueDbl > 0 && Long.parseLong(bundleValidity) > 0) {
                        if ("AMT".equals(bundleTypes[i])) {
                            inbundleValueDbl = InterfaceUtil.getINAmountFromSystemAmountToIN(bundleValueDbl, Double.parseDouble(FileCache.getValue(_interfaceId, "MULT_FACTOR")));
            ...
            e.printStackTrace();
            _log.error("Alcatel462RequestResponseFormatter[getBundleRequestString]", "Exception e::" + e.getMessage());
            throw e;
        } finally {
            if (_log.isDebugEnabled())
    ...
    private String generateImmediateDebitRequest(HashMap<String, String> p_map) throws Exception {
        ...
        try {
            ...
            // sbf.append(InterfaceUtil.getFilterMSISDN((String)
            // p_map.get("INTERFACE_ID"),(String)p_map.get("MSISDN")));
            sbf.append(p_map.get("IN_ACCOUNT_ID"));
    ...
    private void setBundlesRcvdFromIN(String p_responseStr, HashMap<String, String> p_requestMap) throws Exception {
        ...
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug("setBundlesRcvdFromIN: ", "Exiting Defined bundles at IN=" + p_requestMap.get("received_bundles"));
        }
    }
}
