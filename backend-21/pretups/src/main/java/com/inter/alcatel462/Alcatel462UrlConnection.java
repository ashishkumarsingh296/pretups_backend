 ...
 *                                  --------------------------------------------
 *                                  --------
 *                                  This class will stabilized the HTTP
...
public class Alcatel462UrlConnection extends BTSLConnection {
    private HttpURLConnection _urlConnection = null;
    public static Log _log = LogFactory.getLog("Alcatel462UrlConnection".getClass().getName());
     ...
     * @throws Exception
     */
    public Alcatel462UrlConnection(String p_url, int p_connecttimeout, int p_readtimeout, String p_keepAlive) throws Exception {
        if (_log.isDebugEnabled())
            _log.debug("Alcatel462UrlConnection[constructor]", "Entered p_url: " + p_url + "p_connecttimeout=" + p_connecttimeout + " p_readtimeout=" + p_readtimeout + " p_keepAlive=" + p_keepAlive);
        try {
            ...
            e.printStackTrace();
            _log.error("Alcatel462UrlConnection[constructor]", " Exception: " + e.getMessage());
            throw e;
        }
        if (_log.isDebugEnabled())
            _log.debug("Alcatel462UrlConnection[constructor] ", "Exiting ");
    }
