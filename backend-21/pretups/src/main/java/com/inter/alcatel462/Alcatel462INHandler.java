...
public class Alcatel462INHandler implements InterfaceHandler {
    private static Log _log = LogFactory.getLog("Alcatel462INHandler".getClass().getName());

    private HashMap<String, String> _requestMap = null;
    private HashMap<String, String> _responseMap = null;
    private Alcatel462RequestResponseFormatter _formatter = null;
    ...
    public void validate(HashMap<String, String> p_map) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            // get interface id form request map
            ...
            _formatter = new Alcatel462RequestResponseFormatter();
            String inStr = _formatter.generateRequest(Alcatel462I.ACTION_GET_ACCOUNT_INFO, _requestMap);

            // Sending the request to IN
            sendRequestToIN(inStr, Alcatel462I.ACTION_GET_ACCOUNT_INFO);
            String serviceType = (String) p_map.get("REQ_SERVICE");
            _userType = (String) p_map.get("USER_TYPE");
            if (!(("PRC".equals(serviceType)) || ("CPN".equals(serviceType)))) {
                String selectorBundleId = (_requestMap.get("SELECTOR_BUNDLE_ID")).trim();
                ...
                if (InterfaceUtil.isNullString(selectorBundleCode) || ((!"1".equals(selectorBundleId) && InterfaceUtil.isNullString(receivedBundles)) || (!"1".equals(selectorBundleId) && !Arrays.asList(bundleList).contains(selectorBundleCode)))) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[validate]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), " Subscriber " + p_map.get("MSISDN") + " does not have " + selectorBundleCode + " bundle assigned.");
            ...
            try {
                ...
                e.printStackTrace();
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[validate]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), " credit balance from response is not numeric or multiplication factor defined in the INFile is not Numeric, Exception e:" + e.getMessage());
                throw new BTSLBaseException(this, "validate", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }

            // Setting the Service class into request map,if it is present in
            ...
            e.printStackTrace();
            _log.error("validate: ", "Exception e:" + e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[validate]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "Exception while validate");
     ...
     * Alcatel462RequestResponseFormatter.
    ...
    public void credit(HashMap<String, String> p_map) throws BTSLBaseException, Exception {
        ...
        try {
            _userType = _requestMap.get("USER_TYPE");
            // get interface id from request map
            _interfaceID = _requestMap.get("INTERFACE_ID");
            _interfaceClosureSupport = FileCache.getValue(_interfaceID, "INTFCE_CLSR_SUPPORT");
            if ("Y".equalsIgnoreCase(_interfaceClosureSupport))
                checkInterfaceB4SendingRequest();
            ...
            if ("1".equals(selectorBundleId)) {
                ...
                double inAmount = InterfaceUtil.getINAmountFromSystemAmountToIN(Double.parseDouble(amountStr), Double.parseDouble(mulFactor.trim()));
                ...
                // if round flag value is Y, round the amount, else put it as it
                // is.
            ...
            // Alcatel462RequestResponseFormatter class with appropriate
            ...
            _formatter = new Alcatel462RequestResponseFormatter();
            String inStr = _formatter.generateRequest(Alcatel462I.ACTION_IMMEDIATE_CREDIT, _requestMap);

            // send the credit request to IN
            sendRequestToIN(inStr, Alcatel462I.ACTION_IMMEDIATE_CREDIT);
            ...
            try {
                ...
                e.printStackTrace();
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[credit]", _referenceID, _msisdn + " INTERFACE ID= " + _interfaceID, _requestMap.get("NETWORK_CODE"), " credit balance from response is not numeric or multiplication factor defined in the INFile is not Numeric, Exception e:" + e.getMessage());
            ...
            try {
                ...
                e.printStackTrace();
                _log.error("credit ::", "Exception e:" + e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[credit]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), " Exception while processing ambiguous case in credit method.");
                throw new BTSLBaseException(this, "credit", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[credit]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), " While credit get Exception e:" + e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
    ...
    public void debitAdjust(HashMap<String, String> p_map) throws BTSLBaseException, Exception {
        ...
        try {
            _userType = _requestMap.get("USER_TYPE");
            // Get the interface id form request map
            _interfaceID = _requestMap.get("INTERFACE_ID");
            _interfaceClosureSupport = FileCache.getValue(_interfaceID, "INTFCE_CLSR_SUPPORT");
            if ("Y".equalsIgnoreCase(_interfaceClosureSupport))
                checkInterfaceB4SendingRequest();
            ...
            if (InterfaceUtil.isNullString(mulFactor)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[debitAdjust]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), " Multiplication factor is not defined in IN File.");
            ...
            double requestedAmtDouble = Double.parseDouble(_requestMap.get("INTERFACE_AMOUNT"));
            double inAmount = InterfaceUtil.getINAmountFromSystemAmountToIN(requestedAmtDouble, Double.parseDouble(mulFactor.trim()));
            ...
            // debitAdjust request.
            _formatter = new Alcatel462RequestResponseFormatter();
            String inStr = _formatter.generateRequest(Alcatel462I.ACTION_IMMEDIATE_DEBIT, _requestMap);
            // sending the debit request to the IN
            sendRequestToIN(inStr, Alcatel462I.ACTION_IMMEDIATE_DEBIT);
            // On successful response, set TRANSACTION_STATUS as SUCCES into
            // request map.
            _requestMap.put("TRANSACTION_STATUS", InterfaceErrorCodesI.SUCCESS);
            ...
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[debitAdjust]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), " Exception while processing ambiguous case in debitAdjust mrthod.");
            ...
            e.printStackTrace();
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[debitAdjust]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), " While debitAdjust get Exception e=" + e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
        }// end of catch-Exception
        finally {
            if (_log.isDebugEnabled())
    ...
    public void creditAdjust(HashMap<String, String> p_map) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            if ("AMT".equals(_requestMap.get("SELECTOR_BUNDLE_TYPE")))
                ;
            mulFactor = FileCache.getValue(_interfaceID, "MULT_FACTOR");

            // Convert the amount in amount according to the selector.
            double inAmount = InterfaceUtil.getINAmountFromSystemAmountToIN(Double.parseDouble(_requestMap.get("INTERFACE_AMOUNT")), Double.parseDouble(mulFactor.trim()));
            amountStr = String.valueOf(inAmount);
            // round flag
            String roundFlag = null;
            roundFlag = FileCache.getValue(_interfaceID, "ROUND_FLAG");
            ...
            try {
                ...
                e.printStackTrace();
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[creditAdjust]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), " credit balance from response is not numeric or multiplication factor defined in the INFile is not Numeric, Exception e:" + e.getMessage());
                throw new BTSLBaseException(this, "credit", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
            ...
            try {
                ...
                e.printStackTrace();
                _log.error("creditAdjust ::", "Exception e:" + e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[creditAdjust]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), " Exception while processing ambiguous case in creditAdjust method.");
                throw new BTSLBaseException(this, "credit", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
        }// end of catch-BTSLBaseException
        catch (Exception e) {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[creditAdjust]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), " While creditAdjust get Exception e:" + e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
        }// end of catch-Exception
        finally {
            if (_log.isDebugEnabled())
    ...
    public void sendRequestToIN(String p_inRequestStr, int p_action) throws BTSLBaseException {
        ...
        TransactionLog.log(_inTXNID, _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), String.valueOf(p_action), PretupsI.TXN_LOG_REQTYPE_REQ, " INTERFACE_ID:" + _interfaceID + " Request string:" + p_inRequestStr, PretupsI.TXN_LOG_STATUS_UNDERPROCESS, "p_action=" + p_action);
        String responseStr = "";
        Alcatel462UrlConnection Alcatel462UrlConnection = null;
        long startTime = 0;
        long endTime = 0;
        long warnTime = 0;
        int readTimeOut = 0;
        ...
        try {
            ...
            try {
                ...
                if (InterfaceUtil.isNullString(urlFromFileCache)) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[sendRequestToIN]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), "URL is not defined in IN File");
                ...
                if (InterfaceUtil.isNullString(connectTimeOutStr) || InterfaceUtil.isNullString(keepAlive)) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[sendRequestToIN]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), "CONNECT_TIMEOUT or KEEP_ALIVE is not defined in IN File");
                    throw new BTSLBaseException(this, "credit", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
                }
                int connectTimeOut = Integer.parseInt(connectTimeOutStr);
                // Get read time out from INFile

                if (Alcatel462I.ACTION_GET_ACCOUNT_INFO == p_action) {
                    ...
                    if (InterfaceUtil.isNullString(readTimeOutValStr)) {
                        ...
                        EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[sendRequestToIN]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), "READ_TIMEOUT_VAL is not defined in IN File");
                        throw new BTSLBaseException(this, "credit", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
                    }
                    ...
                    if (InterfaceUtil.isNullString(readTimeOutTopStr)) {
                        ...
                        EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[sendRequestToIN]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), "READ_TIMEOUT_TOP is not defined in IN File");
                        throw new BTSLBaseException(this, "credit", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
                    }
                ...
                // ServletName.
                Alcatel462UrlConnection = new Alcatel462UrlConnection(urlFromFileCache, connectTimeOut, readTimeOut, keepAlive);
            } catch (BTSLBaseException be) {
                throw be;
            }// end of catch-BTSLBaseException
            catch (Exception e) {
                e.printStackTrace();
                EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.INFO, "Alcatel462INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), "Error while getting the http connection for INTERFACE_ID=[" + _interfaceID + "]" + " Exception : " + e.getMessage() + " action: " + p_action);
            ...
            try {
                ...
                // object from
                // the Alcatel462UrlConnection class.
                PrintWriter out = Alcatel462UrlConnection.getPrintWriter();
                out.flush();
            ...
            // error occurs does the following.
                ...
                e.printStackTrace();
                _log.error("sendRequestToIN: ", "Exception e:" + e.getMessage());
                EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Action = " + p_action, "Exception while sending request to AlcatelOCI IN" + " action :" + p_action);
            ...
            try {
                ...
                // Alcatel462UrlConnection class.
                Alcatel462UrlConnection.setBufferedReader();
                BufferedReader in = Alcatel462UrlConnection.getBufferedReader();
            ...
            TransactionLog.log(_inTXNID, _referenceID, _msisdn, _requestMap.get("NETWORK_CODE"), String.valueOf(p_action), PretupsI.TXN_LOG_REQTYPE_RES, " INTERFACE_ID:" + _interfaceID + "Request String :" + p_inRequestStr + " Response string:" + responseStr, PretupsI.TXN_LOG_STATUS_UNDERPROCESS, " INTERFACE ID = " + _interfaceID + " action=" + p_action);
            // Get the HTTP Status code and check whether it is OK or Not??
            String httpStatus = Alcatel462UrlConnection.getResponseCode();
            _requestMap.put("PROTOCOL_STATUS", httpStatus);
            if (!Alcatel462I.HTTP_STATUS_OK.equals(httpStatus))
                throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_BAD_REQUEST);
            if (InterfaceUtil.isNullString(responseStr)) {
                // raise the alarm
                EventHandler.handle(EventIDI.INTERFACE_INVALID_RESPONSE, _interfaceID, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Stage = " + p_action, "Blank response from AlcatelOCI IN");
                _log.error("sendRequestToIN: ", "NULL response from interface. ");
                _requestMap.put("INTERFACE_STATUS", InterfaceErrorCodesI.AMBIGOUS);
                throw new BTSLBaseException(InterfaceErrorCodesI.AMBIGOUS);
            }
            // Parse the response using the parseResponse method of
            // Alcatel462RequestResponseFormatter class.
            ...
            String inReconId = _requestMap.get("IN_RECON_ID");
            if (!InterfaceUtil.isNullString(result) && !result.equals(Alcatel462I.RESULT_OK)) {
                _log.info("sendRequestToIN: ", "cp transID:" + cpTransID + " CP ID=" + (String) _responseMap.get("cp_id") + " result=" + result);
                if (result.equals(Alcatel462I.RESULT_ERROR_ACC_NOT_FOUND))
                    throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND);
                // send alert message(TO BE IMPLEMENTED)
                EventHandler.handle(EventIDI.INTERFACE_INVALID_RESPONSE, _interfaceID, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Stage = " + p_action, "Status of the response, result: " + result);
                ...
                // Raise the alarm
                EventHandler.handle(EventIDI.INTERFACE_INVALID_RESPONSE, _interfaceID, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Stage = " + p_action, "Parameters values blank in response, result: " + result);
                throw new BTSLBaseException(InterfaceErrorCodesI.NULL_INTERFACE_RESPONSE);
            } else if (!((String) _responseMap.get("cp_id")).equals(_requestMap.get("cp_id"))) {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Stage = " + p_action, "System Exception:" + e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
        } finally {
            try {
                if (Alcatel462UrlConnection != null)
                    Alcatel462UrlConnection.close();
            } catch (Exception e) {
                e.printStackTrace();
                _log.error("sendRequestToIN: ", "Exception while closing AlcatelOCI452Url Connection:" + e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[sendRequestToIN]", _referenceID, _msisdn, _requestMap.get("NETWORK_CODE") + " INTERFACE ID = " + _interfaceID + " Stage = " + p_action, "Not able to close connection:" + e.getMessage());
            }
            if (_log.isDebugEnabled())
    ...
    private void setInterfaceParameters() throws BTSLBaseException, Exception {
        ...
        try {
            ...
            // by the interface.
            String cpID = (String) FileCache.getValue(_interfaceID, "CP_ID" + "_" + _requestMap.get("MODULE"));
            if (InterfaceUtil.isNullString(cpID)) {
                _log.error("setInterfaceParameters: ", "Value of CP_ID_MODULE is not defined in the INFile");
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "CP_ID_" + _requestMap.get("MODULE") + " is not defined in the INFile.");
            ...
            if (InterfaceUtil.isNullString(application)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "APPLICATION is not defined in the INFile.");
                throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(cancelTxnAllowed)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "CANCEL_TXN_ALLOWED is not defined in the INFile.");
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingCr)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_CREDIT is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters ", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingCrAdj)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_CREDIT_ADJ is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters ", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingDbtAdj)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_DEBIT_ADJ is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters ", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingCrBck)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_CREDIT_BCK is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters ", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(cancelCommandStatusMapping)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, _requestMap.get("NETWORK_CODE"), "CANCEL_COMMAND_STATUS_MAPPING is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters ", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
    ...
    private void setLanguageFromMapping() throws Exception {
        ...
        try {
            ...
            if (InterfaceUtil.isNullString(mappingString)) {
                mappingString = "";
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.MAJOR, "Alcatel462INHandler[setLanguageFromMapping]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), "LANGUAGE_MAPPING is not defined in IN file,Hence setting the Default language");
            }
            ...
            if (mappingNotFound)
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.MAJOR, "Alcatel462INHandler[setLanguageFromMapping]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), "Mapping for language received from IN =  " + langFromIN + " is not defined in IN file Hence setting the Default language");
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "Alcatel462INHandler[setLanguageFromMapping]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, _requestMap.get("NETWORK_CODE"), "Mapping KEY for language is not defined in IN file and Getting Excption=" + e.getMessage());
        }// end of catch-Exception
        finally {
            if (_log.isDebugEnabled())
