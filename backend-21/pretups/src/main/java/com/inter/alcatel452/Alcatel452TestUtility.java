...
public class Alcatel452TestUtility {
    ...
    public Alcatel452TestUtility() {

    }

    public Alcatel452TestUtility(String p_action, String p_interfaceID, String p_cardGroupSelector) {
    ...
    public void executeINMethods(String p_action) {
        try {
            ...
            Alcatel452INHandler inHandler = null;
            ...
            if (_action.equals(_validate)) {
                ...
                _requestMap.put("INTERFACE_HANDLER", "com.btsl.pretups.inter.alcatel452.Alcatel452INHandler");
            ...
            inHandler = new Alcatel452INHandler();
