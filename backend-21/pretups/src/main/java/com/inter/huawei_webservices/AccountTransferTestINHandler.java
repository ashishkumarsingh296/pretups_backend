 ...
 * 
 */
public class AccountTransferTestINHandler {
    // HuaweiOMTConnector connector=null;
    // NodeVO nodevo=null;
    static TransferAccountRequestMsg result = null;
    ...
    public static void main(String aa[]) throws IOException {
        ...
        try {
            ...
            System.out.println("2:Account Transfer");
        ...
        try {
            ...
            _service = (CBSInterfaceAccountMgrBindingStub) _axisPort;
            TransferAccountResultMsg response = new TransferAccountResultMsg();
            RequestHeader requestHeader = new RequestHeader();
            TransferAccountRequest request = new TransferAccountRequest();

            // -----request object---------------
            // -- request header ----
            requestHeader.setCommandId("TransferAccount");
            ...
            requestHeader.setSerialNo("160");

            // ------------- request
            request.setTransfereeNo("7984421");
            request.setTransferorNo("7984420");
            ModifyAcctFeeType[] modifyAcctFeeList = new ModifyAcctFeeType[1];
            ModifyAcctFeeType account = new ModifyAcctFeeType("2000", -1000);
            // System.out.println(account.getAccountType());
            // System.out.println("shahsank***********************");

            modifyAcctFeeList[0] = account;
            // modifyAcctFeeList[0].setAccountType(account.getAccountType());
            // modifyAcctFeeList[0].setCurrAcctChgAmt(account.getCurrAcctChgAmt());
            // System.out.println(modifyAcctFeeList[0].getAccountType());
            // System.out.println(modifyAcctFeeList[0].getCurrAcctChgAmt());
            ...
            // ---------------------
            TransferAccountRequestMsg transferRequestMsg = new TransferAccountRequestMsg(requestHeader, request);

            response = _service.transferAccount(transferRequestMsg);
