/** @# MobinilPostToPreVO
 * This class used to hold the value to enter into postpaid_cust_pay_master tabel
...
public class MobinilPostToPreVO implements Serializable{
		...
		/**
		 * @param entryFor The entryFor to set.
		 */
		...
		/**
		 * @param entryOn The entryOn to set.
		 */
		...
		/**
		 * @param externalInterfaceID The externalInterfaceID to set.
		 */
		...
		/**
		 * @param cdrFileName The cdrFileName to set.
		 */
		...
		/**
		 * @param interfaceAmount The interfaceAmount to set.
		 */
	    ...
	    /**
	     * @param interfaceAmountStr The interfaceAmountStr to set.
	     */
		...
		/**
		 * @param msisdn The receiverMsisdn to set.
		 */
