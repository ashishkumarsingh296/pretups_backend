...
public class Alcatel42INHandler implements InterfaceHandler {
    private static Log _log = LogFactory.getLog("Alcatel42INHandler".getClass().getName());
    private HashMap _requestMap = null;
    private HashMap _responseMap = null;
    private static Alcatel42RequestFormatter _formatter = null;
    ...
    static {
        if (_log.isDebugEnabled())
            _log.debug("Alcatel42INHandler[static block]", "Entered");
        // Creating an instance of Alcatel44RequestFormatter.
        _formatter = new Alcatel42RequestFormatter();
        if (_log.isDebugEnabled())
            _log.debug("Alcatel42INHandler[static block]", "Exited");
    }
    ...
    public void validate(HashMap p_map) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            String inStr = _formatter.generateRequest(Alcatel42I.ACTION_ACCOUNT_INFO, _requestMap);

            // Sending the request to IN
            sendRequestToIN(inStr, Alcatel42I.ACTION_ACCOUNT_INFO);
    ...
    public void credit(HashMap p_map) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            String inStr = _formatter.generateRequest(Alcatel42I.ACTION_RECHARGE_CREDIT, _requestMap);

            // sending the credit request to IN
            sendRequestToIN(inStr, Alcatel42I.ACTION_RECHARGE_CREDIT);
    ...
    public void debitAdjust(HashMap p_map) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            // debitAdjust request.
            String inStr = _formatter.generateRequest(Alcatel42I.ACTION_IMMEDIATE_DEBIT, _requestMap);
            // sending the debit request to the IN
            sendRequestToIN(inStr, Alcatel42I.ACTION_IMMEDIATE_DEBIT);
            // On successful response, set TRANSACTION_STATUS as SUCCES into
            // request map.
            _requestMap.put("TRANSACTION_STATUS", InterfaceErrorCodesI.SUCCESS);
    ...
    public void sendRequestToIN(String p_inRequestStr, int p_action) throws BTSLBaseException {
        ...
        String responseStr = "";
        Alcatel42UrlConnection alcatel44UrlConnection = null;
        ...
        try {
            ...
            try {
                ...
                for (loop = 1; loop <= retryNumber; loop++) {
                    try {
                        ...
                        if (Alcatel42I.ACTION_ACCOUNT_INFO == p_action)
                        ...
                        alcatel44UrlConnection = new Alcatel42UrlConnection(nodeVO.getUrl(), nodeVO.getConnectionTimeOut(), readTimeOut, nodeVO.getKeepAlive());
            ...
            try {
                ...
                // cancel request
                /*
                 * if(Alcatel42I.ACTION_TXN_CANCEL == p_stage)
            ...
            if (!Alcatel42I.HTTP_STATUS_OK.equals(httpStatus))
            ...
            if (!InterfaceUtil.isNullString(result) && !result.equals(Alcatel42I.RESULT_OK)) {
                _log.info("sendRequestToIN", "cp transID:" + cpTransID + " CP ID=" + (String) _responseMap.get("cp_id") + " result=" + result);
                if (result.equals(Alcatel42I.RESULT_ERROR_ACC_NOT_FOUND))
    ...
    private void handleCancelTransaction() throws BTSLBaseException {
        ...
        try {
             ...
             * checkInterfaceB4SendingRequest();
             * String inStr =
             * _formatter.generateRequest(Alcatel42I.ACTION_TXN_CANCEL,
             * _requestMap);
             * _maxRetryCount=cancelRetryCount;
             * sendRequestToIN(inStr,Alcatel42I.ACTION_TXN_CANCEL);
             * }
             * catch(BTSLBaseException bte)
             * {
