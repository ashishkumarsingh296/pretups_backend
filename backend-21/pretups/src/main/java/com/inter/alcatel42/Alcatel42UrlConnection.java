...
public class Alcatel42UrlConnection extends BTSLConnection {
     ...
     * @throws Exception
     */
    public Alcatel42UrlConnection(String p_url, int p_connecttimeout, int p_readtimeout, String p_keepAlive) throws Exception {
