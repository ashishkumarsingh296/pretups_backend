...
public class NodeVO {
    ...
    private int _ReadTimeOut = 0;// Defines the read time out for the validation
                                 // of node.
    ...
    private String _wssdFileLoc = "";// Wssd Location File for the Node.
    private String _soapuri = "";// Soap URL for the Node.
    private String _pwbackcall = "";// Pwdbackcall for the Node.
    ...
    public String toString() {
        ...
        sb.append(", _wssdFileLoc=" + _wssdFileLoc);
        sb.append(", _pwbackcall=" + _pwbackcall);
        sb.append(", _soapuri=" + _soapuri);
     ...
     * _log.info("incrementConNumber","p_inTxnID::"+p_inTxnID+
