...
public class NodeManager {
    ...
    private static HashMap _comNodeSchedulerMap = null;// Contains the instance
    ...
    public static void initialize(String p_interfaceIDs) throws BTSLBaseException {
        ...
        try {
            _comNodeSchedulerMap = new HashMap();
            ...
            for (int i = 0, size = inStrArray.length; i < size; i++) {
                ...
                // into a HashMap.
                _comNodeSchedulerMap.put(strINId, comNodeController);
            }// end of while.
            ...
            if (_log.isDebugEnabled())
                _log.debug("initialize", "Exited _comObjectMap::" + _comNodeSchedulerMap);
        }// end of finally
    }// end of initialize
    ...
    public static NodeScheduler getScheduler(String p_interfaceID) throws BTSLBaseException {
        ...
        try {
            ...
            comverseNodeScheduler = (NodeScheduler) _comNodeSchedulerMap.get(p_interfaceID);
        } catch (Exception e) {
            e.printStackTrace();
            ...
            if (_log.isDebugEnabled())
                _log.debug("getScheduler", "Exited comNodeScheduler::" + comverseNodeScheduler);
        }// end of finally
    ...
    private static void destroy() {
        ...
        HashMap map = null;
        try {
            if (_comNodeSchedulerMap != null) {
                map = new HashMap(_comNodeSchedulerMap);
                ...
                while (iter.hasNext()) {
                    ...
                    _log.info("destroy", "Destroying comverseNodeScheduler object from _comNodeSchedulerMap for Interface ID=" + key);
                    try {
                        comverseNodeScheduler = (NodeScheduler) _comNodeSchedulerMap.remove(key);
