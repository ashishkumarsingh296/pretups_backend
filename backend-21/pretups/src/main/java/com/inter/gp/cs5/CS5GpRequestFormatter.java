...
public class CS5GpRequestFormatter 
{
    private static Log log = LogFactory.getLog(CS5GpRequestFormatter.class);
...
/**
	...
	protected String generateRequest(int p_action, HashMap p_map) throws Exception 
	{
		...
		LogFactory.printLog(METHOD_NAME, "Entered p_action::"+p_action+" map::"+p_map, log);
		...
		try
		{
			switch(p_action)
			{
				case CS5GpI.ACTION_ACCOUNT_INFO: 
				{
					str=generateGetAccountInfoRequest(p_map);
					break;	
				}
				case CS5GpI.ACTION_ACCOUNT_DETAILS:
				{
                         str=generateGetAccountDetailRequest(p_map);
                         break;
				}
				case CS5GpI.ACTION_RECHARGE_CREDIT: 
				{
				    str=generateRechargeCreditRequest(p_map);
					break;	
				}
				case CS5GpI.ACTION_IMMEDIATE_DEBIT: 
				{
		...
		{
			log.error("generateRequest","Exception e ::"+e.getMessage());
			throw e;
		}//end of catch-Exception 
		finally
		{
			
			LogFactory.printLog(METHOD_NAME, "Exited Request String: str::"+str,log);
		}//end of finally
		return str;
    ...
    public HashMap parseResponse(int p_action,String p_responseStr,HashMap p_responseMap) throws Exception
    {
    	...
    	LogFactory.printLog(METHOD_NAME, "Entered p_action::"+p_action+" p_responseStr:: "+p_responseStr, log);
		HashMap map=null;
		try
		{
			switch(p_action)
		...
		{
			log.error("parseResponse","Exception e::"+e.getMessage());
			throw e;
		}//end of catch-Exception
		finally
		{
			LogFactory.printLog(METHOD_NAME, "Exiting map::"+map, log);
		}//end of finally
		return map;	
    ...
    private String generateGetAccountInfoRequest(HashMap p_requestMap) throws Exception
	{
		...
		try
		{
		    stringBuffer=new StringBuilder(1028);
		...
		{
			log.error("generateGetAccountInfoRequest","Exception e::"+e.getMessage());
			throw e;
		}//end of catch-Exception
		finally
		{
			LogFactory.printLog(METHOD_NAME, "Exiting Request String:requestStr::"+requestStr, log);
		}//end of finally
		return requestStr;
    ...
    private String generateRechargeCreditRequest(HashMap p_requestMap) throws Exception
    {
		...
		{
			log.error("generateRechargeCreditRequest","Exception e: "+e);
			throw e;
		}//end of catch-Exception
		finally
		{
			LogFactory.printLog(METHOD_NAME, "Exiting Request requestStr::"+requestStr, log);
		}//end of finally
		return requestStr;
    ...
    private String generateImmediateDebitRequest(HashMap p_requestMap) throws Exception
    {
		...
		{
			log.error("generateImmediateDebitRequest","Exception e: "+e.getMessage());
			throw e;
		}//end of catch-Exception
		finally
		{
			LogFactory.printLog(METHOD_NAME, "Exiting  requestStr::"+requestStr, log);
		}//end of finally
        return requestStr;
    ...
    private HashMap parseGetAccountInfoResponse(String p_responseStr) throws Exception
    {
        ...
        try
        {
	        ...
	        if(tempIndex>0)
	        {
	            ...
	            Object[] successList=CS5GpI.RESULT_OK.split(",");
        ...
        {
            log.error("parseGetAccountInfoResponse","Exception e::"+e.getMessage());
            throw e;
        }//end catch-Exception
        finally
        {
           LogFactory.printLog("parseGetAccountInfoResponse", "Exited responseMap::"+responseMap, log);
        }//end of finally
		return responseMap;
    }
    ...
    public HashMap parseRechargeCreditResponse(String p_responseStr) throws Exception
    {
    	...
    	LogFactory.printLog(METHOD_NAME, "Entered p_requestMap:"+p_responseStr, log);
        ...
        {
        	LogFactory.printLog(METHOD_NAME, "Exited responseMap::"+responseMap, log);
        }//end of finally
		return responseMap;
    ...
    private HashMap parseImmediateDebitResponse(String p_responseStr) throws Exception
    {
    	...
    	LogFactory.printLog(METHOD_NAME, "Entered p_responseStr:"+p_responseStr, log);
        ...
        {
            log.error("parseImmediateDebitResponse","Exception e::"+e.getMessage());
            throw e;
        }//end of catch-Exception
        finally
        {
    ...
    public String getDateString(String p_dateStr) throws Exception
    {
    	...
    	LogFactory.printLog(METHOD_NAME, "Entered p_dateStr::"+p_dateStr, log);
        ...
        {
            log.error("getDateString","Exception e::"+e.getMessage());
            throw e;
        }
        finally
        {
           LogFactory.printLog(METHOD_NAME, "Exited dateStr::"+dateStr, log);
        }
        return dateStr;
    }
...
private String generateGetAccountDetailRequest(HashMap p_requestMap) throws Exception
    {
		...
		LogFactory.printLog(METHOD_NAME, "Entered p_requestMap:"+p_requestMap, log);
            ...
            {
                    log.error("generateGetAccountDetailRequest","Exception e::"+e.getMessage());
                    throw e;
            }//end of catch-Exception
            finally
            {
...
private HashMap parseGetAccountDetailResponse(String p_responseStr) throws Exception
{
    ...
    {
        log.error("parseGetAccountDetailResponse","Exception e::"+e.getMessage());
        throw e;
    }//end catch-Exception
    finally
    {
	...
	public static String  addDaysInUtilDate()
	{
		...
		cal.add(Calendar.DATE,CS5GpI.ADD_DAYS_INSTALLED);
	...
	public boolean comparetags(String stringoffileP, HashMap<String,String> _responseMap) {
			
		
		String stringoffile = stringoffileP;
	...
	public static void main(String [] args){
		...
		boolean flag=new CS5GpRequestFormatter().comparetags(xml, responseMap);
		}catch(Exception e){log.errorTrace("Exception",e);
		log.error("Exception", "Exception :" + e.getMessage()); }
	}
