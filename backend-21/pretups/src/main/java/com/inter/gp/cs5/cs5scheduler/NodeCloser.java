...
public class NodeCloser {
    ...
    public synchronized void checkExpiry(NodeVO p_nodeVO) throws BTSLBaseException
    {
    	...
    	LogFactory.printLog(METHOD_NAME,"Entered p_nodeVO:"+p_nodeVO,log);
        ...
        try
        {
        	...
        	{
        		log.error("checkExpiry","Interface Suspended.");
            ...
            {
            	log.error("checkExpiry","Interface Suspended and expiry time has not been expired.So not sending request to IN");
        		throw new BTSLBaseException(this,"checkExpiry",InterfaceErrorCodesI.INTERFACE_SUSPENDED);
            }
        }
        ...
        catch(Exception e)
        {
            ...
            log.error("checkExpiry","Exception e:"+e.getMessage());
        }
        finally
        {
        	LogFactory.printLog(METHOD_NAME,"Exited isSuspensionExpired:"+isSuspensionExpired,log);
        }        
    ...
    public synchronized void updateCountersOnAmbiguousResp(NodeVO p_nodeVO)
    {
    	...
    	LogFactory.printLog(METHOD_NAME,"Entered printNodeVO:"+printNodeVO(p_nodeVO),log);
        ...
        {
            log.errorTrace("Exception",e);
            log.error("updateCountersOnAmbiguousResp","Exception e:"+e.getMessage());
        }
        finally
        {
        	LogFactory.printLog(METHOD_NAME,"Exited printNodeVO:"+printNodeVO(p_nodeVO),log);
        }
    ...
    public synchronized void resetCounters(NodeVO p_nodeVO)
    {
        ...
        {
            log.errorTrace("Exception",e);
            log.error("resetCounters","Exception e:"+e.getMessage());
        }
        finally
        {
        	LogFactory.printLog(METHOD_NAME,"Exited printNodeVO:"+printNodeVO(p_nodeVO),log);
