...
public class NodeCloser 
{
	...
	{
		String METHOD_NAME="checkExpiry";
		if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"Entered p_nodeVO:"+p_nodeVO);
		...
		try
		{
			...
			{
				_log.error(METHOD_NAME,"Interface Suspended.");
				throw new BTSLBaseException(this,METHOD_NAME,InterfaceErrorCodesI.INTERFACE_SUSPENDED);
			}        		
			long currentRequestTime=System.currentTimeMillis();
			_log.error(METHOD_NAME,"IcurrentRequestTime = " +currentRequestTime);
			...
			{
				_log.error(METHOD_NAME,"Interface Suspended and expiry time has not been expired.So not sending request to IN");
				throw new BTSLBaseException(this,METHOD_NAME,InterfaceErrorCodesI.INTERFACE_SUSPENDED);
			}
		}
		...
		{
			if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"Exited isSuspensionExpired:"+isSuspensionExpired);
		}        
	}
	...
	{
		String METHOD_NAME="updateCountersOnAmbiguousResp";
		if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"Entered printNodeVO:"+printNodeVO(p_nodeVO));   
		try
		{
		...
		{
			if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"Exited printNodeVO:"+printNodeVO(p_nodeVO));
		}
	}
	/**
	...
	{
		String METHOD_NAME="resetCounters";
		if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"Entered printNodeVO:"+printNodeVO(p_nodeVO));
		try
		{
			if(p_nodeVO.isSuspended())
