package com.inter.cs5omg.cs5scheduler;
...
public class NodeScheduler
{
	...
	private Hashtable<String,NodeVO> _nodeTable = null;//Conatins the node number as Key and VO as nod detail
	...
	{
		String METHOD_NAME="NodeScheduler[constructor]";
		if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"Entered p_cs3INId::"+p_cs3INId);
		...
		try
		{
			...
			try
			{
				...
				if(_log.isDebugEnabled())_log.debug(METHOD_NAME,"MAX_NODE::"+_totalNodes);
			}
			catch(Exception e)
			{
				_log.errorTrace(METHOD_NAME,e);
				EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "check the value of MAX_NODE in IN File Exception e::"+e.getMessage());
			...
			try
			{
				...
				if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"MAX_ALWD_NO::"+_maxAllowedNum);
			}
			catch(Exception e)
			{
				_log.errorTrace(METHOD_NAME,e);
				EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of MAX_ALWD_NO in INFile Exception e::"+e.getMessage());
				throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
			}
			try
			{
				_retryNum = Integer.parseInt(FileCache.getValue(p_cs3INId,"RETRY_NUM").trim());
				if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"RETRY_NUM::"+_retryNum);
			}
			catch(Exception e)
			{
				_log.errorTrace(METHOD_NAME,e);
				EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of RETRY_NUM in INFile Exception e::"+e.getMessage());
				throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
			}
			try
			{
				...
				{
					EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "HEADER_HOST_NAME is not defined into IN File");
					throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
				}
				if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"HEADER_HOST_NAME::"+_headerHostName);
			}
			catch(Exception e)
			{
				_log.errorTrace(METHOD_NAME,e);
				EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "check the value of HEADER_HOST_NAME in IN File Exception e::"+e.getMessage());
				throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
			}
			try
			{
				...
				{
					EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "HOST_NAME is not defined into IN File");
					throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
				}
				if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"HOST_NAME::"+_hostName);
			}
			catch(Exception e)
			{
				_log.errorTrace(METHOD_NAME,e);
				EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "check the value of HOST_NAME in IN File Exception e::"+e.getMessage());
				throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
			}
			try
			{
				...
				if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"USER_AGENT::"+_userAgent);
			}
			catch(Exception e)
			{
				_log.errorTrace(METHOD_NAME,e);
				EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.MAJOR, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "check the value of USER_AGENT in IN File Exception e::"+e.getMessage());
			}
			...
			for(int l=1;l<=_totalNodes;l++)
			{
				try
				{
					...
					if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"url_"+l+"::"+url);
					if(InterfaceUtil.isNullString(url))
					{
						EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of URL_"+l +" in INFile "+p_cs3INId);
						throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}   
					...
					try
					{
						...
						if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"CONN_TIMEOUT_"+l+"::"+connectionTimeOut);
						cs3NodeVO.setConnectionTimeOut(connectionTimeOut);
					}
					catch(Exception e)
					{
						_log.errorTrace(METHOD_NAME,e);
						EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of CONN_TIMEOUT_"+l +" in INFile "+p_cs3INId);
						throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{
						maxConPerNode = Integer.parseInt(FileCache.getValue(p_cs3INId,"MAX_CON_NODE_"+l).trim());
						if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"MAX_CON_NODE_"+l+"::"+maxConPerNode);
						cs3NodeVO.setMaxConPerNode(maxConPerNode);
					}
					catch(Exception e)
					{
						_log.errorTrace(METHOD_NAME,e);
						EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "check the value of MAX_CON_NODE_"+l+" for interface id p_cs3INId ::"+p_cs3INId);
						throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{
						...
						if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"VAL_READ_TIMEOUT_"+l+"::"+readTimeOutVal);
						cs3NodeVO.setValReadTimeOut(readTimeOutVal);
					}
					catch(Exception e)
					{
						_log.errorTrace(METHOD_NAME,e);
						EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of VAL_READ_TIMEOUT_"+l +" in INFile "+p_cs3INId);
						throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{
						...
						if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"TOP_READ_TIMEOUT_"+l+"::"+readTimeOutTop);
						cs3NodeVO.setTopReadTimeOut(readTimeOutTop);
					}
					catch(Exception e)
					{
						_log.errorTrace(METHOD_NAME,e);
						EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of TOP_READ_TIMEOUT_"+l +" in INFile "+p_cs3INId);
						throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{
						...
						if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"WARN_TIME_"+l+"::"+readTimeOutVal);
						cs3NodeVO.setWarnTime(warnTime);
					}
					catch(Exception e)
					{
						_log.errorTrace(METHOD_NAME,e);
						EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of WARN_TIME_"+l +" in INFile "+p_cs3INId);
						throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{
						String expiryTimeStr = FileCache.getValue(p_cs3INId,"EXPIRY_TIME_"+l).trim();
						if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"EXPIRY_TIME_"+l+"::"+expiryTimeStr);
					...
					{
						_log.errorTrace(METHOD_NAME,e);
						EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of EXPIRY_TIME_"+l +" in INFile "+p_cs3INId);
						throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{ 
						keepAlive = FileCache.getValue(p_cs3INId,"KEEP_ALIVE_"+l).trim();
						if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"KEEP_ALIVE_"+l+"::"+keepAlive);
						cs3NodeVO.setKeepAlive(keepAlive);
					}
					catch(Exception e)
					{
						_log.errorTrace(METHOD_NAME,e);
						EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of KEEP_ALIVE_"+l +" in INFile "+p_cs3INId);
						throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{ 
						userName = FileCache.getValue(p_cs3INId,"USERNAME_"+l).trim();
						if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"USERNAME_"+l+"::"+userName);
						cs3NodeVO.setUsername(userName);
					}
					catch(Exception e)
					{
						_log.errorTrace(METHOD_NAME,e);
						EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of USERNAME_"+l +" in INFile "+p_cs3INId);
						throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					try
					{ 
						password = FileCache.getValue(p_cs3INId,"PASSWORD_"+l).trim();
						if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"PASSWORD_"+l+"::"+password);
						cs3NodeVO.setPassword(password);
					}
					catch(Exception e)
					{
						_log.errorTrace(METHOD_NAME,e);
						EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "", "Check the value of PASSWORD_"+l +" in INFile "+p_cs3INId);
						throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
					}
					...
					if(InterfaceUtil.isNullString(numberOfAmbguousTxnAllowedStr)|| !InterfaceUtil.isNumeric(numberOfAmbguousTxnAllowedStr.trim()))
					{
						...
						EventHandler.handle(EventIDI.SYSTEM_ERROR,EventComponentI.INTERFACES,EventStatusI.RAISED,EventLevelI.FATAL,METHOD_NAME,"","_interfaceID:"+_interfaceID,"","NO_ALLWD_AMB_TXN is either not defined in the INFile or its value is not numeric");
					...
					if(InterfaceUtil.isNullString(thresholdTimeStr)||!InterfaceUtil.isNumeric(thresholdTimeStr.trim()))
					{
						...
						EventHandler.handle(EventIDI.SYSTEM_ERROR,EventComponentI.INTERFACES,EventStatusI.RAISED,EventLevelI.FATAL,METHOD_NAME,"","_interfaceID:"+_interfaceID,"","THRESHOLD_TIME is either not defined in the INFile or its value is not numeric");
						throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_INIT_INTERFACE_CLOSER);
					}
				...
				{
					_log.errorTrace(METHOD_NAME,e);
					EventHandler.handle(EventIDI.INTERFACE_REQUEST_EXCEPTION, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, METHOD_NAME, "INTERFACE_ID::"+_interfaceID,"", "","Exception while initializing the Node details of interfaceID = "+p_cs3INId +" Exception e="+e.getMessage());
					throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_INITIALIZATION);
				}
			}
		}
		...
		{
			if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"Exiting _nodeTable::"+_nodeTable);
		}
	}
	...
	public synchronized NodeVO getNodeVO(String p_transId) throws BTSLBaseException
	{
		...
		{
			if(_log.isDebugEnabled()) _log.debug("getNodeVO",p_transId,"Exited cs3NodeVO::"+cs3NodeVO);
		}
		return cs3NodeVO;
	}
	...
	{
		String METHOD_NAME="getNode";
		if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,p_transId,"Entered p_transId::"+p_transId);
		boolean isNext=true;
		String nodeNumStr=null;
		NodeVO cs3NodeVO=null;
		int tempCount=1;
		...
		try
		{
			...
			while(isNext)
			{
				try
				{
					...
					if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,p_transId,"tempCount::"+tempCount);
					...
					if(!cs3NodeVO.isBlocked())
					{
						if(cs3NodeVO.getConNumber()>cs3NodeVO.getMaxConPerNode())
						{
							...
							//throw new BTSLBaseException(this,METHOD_NAME,"MAX ALLOWED CONNECTION FOR NODE IS REACHED");
							incrementNodeNumber();
							continue; 
						}
					...
					if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,p_transId,"NodeNumber ["+_nodeNumber+"] is blocked"+ "p_transId::"+p_transId);
					...
					_log.info(METHOD_NAME,p_transId,"Node number ::"+_nodeNumber+" of interfaceID::"+_interfaceID+"is blocked and its expiry is not reached");
					incrementNodeNumber();
				}
				catch(BTSLBaseException be)
				{
				...
				catch(Exception e)
				{
					...
					_log.errorTrace(METHOD_NAME,e);
					_log.error(METHOD_NAME,p_transId,"_interfaceID"+_interfaceID+" p_transId ::"+p_transId+" Exception e::"+e.getMessage());
					if(connIncremented)
		...
		{
			_log.error(METHOD_NAME,p_transId,"p_transId::"+p_transId+" BTSLBaseException  be::"+be.getMessage());
			throw be;
		}
		catch(Exception e)
		{
			...
			_log.error(METHOD_NAME,p_transId,"p_transId::"+p_transId+" Exception e::"+e.getMessage());
			throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_SCHEDULING);
		}
		finally
		{
			if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,p_transId,"Exited nodeNumStr::"+nodeNumStr);
		}
		return nodeNumStr;
	}
	...
	public boolean isExpired(long p_blockedAt,long p_expiryDuration)throws BTSLBaseException
	{
		...
		if(_log.isDebugEnabled()) _log.debug(METHOD_NAME,"Entered p_blockedAt::"+p_blockedAt+" p_expiryDuration::"+p_expiryDuration);
		boolean isExp=false;
		try
		{
			long currentTime = System.currentTimeMillis();
			if(_log.isDebugEnabled())_log.debug(METHOD_NAME,"currentTime::"+currentTime);
		...
		{
			_log.errorTrace(METHOD_NAME,e);
			_log.error(METHOD_NAME,"While checking the expiry of blocked node get the Exception e::"+e.getMessage());
			throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_CS3_NODE_SCHEDULING);
		}
		finally
		{
			if(_log.isDebugEnabled())_log.debug(METHOD_NAME,"isExp::"+isExp);
		}
		return isExp;
	}
