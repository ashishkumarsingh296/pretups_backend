 ...
 * Logger class for Voucher Management System to log the ambiguous or failed
 * voucher request in to the log.
 */
...
public class VoucherAmbiFailStatusLog {

    private static Log _log = LogFactory.getFactory().getInstance(VoucherAmbiFailStatusLog.class.getName());
