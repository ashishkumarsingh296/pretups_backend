 ...
 *                               when a corresponding URL is submitted through
 *                               browser.
 */
...
public class ZTEINPoolLoaderServlet extends HttpServlet {
    ...
    public void destroy() {
        ...
        String poolIDs = Constants.getProperty("ZTEETHIO_POOL_IN_IDS");
    ...
    public void initialize() {
        ...
        try {
            ...
            poolINIDs = Constants.getProperty("ZTEETHIO_POOL_IN_IDS");
