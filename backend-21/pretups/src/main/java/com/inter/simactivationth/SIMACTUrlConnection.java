 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class SIMACTUrlConnection extends BTSLConnection {
    private HttpURLConnection _urlConnection = null;

    public SIMACTUrlConnection(String p_url, int p_connectTimeout, int p_readTimeout, String p_keepAlive, long p_contentLength) throws Exception {
        if (_log.isDebugEnabled())
            _log.debug("SIMACTUrlConnection", "Entered p_url: " + p_url + "p_connecttimeout=" + p_connectTimeout + " p_readtimeout=" + p_readTimeout + " p_keepAlive=" + p_keepAlive);
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug("SIMACTUrlConnection", "Exception " + e.getMessage());
            throw e;
        }
        if (_log.isDebugEnabled())
            _log.debug("SIMACTUrlConnection", "Exiting");
    }
