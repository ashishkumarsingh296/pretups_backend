...
public class ZTEONIINHandler implements InterfaceHandler {
    private Log _log = LogFactory.getLog(ZTEONIINHandler.class.getName());
    ...
    public void validate(HashMap p_requestMap) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            if (InterfaceUtil.isNullString(multFactor)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[validate]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "MULT_FACTOR  is not defined in the INFile");
            ...
            try {
                ...
                String amountWaData = (String) _responseMap.get("resp_Balance_wadata");
                // amountWaData=InterfaceUtil.getSystemAmountFromINAmount(amountWaData,Double.parseDouble(multFactor));
                if (("PRC".equals(serviceType)) && "S".equals(_userType) && "2".equals((String) p_requestMap.get("CARD_GROUP_SELECTOR"))) {
                    if (!InterfaceUtil.isNullString((String) _responseMap.get("resp_Balance_wadata"))) {
                        amountWaData = InterfaceUtil.getSystemAmountFromINAmount(amountWaData, Double.parseDouble(multFactor));
                        _requestMap.put("INTERFACE_PREV_BALANCE", amountWaData);
                        _requestMap.put("WADATA_BDL_BALID", amountStr);
                    } else {
                    ...
                    _requestMap.put("WADATA_BDL_BALID", "0");
                }
            } catch (Exception e) {
                e.printStackTrace();
                _log.error("validate", "Exception e:" + e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[validate]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "Balance obtained from the IN is not numeric, while parsing the Balance get Exception e:" + e.getMessage());
            ...
            e.printStackTrace();
            _log.error("validate", "Exception e:" + e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[validate]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "While validating the subscriber get the Exception e:" + e.getMessage());
            throw new BTSLBaseException(this, "validate", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled())
    ...
    public void credit(HashMap p_requestMap) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _referenceID = (String) _requestMap.get("TRANSACTION_ID");
            _msisdn = (String) _requestMap.get("MSISDN");
            cardGrpSelectorCode = (String) _requestMap.get("CARD_GROUP_SELECTOR");
            ...
            if (InterfaceUtil.isNullString(multFactor)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[credit]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "MULT_FACTOR  is not defined in the INFile");
            ...
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[credit]", "REFERENCE ID = " + _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "INTERFACE_AMOUNT  is not Numeric");
                throw new BTSLBaseException(this, "credit", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
            if (_log.isDebugEnabled())
            ...
            try {
                ...
                _log.error("credit", "Exception e:" + e.getMessage());
                e.printStackTrace();
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[credit]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "credit balance from response is not numeric or multiplication factor defined in the INFile is not Numeric, Exception e:" + e.getMessage());
                throw new BTSLBaseException(this, "credit", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
            ...
            try {
                ...
                e.printStackTrace();
                _log.error("credit", "Exception e:" + e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[credit]", _referenceID, _msisdn, (String) _requestMap.get("NETWORK_CODE"), "Exception while processing ambiguous case in credit");
                throw new BTSLBaseException(this, "credit", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
        } catch (Exception e) {
            e.printStackTrace();
            _log.error("credit", "Exception e:" + e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[credit]", _referenceID, _msisdn, (String) _requestMap.get("NETWORK_CODE"), "While credit get the Exception e:" + e.getMessage());
            throw new BTSLBaseException(this, "credit", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled())
    ...
    public void creditAdjust(HashMap p_requestMap) throws BTSLBaseException, Exception {
         ...
         * factor, and recieved balance would be devided by this factor.
         * String multFactor = FileCache.getValue(_interfaceID,"MULT_FACTOR");
         * if(_log.isDebugEnabled())_log.debug("creditAdjust","multFactor: "+
         * multFactor);
         * if(InterfaceUtil.isNullString(multFactor))
         * {
         * _log.error("credit","MULT_FACTOR  is not defined in the INFile");
         ...
         * "ZTEONIINHandler[credit]",_referenceID,_msisdn
         * +" INTERFACE ID = "+_interfaceID, (String)
         * _requestMap.get("NETWORK_CODE"),
         * "MULT_FACTOR  is not defined in the INFile");
         * throw new BTSLBaseException(this,"credit",InterfaceErrorCodesI.
         ...
         * multFactorDouble=Double.parseDouble(multFactor);
         * interfaceAmtDouble =
         * InterfaceUtil.getINAmountFromSystemAmountToIN(interfaceAmtDouble
         * ,multFactorDouble);
         * }
         * else
         * {
         * String
         * selectorBundleType=(String)_requestMap.get("SELECTOR_BUNDLE_TYPE");
         ...
         * multFactor=FileCache.getValue(_interfaceID,"UNIT_MULT_FACTOR");
         * //Convert the amount in amount according to the selector.
         * interfaceAmtDouble=InterfaceUtil.getINAmountFromSystemAmountToIN(
         * interfaceAmtDouble,Double.parseDouble(multFactor.trim()));
         * }
         * }
         * //Change the amount in to string.
         * amountStr=String.valueOf(interfaceAmtDouble);
         ...
         * "ZTEONIINHandler[credit]",_referenceID+"MSISDN = "+_msisdn
         * ," INTERFACE ID = "+_interfaceID, "Network code = "+(String)
         * _requestMap.get("NETWORK_CODE"),
         * "ROUND_FLAG is not defined in IN File hence system taken the default value=N."
         * );
         * }
         ...
         * EventHandler.handle(EventIDI.SYSTEM_ERROR,
         * EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL,
         * "ZTEONIINHandler[credit]","REFERENCE ID = "+_referenceID,_msisdn
         * +" INTERFACE ID = "+_interfaceID, (String)
         * _requestMap.get("NETWORK_CODE"), "INTERFACE_AMOUNT  is not Numeric");
         * throw new BTSLBaseException(this,"creditAdjust",InterfaceErrorCodesI.
         * INTERFACE_HANDLER_EXCEPTION);
         * }
         * if(_log.isDebugEnabled())
         ...
         * _requestMap.put("transfer_amount",amountStr);
         * String requestStr =
         * _formatter.generateRequest(ZTEONII.ACTION_RECHARGE_CREDIT
         * ,_requestMap);
         * //sending the Re-charge request to IN along with re-charge action
         * defined in SafcomI interface
         * sendRequestToIN(ZTEONII.ACTION_RECHARGE_CREDIT,requestStr);
         ...
         * String postBalanceStr = (String) _responseMap.get("resp_Balance");
         * postBalanceStr =
         * InterfaceUtil.getSystemAmountFromINAmount(postBalanceStr
         * ,multFactorDouble);
         * _requestMap.put("INTERFACE_POST_BALANCE",postBalanceStr);
         * }
         * }
         ...
         * +" INTERFACE ID = "+_interfaceID, (String)
         * _requestMap.get("NETWORK_CODE"),
         * "credit balance from response is not numeric or multiplication factor defined in the INFile is not Numeric, Exception e:"
         * +e.getMessage());
         * throw new BTSLBaseException(this,"creditAdjust",InterfaceErrorCodesI.
         * INTERFACE_HANDLER_EXCEPTION);
         * }
         ...
         * if(cardGrpSelectorCode.equals("1"))
         * {
         * //Set the value of NEW_EXPIRY_DATE as the value of end_val_date from
         * responseMap, after converting the format as per interface
         * _requestMap.put("NEW_EXPIRY_DATE",
         * InterfaceUtil.getInterfaceDateFromDateString((String)
         * _responseMap.get("resp_ExpDate"), "yyyy/MM/dd"));
         ...
         * catch (BTSLBaseException be)
         * {
         * p_requestMap.put("AMBGUOUS_TIME",InterfaceUtil.
         * getTimeWhenAmbiguousCaseOccured());
         ...
         * EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[credit]",
         ...
         * EventHandler.handle(EventIDI.SYSTEM_ERROR,
         * EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL,
         * "ZTEONIINHandler[credit]",_referenceID,_msisdn, (String)
         * _requestMap.get("NETWORK_CODE"),
         * "While credit get the Exception e:"+e.getMessage());
         * throw new BTSLBaseException(this,"creditAdjust",InterfaceErrorCodesI.
         * INTERFACE_HANDLER_EXCEPTION);
         * }
         * finally
         * {
         * if (_log.isDebugEnabled()) _log.debug("creditAdjust",
    ...
    public void debitAdjust(HashMap p_requestMap) throws BTSLBaseException, Exception {
        ...
        double multFactorDouble = 0;
        String amountStr = null;
        String accessFee = null;
        double acesFee = 0;
        String wadataBal = null;
        double wadataBalLng = 0;
        String previousBal = null;
        double previousBalLng = 0;
        _requestMap = p_requestMap;
        String cardGrpSelectorCode = null;
        try {
            _interfaceID = (String) _requestMap.get("INTERFACE_ID");
            ...
            if (InterfaceUtil.isNullString(multFactor)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[debitAdjust]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "MULT_FACTOR  is not defined in the INFile");
            ...
            try {
                // amountStr=(String)_requestMap.get("INTERFACE_AMOUNT");
                amountStr = (String) _requestMap.get("REQUESTED_AMOUNT");
                multFactorDouble = Double.parseDouble(multFactor);
                interfaceAmtDouble = Double.parseDouble(amountStr);

                // Added by Narendra Kumar for access fee calculation 19/9/13

                accessFee = (String) _requestMap.get("ACCESS_FEE");
                acesFee = Double.parseDouble(accessFee);
                wadataBal = (String) _requestMap.get("WADATA_BDL_BALID");
                wadataBalLng = Double.parseDouble(wadataBal);

                previousBal = (String) _requestMap.get("INTERFACE_PREV_BALANCE");
                previousBalLng = Double.parseDouble(previousBal);

                // End

                if ("1".equals(cardGrpSelectorCode)) {
                    interfaceAmtDouble = InterfaceUtil.getINAmountFromSystemAmountToIN(interfaceAmtDouble, multFactorDouble);
                    acesFee = InterfaceUtil.getINAmountFromSystemAmountToIN(acesFee, multFactorDouble);
                } else {
                    String selectorBundleType = (String) _requestMap.get("SELECTOR_BUNDLE_TYPE");
                    if (!InterfaceUtil.isNullString(selectorBundleType)) {
                        if ("AMT".equals(selectorBundleType))
                        ...
                        acesFee = InterfaceUtil.getINAmountFromSystemAmountToIN(acesFee, Double.parseDouble(multFactor.trim()));
                        wadataBalLng = InterfaceUtil.getINAmountFromSystemAmountToIN(wadataBalLng, multFactorDouble);
                        previousBalLng = InterfaceUtil.getINAmountFromSystemAmountToIN(previousBalLng, multFactorDouble);
                    }
                }
                // Change the amount in to string.
                amountStr = String.valueOf(interfaceAmtDouble);
                accessFee = String.valueOf(acesFee);
                ...
                if (InterfaceUtil.isNullString(roundFlag)) {
                    roundFlag = "Y";
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.MINOR, "ZTEONIINHandler[debitAdjust]", _referenceID + "MSISDN = " + _msisdn, " INTERFACE ID = " + _interfaceID, "Network code = " + (String) _requestMap.get("NETWORK_CODE"), "ROUND_FLAG is not defined in IN File hence system taken the default value=Y.");
                }
                // If rounding of amount is allowed, round the amount value and
                // put this value in request map.
                if ("Y".equals(roundFlag.trim())) {
                    amountStr = String.valueOf(Math.round(interfaceAmtDouble));
                    accessFee = String.valueOf(Math.round(acesFee));
                    _requestMap.put("INTERFACE_ROUND_AMOUNT", amountStr);
                    _requestMap.put("SENDER_ACCESS_FEES", accessFee);
                }
            } catch (Exception e) {
                e.printStackTrace();
                _log.error("debitAdjust", "Exception e:" + e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[debitAdjust]", "REFERENCE ID = " + _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "INTERFACE_AMOUNT  is not Numeric");
                throw new BTSLBaseException(this, "debitAdjust", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
            if (_log.isDebugEnabled())
                _log.debug("debitAdjust", "transfer_amount:" + amountStr + "aceess_fees" + accessFee);
            // set transfer_amount in request map as amountStr (which is round
            // value of INTERFACE_AMOUNT)
            _requestMap.put("transfer_amount", amountStr);
            _requestMap.put("access_fees", accessFee);
            if ("2".equals(cardGrpSelectorCode)) {
                if (acesFee > wadataBalLng)
                    throw new BTSLBaseException(this, "debitAdjust", InterfaceErrorCodesI.P2P_MAIN_BALANCE_LESS);
                ;
                if (interfaceAmtDouble > previousBalLng)
                    throw new BTSLBaseException(this, "debitAdjust", InterfaceErrorCodesI.P2P_WADATA_BALANCE_LESS);
                ;
            }
            ...
            try {
                ...
                _log.error("debitAdjust", "Exception e:" + e.getMessage());
                e.printStackTrace();
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[debitAdjust]", _referenceID, _msisdn + " INTERFACE ID = " + _interfaceID, (String) _requestMap.get("NETWORK_CODE"), "balance from response is not numeric or multiplication factor defined in the INFile is not Numeric, Exception e:" + e.getMessage());
                throw new BTSLBaseException(this, "debitAdjust", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
            // Set the value of NEW_EXPIRY_DATE as the value of end_val_date
            ...
            try {
                ...
                e.printStackTrace();
                _log.error("debitAdjust", "Exception e:" + e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[debitAdjust]", _referenceID, _msisdn, (String) _requestMap.get("NETWORK_CODE"), "Exception while processing ambiguous case in debitAdjust");
                throw new BTSLBaseException(this, "debitAdjust", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
            }
        } catch (Exception e) {
            e.printStackTrace();
            _log.error("debitAdjust", "Exception e:" + e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[debitAdjust]", _referenceID, _msisdn, (String) _requestMap.get("NETWORK_CODE"), "While debitAdjust get the Exception e:" + e.getMessage());
            throw new BTSLBaseException(this, "debitAdjust", InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled())
    ...
    private void sendRequestToIN(int p_action, String p_requestStr) throws BTSLBaseException {
        ...
        try {
            ...
            try {
                ...
                if (call == null) {
                    EventHandler.handle(EventIDI.INTERFACE_INVALID_RESPONSE, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[sendRequestToIN]", "REFERENCE ID = " + _referenceID + "MSISDN = " + _msisdn, "INTERFACE ID = " + _interfaceID, "Network code = " + (String) _requestMap.get("NETWORK_CODE") + " Action = " + p_action, "Unable to get Client Object");
            ...
            if (p_action == ZTEONII.ACTION_ACCOUNT_INFO && ZTEONII.RESULT_OK.equals(status)) {
                String stateSet = (String) _responseMap.get("resp_stateSet");
                ...
                if (stateSet.charAt(0) != 48) {
                    EventHandler.handle(EventIDI.INTERFACE_INVALID_RESPONSE, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[sendRequestToIN]", "REFERENCE ID = " + _referenceID + "MSISDN = " + _msisdn, "INTERFACE ID = " + _interfaceID, "Network code = " + (String) _requestMap.get("NETWORK_CODE") + " Action = " + p_action, " Subscriber has applied for the block.");
                ...
                // INTERFACE_OPERATOR_FORCED_BLOCK will be thrown.
                    ...
                    EventHandler.handle(EventIDI.INTERFACE_INVALID_RESPONSE, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[sendRequestToIN]", "REFERENCE ID = " + _referenceID + "MSISDN = " + _msisdn, "INTERFACE ID = " + _interfaceID, "Network code = " + (String) _requestMap.get("NETWORK_CODE") + " Action = " + p_action, " Operator forced block.");
                    _log.error("sendRequestToIN", "Subscriber has applied for the block. StateSet Received from IN=" + stateSet);
                ...
                // INTERFACE_SIM_LOSS_BLOCk will be thrown.
                    ...
                    EventHandler.handle(EventIDI.INTERFACE_INVALID_RESPONSE, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[sendRequestToIN]", "REFERENCE ID = " + _referenceID + "MSISDN = " + _msisdn, "INTERFACE ID = " + _interfaceID, "Network code = " + (String) _requestMap.get("NETWORK_CODE") + " Action = " + p_action, " Recharge not allowed due to SIM loss.");
    ...
    public void setInterfaceParameters(int p_action) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            if (InterfaceUtil.isNullString(cancelTxnAllowed)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "CANCEL_TXN_ALLOWED is not defined in the INFile.");
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingCr)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_CREDIT is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingCrAdj)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_CREDIT_ADJ is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingDbtAdj)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_DEBIT_ADJ is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(systemStatusMappingCrBck)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "SYSTEM_STATUS_MAPPING_CREDIT_BCK is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(cancelCommandStatusMapping)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "CANCEL_COMMAND_STATUS_MAPPING is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(cancelNA)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "CANCEL_NA is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(userId)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "USER_NAME is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(passwd)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "PASSWORD is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(authHeader)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "AUTH_HEADER is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(zteNameSpace)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "ZTE_NAMESPACE is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(uri)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "SOAP_ACTION_URI is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(endPt)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "END_POINT is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(operationName)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "OPERATION_NAME is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(channelId)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", _referenceID, "INTERFACE ID" + _interfaceID + " MSISDN " + _msisdn, (String) _requestMap.get("NETWORK_CODE"), "CHANNEL_ID is not defined in the INFile.");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
            ...
            if (InterfaceUtil.isNullString(warnTimeStr) || !InterfaceUtil.isNumeric(warnTimeStr)) {
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[setInterfaceParameters]", "REFERENCE ID = " + _referenceID + "MSISDN = " + _msisdn, " INTERFACE ID = " + _interfaceID, "Network code " + (String) _requestMap.get("NETWORK_CODE"), "WARN_TIMEOUT is not defined in IN File or not numeric");
                throw new BTSLBaseException(this, "setInterfaceParameters", InterfaceErrorCodesI.ERROR_CONFIG_PROBLEM);
            }
    ...
    private void setLanguageFromMapping() throws Exception {
        ...
        try {
            ...
            if (mappingNotFound)
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.MAJOR, "ZTEONIINHandler[setLanguageFromMapping]", _referenceID, _msisdn, (String) _requestMap.get("NETWORK_CODE"), "Mapping for language received from IN =  " + langFromIN + " is not defined in IN file Hence setting the Default language");
            ...
            EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.MAJOR, "ZTEONIINHandler[setLanguageFromMapping]", _referenceID, _msisdn, (String) _requestMap.get("NETWORK_CODE"), "while setting the language mapping get Exception=" + e.getMessage());
        }// end of catch-Exception
        finally {
            if (_log.isDebugEnabled())
    ...
    protected String getINTransactionID(HashMap p_map) {
        ...
        // Added By Narendra
        System.out.println(" @@@_interfaceID " + _interfaceID);
        chnlId = FileCache.getValue(_interfaceID, "CHNL_ID");
        if (InterfaceUtil.isNullString(chnlId)) {
            _log.error("validate", "Mapping of Channel ID " + chnlId + " is not defined in the INFile");
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ZTEONIINHandler[validate]", "", "", chnlId, "Mapping of Channel ID " + chnlId + " is not defined in the INFile");
        }
        // inTxnId=chnlId+inTxnId.substring(3,inTxnId.length());
        inTxnId = chnlId + inTxnId.substring(1, inTxnId.length());
        ...
        if (!InterfaceUtil.isNullString(userType))
            ...
            // inReconID=inTxnId+userType.trim();
            if ("S".equalsIgnoreCase(userType.trim()))
                inReconID = inTxnId + "1"; // for Sender
            else
                inReconID = inTxnId + "2"; // for Receiver
