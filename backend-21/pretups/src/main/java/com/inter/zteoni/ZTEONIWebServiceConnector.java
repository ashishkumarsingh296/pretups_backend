...
/**
 * @(#)ZTEONIWebServiceConnector.java
...
public class ZTEONIWebServiceConnector {

    private Log _log = LogFactory.getLog(ZTEONIWebServiceConnector.class.getName());

    public ZTEONIWebServiceConnector() {
    }
