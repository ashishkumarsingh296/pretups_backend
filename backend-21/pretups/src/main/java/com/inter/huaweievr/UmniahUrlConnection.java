...
public class UmniahUrlConnection extends BTSLConnection {
     ...
     * @throws Exception
     */
    public UmniahUrlConnection(String p_url, int p_connecttimeout, int p_readtimeout, String p_keepAlive) throws Exception {
        if (_log.isDebugEnabled())
            _log.debug("UmniahUrlConnection", "Entered p_url: " + p_url + "p_connecttimeout=" + p_connecttimeout + " p_readtimeout=" + p_readtimeout + " p_keepAlive=" + p_keepAlive);
        try {
            ...
            e.printStackTrace();
            _log.error("UmniahUrlConnection", "Exception " + e.getMessage());
            throw e;
        }
        if (_log.isDebugEnabled())
            _log.debug("UmniahUrlConnection", "Exiting");
    }
