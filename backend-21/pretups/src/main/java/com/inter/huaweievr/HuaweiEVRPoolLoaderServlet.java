...
/**
 * @(#)HuaweiEVRPoolLoaderServlet.java
...
public class HuaweiEVRPoolLoaderServlet extends HttpServlet {
    private Log _log = LogFactory.getLog(HuaweiEVRPoolLoaderServlet.class.getName());
    private HuaweiEVRPoolManager _poolManager = null;
    private HuaweiEVRHeartBeatController _huaweiHeartController = null;

    /**
     * Constructor of the object.
     */
    public HuaweiEVRPoolLoaderServlet() {
        super();
    }
    ...
    public void initialize() {
        ...
        try {
            _poolManager = new HuaweiEVRPoolManager();
            ...
            if (!InterfaceUtil.isNullString(poolINIDs)) {
                ...
                _huaweiHeartController = new HuaweiEVRHeartBeatController(poolINIDs);
            }
    ...
    public void initialize(String p_interfaceId) {
        ...
        try {
            ...
            if (!InterfaceUtil.isNullString(p_interfaceId)) {
                ...
                _huaweiHeartController = new HuaweiEVRHeartBeatController(p_interfaceId);
            }
        } catch (BTSLBaseException be) {
            _log.error("initialize", "BTSLBaseException be::" + be.getMessage());
        } catch (Exception e) {
