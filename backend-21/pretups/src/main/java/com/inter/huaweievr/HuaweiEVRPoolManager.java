 ...
 *                               ----------------------------------------------
 *                               --
 *                               This class will manage the pool.
 */
...
public class HuaweiEVRPoolManager {
    private static Log _log = LogFactory.getLog(HuaweiEVRPoolManager.class.getName());
    ...
    public static HashMap _busyBucket = new HashMap();// Contains the list of
                                                      ...
                                                      // objects,associated with
                                                      // interface id.
    private static HuaweiEVRHeartBeatController _huaweiHeartBeatController = null;
        ...
        try {
            ...
            for (int i = 0, size = inStrArray.length; i < size; i++) {
                ...
                try {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiEVRPoolManager[initialize]", "", "", "", "While instantiation of the Client objects MAX_POOL_SIZE/POOL_SLEEP is either not defined or not numeric, in the INFile");
                    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_OBJECT_POOL_INITIALIZATION);
                }
                ...
                for (int loop = 0; loop < poolSize; loop++) {
                    try {
                        ...
                        e.printStackTrace();
                        _log.error("initialize", "Exception e:" + e.getMessage());
                        EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiEVRPoolManager[initialize]", "", "", "", "While instantiation of the Client objects got the Exception " + e.getMessage());
                        throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_OBJECT_POOL_INITIALIZATION);
                    }
                }// end of for loop
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiEVRPoolManager[initialize]", "String of interface ids=" + p_interfaceIDs, "", "", "While initializing the instance of Client Object for the INTERFACE_ID =" + interfaceId + " get Exception=" + e.getMessage());
     ...
     * @throws Exception
     */
    public static synchronized HuaweiEVRSocketWrapper getClientObject(String p_interfaceID, boolean p_module) throws BTSLBaseException {
        if (_log.isDebugEnabled())
            _log.debug("getClientObject", "Entered p_interfaceID::" + p_interfaceID + " p_module:" + p_module);
        HuaweiEVRSocketWrapper clientObject = null;
        ...
        try {
            if (_freeBucket.isEmpty() || !_freeBucket.containsKey(p_interfaceID)) {
                ...
                // EventLevelI.FATAL,
                // "HuaweiEVRPoolManager[getClientObject]","INTERFACE_ID="+p_interfaceID,
                // "","",
                ...
                _huaweiHeartBeatController = new HuaweiEVRHeartBeatController(p_interfaceID);
                // throw new
                // BTSLBaseException("HuaweiEVRPoolManager[getClientObject]",InterfaceErrorCodesI.ERROR_OBJECT_POOL_INITIALIZATION);
            }
            ...
            if (freeList == null) {
                ...
                if (!_isPoolInitializing && ((System.currentTimeMillis() / 1000) - _lastPoolInitializationTime) > poolInitializationTimeLong) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "HuaweiEVRPoolManager[getClientObject]", "INTERFACE_ID=" + p_interfaceID, "", "", "Pool Container is Null for interface Id =" + p_interfaceID + " Hence reinitialized the Pool: last Initiazation time:" + _lastPoolInitializationTime);
                }
                _log.error("getClientObject", "POOL Container(Vector list) is NULL for the interface id:" + p_interfaceID);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "HuaweiEVRPoolManager[getClientObject]", "INTERFACE_ID=" + p_interfaceID, "", "", "While getting the the instance of ClintObject for the interfaceID =" + p_interfaceID + "POOL contains no object for the p_interfaceID:" + p_interfaceID);
                throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_OBJECT_POOL_INITIALIZATION);
            }
            ...
            if (listSize == 0) {
                try {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiEVRPoolManager[getClientObject]", "INTERFACE_ID=" + p_interfaceID, "", "", "While getting the retry attempt[SLEEP_TIME, C2S_RETRY_ATTEMPT and P2P_RETRY_ATTEMPT] for interface id=" + p_interfaceID + " get Exception=" + e.getMessage());
                    throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_FETCH_CLIENT_OBJECT);
                }
            ...
            if (listSize == 0) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "HuaweiEVRPoolManager[getClientObject]", "INTERFACE_ID=" + p_interfaceID, "", "", "While getting the retry attempt[SLEEP_TIME, C2S_RETRY_ATTEMPT and P2P_RETRY_ATTEMPT] for interface id=" + p_interfaceID + " POOL does not contain any free objects");
            ...
            clientObject = (HuaweiEVRSocketWrapper) freeList.remove(0);
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiEVRPoolManager[getClientObject]", "INTERFACE_ID=" + p_interfaceID, "", "", "While getting the the instance of ClintObject for the interfaceID =" + p_interfaceID + " get Exception=" + e.getMessage());
     ...
     * @throws BTSLBaseException
     */
    public static synchronized HuaweiEVRSocketWrapper getNewClientObject(String p_interfaceID) throws BTSLBaseException {
        if (_log.isDebugEnabled())
            _log.debug("getNewClientObject", "p_interfaceID::" + p_interfaceID);
        HuaweiEVRSocketWrapper huaweiEVRSocketWrapper = null;
        try {
            huaweiEVRSocketWrapper = new HuaweiEVRSocketWrapper(p_interfaceID);
        } catch (BTSLBaseException be) {
            throw be;
        } catch (Exception e) {
            e.printStackTrace();
            _log.error("getNewClientObject", "Exception e::" + e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiEVRPoolManager[getNewClientObject]", "INTERFACEID:" + p_interfaceID, "", "", "While getting the instance of Client objects got the Exception " + e.getMessage());
            throw new BTSLBaseException(InterfaceErrorCodesI.ERROR_GETTIN_NEW_CLIENT_OBJECT);
        } finally {
            if (_log.isDebugEnabled())
                _log.debug("getNewClientObject", "Exiting HuaweiEVRSocketWrapper:" + huaweiEVRSocketWrapper);
        }
        return huaweiEVRSocketWrapper;
    }
    ...
    public void destroy(String p_interfaceId) {
        ...
        try {
                            ...
                            try {
                                ...
                                if (objectList != null) {
                                    ...
                                    for (int i = 0; i < size; i++) {
                                        HuaweiEVRSocketWrapper socketWrapper = (HuaweiEVRSocketWrapper) objectList.get(i);
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.INTERFACES, EventStatusI.RAISED, EventLevelI.FATAL, "HuaweiEVRPoolManager[destroy]", "", "", "", "While destorying the Client objects got the Exception " + e.getMessage());
        }// end of catch-Exception
        finally {
            if (_log.isDebugEnabled())
