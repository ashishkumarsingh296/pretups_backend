...
public class UserTxnPostgresQry implements UserTxnQry{
	...
	public StringBuilder loadUsersDetailsByLoginId() {
        ...
        strBuff.append(" users PRNT_USR right outer join users USR on (USR.parent_id=PRNT_USR.user_id) left outer join  categories  PRNT_CAT on (PRNT_USR.category_code=PRNT_CAT.category_code),users ONR_USR,categories USR_CAT, ");
