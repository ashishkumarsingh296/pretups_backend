...
public class SubscriberTxnPostgresQry implements SubscriberTxnQry{
	@Override
	public String loadBuddyDetailsByScheduleTypeQry(){
        ...
        selectQueryBuff.append(" WHERE date_trunc('day',batch.schedule_date::TIMESTAMP) <= date_trunc('day',CURRENT_TIMESTAMP::TIMESTAMP)");
        ...
        selectQueryBuff.append(" AND batch.execution_count < batch.no_of_schedule::integer");
