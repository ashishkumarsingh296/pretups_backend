...
public class LoyaltyTxnPostgresQry implements LoyaltyTxnQry{
...
@Override
	public String loadLMSProfileAndVersionQry(String plmsProfileServiceType)
	{
        ...
        selectQueryBuff.append(" WHERE (applicable_from=(SELECT MAX(applicable_from) FROM PROFILE_SET_VERSION WHERE applicable_from<=current_timestamp and psv.applicable_to>=current_timestamp ");
