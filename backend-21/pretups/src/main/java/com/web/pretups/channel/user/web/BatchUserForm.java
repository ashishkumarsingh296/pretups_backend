 ...
 * ------------------------------------------------------------------------------
 * --
 * Amit Ruwali July 13, 2006 Initial creation
 * ------------------------------------------------------------------------------
 * --
...
public class BatchUserForm  {
    ...
    /**
     * @return Returns the geographyStr.
     */
    public String getGeographyStr() {
        return _geographyStr;
    }

    /**
     * @param geographyStr
     *            The geographyStr to set.
     */
    public void setGeographyStr(String geographyStr) {
        _geographyStr = geographyStr;
    }
