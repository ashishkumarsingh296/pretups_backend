...
public class FOCBatchForm {
    ...
    private String _thirdApprovedOn = null;
   ...
   // private FormFile _file;
    ...
    private int _focOrderApprovalLevel = 0;
    ...
    private ArrayList _focBatchItemVOList = null;
    ...
    //added for online/offline record count
    private int _recordCount = 0;
    private boolean offlineUploadFormOnline = false;
    ...
    // Lohit added for direct payout
    private ArrayList _bonusTypeList = null;
    private String _bonusType = null;
    // added for offline or online
    ...
    private List<ListValueVO> _walletTypeList = null;
	...
	private int _validRecordCount = 0;
	
	private boolean _fileExits = false;
	
	public boolean getFileExists() {
		return _fileExits;
	}
	
	public void setFileExists(boolean var) {
		_fileExits =  var;
	}
	
	public int getValidRecordCount() {
		return _validRecordCount;
	}
	public void setValidRecordCount(int totalRecords) {
		_validRecordCount = totalRecords;
	}
     ...
     */
    public ArrayList getFocBatchItemVOList() {
        return _focBatchItemVOList;
    }
     ...
     */
    public void setFocBatchItemVOList(ArrayList focBatchItemVOList) {
        _focBatchItemVOList = focBatchItemVOList;
    }
    ...
    private ArrayList _focBatchMasterVOList = null;

    /**
     * @return Returns the focBatchMasterVOList.
     */
    public ArrayList getFocBatchMasterVOList() {
        return _focBatchMasterVOList;
    }

    /**
     * @param focBatchMasterVOList
     *            The focBatchMasterVOList to set.
     */
    public void setFocBatchMasterVOList(ArrayList focBatchMasterVOList) {
        _focBatchMasterVOList = focBatchMasterVOList;
    }
...
//    public void setFile(FormFile file) {
  ...
  //  }
    ...
    public void setFocOrderApprovalLevel(int focOrderApprovalLevel) {
        _focOrderApprovalLevel = focOrderApprovalLevel;
    }
    ...
    public void flush() {
        ...
        _thirdApprovedBy = null;
        _thirdApprovedOn = null;
        _cancelledBy = null;
        _cancelledOn = null;
        _rcrdStatus = null;
        _geographyCode = null;
    ...
    public int getFocBatchMasterVOListSize() {
        if (_focBatchMasterVOList != null && !_focBatchMasterVOList.isEmpty()) {
            return _focBatchMasterVOList.size();
        }
        return 0;
    }
    ...
    public void setWalletTypeList(List<ListValueVO> walletTypeList) {
        this._walletTypeList = walletTypeList;
    }
    ...
    public void setRecordCount(int recordTotal) {
        this._recordCount = recordTotal;
    }
    
    public boolean getOfflineUploadFormOnline() {
        return offlineUploadFormOnline;
    }

    public void setOfflineUploadFormOnline(boolean offlineUploadFormOnline) {
        this.offlineUploadFormOnline = offlineUploadFormOnline;
    }
