...
public class VomsVoucherWebPostgresQry implements VomsVoucherWebQry {
	@Override
	public String loadBatchLogListQry(){
		final StringBuilder sqlSelectBuf = new StringBuilder(
            ...
            sqlSelectBuf.append(" va.status_change_source STATCHSRC, va.batch_no, coalesce( va.message,'') MESSAGE, ");
	...
	public String getVomsVoucherListQry(String tablename){
           ...
           sqlSelectBuf.append(" FROM " + tablename + " where serial_no BETWEEN ? and ? ");
           sqlSelectBuf.append(" and sale_batch_no=? order by serial_no");
           return sqlSelectBuf.toString();
	}
	...
	public String selectVouchersOnSaleNo(String tablename) {
         ...
         sqlSelectBuf.append(" FROM " + tablename + " where serial_no::bigint BETWEEN ? and ? ");
         sqlSelectBuf.append(" and sale_batch_no=? order by  serial_no::bigint ");
		return sqlSelectBuf.toString();
	}
