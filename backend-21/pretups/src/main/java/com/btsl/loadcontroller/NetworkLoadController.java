                    ...
                    if (isSameSecRequest) {
                        if (networkLoadVO.getNoOfRequestSameSec() < networkLoadVO.getCurrentTPS()) {
                            ...
                            if (_log.isDebugEnabled()) {
                            	...
                            	msg.append("Request in Same Second and is not within the allowed limit=");
                            	msg.append(networkLoadVO.getCurrentTPS());
                            	msg.append(" Current =");
                            	msg.append(networkLoadVO.getNoOfRequestSameSec());
                            	msg.append(" , Refusing the request");
                            	
                            	String message=msg.toString();
                                _log.debug("checkNetworkLoad", message);
                            }
                        ...
                        if (isSameSecRequest) {
                            if (networkLoadVO.getNoOfRequestSameSec() < networkLoadVO.getCurrentTPS()) {
                                if (_log.isDebugEnabled()) {
                                	...
                                	String message=msg.toString();
                                    _log.debug("checkSystemNetworkLoad", message);
                                }
