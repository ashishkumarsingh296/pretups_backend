 ...
 *        SUMMARY <br/>
 * <br/>
 *        This is a set of meethods for validating input. Functions are provided
 *        to validate: <br/>
 ...
 *        - remove from a string characters which are/are not in a "bag" of
 *        selected characters <br/>
 *        - strip whitespace/leading whitespace from a string <br/>
 * <br/>
 *        ======================================================================
 *        ======== <br/>
 *        NOTE: This code was adapted from the Netscape JavaScript form
 *        validation code, <br/>
 *        usually found in "FormChek.js". Credit card verification functions
 *        Originally
 *        <br< included as Starter Application 1.0.0 in LivePayment. <br/>
 *        ======================================================================
 *        ========
 */
...
public class UtilValidate {
    ...
    private static Log _log = LogFactory.getLog(UtilValidate.class.getName());
     ...
     * Member whitespace(see above) defines which characters are considered
     * whitespace.
     */
    /**
     * @param s
    ...
    public static String stripInitialWhitespace(String s) {
        int i = 0;
     int   sLength = s.length();
        while ((i < sLength) && charInString(s.charAt(i), whitespace)) {
            i++;
        }
    ...
    public static boolean isSignedInteger(String s) {
        ...
        final String METHOD_NAME = "isSignedInteger";
        try {
            Integer.parseInt(s);
            return true;
        } catch (Exception e) {
    ...
    public static boolean isSignedLong(String s) {
        ...
        final String METHOD_NAME = "isSignedLong";
        try {
            Long.parseLong(s);
            return true;
        } catch (Exception e) {
    ...
    public static boolean isPositiveInteger(String s) {
        ...
        final String METHOD_NAME = "isPositiveInteger";
        try {
            final long temp = Long.parseLong(s);
    ...
    public static boolean isNonnegativeInteger(String s) {
        ...
        final String METHOD_NAME = "isNonnegativeInteger";
        try {
    ...
    public static boolean isNegativeInteger(String s) {
        ...
        final String METHOD_NAME = "isNegativeInteger";
        try {
            final int temp = Integer.parseInt(s);
    ...
    public static boolean isNonpositiveInteger(String s) {
        ...
        final String METHOD_NAME = "isNonpositiveInteger";
        try {
            final int temp = Integer.parseInt(s);
    ...
    public static boolean isFloat(String s, boolean allowNegative, boolean allowPositive, int minDecimal, int maxDecimal) {
        ...
        final String METHOD_NAME = "isFloat";
        try {
            ...
            final String floatString = Float.toString(temp);
            final int decimalPoint = floatString.indexOf(".");
            if (decimalPoint == -1) {
                if (minDecimal > 0) {
                    return false;
                }
            ...
            final int numDecimals = floatString.length() - decimalPoint;
    ...
    public static boolean isDouble(String s, boolean allowNegative, boolean allowPositive, int minDecimal, int maxDecimal) {
        ...
        final String METHOD_NAME = "isDouble";
        try {
            ...
            final String doubleString = Double.toString(temp);
            final int decimalPoint = doubleString.indexOf(".");
            if (decimalPoint == -1) {
                if (minDecimal > 0) {
                    return false;
                }
            ...
            // 1.2345; length=6; point=1; num=4
            final int numDecimals = doubleString.length() - decimalPoint;
            if (minDecimal >= 0 && numDecimals < minDecimal) {
                return false;
            }
            if (maxDecimal >= 0 && numDecimals > maxDecimal) {
    ...
    public static boolean isSignedFloat(String s) {
        ...
        final String METHOD_NAME = "isSignedFloat";
        try {
            Float.parseFloat(s);
            return true;
        } catch (Exception e) {
    ...
    public static boolean isSignedDouble(String s) {
        ...
        final String METHOD_NAME = "isSignedDouble";
        try {
    ...
    public static boolean isSSN(String s) {
        ...
        final String normalizedSSN = stripCharsInBag(s, SSNDelimiters);
    ...
    public static boolean isUSPhoneNumber(String s) {
        ...
        final String normalizedPhone = stripCharsInBag(s, phoneNumberDelimiters);
    ...
    public static boolean isZipCode(String s) {
        ...
        final String normalizedZip = stripCharsInBag(s, ZipCodeDelimiters);
    ...
    public static boolean isContiguousZipCode(String s) {
        ...
        if (isZipCode(s)) {
            if (isEmpty(s)) {
                ...
                final String normalizedZip = s.substring(0, 5);
                final int iZip = Integer.parseInt(normalizedZip);
    ...
    public static boolean isEmail(String s, boolean requireDot) {
        ...
        final int atSymbolIndex = s.indexOf('@');
        ...
        if (requireDot) {
            ...
            if (dotIndex < atSymbolIndex + 2) {
                return false; // nothing between @ and .
            }
            if (dotIndex == s.length() - 1) {
                return false; // . is last character
            }
        }
    ...
    public static boolean isDate(String date) {
        ...
        final int dateSlash1 = date.indexOf("/");
        final int dateSlash2 = date.lastIndexOf("/");
    ...
    public static boolean isDateAfterToday(String date) {
        ...
        final String METHOD_NAME = "isDateAfterToday";
        final int dateSlash1 = date.indexOf("/");
        final int dateSlash2 = date.lastIndexOf("/");
        ...
        if (dateSlash1 == dateSlash2) {
            ...
            final String month = date.substring(0, dateSlash1);
            final String day = "28";
            final String year = date.substring(dateSlash1 + 1);
            ...
            final String month = date.substring(0, dateSlash1);
            final String day = date.substring(dateSlash1 + 1, dateSlash2);
            final String year = date.substring(dateSlash2 + 1);
            if (!isDate(year, month, day)) {
                return false;
                // passed = UtilDateTime.toDate(month, day, year, "0", "0",
                // "0");
            }
        }
    ...
    public static boolean isTime(String time) {
        ...
        final int timeColon1 = time.indexOf(":");
        final int timeColon2 = time.lastIndexOf(":");
    ...
    public static boolean isValueLinkCard(String stPassed) {
        ...
        final String st = stripCharsInBag(stPassed, creditCardDelimiters);
    ...
    public static int getLuhnCheckDigit(String stPassed) {
        final int sum = getLuhnSum(stPassed);
        final int mod = ((sum / 10 + 1) * 10 - sum) % 10;
        return (10 - mod);
    }
    ...
    public static String appendCheckDigit(String stPassed) {
        final String checkDigit = new Integer(getLuhnCheckDigit(stPassed)).toString();
    ...
    public static boolean isMasterCard(String cc) {
        final int firstdig = Integer.parseInt(cc.substring(0, 1));
        final int seconddig = Integer.parseInt(cc.substring(1, 2));
    ...
    public static boolean isDiscover(String cc) {
        final String first4digs = cc.substring(0, 4);
    ...
    public static boolean isJCB(String cc) {
        ...
        if ((cc.length() == 16) && ("3088".equals(first4digs) || "3096".equals(first4digs) || "3112".equals(first4digs) || "3158".equals(first4digs) || "3337"
            .equals(first4digs) || "3528".equals(first4digs))) {
            return isCreditCard(cc);
        }
        return false;
    }
    ...
    public static boolean isAnyCard(String ccPassed) {
        ...
        final String cc = stripCharsInBag(ccPassed, creditCardDelimiters);
    ...
    public static boolean isCardMatch(String cardType, String cardNumberPassed) {
        ...
        final String cardNumber = stripCharsInBag(cardNumberPassed, creditCardDelimiters);

        if (("VISA".equalsIgnoreCase(cardType)) && (isVisa(cardNumber))) {
            return true;
        }
        if (("MASTERCARD".equalsIgnoreCase(cardType)) && (isMasterCard(cardNumber))) {
            return true;
        }
        if ((("AMERICANEXPRESS".equalsIgnoreCase(cardType)) || ("AMEX".equalsIgnoreCase(cardType))) && (isAmericanExpress(cardNumber))) {
            return true;
        }
        if (("DISCOVER".equalsIgnoreCase(cardType)) && (isDiscover(cardNumber))) {
            return true;
        }
        if (("JCB".equalsIgnoreCase(cardType)) && (isJCB(cardNumber))) {
            return true;
        }
        if ((("DINERSCLUB".equalsIgnoreCase(cardType)) || ("DINERS".equalsIgnoreCase(cardType))) && (isDinersClub(cardNumber))) {
            return true;
        }
        if (("CARTEBLANCHE".equalsIgnoreCase(cardType)) && (isCarteBlanche(cardNumber))) {
            return true;
        }
        if (("ENROUTE".equalsIgnoreCase(cardType)) && (isEnRoute(cardNumber))) {
            return true;
        }
        return false;
    }
