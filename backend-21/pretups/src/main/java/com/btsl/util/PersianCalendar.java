...
public class PersianCalendar {
	...
	final static String monthNamesShort[] = {"Far", "Ord", "Kho", "Tir", "Mor", "Sha", "Meh", "Aba", "Aza", "Day", "Bah", "Esf"};
	...
	public String getIranianDate() {
		return BTSLUtil.getTwoDigit(irYear) + PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(irMonth) + PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(irDay);
	}
	 ...
	 * @return
	 */
	public String getIranianDate(String dateFormat) {
		String format = BTSLUtil.getTrimmedValue(dateFormat);
		if(PretupsI.DATE_FORMAT_DDMMYYYY.equalsIgnoreCase(format)) {
			return BTSLUtil.getTwoDigit(irDay) + PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(irMonth) + 
					PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(irYear);
		} else if(PretupsI.DATE_FORMAT_YYMMDD.equalsIgnoreCase(format)) {
			return BTSLUtil.getTwoDigit(irYear).substring(2) + PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(irMonth) + 
					PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(irDay);
		} else if(PretupsI.DATE_FORMAT_DDMMYY.equalsIgnoreCase(format)) {
			return BTSLUtil.getTwoDigit(irDay) + PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(irMonth) + 
					PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(irYear).substring(2);
		} else if(PretupsI.DATE_FORMAT_DDMMYYYY_HYPHEN.equalsIgnoreCase(format)) {
			return BTSLUtil.getTwoDigit(irDay) + PretupsI.HYPHEN + BTSLUtil.getTwoDigit(irMonth) + 
					PretupsI.HYPHEN + BTSLUtil.getTwoDigit(irYear);
		}  else if(PretupsI.DATE_FORMAT_DDMMYY_HYPHEN.equalsIgnoreCase(format)) {
			return BTSLUtil.getTwoDigit(irDay) + PretupsI.HYPHEN + BTSLUtil.getTwoDigit(irMonth) + 
					PretupsI.HYPHEN + BTSLUtil.getTwoDigit(irYear).substring(2);
		} else if(PretupsI.DATE_FORMAT_YYYYMMDD_HYPHEN.equalsIgnoreCase(format)) {
			return BTSLUtil.getTwoDigit(irYear) + PretupsI.HYPHEN + BTSLUtil.getTwoDigit(irMonth) + 
					PretupsI.HYPHEN + BTSLUtil.getTwoDigit(irDay);
		} else if(PretupsI.DATE_FORMAT_YYMMDD_HYPHEN.equalsIgnoreCase(format)) {
			return BTSLUtil.getTwoDigit(irYear).substring(2) + PretupsI.HYPHEN + BTSLUtil.getTwoDigit(irMonth) + 
					PretupsI.HYPHEN + BTSLUtil.getTwoDigit(irDay);
		} else if(PretupsI.DATE_FORMAT_YYYYMMDD.equalsIgnoreCase(format)) {
			return BTSLUtil.getTwoDigit(irYear) + PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(irMonth) + 
					PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(irDay);
		} else if(PretupsI.DATE_FORMAT_DDMMYY_WOSEPARATOR.equalsIgnoreCase(format)) {
			return BTSLUtil.getTwoDigit(irDay) + BTSLUtil.getTwoDigit(irMonth) + BTSLUtil.getTwoDigit(irYear).substring(2);
		} else if(PretupsI.DATE_FORMAT_YYMMDD_WOSEPARATOR.equalsIgnoreCase(format)) {
			return BTSLUtil.getTwoDigit(irYear).substring(2) + BTSLUtil.getTwoDigit(irMonth) + BTSLUtil.getTwoDigit(irDay);
		}
		return BTSLUtil.getTwoDigit(irYear) + PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(irMonth) + 
				PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(irDay);
	}
	...
	public String getGregorianDate() {
		String gregorianDate = PretupsI.EMPTY;
		/*return (BTSLUtil.getTwoDigit(gYear) + PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(gMonth) + 
				PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(gDay));*/
		try {
			gregorianDate = BTSLDateUtil.getStringDateInDDMMYY(BTSLUtil.getTwoDigit(gDay) + PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(gMonth) + 
					PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(gYear));
	...
	public String getJulianDate() {
		return (BTSLUtil.getTwoDigit(juYear) + PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(juMonth)
				+ PretupsI.FORWARD_SLASH + BTSLUtil.getTwoDigit(juDay));
	}
