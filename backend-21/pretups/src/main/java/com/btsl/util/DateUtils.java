...
/**
 *  Utility to compare two dates values
 * @author tarun.kumar
 *
 */
public class DateUtils {

	 private static Log _log = LogFactory.getLog(DateUtils.class.getName());	 
	 public static final String Msg = "The dates must not be null";
