...
public class C2SRoamRechargeReversalController extends C2SBaseController implements ServiceKeywordControllerI, Runnable {

    private static Log _log = LogFactory.getLog(C2SRoamRechargeReversalController.class.getName());
    ...
    static {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "C2SRoamRechargeReversalController[initialize]", "",
                "", "", "Exception while loading the class at the call:" + e.getMessage());
        }
    }

    public C2SRoamRechargeReversalController() {
        ...
        try {
            ...
            if (!_receiverVO.getSubscriberType().equals(_type)) {
                ...
                if (_networkPrefixVO != null) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "C2SRoamRechargeReversalController[process]", "",
                        "", "",
            ...
            try {
                ...
                throw new BTSLBaseException("C2SRoamRechargeReversalController", "process", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            }
            ...
            if (((Boolean) PreferenceCache.getSystemPreferenceValue(PreferenceI.SKEY_REQUIRED)).booleanValue()) {
                ...
                if(mcomCon != null){mcomCon.close("C2SRoamRechargeReversalController#process");mcomCon=null;}
                con = null;
            ...
            /*if((Boolean)PreferenceCache.getNetworkPrefrencesValue(PreferenceI.TARGET_BASED_COMMISSION,_c2sTransferVO.getNetworkCode()) && _c2sTransferVO.isOtfCountsDecreased())
			{
					...
					try {
						...
						_log.error(METHOD_NAME, "Exception:e=" + e1);
						_log.errorTrace(METHOD_NAME, e1);
					}
		
			}*/
            // raising alarm
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "C2SRoamRechargeReversalController[process]",
            ...
            try {
                ...
                _log.error(METHOD_NAME, "Exception:" + e.getMessage());
                _log.errorTrace(METHOD_NAME, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "C2SRoamRechargeReversalController[process]",
                    _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            }
    ...
    private void processSKeyGen(Connection p_con) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _log.error(METHOD_NAME, "Exception:" + e.getMessage());
            _log.errorTrace(METHOD_NAME, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "C2SRoamRechargeReversalController[processSKeyGen]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException("C2SRoamRechargeReversalController", "processSKeyGen", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
    ...
    public void processTransfer(Connection p_con) throws BTSLBaseException {
        ...
        try {
            ...
            _c2sTransferVO.setTransferStatus(PretupsErrorCodesI.TXN_STATUS_FAIL);
            _c2sTransferVO.setErrorCode(PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "C2SRoamRechargeReversalController[processTransfer]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException("C2SRoamRechargeReversalController", "processTransfer", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
    ...
    public void run() {
        ...
        try {
            ...
            if (_log.isDebugEnabled()) {
                _log.debug("run", _transferID, "Got the response from IN Module receiverCreditResponse=" + receiverCreditResponse + " ,Old Txn Id=" + _c2sTransferVO
                    .getOldTxnId());
            }
            ...
            if (PretupsI.YES.equals(_c2sTransferVO.getDifferentialAllowedForService()) && PretupsI.YES.equals(_c2sTransferVO.getDifferentialGiven())) {
                ...
                try {
                	...
                	if((Boolean)PreferenceCache.getNetworkPrefrencesValue(PreferenceI.TARGET_BASED_COMMISSION,_c2sTransferVO.getNetworkCode()) && adjustmentsVO.getOtfTypePctOrAMt()!=null )
        			{
                    ...
                    if (_log.isDebugEnabled()) {
                        _log.debug(
                            "C2SRoamRechargeReversalController",
                            "For _transferID=" + _transferID + " Diff applicable=" + _c2sTransferVO.getDifferentialApplicable() + " Diff Given=" + _c2sTransferVO
                                .getDifferentialGiven() + " Not able to give Diff commission getting BTSL Base Exception=" + be.getMessage() + " Leaving transaction status as Under process" + " ,Old Txn Id=" + _c2sTransferVO
                                .getOldTxnId());
                    }
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "C2SRoamRechargeReversalController[run]",
                    ...
                    if (_log.isDebugEnabled()) {
                        _log.debug(
                            "C2SRoamRechargeReversalController",
                            "For _transferID=" + _transferID + " Diff applicable=" + _c2sTransferVO.getDifferentialApplicable() + " Diff Given=" + _c2sTransferVO
                                .getDifferentialGiven() + " Not able to give Diff commission getting Exception=" + e.getMessage() + " Leaving transaction status as Under process" + " ,Old Txn Id=" + _c2sTransferVO
                                .getOldTxnId());
                    }
                }
                if(mcomCon != null){mcomCon.close("C2SRoamRechargeReversalController#run");mcomCon=null;}
                con = null;
             ...
             * {
             * diffCalBL=new DiffCalBL();
             * diffBonusList=diffCalBL.loadDifferentialBonusCalculationsReversal(
             * con, _c2sTransferVO, PretupsI.C2S_MODULE);
             * }
             * catch(BTSLBaseException be)
             * {
             * _log.error(METHOD_NAME, "Exception:"+ be.getMessage());
             ...
             * _finalTransferStatusUpdate=false;
             * if(_log.isDebugEnabled())
             * _log.debug("C2SRoamRechargeReversalController"
             * ,"For _transferID="+
             * _transferID+" Diff applicable="+_c2sTransferVO
             * .getDifferentialApplicable
             * ()+" Diff Given="+_c2sTransferVO.getDifferentialGiven()
             * +" Not able to give Diff commission getting BTSL Base Exception="
             * +be.getMessage()+" Leaving transaction status as Under process"+
             * " ,Old Txn Id="+_c2sTransferVO.getOldTxnId());
             * EventHandler.handle(EventIDI.SYSTEM_INFO,EventComponentI.SYSTEM,
             * EventStatusI
             * .RAISED,EventLevelI.MAJOR,"C2SRoamRechargeReversalController[run]"
             * ,_c2sTransferVO.getTransferID(),_c2sTransferVO.getSenderMsisdn(),
             * _c2sTransferVO.getNetworkCode(),"Exception:"+be.getMessage());
             * }
             * catch(Exception e)
             * {
             * _log.error(METHOD_NAME, "Exception:"+ e.getMessage());
             ...
             * .getDifferentialApplicable
             * ()+" Diff Given="+_c2sTransferVO.getDifferentialGiven()
             * +" Not able to give Diff commission getting Exception="
             * +e.getMessage
             * ()+" Leaving transaction status as Under process"+" ,Old Txn Id="
             * +_c2sTransferVO.getOldTxnId());
             * }
             * try {con.close();} catch(Exception e) {
             * _log.error(METHOD_NAME, "Exception:"+ e.getMessage());
             * _log.errorTrace(METHOD_NAME, e);
             * throw new
             * BTSLBaseException("C2SRoamRechargeReversalController","process"
            ...
            if (_log.isDebugEnabled()) {
                _log.debug("C2SRoamRechargeReversalController",
                    "For _transferID=" + _transferID + " Diff applicable=" + _c2sTransferVO.getDifferentialApplicable() + " Diff Given=" + _c2sTransferVO
                        .getDifferentialGiven() + " ,Old Txn Id=" + _c2sTransferVO.getOldTxnId());
            }
        }// end try
        catch (BTSLBaseException be) {
            _log.error(METHOD_NAME, "BTSLException:" + be.getMessage());
            ...
            if (_c2sTransferVO.getSenderReturnMessage() == null) {
                _c2sTransferVO.setSenderReturnMessage(PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            }
            if (_log.isDebugEnabled()) {
                _log.debug("run", _transferID, "Error Code:" + _c2sTransferVO.getErrorCode() + " ,Old Txn Id=" + _c2sTransferVO.getOldTxnId());
            }
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "{C2SRoamRechargeReversalController[run]", _transferID,
            ...
            try {
                ...
                if (_finalTransferStatusUpdate) {
                     ...
                     * updateCount=ChannelUserBL.creditUserBalanceForProductReversal
                     * (con,_transferID,_c2sTransferVO);
                     * }
                     * }
                     */
                ...
                if (updateCount > 0) {
                    ...
                    // changes done to handle bonus i.e promo commission.
                    /*
                     * if(_finalTransferStatusUpdate && diffBonusList!=null &&
                     * diffBonusList.size()>0)
                     * {
                     * try{
                     * updateCount=0;
                     * diffCalBL=new DiffCalBL();
                     * ((AdjustmentsVO)diffBonusList.get(0)).setSubService(
                     * _c2sTransferVO.getSelectorCode());
                     * updateCount=diffCalBL.differentialBonusAdjustmentForReversal
                     * (con,_c2sTransferVO,diffBonusList);
                     * }catch (Exception e) {
                     * _log.error(METHOD_NAME, "Exception:"+ e.getMessage());
                     * _log.errorTrace(METHOD_NAME, e);
        ...
        if (!InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(status) || isRequired) {
            ...
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                    "C2SRoamRechargeReversalController[updateForReceiverValidateResponse]", _transferID, _senderMSISDN, _senderNetworkCode,
            ...
            if (!InterfaceErrorCodesI.SUCCESS.equals(status)) {
                ...
                throw new BTSLBaseException("C2SRoamRechargeReversalController", "updateForReceiverValidateResponse", _c2sTransferVO.getErrorCode(), 0, strArr, null);
            }
            try {
            ...
            // Done so that receiver check can be brought to common
    ...
    public void updateForReceiverDebitResponse(String str) throws BTSLBaseException {
        ...
        if (_log.isDebugEnabled()) {
            _log.debug("updateForReceiverCreditResponse",
                "Mape from response=" + map + " status=" + status + " interface Status=" + interfaceStatusType + " ,Old Txn Id=" + _c2sTransferVO.getOldTxnId());
        }
        if (!BTSLUtil.isNullString(interfaceStatusType) && (InterfaceCloserI.INTERFACE_SUSPEND.equals(interfaceStatusType) || InterfaceCloserI.INTERFACE_RESUME
            .equals(interfaceStatusType))) {
            new ResumeSuspendProcess(ResumeSuspendProcess._INTERFACES, _receiverTransferItemVO.getInterfaceID(), interfaceStatusType,
        ...
        if (!BTSLUtil.isNullString((String) map.get("IN_TXN_ID"))) {
            try {
                ...
                _log.errorTrace(METHOD_NAME, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                    "C2SRoamRechargeReversalController[updateForReceiverCreditResponse]", _transferID, _senderMSISDN, _senderNetworkCode,
                    "Exception while parsing for interface txn ID , Exception:" + e.getMessage());
            }
        }
    ...
    public void populateServiceInterfaceDetails(Connection p_con, String action) throws BTSLBaseException {
        ...
        if (!isReceiverFound) {
            throw new BTSLBaseException("C2SRoamRechargeReversalController", "populateServiceInterfaceDetails", PretupsErrorCodesI.C2S_ERROR_NOTFOUND_SERVICEINTERFACEMAPPING);
        }
    }
    ...
    private void checkTransactionLoad() throws BTSLBaseException {
        ...
        if (_log.isDebugEnabled()) {
            _log.debug("checkTransactionLoad", "Checking load for transfer ID=" + _transferID + " ,Old Txn Id=" + _c2sTransferVO.getOldTxnId());
        }
        ...
        try {
            ...
            if (recieverLoadStatus == 0) {
                ...
                if (_log.isDebugEnabled()) {
                    _log.debug("C2SRoamRechargeReversalController[checkTransactionLoad]", "_transferID=" + _transferID + " Successfully through load");
                }
            }
            // Request in Queue
                ...
                throw new BTSLBaseException("C2SRoamRechargeReversalController", "checkTransactionLoad", PretupsErrorCodesI.REQUEST_IN_QUEUE, 0, strArr, null);
            }
            // Refuse the request
            else {
                throw new BTSLBaseException("C2SRoamRechargeReversalController", "checkTransactionLoad", PretupsErrorCodesI.REQUEST_REFUSE_FROM_INTLOAD);
            }
        } catch (BTSLBaseException be) {
            _log.errorTrace(METHOD_NAME, be);
            _log.error("C2SRoamRechargeReversalController[checkTransactionLoad]", "Refusing request getting Exception:" + be.getMessage());
            throw be;
        } catch (Exception e) {
            _log.errorTrace(METHOD_NAME, e);
            _log.error("C2SRoamRechargeReversalController[checkTransactionLoad]", "Refusing request getting Exception:" + e.getMessage());
            throw new BTSLBaseException("C2SRoamRechargeReversalController", "checkTransactionLoad", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        }
    }
    ...
    private void processValidationRequest() throws BTSLBaseException, SQLException {
        ...
        try {
            ...
            if (_log.isDebugEnabled()) {
                _log.debug("processValidationRequest", _transferID, "validation response from IN Module receiverValResponse=" + receiverValResponse);
            }
            ...
            if (!BTSLUtil.isNullString(receiverValResponse)) {
                ...
                if (index != -1) {
                    ...
                    if ( _status!=null && !_status.equals("null") &&!(_status.equals(null))) {
                        if (!(_status.equalsIgnoreCase(PretupsI.SUBSCRIBER_STATUS))) {
                            ...
                            throw new BTSLBaseException("C2SRoamRechargeReversalController", "processValidationRequest", PretupsErrorCodesI.SUBSCRIBER_NOT_ACTIVE);
                        }
                    }
                    else 
                    {
                    	_log.debug("processValidationRequest", _transferID, "Didn't get the subscriber status from the IN");
                        throw new BTSLBaseException("C2SRoamRechargeReversalController", "processValidationRequest", PretupsErrorCodesI.C2S_ERROR_EXCEPTION_BALANCE_PARAM_NOT_PRESENT);
                    }
                } else {
                    _log.debug("processValidationRequest", _transferID, "Didn't get the subscriber status from the IN");
                    throw new BTSLBaseException("C2SRoamRechargeReversalController", "processValidationRequest",
                ...
                throw new BTSLBaseException("C2SRoamRechargeReversalController", "processValidationRequest", PretupsErrorCodesI.C2S_ERROR_EXCEPTION_NO_RESP_FROM_IN);
            }
            ...
            if (balance < 0) {
                ...
                final String[] messageArgArray = { _transferID, _receiverMSISDN }; // ,PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()),_channelUserVO.getUserName(),_requestVO.getPosUserMSISDN()};
                ...
                throw new BTSLBaseException("C2SRoamRechargeReversalController", "processValidationRequest", PretupsErrorCodesI.C2S_ERROR_EXCEPTION_INSUF_BALANCE,
                    messageArgArray);
            }
           ...
           /* _c2sTransferVO.setPenalty(c2sVOForBalance.getPenalty());
            ...
            if (c2sVOForBalance == null) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                    "C2SRoamRechargeReversalController[processValidationRequest]", "", "", "", "Records not found in transfers table For Transfer ID =" + _c2sTransferVO
                        .getOldTxnId());
                if(mcomCon != null){mcomCon.close("C2SRoamRechargeReversalController#processValidationRequest");mcomCon=null;}
                throw new BTSLBaseException("C2SRoamRechargeReversalController", "processValidationRequest", PretupsErrorCodesI.EVD_TRANSACTION_DETAILS_NOT_FOUND);
            }// end _reversalAmount
            ...
            if (reversalAllowed.equals(PretupsI.NO)) {
                _log.error("C2SRoamRechargeReversalController", "The operator does not allow to reverse this transaction");
                throw new BTSLBaseException("C2SRoamRechargeReversalController", "processValidationRequest", PretupsErrorCodesI.REVERSAL_NOT_ALLOWED_CARDGROUP);
            ...
            if (balance >= thresholdBalance) {
            	long senderReturnValue=c2sVOForBalance.getTransferValue();  
	           	  ...
	           	  {
	           		   //senderReturnValue=balance.longValue();
	              ...
	              if (balance >= c2sVOForBalance.getReceiverTransferValue()) {
	               ...
	               //_receiverTransferItemVO.setPreviousBalance(balance.longValue());
            ...
            if (_log.isDebugEnabled()) {
                _log.debug("processValidationRequest", _transferID, "Got the validation response from IN Module receiverValResponse=" + receiverValResponse);
            }
            ...
            if ((System.currentTimeMillis() - _c2sTransferVO.getRequestStartTime()) > interfaceVO.getValExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                    "C2SRoamRechargeReversalController[processValidationRequest]", _transferID, _senderMSISDN, _senderNetworkCode,
                    "Exception: System is taking more time till validation");
                throw new BTSLBaseException("C2SRoamRechargeReversalController", "processValidationRequest", PretupsErrorCodesI.C2S_ERROR_EXCEPTION_TKING_TIME_TILL_VAL);
            }
            if (mcomCon == null) {
            	mcomCon = new MComConnection();con=mcomCon.getConnection();
            }
            ...
            if ((System.currentTimeMillis() - _c2sTransferVO.getRequestStartTime()) > interfaceVO.getTopUpExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "C2SRoamRechargeReversalController[run]",
                    _transferID, _senderMSISDN, _senderNetworkCode, "Exception: System is taking more time till topup");
                throw new BTSLBaseException("C2SRoamRechargeReversalController", "run", PretupsErrorCodesI.C2S_ERROR_EXCEPTION_TKING_TIME_TILL_TOPUP);
            }
            interfaceVO = null;
            ...
            _log.error("C2SRoamRechargeReversalController[processValidationRequest]", "Getting BTSL Base Exception:" + be.getMessage());
            throw be;
        } catch (Exception e) {
            _log.error(METHOD_NAME, "Exception:" + e.getMessage());
            _log.errorTrace(METHOD_NAME, e);
            ...
            throw new BTSLBaseException("C2SRoamRechargeReversalController", "processValidationRequest", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        } finally {
        	if(mcomCon != null){mcomCon.close("C2SRoamRechargeReversalController#processValidationRequest");mcomCon=null;}
            con = null;
        }
    ...
    private void processValidationRequestInThread() throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _log.errorTrace(METHOD_NAME, be);
            _log.error("C2SRoamRechargeReversalController[processValidationRequestInThread]", "Getting BTSL Base Exception:" + be.getMessage());
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "C2SRoamRechargeReversalController[processValidationRequestInThread]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            TransactionLog.log(_transferID, _requestIDStr, _receiverMSISDN, _receiverVO.getNetworkCode(), PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
            ...
            if (_transferID != null) {
                ...
                try {
                    ...
                    if(mcomCon != null){mcomCon.close("C2SRoamRechargeReversalController#processValidationRequestInThread");mcomCon=null;}
    ...
    private void addEntryInTransfers(Connection p_con) {
        ...
        try {
            ...
            _log.errorTrace(METHOD_NAME, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "C2SRoamRechargeReversalController[addEntryInTransfers]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            if (!_isCounterDecreased && _decreaseTransactionCounts) {
                LoadController.decreaseTransactionLoad(_transferID, _senderNetworkCode, LoadControllerI.DEC_LAST_TRANS_COUNT);
                _isCounterDecreased = true;
            }
    ...
    private boolean getInterfaceRoutingDetails(Connection p_con, String p_msisdn, long p_prefixID, String p_subscriberType, String p_networkCode, String p_serviceType, String p_interfaceCategory, String p_userType, String p_action) throws BTSLBaseException {
        ...
        try {
            if (_log.isDebugEnabled()) {
                _log.debug("getInterfaceRoutingDetails", " subscriberRoutingControlVO=" + subscriberRoutingControlVO);
            }
            ...
            if (subscriberRoutingControlVO != null) {
                                ...
                                try {
                                    ...
                                    EventHandler
                                        .handle(
                                            ...
                                            EventStatusI.RAISED,
                                            EventLevelI.MAJOR,
                                            "C2SRoamRechargeReversalController[getInterfaceRoutingDetails]",
                                            _transferID,
                                            _receiverMSISDN,
                                            "",
                ...
                // based routing
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                    "C2SRoamRechargeReversalController[getInterfaceRoutingDetails]", _transferID, _senderMSISDN, _senderNetworkCode,
            ...
            _log.errorTrace(METHOD_NAME, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "C2SRoamRechargeReversalController[getInterfaceRoutingDetails]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            isSuccess = false;
            throw new BTSLBaseException(this, "getInterfaceRoutingDetails", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        }
        if (_log.isDebugEnabled()) {
            _log.debug("getInterfaceRoutingDetails", " Exiting with isSuccess=" + isSuccess);
        }
        return isSuccess;
    }
    ...
    public void receiverValidateResponse(String str, int p_attempt, int p_altSize) throws BTSLBaseException {
        ...
        try {
            ...
            _log.errorTrace(METHOD_NAME, e);
            EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                "C2SRoamRechargeReversalController[receiverValidateResponse]", _transferID, _senderMSISDN, _senderNetworkCode,
                "Exception while parsing for interface txn ID , Exception:" + e.getMessage());
        }
        // }
        ...
        if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
            ...
            throw new BTSLBaseException("C2SRoamRechargeReversalController", "receiverValidateResponse", PretupsErrorCodesI.C2S_RECEIVER_FAIL_REVERSAL, 0, strArr, null);
        }
        try {
            _receiverTransferItemVO.setPreviousBalance(Long.parseLong((String) map.get("INTERFACE_PREV_BALANCE")));
        } catch (Exception e) {
    ...
    public void processFromQueue(TransferVO p_transferVO) {
        ...
        try {
            ...
            try {
                ...
                _log.error(METHOD_NAME, "Exception:" + e.getMessage());
                _log.errorTrace(METHOD_NAME, e);
                throw new BTSLBaseException("C2SRoamRechargeReversalController", "processFromQueue", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            }
            if(mcomCon != null){mcomCon.close("C2SRoamRechargeReversalController#processFromQueue");mcomCon=null;}
            con = null;

            if (_log.isDebugEnabled()) {
                _log.debug("C2SRoamRechargeReversalController[processFromQueue]", "_transferID=" + _transferID + " Successfully through load");
            }
            ...
            // setting transaction status to Fail
            _c2sTransferVO.setTransferStatus(PretupsErrorCodesI.TXN_STATUS_FAIL);
            /*Security fixes DEAD CODE IF always true so else removed*/
                _c2sTransferVO.setErrorCode(be.getMessageKey());
            ...
            // raising alarm
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "C2SRoamRechargeReversalController[processFromQueue]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            // logging in the transaction log
            TransactionLog.log(_transferID, _requestVO.getRequestIDStr(), _requestVO.getFilteredMSISDN(), "", PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
                _c2sTransferVO.getSenderReturnMessage(), PretupsI.TXN_LOG_STATUS_FAIL, "Getting Code=" + _requestVO.getMessageCode() + " ,Old Txn Id=" + _c2sTransferVO
            ...
            try {
                ...
                _log.errorTrace(METHOD_NAME, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                    "C2SRoamRechargeReversalController[processFromQueue]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            }
        ...
        if (!BTSLUtil.isNullString(p_languageCode)) {
            try {
                if (LocaleMasterCache.getLocaleFromCodeDetails(p_languageCode) == null) {
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                        "C2SRoamRechargeReversalController[updateReceiverLocale]", _transferID, _receiverMSISDN, "",
    ...
    public boolean performSeriesBasedRouting(long p_prefixID, String p_subscriberType, String p_action, String p_networkCode) throws BTSLBaseException {
        ...
        boolean isSuccess = false;
        if (_log.isDebugEnabled()) {
            _log.debug("performSeriesBasedRouting",
                "Entered p_prefixID=" + p_prefixID + " p_subscriberType=" + p_subscriberType + " p_action=" + p_action + "p_networkCode" + p_networkCode);
        }
        try {
        ...
        if (_log.isDebugEnabled()) {
            _log.debug("performSeriesBasedRouting", "Exited isSuccess=" + isSuccess);
        }
        return isSuccess;
    }
    ...
    private static synchronized void generateReversalTransferID(TransferVO p_transferVO) {
        ...
        try {
            ...
            if (currentMinut != _prevMinut) {
                _transactionIDCounter = 2;
                _prevMinut = currentMinut;
            } else {
                _transactionIDCounter++;
            }
            if (_transactionIDCounter == 0) {
                throw new BTSLBaseException("C2SRoamRechargeReversalController", "generateReversalTransferID", PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
    ...
    /*
     * private boolean getInterfaceRoutingDetailsForMNP(Connection p_con,String
     * p_msisdn,long p_prefixID,String p_subscriberType,String
     * p_networkCode,String p_serviceType,String p_interfaceCategory,String
     * p_userType,String p_action) throws BTSLBaseException
     * {
     ...
     * _receiverVO.getListValueVO().getValue()!="")
     * {
     ...
     * if(p_userType.equals(PretupsI.USER_TYPE_RECEIVER) &&
     * p_action.equals(PretupsI.INTERFACE_VALIDATE_ACTION))
     * _receiverInterfaceInfoInDBFound=true;
     ...
     * listValueVO=PretupsBL.validateNumberInRoutingDatabaseForMNP(p_con,p_msisdn
     * ,p_interfaceCategory);
     * if(listValueVO!=null)
     * {
     ...
     * .
     * RAISED,EventLevelI.FATAL,"C2SPrepaidController[getInterfaceRoutingDetails]"
     * ,
     * _transferID,_senderMSISDN,_senderNetworkCode,"Exception:"+e.getMessage())
     * ;
     * isSuccess=false;
     * throw new
     * BTSLBaseException(this,methodName,PretupsErrorCodesI.C2S_ERROR_EXCEPTION
     * );
     * }
     * if(_log.isDebugEnabled()) {
