...
public class TransferItemVO implements Serializable {
    ...
    private String _dedicatedAccountID;
    private String _dedicatedAccountValues;
    private String _dedicatedAccountExpiry;
    private String _senderDediAccountExpiry;

    // added for lmb
    private double _lmbAllowedBal;
    private Date _subscriberDateEnterActive;
    ...
    private boolean _validationRequiredIN = true;
    

	private String _currencyDetail;
	private long _previousMainBalance;
	private String _transferDatetimeStr;
	private String _entryDatetimeStr;
	private String _previousExpiryStr;
	private String _newExpiryStr;
	...
	public String toString() {
        ...
        sbd.append("_transferID:").append(_transferID).append(" _msisdn:").append(_msisdn).append(" _subscriberType:").append(_subscriberType).append(" _userType:").append(
                        _userType).append(" _transferType:").append(_transferType).append("_validationStatus:").append(_validationStatus).append(" _updateStatus:").append(
                        _updateStatus).append(" _transferValue:").append(_transferValue).append(" _transferStatus:").append(_transferStatus).append("_serviceClass:").append(
                        _serviceClass).append(" _interfaceResponseCode:").append(_interfaceResponseCode);
        return sbd.toString();
    }
    ...
    public boolean isValidationRequiredIN() {
        return _validationRequiredIN;
    }

    public void setValidationRequiredIN(boolean validationRequiredIN) {
        _validationRequiredIN = validationRequiredIN;
    }
    /**
	 * @return the _currencyDetail
	 */
	...
	/**
	 * @param _currencyDetail the _currencyDetail to set
	 */
	public void setCurrencyDetail(String _currencyDetail) {
		this._currencyDetail = _currencyDetail;
	}
	
	public long getPreviousMainBalance() {
		return _previousMainBalance;
	}
	public void setPreviousMainBalance(long previousMainBalance) {
		_previousMainBalance = previousMainBalance;
	}
	
	//defect c2s transfer enquiry spring
	 public String getTransferDateTimeStr() {
	        return _transferDatetimeStr;
	 }

	 public void setTransferDatetimeStr(String transferDatetimeStr) {
	    	_transferDatetimeStr = transferDatetimeStr;
	 }
	
	 public String getEntryDateTimeStr(){
		 return _entryDatetimeStr;
	 }
	 
	 public void setEntryDateTimeStr(String entryDatetimeStr) {
		 _entryDatetimeStr = entryDatetimeStr;
	 }
	 
	 public String getPreviousExpiryStr(){
		 return _previousExpiryStr;
	 }
	 
	 public void setPreviousExpiryStr(String previousExpiryStr) {
		 _previousExpiryStr = previousExpiryStr;
	 }
	 
	 
	 public String getNewExpiryStr(){
		 return _newExpiryStr;
	 }
	 
	 public void setNewExpiryStr(String newExpiryStr) {
		 _newExpiryStr = newExpiryStr;
	 }
	 
	 public static TransferItemVO getInstance()
	 {
		 return new TransferItemVO();
	 }
}
