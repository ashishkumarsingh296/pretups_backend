...
public class SubscriberVO implements Serializable {
    ...
    private Date lastSuccessTransferService;
    ...
    public String toString() {
        return (" _msisdn:" + _msisdn + " _subscriberType:" + _subscriberType + " _networkCode:" + _networkCode + ",_subscriberTypeDescription=" + _subscriberTypeDescription);
    }
    ...
    public String getLastSuccessTransferDateStr() {
        if (_lastSuccessTransferDate != null) {
            try {
                return BTSLDateUtil.getSystemLocaleDate((BTSLUtil.getDateStringFromDate(_lastSuccessTransferDate)));
    ...
    /**
     * @return Returns the userControlGrouptypeCounters.
     */
    ...
    /**
     * @param userControlGrouptypeCounters
     *            The userControlGrouptypeCounters to set.
     */
    ...
    public void setScheduleAmount(int amount) {
	...
	public Date getlastSuccessTransferService() {
		return lastSuccessTransferService;
	}

	public void setlastSuccessTransferService(Date _lastSuccessTransferService) {
		this.lastSuccessTransferService = _lastSuccessTransferService;
	}
