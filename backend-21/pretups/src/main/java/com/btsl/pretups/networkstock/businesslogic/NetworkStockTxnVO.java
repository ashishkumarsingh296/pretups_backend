...
public class NetworkStockTxnVO implements Serializable {
    ...
    private String _txnWallet = PretupsI.SALE_WALLET_TYPE;
    ...
    public String getTxnDateAsString() {
        try {
			return BTSLDateUtil.getSystemLocaleDate(BTSLUtil.getDateStringFromDate(_txnDate));
    ...
    public void setTxnDateAsString(Date txnDate) {
        _txnDate = txnDate;
    }
    ...
    public static NetworkStockTxnVO getInstance(){
    	return new NetworkStockTxnVO();
    }
}
