...
public class IATRoamReachargeController implements ServiceKeywordControllerI, Runnable {
    private static final Log _log = LogFactory.getLog(IATRoamReachargeController.class.getName());
     ...
     */
    public IATRoamReachargeController() {
    ...
    public void process(RequestVO p_requestVO) {
        if (_log.isDebugEnabled()) {
        	...
        	sb.append(_notAllowedSendMessGatw);
        	sb.append(" ");
            _log.debug("process", p_requestVO.getRequestIDStr(),sb.toString());
        }
        ...
        try {
            ...
            // type 'RR')
            _operatorUtil.validateRRServiceRequest(con, _c2sTransferVO, p_requestVO);
            ...
            // service type.
            // Since roam recharge service is for PRE type of subscriber, so
            // subscriber type is hard coded as 'PRE'.
            ...
            try {
                ...
                _log.errorTrace(METHOD_NAME, e);
                throw new BTSLBaseException("IATRoamReachargeController", "process", PretupsErrorCodesI.IAT_COMMIT_ERR_EXCEPTION);
            }
            ...
            try {
                ...
                if (_transferID != null && !_transferDetailAdded && (p_requestVO.getMessageGatewayVO().getFlowType().equals(PretupsI.MSG_GATEWAY_FLOW_TYPE_COMMON) || p_requestVO.getMessageGatewayVO().getFlowType().equals(PretupsI.MSG_GATEWAY_FLOW_TYPE_REQUEST) || (p_requestVO.getMessageGatewayVO().getFlowType().equals(PretupsI.MSG_GATEWAY_FLOW_TYPE_THREAD) && !p_requestVO.getMessageCode().equals(PretupsI.TXN_STATUS_UNDER_PROCESS)))) {
                	...
                	StringBuilder sb = new StringBuilder("");
                	sb.append("Send the message to MSISDN=");
                	sb.append(p_requestVO.getFilteredMSISDN());
                	sb.append(" Transfer ID=");
                	sb.append(_transferID);
                	sb.append(" But not added entry in Transfers yet");
                	_log.info("process", p_requestVO.getRequestIDStr(),sb.toString() );
                }
            } catch (BTSLBaseException be) {
                _log.errorTrace(METHOD_NAME, be);
            ...
            if (con != null && (p_requestVO.getMessageGatewayVO().getFlowType().equals(PretupsI.MSG_GATEWAY_FLOW_TYPE_REQUEST) || _closeConInFinally)) {
				...
				if (mcomCon != null) {
					mcomCon.close("IATRoamReachargeController#process");
					mcomCon = null;
				}
                con = null;
            }// end if
    ...
    private void populateIATServiceDetails() throws BTSLBaseException {
        ...
        try {
            ...
            // iat item vo.
        	StringBuilder sb = new StringBuilder("");
        	sb.append(_iatTransferItemVO.getIatRecCountryShortName());
        	sb.append("_");
        	sb.append(_iatTransferItemVO.getIatRecNWCode());
        	sb.append("_");
        	sb.append(_c2sTransferVO.getServiceType());
        	 
            IATNetworkServiceMappingVO iatNetworkServiceMappingVO = (IATNetworkServiceMappingVO) IATNWServiceCache.getNetworkServiceObject(sb.toString());
            /*
           ...
           throw new BTSLBaseException(be) ;
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "IATRoamRechargeController[populateIATServiceDetails]", "", _receiverMSISDN, "", "Exception while populating iat code and handler. Exception: " + e.getMessage());
    ...
    private static synchronized void generateIATRoamRechargeTransferID(TransferVO p_transferVO) throws BTSLBaseException {
        ...
        try {
            ...
            if (_transactionIDCounter == 0) {
                throw new BTSLBaseException("IATRoamReachargeController", "generateIATRoamRechargeTransferID", PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
            transferID = _operatorUtil.formatRoamRechargeTransferID(p_transferVO, _transactionIDCounter);
            if (transferID == null) {
                throw new BTSLBaseException("IATRoamReachargeController", "generateIATRoamRechargeTransferID", PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
    ...
    private void checkTransactionLoad() throws BTSLBaseException {
        ...
        try {
            ...
            if (recieverLoadStatus == 0) {
                ...
                if (_log.isDebugEnabled()) {
                    _log.debug("IATRoamReachargeController[checkTransactionLoad]", "_transferID=" + _transferID + " Successfully through load");
                }
            }
            // Request in Queue
                ...
                throw new BTSLBaseException("IATRoamReachargeController", "checkTransactionLoad", PretupsErrorCodesI.REQUEST_IN_QUEUE, 0, strArr, null);
            }
            // Refuse the request
            else {
                throw new BTSLBaseException("IATRoamReachargeController", "checkTransactionLoad", PretupsErrorCodesI.REQUEST_REFUSE_FROM_INTLOAD);
            }
        } catch (BTSLBaseException be) {
            _log.error("IATRoamReachargeController[checkTransactionLoad]", "Refusing request getting Exception:" + be.getMessage());
            throw be;
        } catch (Exception e) {
            _log.errorTrace(METHOD_NAME, e);
            _log.error("IATRoamReachargeController[checkTransactionLoad]", "Refusing request getting Exception:" + e.getMessage());
            throw new BTSLBaseException("IATRoamReachargeController", "checkTransactionLoad", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        }
    }
    ...
    private void processValidationRequest() throws BTSLBaseException, SQLException {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder("");
            sb.append("After Card Group Set Id=");
            sb.append(_c2sTransferVO.getCardGroupSetID());
            sb.append(" Code");
            sb.append(_c2sTransferVO.getCardGroupCode());
            sb.append(" Card ID=");
            sb.append(_c2sTransferVO.getCardGroupID());
            sb.append(" Access fee=");
            sb.append(_c2sTransferVO.getReceiverAccessFee());
            sb.append(" Tax1 =");
            sb.append(_c2sTransferVO.getReceiverTax1Value());
            sb.append(" Tax2=");
            sb.append(_c2sTransferVO.getReceiverTax1Value());
            sb.append(" Bonus=");
            sb.append(_c2sTransferVO.getReceiverBonusValue());
            sb.append(" Val Type=");
            sb.append(_c2sTransferVO.getReceiverValPeriodType());
            sb.append(" Validity=");
            sb.append(_c2sTransferVO.getReceiverValidity());
            sb.append(" Talk Time=");
            sb.append(_c2sTransferVO.getReceiverTransferValue());
            TransactionLog.log(_transferID, _requestIDStr, _receiverMSISDN, _receiverVO.getNetworkCode(), PretupsI.TXN_LOG_REQTYPE_INT, PretupsI.TXN_LOG_TXNSTAGE_PROCESS, sb.toString(), PretupsI.TXN_LOG_STATUS_SUCCESS, "");
            ...
            _log.error("IATRoamReachargeController[processValidationRequest]", "Getting BTSL Base Exception:" + be.getMessage());
            if (_transferDetailAdded) {
            ...
            throw new BTSLBaseException("IATRoamReachargeController", "processValidationRequest", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        } finally {
	...
	p_iatInterfaceVO.setReceiverCurrency(_iatTransferItemVO.getIatRcvrCurrency());
        if (_log.isDebugEnabled()) {
    ...
    public void updateForReceiverValidateResponse(IATInterfaceVO p_iatInterfaceVO) throws BTSLBaseException {
        ...
        if (!InterfaceErrorCodesI.SUCCESS.equals(status)) {
            ...
            throw new BTSLBaseException("IATRoamReachargeController", "updateForReceiverValidateResponse", _c2sTransferVO.getErrorCode(), 0, strArr, null);
        }
        _receiverTransferItemVO.setValidationStatus(status);
        ...
        try {
            ...
            if (PretupsI.YES.equals(_c2sTransferVO.getDifferentialAllowedForService())) {
                ...
                try {
                    ...
                    if (_log.isDebugEnabled()) {
                    	StringBuilder sb = new StringBuilder("");
                    	sb.append( "For _transferID=");
                    	sb.append(_transferID);
                    	sb.append(" Diff applicable=");
                    	sb.append(_c2sTransferVO.getDifferentialApplicable());
                    	sb.append(" Diff Given=");
                    	sb.append(_c2sTransferVO.getDifferentialGiven());
                    	sb.append(" Not able to give Diff commission getting BTSL Base Exception=");
                    	sb.append(be.getMessage());
                    	sb.append(" Leaving transaction status as Under process");
                    	
                        _log.debug("C2SPrepaidController",sb.toString());
                    }
                    _log.errorTrace(METHOD_NAME, be);
                    ...
                    if (_log.isDebugEnabled()) {
                    	...
                    	sb.append(" Diff Given=");
                    	sb.append(_c2sTransferVO.getDifferentialGiven());
                    	sb.append(" Not able to give Diff commission getting Exception=");
            ...
            if (con != null) {
				...
				if (mcomCon != null) {
					mcomCon.close("IATRoamReachargeController#run");
					mcomCon = null;
				}
                con = null;
            }
    ...
    public void updateForReceiverCreditResponse(IATInterfaceVO p_iatInterfaceVO) throws BTSLBaseException {
        ...
        if (BTSLUtil.isNullString(status) || (!status.equals(InterfaceErrorCodesI.SUCCESS) && !status.equals(InterfaceErrorCodesI.AMBIGOUS))) {
            ...
            // (This vo finally updates the iat item table)
            _iatTransferItemVO.setTransferStatus(PretupsErrorCodesI.TXN_STATUS_FAIL);
            _iatTransferItemVO.setQuantity(_c2sTransferVO.getQuantity());
            _receiverTransferItemVO.setTransferStatus(status);
            strArr = new String[] { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()) };
            // throw new
