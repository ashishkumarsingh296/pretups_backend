...
public void setInvalidVoucherPinCount(long invalidVoucherPinCount) {
	this.invalidVoucherPinCount = invalidVoucherPinCount;
}
    ...
    public String toString() {
        ...
        temp.append("_userID=");
        temp.append(_userID);
        temp.append("  _userName:");
        temp.append(_userName);
        temp.append("	_status:");
        temp.append(_status);
        temp.append("_billingType");
        temp.append(_billingType);
        temp.append("_billingCycleDate");
        temp.append(_billingCycleDate);
        temp.append("_creditLimit");
        temp.append(_creditLimit);
        temp.append(super.toString());

        temp.append(",_dailyTransferAmount=").append(_dailyTransferAmount);
        temp.append(",_dailyTransferCount=").append(_dailyTransferCount);
        temp.append(",_weeklyTransferAmount=").append(_weeklyTransferAmount);
        temp.append(",_weeklyTransferCount=").append(_weeklyTransferCount);
        temp.append(",MonthlyTransferAmount=").append(this.getMonthlyTransferAmount());
        temp.append(",MonthlyTransferCount=").append(this.getMonthlyTransferCount());
         ...
         * return
         * ("_userID="+_userID+"  _userName:"+_userName+"	_status:"+_status+
         * "_billingType"+_billingType+"_billingCycleDate"+_billingCycleDate+
         * "_creditLimit"+_creditLimit+super.toString()+sbf);
         */
    }
    ...
    public void setSubscriptions(String _subscriptions) {
	...
	public void setForMsisdn(String forMsisdn) {
	    ...
	    public void setTransferList(ArrayList transferList) {
	        this._transferList = transferList;
	    }
