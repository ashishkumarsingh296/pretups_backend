...
public class PostPaidBillPaymentController implements ServiceKeywordControllerI, Runnable {
    private final static Log _log = LogFactory.getLog(PostPaidBillPaymentController.class.getName());
    ...
    public PostPaidBillPaymentController() {
        _c2sTransferVO = new C2STransferVO();
        _currentDate = new Date();
        /*
         * The process below is used to control the messages that are send to
         * receiver. If BILLPAY_REC_GEN_FAIL_MSG_REQD_V is Y then all validation
         * fail message are send to receiver If BILLPAY_REC_GEN_FAIL_MSG_REQD_T
         * is Y then all topup fail message are send to receiver.
         */
	...
	public void process(RequestVO p_requestVO) {
        ...
        try {
            ...
            _receiverVO = (ReceiverVO) _c2sTransferVO.getReceiverVO();
				if(_log.isDebugEnabled()) _log.debug("process","Different Prefixes :: Receiver prefix : ",PretupsBL.getMSISDNPrefix(_receiverVO.getMsisdn()) +"  Sender prefix : "+PretupsBL.getMSISDNPrefix(_channelUserVO.getMsisdn()) );
				if(((Boolean) (PreferenceCache.getSystemPreferenceValue(PreferenceI.SUBSCRIBER_PREFIX_ROUTING_ALLOWED))).booleanValue()){
					if(!_operatorUtil.isSubscriberPrefixMappingExist(con, _receiverVO.getMsisdn(), _channelUserVO.getMsisdn(), PretupsI.SERVICE_TYPE_POST))
            ...
            if (((Boolean) PreferenceCache.getSystemPreferenceValue(PreferenceI.SKEY_REQUIRED)).booleanValue()) {
                ...
                dueAmtPaid = new QueueTableDAO().getAmountforPPBEnqCalc(con, _receiverMSISDN);
                ...
                if(mcomCon != null){mcomCon.close("PostPaidBillPaymentController#process");mcomCon=null;}
                con = null;
                ...
                if (p_requestVO.getMessageGatewayVO().getFlowType().equals(PretupsI.MSG_GATEWAY_FLOW_TYPE_COMMON)) {
                    ...
                    processValidationRequest();
                    run();
                    final String[] messageArgArray = {(_receiverVO.getSid()!=null)?_receiverVO.getSid(): _receiverMSISDN, _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getTransferValue()), PretupsBL
	...
	public void run() {
        ...
        try {
            ...
            if (PretupsI.YES.equals(_c2sTransferVO.getDifferentialAllowedForService())) {
			 ...
			 // FOR BONUS TAG IF EXIST IN REQUEST
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "PostPaidBillPaymentController[run]", _c2sTransferVO
			...
			if (mcomCon != null) {
					mcomCon.close("PostPaidBillPaymentController#run");
					mcomCon = null;
				}
            con = null;
            ...
            if (((Boolean) PreferenceCache.getSystemPreferenceValue(PreferenceI.LMS_APPL)).booleanValue() && _c2sTransferVO.getTransferStatus().equals(PretupsErrorCodesI.TXN_STATUS_SUCCESS)) {
                try {
                    if (!BTSLUtil.isNullString(_channelUserVO.getLmsProfile())) {
                        ...
                        loyaltyVO.setServiceType(PretupsI.SERVICE_TYPE_CHNL_BILLPAY);
            ...
            if (con != null) {
                ...
                if(mcomCon != null){mcomCon.close("PostPaidBillPaymentController#run");mcomCon=null;}
                con = null;
            }
    ...
    public void updateForReceiverValidateResponse(String str) throws BTSLBaseException {
        ...
        if (InterfaceErrorCodesI.ERROR_RECHARGE_AMOUNT_LESS.equals(status)) {
            String minAmt = "", reqAmt = "", paidAmt = "";
            try {
                minAmt = (String) map.get("MIN_AMT_DUE");
                minAmt = PretupsBL.getDisplayAmount(PretupsBL.getSystemAmount(minAmt));
                reqAmt = (String) map.get("REQUESTED_AMOUNT");
                paidAmt = (String) map.get("DUE_AMOUNT_PAID");

            } catch (Exception e) {
                _log.errorTrace(methodName, e);
            }
            final String[] arr = new String[] { minAmt, reqAmt, paidAmt };
            _log.error(methodName, "@@@@@ AMT less");
            ...
            throw new BTSLBaseException("PostPaidBillPaymentController", methodName, InterfaceErrorCodesI.ERROR_RECHARGE_AMOUNT_LESS, 0, arr, null);
        }
        ...
        if (!InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(status) || isRequired) {
            ...
            if (!InterfaceErrorCodesI.SUCCESS.equals(status)) {
                ...
                throw new BTSLBaseException("PostPaidBillPaymentController", methodName, _c2sTransferVO.getErrorCode(), 0, strArr, null);
            }
            try {
    ...
    public void updateForReceiverCreditResponse(String str) throws BTSLBaseException {
        ...
        try {
            _c2sTransferVO.setExtCreditIntfceType((String) map.get("EXT_CREDIT_INTFCE_TYPE"));
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
        }// rahuld
         // If status is other than Success in validation stage mark sender
    ...
    private void checkTransactionLoad() throws BTSLBaseException {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            _log.error("PostPaidBillPaymentController[checkTransactionLoad]", "Refusing request getting Exception:" + e.getMessage());
            throw new BTSLBaseException("PostPaidBillPaymentController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        }
    }
    ...
    private void processValidationRequest() throws BTSLBaseException, SQLException {
        ...
        try {
            ...
            if(mcomCon != null){mcomCon.close("PostPaidBillPaymentController#processValidationRequest");mcomCon=null;}
            con = null;
			...
			if (mcomCon != null) {
				mcomCon.close("PostPaidBillPaymentController#processValidationRequest");
				mcomCon = null;
			}
            con = null;
        }
    ...
    public String getReceiverValidateStr() {
        ...
        strBuff.append("&REQUESTED_AMOUNT=" + _c2sTransferVO.getRequestedAmount());// changed
        // for
        // vfe
        strBuff.append("&DUE_AMOUNT_PAID=" + dueAmtPaid);
    ...
    public String getReceiverCreditStr() {
        ...
        strBuff.append("&UPDATE_STATUS1=" + _receiverTransferItemVO.getUpdateStatus1());// for
        // online
        // status
        return strBuff.toString();
    }
    ...
    private String getReceiverSuccessMessage() {
        ...
        String key = null;
        messageArgArray = new String[] { PretupsBL.getDisplayAmount(_c2sTransferVO.getTransferValue()), _senderPushMessageMsisdn, _transferID, _c2sTransferVO
    ...
    private String getSenderSuccessMessage() {
        ...
        final String[] messageArgArray = { PretupsBL.getDisplayAmount(_c2sTransferVO.getTransferValue()), _transferID, _requestVO.getSid(), PretupsBL
            .getDisplayAmount(_senderTransferItemVO.getPostBalance()), _c2sTransferVO.getSubService(), _channelUserVO.getEmpCode() };
    ...
    private String getSenderUnderProcessMessage() {
        // vfe String[]
        // messageArgArray={PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()),_transferID,_receiverMSISDN,PretupsBL.getDisplayAmount(_senderTransferItemVO.getPostBalance())};
        final String[] messageArgArray = { PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _transferID, _requestVO.getSid(), PretupsBL
            .getDisplayAmount(_senderTransferItemVO.getPostBalance()), _channelUserVO.getEmpCode() };
    ...
    private String getSndrUPMsgBeforeValidation() {
        ...
        final String[] messageArgArray = { PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _transferID, _requestVO.getSid(), _channelUserVO.getEmpCode() };
        ...
        try {
            ...
            if (_requestVO.getMessageGatewayVO().getFlowType().equals(PretupsI.MSG_GATEWAY_FLOW_TYPE_REQUEST)) {
                ...
                final String[] messageArgArray = { _c2sTransferVO.getReceiverMsisdn(), PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _c2sTransferVO
                    .getTransferID(), PretupsBL.getDisplayAmount(_userBalancesVO.getBalance()), _channelUserVO.getEmpCode() };
        ...
        try {
            ...
            if (_transferID != null) {
                ...
                try {
					...
					if (mcomCon != null) {
						mcomCon.close("PostPaidBillPaymentController#processValidationRequestInThread");
						mcomCon = null;
					}
                    con=null;
                    _log.errorTrace(methodName, be);
    ...
    private void performAlternateRouting(ArrayList altList) throws BTSLBaseException {
        ...
        try {
                    ...
                    case 1:
                        {
                            ...
                            try {
                                 ...
                                 * );
                                 * else { SubscriberRoutingControlVO
                                 * subscriberRoutingControlVO=
                                 * SubscriberRoutingControlCache
                                 * .getRoutingControlDetails(_c2sTransferVO.
                                 * getReceiverNetworkCode
                            ...
                            try {
                                ...
                                if (be.isKey() && InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(be.getMessageKey())) {
                                    ...
                                    try {
                                         ...
                                         * if(_receiverInterfaceInfoInDBFound)
                                         * PretupsBL.
                                         * updateSubscriberInterfaceRouting(
                                         * _receiverTransferItemVO
                                         ...
                                         * ()) {
                                         * PretupsBL.
                                         * insertSubscriberInterfaceRouting(
                                         * _receiverTransferItemVO
                                         * .getInterfaceID(),_externalID
                                         * ,_receiverMSISDN,
                                         * _type,_channelUserVO.getUserID
            ...
            throw new BTSLBaseException(this, "performAlternateRouting", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        }
    }
    ...
    public void processFromQueue(TransferVO p_transferVO) {
        ...
        try {
            ...
            if(mcomCon != null){mcomCon.close("PostPaidBillPaymentController#processFromQueue");mcomCon=null;}
            con = null;
            ...
            if (con != null) {
				...
				if (mcomCon != null) {
					mcomCon.close("PostPaidBillPaymentController#processFromQueue");
					mcomCon = null;
				}
                con = null;
            }// end if
    ...
    /**
     * Method: performSeriesBasedRouting This method to perform series based
     * interface routing
     * 
     * @param p_prefixID
     *            long
     ...
     * generatePostPaidBillPmtTransferID(TransferVO p_transferVO) { String
     * transferID=null; try { //ReceiverVO
     ...
     * if(currentReqTime-_prevReqTime>=(60000)) _transactionIDCounter=1; else
     * _transactionIDCounter=_transactionIDCounter+1;
     * _prevReqTime=currentReqTime; if(_transactionIDCounter==0) throw new
     * BTSLBaseException("PostPaidBillPaymentController",
    ...
    private static synchronized void generatePostPaidBillPmtTransferID(TransferVO p_transferVO) {
        ...
        try {
            ...
            if (_transactionIDCounter == 0) {
                throw new BTSLBaseException("PostPaidBillPaymentController", "generatePostPaidBillPmtTransferID", PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
