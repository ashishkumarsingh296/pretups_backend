...
public class ServiceSelectorMappingVO {
    private String _sno;
    ...
    public String toString() {
        ...
        sb.append("_selectorCode=").append(_selectorCode).append(",");
        sb.append("_status=").append(_status).append(",");
        sb.append("_type=").append(_type).append(",");
        sb.append("_isDefaultCode=").append(_isDefaultCode).append(",");
        sb.append("_senderBundleID=").append(_senderBundleID).append(",");
        sb.append("_receiverBundleID=").append(_receiverBundleID).append(",");
        sb.append("_amountStr=").append(_amountStr).append(",");
        sb.append("_modifiedAllowed=").append(_modifiedAllowed).append(",");
        sb.append("_displayOrder=").append(_displayOrder).append("");
        sb.append("_statusDesc=").append(_statusDesc).append("");
        return sb.toString();
    }
}
