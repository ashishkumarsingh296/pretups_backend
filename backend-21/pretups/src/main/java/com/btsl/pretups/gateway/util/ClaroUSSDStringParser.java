...
public class ClaroUSSDStringParser {
    ...
    // public static String LANG1_STR="LANGUAGE1";//@@@@
    // public static String LANG2_STR="LANGUAGE2";//@@@@
    ...
    private static final Log _log = LogFactory.getLog(ClaroUSSDStringParser.class.getName());
    ...
    public static void parseChannelCreditTransferRequest(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            // VFE String language1=(String)requestMap.get("LANGUAGE1");
            // VFE String language2=(String)requestMap.get("LANGUAGE2");
            ...
            if (BTSLUtil.isNullString(type) || BTSLUtil.isNullString(msisdn1) || BTSLUtil.isNullString(pin) || BTSLUtil.isNullString(msisdn2) || BTSLUtil.isNullString(amount) || BTSLUtil
                ...
                throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.C2S_ERROR_MISSING_MANDATORY_FIELD);
            }
            ...
            if (!BTSLUtil.isNullString(p_requestVO.getMessageGatewayVO().getGatewayCode()) && ("EXTGW".equals(p_requestVO.getMessageGatewayVO().getGatewayCode()))) {
                ...
                if (BTSLUtil.isNullString(externalNetworkCode)) {
                    throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.C2S_ERROR_INVALIDMESSAGEFORMAT);
                }
            }
            ...
            if (tagsMandatory) {
                try {
                    if (BTSLUtil.isNullString(cellId)) {
                        throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.USSD_CELLID_BLANK__ERROR);
                    }
                    if (BTSLUtil.isNullString(switchId)) {
                        throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.USSD_SWITCHID_BLANK__ERROR);
                    }
    ...
    public static void generateChannelCreditTransferResponse(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ClaroUSSDStringParser[generateChannelCreditTransferResponse]", PretupsErrorCodesI.XML_ERROR_EXCEPTION, "", "", "generateChannelCreditTransferResponse:" + e
                    .getMessage());
        } finally {
            if (_log.isDebugEnabled()) {
    ...
    public static void generateChannelChangePinResponse(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            p_requestVO.setMessageCode(PretupsErrorCodesI.XML_ERROR_EXCEPTION);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ClaroUSSDStringParser[generateChannelChangePinResponse]", PretupsErrorCodesI.XML_ERROR_EXCEPTION, "", "", "generateChannelChangePinResponse:" + e
                    .getMessage());
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, "Exiting responseStr: " + responseStr);
    ...
    public static void generateChannelNotificationLanguageResponse(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            p_requestVO.setMessageCode(PretupsErrorCodesI.XML_ERROR_EXCEPTION);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ClaroUSSDStringParser[generateChannelNotificationLanguageResponse]", PretupsErrorCodesI.XML_ERROR_EXCEPTION, "", "",
    ...
    public static void generateChannelTransferResponse(RequestVO p_requestVO, int p_action) throws Exception {
        ...
        try {
            ...
            p_requestVO.setMessageCode(PretupsErrorCodesI.XML_ERROR_EXCEPTION);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ClaroUSSDStringParser[generateChannelTransferResponse]", PretupsErrorCodesI.XML_ERROR_EXCEPTION, "", "", "generateChannelTransferResponse:" + e.getMessage());
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, "Exiting responseStr: " + responseStr);
            }
    ...
    public static void generateChannelBalanceEnquiryResponse(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            p_requestVO.setMessageCode(PretupsErrorCodesI.XML_ERROR_EXCEPTION);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ClaroUSSDStringParser[generateChannelBalanceEnquiryResponse]", PretupsErrorCodesI.XML_ERROR_EXCEPTION, "", "", "generateChannelBalanceEnquiryResponse:" + e
                    .getMessage());
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, "Exiting responseStr: " + responseStr);
    ...
    public static void generateChannelDailyStatusReportResponse(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            p_requestVO.setMessageCode(PretupsErrorCodesI.XML_ERROR_EXCEPTION);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ClaroUSSDStringParser[generateChannelDailyStatusReportResponse]", PretupsErrorCodesI.XML_ERROR_EXCEPTION, "", "",
    ...
    public static void generateChannelLastTransferStatusResponse(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            p_requestVO.setMessageCode(PretupsErrorCodesI.XML_ERROR_EXCEPTION);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ClaroUSSDStringParser[generateChannelLastTransferStatusResponse]", PretupsErrorCodesI.XML_ERROR_EXCEPTION, "", "",
    ...
    public static void parseChannelLastXTransferStatus(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            final String msisdn1 = (String) requestMap.get("MSISDN1");
            final String pin = (String) requestMap.get("PIN");
                final String recMsisdn = (String) requestMap.get("MSISDN2");
        final String language1 = (String) requestMap.get(LANG1_STR);
            if(!BTSLUtil.isNullString(recMsisdn)){
                        requestHashMap.put("RECEIVER_MSISDN",recMsisdn);
                }
            final String noOfLastXTxn = (String) requestMap.get("NUMBER_OF_LAST_X_TXN");
            if(!BTSLUtil.isNullString(noOfLastXTxn)){
                ...
                final String typeOfLastTxn = (String) requestMap.get("TYPE_OF_LAST_TXN");
            if(!BTSLUtil.isNullString(typeOfLastTxn)){
            requestHashMap.put("TYPE_OF_LAST_TXN",typeOfLastTxn);
            }
            if (BTSLUtil.isNullString(type) || BTSLUtil.isNullString(msisdn1) || BTSLUtil.isNullString(pin)) {
                throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.C2S_ERROR_MISSING_MANDATORY_FIELD);
            }
    ...
    public static void parseChannelExtRechargeStatusRequest(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            throw new BTSLBaseException("ClaroUSSDStringParser", "parseChannelExtRechargeStatusRequest", PretupsErrorCodesI.C2S_ERROR_INVALIDMESSAGEFORMAT);
        } finally {
            if (_log.isDebugEnabled()) {
    ...
    public static void generateChannelExtRechargeStatusResponse(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            p_requestVO.setMessageCode(PretupsErrorCodesI.XML_ERROR_EXCEPTION);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ClaroUSSDStringParser[generateChannelExtRechargeStatusResponse]", PretupsErrorCodesI.XML_ERROR_EXCEPTION, "", "",
    ...
    public static void parseP2PGiveMeBalanceRequest(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            if (BTSLUtil.isNullString(amount)) {
                ...
                throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.P2P_ERROR_BLANK_AMOUNT);
            }
            ...
            if (tagsMandatory) {
                try {
                    if (BTSLUtil.isNullString(cellId)) {
                        ...
                        throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.USSD_CELLID_BLANK_ERROR);
                    }
                    if (BTSLUtil.isNullString(switchId)) {
                        p_requestVO.setMessageCode(PretupsErrorCodesI.USSD_SWITCHID_BLANK_ERROR);
                        throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.USSD_SWITCHID_BLANK_ERROR);
                    }
                } catch (BTSLBaseException btsle) {
                    throw btsle;
                }
            ...
            if (BTSLUtil.isNullString(type)) {
                ...
                throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.P2PGMB_TYPE_BLANK);
            }
            if (BTSLUtil.isNullString(msisdn1)) {
                p_requestVO.setMessageCode(PretupsErrorCodesI.P2PGMB_MSISDN1_BLANK);
                throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.P2PGMB_MSISDN1_BLANK);
            }
            if (BTSLUtil.isNullString(msisdn2)) {
                p_requestVO.setMessageCode(PretupsErrorCodesI.P2PGMB_MSISDN2_BLANK);
                throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.P2PGMB_MSISDN2_BLANK);
            }
            if (!BTSLUtil.isNullString(msisdn1) && !BTSLUtil.isNullString(msisdn2) && msisdn1.equals(msisdn2)) {
                ...
                throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.P2PGMB_MSISDN1_MSISDN2_EQUAL);
            }
            ...
            _log.error(methodName, "Exception e: " + e);
            throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.P2PGMB_INVALID_MESSAGE);
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, "Exiting p_requestVO ID: " + p_requestVO.getRequestIDStr());
            }
    ...
    public static void generateP2PGiveMeBalanceResponse(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ClaroUSSDStringParser[generateP2PGiveMeBalanceResponse]", PretupsErrorCodesI.P2P_ERROR_EXCEPTION, "", "", "generateP2PGiveMeBalanceResponse:" + e
                    .getMessage());
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, "Exiting responseStr: " + responseStr);
    ...
    public static void parseCreditTransferRequest(RequestVO p_requestVO) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            if (BTSLUtil.isNullString(msisdn1) || BTSLUtil.isNullString(msisdn2)) {
                throw new BTSLBaseException("ClaroUSSDStringParser", "parseGetAccountInfoRequest", PretupsErrorCodesI.P2P_ERROR_INVALIDMESSAGEFORMAT);
            }
            ...
            _log.error(methodName, "Exception e: " + e);
            throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.P2P_ERROR_INVALIDMESSAGEFORMAT);
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, "Exiting p_requestVO: " + p_requestVO.toString());
            }
    ...
    public static void generateCreditTransferResponse(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            p_requestVO.setMessageCode(PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ClaroUSSDStringParser[generateCreditTransferResponse]", PretupsErrorCodesI.P2P_ERROR_EXCEPTION, "", "", "generateCreditTransferResponse:" + e.getMessage());
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, "Exiting responseStr: " + responseStr);
            }
    ...
    public static void parseChannelPostPaidBillPaymentRequest(RequestVO p_requestVO) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            p_requestVO.setMessageCode(PretupsErrorCodesI.C2S_ERROR_INVALIDMESSAGEFORMAT);
            _log.error(methodName, "Exception e: " + e);
            throw new BTSLBaseException("ClaroUSSDStringParser", methodName, PretupsErrorCodesI.BILLPAY_INVALID_MESSAGE_FORMAT);
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, "Exiting p_requestVO: " + p_requestVO.toString());
            }
    ...
    public static void generateChannelCollectionEnquiryResponse(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            p_requestVO.setMessageCode(PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ClaroUSSDStringParser[generateChannelCollectionEnquiryResponse]", PretupsErrorCodesI.C2S_ERROR_EXCEPTION, "", "",
...
/**
    ...
    public static void parseIATRoamRecharge(RequestVO p_requestVO) throws Exception {
        ...
        try {
           ...
           String tempMSISDN2=msisdn2;
            if (msisdn2.length() > ((Integer) (PreferenceCache.getSystemPreferenceValue(PreferenceI.MIN_MSISDN_LENGTH))).intValue()) {
    ...
    public static void generateC2SPostPaidReversalResponse(RequestVO p_requestVO) throws Exception {
        ...
        try {
            ...
            p_requestVO.setMessageCode(PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ClaroUSSDStringParser[generateC2SPostPaidReversalResponse]", PretupsErrorCodesI.C2S_ERROR_EXCEPTION, "", "",
	...
	{
		  final String METHOD_NAME="parseChannelUserAuthRequest";
...
public static void generateRoamRechargeResponse(RequestVO p_requestVO) throws Exception {
        ...
        public static void parseC2SStatusRequest(RequestVO p_requestVO) throws Exception
        {
                if(_log.isDebugEnabled())_log.debug("parseC2SStatusRequest","Entered p_requestVO: "+p_requestVO.toString());
                String parsedRequestStr =null;
                ...
                try
                {
                        ...
                        String type = (String)requestMap.get(TYPE_STR);
                        String extRefNum = (String)requestMap.get(EXTREFNUM_STR);
                        String txnID = (String)requestMap.get("TXNID");
                        String msisdn = (String)requestMap.get(MSISDN1_STR);
                        String pin = (String)requestMap.get(PIN_STR);
                        String ussdSessionID = (String)requestMap.get(USSD_SESSION_ID);
                        String language1 = (String)requestMap.get(LANG1_STR);
                        if(BTSLUtil.isNullString(msisdn)||BTSLUtil.isNullString(pin) || (BTSLUtil.isNullString(extRefNum) && BTSLUtil.isNullString(txnID)))
                        {
                                throw new BTSLBaseException("USSDStringParser","parseC2SStatusRequest",PretupsErrorCodesI.XML_ERROR_INVALIDREQUESTFORMAT);
                        }
                        ...
                        if (!BTSLUtil.isNullString(extRefNum) && !BTSLUtil.isNullString(txnID)) {
                                parsedRequestStr = PretupsI.SERVICE_TYPE_RECHARGE_STATUS + chnl_message_sep + txnID + chnl_message_sep + extRefNum + chnl_message_sep + MSG_IDNTFICATION_BOTH + chnl_message_sep + pin;
                        }
                        if (!BTSLUtil.isNullString(extRefNum)) {
                                parsedRequestStr = PretupsI.SERVICE_TYPE_RECHARGE_STATUS + chnl_message_sep + extRefNum + chnl_message_sep + MSG_IDNTFICATION_EXT_REF + chnl_message_sep + pin;
                        }
                        if (!BTSLUtil.isNullString(txnID)) {
                ...
                {
                		_log.errorTrace("parseC2SStatusRequest", e);
                        p_requestVO.setTxnAuthStatus(PretupsErrorCodesI.XML_ERROR_INVALIDREQUESTFORMAT);
                        p_requestVO.setMessageCode(PretupsErrorCodesI.XML_ERROR_INVALIDMESSAGEFORMAT);
                        _log.error("parseC2SStatusRequest","Exception e: "+e);
                        EventHandler.handle(EventIDI.SYSTEM_ERROR,EventComponentI.SYSTEM,EventStatusI.RAISED,EventLevelI.FATAL,"USSDStringParser[parseC2SStatusRequest]",PretupsErrorCodesI.XML_ERROR_INVALIDREQUESTFORMAT,"","","parseC2SStatusRequest:"+e.getMessage());
                        throw new BTSLBaseException("USSDStringParser","parseC2SStatusRequest",PretupsErrorCodesI.XML_ERROR_INVALIDREQUESTFORMAT);
                }
                finally
                {
                        if(_log.isDebugEnabled())_log.debug("parseC2SStatusRequest","Exiting  p_requestVO: "+p_requestVO.toString());
                }
        }
    public static void generateC2SStatusResponse(RequestVO p_requestVO) throws Exception {
        final String methodName = "generateC2SStatusResponse";
        if (_log.isDebugEnabled()) {
            _log.debug(methodName, "Entered p_requestVO: " + p_requestVO.toString());
        }
        String responseStr = null;
        ...
        try {
            ...
            _log.error(methodName, "Exception e: " + e);
            p_requestVO.setMessageCode(PretupsErrorCodesI.XML_ERROR_EXCEPTION);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ClaroUSSDStringParser[generateC2SStatusResponse]",
                PretupsErrorCodesI.XML_ERROR_EXCEPTION, "", "", "generateC2SStatusResponse:" + e.getMessage());
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, "Exiting responseStr: " + responseStr);
            }
        ...
        public static void parseRetListRequest(RequestVO p_requestVO) throws Exception
        {
                if(_log.isDebugEnabled())_log.debug("parseRetListRequest","Entered p_requestVO: "+p_requestVO.toString());
                String parsedRequestStr =null;
                try
                {
                        String requestStr = p_requestVO.getRequestMessage();
                        ...
                        String ussdSessionID = (String)requestMap.get(USSD_SESSION_ID);
                        String language1 = (String)requestMap.get(LANG1_STR);
                        String extNetworkCode = (String)requestMap.get(EXTNWCODE_STR);
                        String extRefNum = (String)requestMap.get(EXTREFNUM_STR);
                        String extCode = (String)requestMap.get("EXTCODE");
                        String action = (String)requestMap.get("ACTION");
                        p_requestVO.setRequestMap(requestMap);
                        if(BTSLUtil.isNullString(msisdn)||BTSLUtil.isNullString(type) || BTSLUtil.isNullString(action))
                        {
                                throw new BTSLBaseException("USSDStringParser","parseC2SStatusRequest",PretupsErrorCodesI.XML_ERROR_INVALIDREQUESTFORMAT);
                        }
                        else if(!BTSLUtil.isNullString(action) && "V".equalsIgnoreCase(action)){
                                if(BTSLUtil.isNullString(extCode)){
                                        throw new BTSLBaseException("USSDStringParser","parseC2SStatusRequest",PretupsErrorCodesI.XML_ERROR_INVALIDREQUESTFORMAT);
                                }
                        }
                        if(BTSLUtil.isNullString(extCode))
                                parsedRequestStr = type + chnl_message_sep + action ;
                        else
                                parsedRequestStr = type + chnl_message_sep + action +  chnl_message_sep + extCode;
                        p_requestVO.setSenderLocale(LocaleMasterCache.getLocaleFromCodeDetails(language1));
                        p_requestVO.setRequestMSISDN(msisdn);
                        p_requestVO.setExternalNetworkCode(extNetworkCode);
                        p_requestVO.setSenderExternalCode(extCode);
                        p_requestVO.setEnquiryServiceType(type);
                        p_requestVO.setExternalReferenceNum(extRefNum);
                        p_requestVO.setDecryptedMessage(parsedRequestStr);
                        p_requestVO.setRequestMap(requestMap);
                        p_requestVO.setUssdSessionID(ussdSessionID);
                ...
                catch(Exception e)
                {
                        ...
                        p_requestVO.setMessageCode(PretupsErrorCodesI.XML_ERROR_INVALIDMESSAGEFORMAT);
                        _log.error("parseC2SStatusRequest","Exception e: "+e);
                        EventHandler.handle(EventIDI.SYSTEM_ERROR,EventComponentI.SYSTEM,EventStatusI.RAISED,EventLevelI.FATAL,"USSDStringParser[parseRetListRequest]",PretupsErrorCodesI.XML_ERROR_INVALIDREQUESTFORMAT,"","","parseRetListRequest:"+e.getMessage());
                        throw new BTSLBaseException("ClaroUSSDStringParser","parseRetListRequest",PretupsErrorCodesI.XML_ERROR_INVALIDREQUESTFORMAT);
                }
                finally
                {
                        if(_log.isDebugEnabled())_log.debug("parseRetListRequest","Exiting  p_requestVO: "+p_requestVO.toString());
                }
        }
         public static void generateRetListResponse(RequestVO p_requestVO) throws Exception {
                final String methodName = "generateRetListResponse";
                if (_log.isDebugEnabled()) {
                    _log.debug(methodName, "Entered p_requestVO: " + p_requestVO.toString());
                }
                String responseStr = null;
                ...
                if (p_requestVO.isSuccessTxn()) {
                        ...
                        sbf.append("TXNSTATUS=" + message + "&");
                    }
                    if (p_requestVO.getRequestMap() != null) {
                        sbf.append("EXTREFNUM=" + (String) p_requestVO.getRequestMap().get("EXTREFNUM") + "&");
                    } else {
                        sbf.append("EXTREFNUM=&");
                    }
                    sbf.append("RECORD=");
                    if("L".equalsIgnoreCase((String)p_requestVO.getRequestMap().get("ACTION"))){
                        String msisdnList=getMessage(p_requestVO.getLocale(), p_requestVO.getMessageCode(), p_requestVO.getMessageArguments());
                        if(msisdnList.contains(",")){
                                String msisdnArray[]=msisdnList.split("[,]");
                                for(int count=0;count<msisdnArray.length;count++){
                                        sbf.append(msisdnArray[count]);
                                        sbf.append("\\n");
                                }
                        }
                    }
                    ...
                    _log.error(methodName, "Exception e: " + e);
                    p_requestVO.setMessageCode(PretupsErrorCodesI.XML_ERROR_EXCEPTION);
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ClaroUSSDStringParser[generateRetListResponse]",
                        PretupsErrorCodesI.XML_ERROR_EXCEPTION, "", "", "generateRetListResponse:" + e.getMessage());
                } finally {
                    if (_log.isDebugEnabled()) {
                        _log.debug(methodName, "Exiting responseStr: " + responseStr);
                    }
         ...
         public static void parseOLOTransferRequest(RequestVO p_requestVO) throws Exception{
     		if(_log.isDebugEnabled())_log.debug("parseOLOTransferRequest","Entered p_requestVO: "+p_requestVO.toString());
     		String parsedRequestStr=null;
     		String cellId=null;
     		String switchId=null;
     		...
     		try
     		{
     			...
     			String selector=(String)requestMap.get("SELECTOR");
     			String msisdn2=(String)requestMap.get("MSISDN2");

     			String planID=(String)requestMap.get("IDPLAN");
     			String msisdn1=(String)requestMap.get("MSISDN1");
     			String amount=(String)requestMap.get("AMOUNT");

     			String language1=(String)requestMap.get(LANG1_STR);
     			String language2=(String)requestMap.get(LANG2_STR);
     		    
     			String ussdSessionID=(String)requestMap.get(USSD_SESSION_ID);	 
     			String pin=(String)requestMap.get("PIN");
     			cellId=(String)requestMap.get(CELLID_STR);
     			switchId=(String)requestMap.get(SWITCHID_STR);

     			if(BTSLUtil.isNullString(type) || BTSLUtil.isNullString(msisdn1) ||BTSLUtil.isNullString(pin) || BTSLUtil.isNullString(msisdn2) || BTSLUtil.isNullString(amount) ||BTSLUtil.isNullString(selector)||BTSLUtil.isNullString(planID) )
     			{
     				throw new BTSLBaseException("ClaroUSSDStringParser","parseOLOTransferRequest",PretupsErrorCodesI.C2S_ERROR_MISSING_MANDATORY_FIELD);
     			}
     			if(BTSLUtil.isNullString(selector))
     			{
     				ServiceSelectorMappingVO serviceSelectorMappingVO=ServiceSelectorMappingCache.getDefaultSelectorForServiceType(PretupsI.SERVICE_TYPE_OLO_RECHARGE);
     				if(serviceSelectorMappingVO!=null)
     					selector=serviceSelectorMappingVO.getSelectorCode();
     			}
     			...
     			if(!BTSLUtil.isNullString(p_requestVO.getMessageGatewayVO().getGatewayCode())&& (p_requestVO.getMessageGatewayVO().getGatewayCode().equals("EXTGW")))
     			{
     				externalNetworkCode=(String)requestMap.get(EXTNWCODE_STR);
     				if(BTSLUtil.isNullString(externalNetworkCode))
     					throw new BTSLBaseException("ClaroUSSDStringParser","parseOLOTransferRequest",PretupsErrorCodesI.C2S_ERROR_INVALIDMESSAGEFORMAT);
     			}
     			...
     			if(tagsMandatory)
     			{
     				try{
     					if(BTSLUtil.isNullString(cellId))
     					{
     						throw new BTSLBaseException("ClaroUSSDStringParser","parseOLOTransferRequest",PretupsErrorCodesI.USSD_CELLID_BLANK__ERROR);
     					}
     					if(BTSLUtil.isNullString(switchId))
     					{
     						throw new BTSLBaseException("ClaroUSSDStringParser","parseOLOTransferRequest",PretupsErrorCodesI.USSD_SWITCHID_BLANK__ERROR);
     					}
     				}catch(BTSLBaseException btsle){
     					throw btsle;
     				}
     			...
     			parsedRequestStr=PretupsI.SERVICE_TYPE_OLO_RECHARGE+chnl_message_sep+msisdn2+chnl_message_sep+amount+chnl_message_sep+planID+chnl_message_sep+selector+chnl_message_sep+language1+chnl_message_sep+language2+chnl_message_sep+pin;
     		...
     		catch(Exception e)
     		{
     			e.printStackTrace();
     			p_requestVO.setMessageCode(PretupsErrorCodesI.C2S_ERROR_INVALIDMESSAGEFORMAT);
     			_log.error("parseOLOTransferRequest","Exception e: "+e);
     			throw new BTSLBaseException("ClaroUSSDStringParser","parseOLOTransferRequest",PretupsErrorCodesI.C2S_ERROR_INVALIDMESSAGEFORMAT);
     		}
     		finally
     		{
     			if(_log.isDebugEnabled())_log.debug("parseOLOTransferRequest","Exiting p_requestVO: "+p_requestVO.toString());
     		}
     	}
     	
     	public static void generateOLOTransferResponse(RequestVO p_requestVO) throws Exception
     	{
     		if(_log.isDebugEnabled())_log.debug("generateOLOTransferResponse","Entered p_requestVO: "+p_requestVO.toString());
     		String responseStr= null;
     		StringBuffer sbf=null;
     		try
     		{
     			...
     			if(p_requestVO.isSuccessTxn())
     			{
     				if(p_requestVO.getMessageGatewayVO()==null || p_requestVO.getMessageGatewayVO().getFlowType()==null)
     		   		{
     		   			sbf.append(getMessage(p_requestVO.getLocale(),"UNDERPROCESS",p_requestVO.getMessageArguments()));
     		   		}
     		   		else if(p_requestVO.getMessageGatewayVO().getFlowType().equals(PretupsI.MSG_GATEWAY_FLOW_TYPE_COMMON))
     				{
     		   			sbf.append(getMessage(p_requestVO.getLocale(),"UNDERPROCESS",p_requestVO.getMessageArguments()));
     				...
     				{
     					sbf.append(getMessage(p_requestVO.getLocale(),"SUCCESS"+underProcess,p_requestVO.getMessageArguments()));
     				}else
     				{
     					sbf.append(getMessage(p_requestVO.getLocale(),"UNDERPROCESS",p_requestVO.getMessageArguments()));
     				}
     		...
     		catch(Exception e)
     		{
     			e.printStackTrace();
     			p_requestVO.setMessageCode(PretupsErrorCodesI.XML_ERROR_EXCEPTION);
     			EventHandler.handle(EventIDI.SYSTEM_ERROR,EventComponentI.SYSTEM,EventStatusI.RAISED,EventLevelI.FATAL,"ClaroUSSDStringParser[generateOLOTransferResponse]",PretupsErrorCodesI.XML_ERROR_EXCEPTION,"","","generateOLOTransferResponse:"+e.getMessage());
     		}
     		finally
     		{
     			if(_log.isDebugEnabled())_log.debug("generateOLOTransferResponse","Exiting responseStr: "+responseStr);
     		}
     	}
