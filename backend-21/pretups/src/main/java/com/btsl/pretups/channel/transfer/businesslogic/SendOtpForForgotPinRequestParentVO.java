...
public class SendOtpForForgotPinRequestParentVO {
	
	@JsonProperty("reqGatewayLoginId")
	private String reqGatewayLoginId;
	
	@JsonProperty("data")
	SendOtpForForgotPinData data;
	...
	@JsonProperty("data")
	public SendOtpForForgotPinData getData() {
		return data;
	}

	public void setData(SendOtpForForgotPinData data) {
		this.data = data;
	}
