...
public class C2STransactionRequestParentVO {
	...
	@JsonProperty("data")
	public AllTransactionRequest getData() {
		return data;
	}

	public void setData(AllTransactionRequest data) {
		this.data = data;
	}
