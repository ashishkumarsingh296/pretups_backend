...
/**
 * @(#)MCDListCreditTransferThreadThread.java
...
public class MCDListCreditTransferThread implements Runnable {
    private static Log _log = LogFactory.getLog(MCDListCreditTransferThread.class.getName());
    ...
    public MCDListCreditTransferThread() {
    ...
    static {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "MCDListCreditTransferThread[initialize]", "", "", "",
    ...
    public void process(RequestVO p_requestVO) {
        ...
        MCDListCreditTransferThread newContr = null;
        try {
            seperator = ((String) PreferenceCache.getSystemPreferenceValue(PreferenceI.MCDL_DIFFERENT_REQUEST_SEPERATOR));
            ...
            if (!BTSLUtil.isNullString(decrMsg) && decrMsg.contains(seperator)) {
                if (!BTSLUtil.isNullString(decrMsg)) {
                    ...
                    for (int i = 0; i < reqMsgArr.length; i++) {
                        ...
                        p_requestVO.setServiceType(PretupsI.MULT_CRE_TRA_DED_ACC);
                        newContr = new MCDListCreditTransferThread();
    ...
    public void processReq(RequestVO p_requestVO) {
        ...
        try {
            ...
            if (p_requestVO.getServiceType().equals(PretupsI.REQUEST_TYPE_ACCEPT)) {
                ...
                _operatorUtil.handleMCDTransferMessageFormat(con, p_requestVO, _p2pTransferVO);
            }
            ...
            if (_type.equals(PretupsI.INTERFACE_CATEGORY_BOTH)) {
                ...
                if (_serviceInterfaceRoutingVO != null) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "MCDListCreditTransferThread[process]", "",
                ...
                if (_serviceInterfaceRoutingVO != null) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "MCDListCreditTransferThread[process]", "",
            ...
            if (!_receiverVO.getSubscriberType().equals(_type)) {
                ...
                if (_networkPrefixVO != null) {
                    ...
                    EventHandler
                        .handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "MCDListCreditTransferThread[process]", "", "", "",
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                throw new BTSLBaseException("MCDListCreditTransferThread", "process", PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
            }
            ...
            if (((Boolean) PreferenceCache.getSystemPreferenceValue(PreferenceI.SKEY_REQUIRED)).booleanValue() && _senderVO.getSkeyRequired().equals(PretupsI.YES)) {
				...
				if (mcomCon != null) {
					mcomCon.close("MCDListCreditTransferThread#processReq");
					mcomCon = null;
				}
                con = null;
            ...
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "MCDListCreditTransferThread[process]", _transferID,
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "MCDListCreditTransferThread[process]", _transferID,
                _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            TransactionLog.log(_transferID, _requestIDStr, p_requestVO.getFilteredMSISDN(), "", PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
                _p2pTransferVO.getSenderReturnMessage(), PretupsI.TXN_LOG_STATUS_FAIL, "Getting Code=" + p_requestVO.getMessageCode());
            // Populate the P2PRequestDailyLog and log
    ...
    private void processSKeyGen(Connection p_con) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "MCDListCreditTransferThread[processSKeyGen]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException("MCDListCreditTransferThread", methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
        ...
        try {
            ...
            try {
                ...
                if (!_senderVO.isDefUserRegistration() && _senderTransferItemVO.getValidationStatus().equals(InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND)) {
                    throw new BTSLBaseException("MCDListCreditTransferThread", methodName, PretupsErrorCodesI.P2P_SENDER_ALREADY_REG_NOT_FOUND_IN_VAL, 0,
            ...
            if ((System.currentTimeMillis() - _p2pTransferVO.getRequestStartTime()) > interfaceVO.getValExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                    "MCDListCreditTransferThread[processValidationRequest]", _transferID, _senderMSISDN, _senderNetworkCode,
                    "Exception: System is taking more time till validation of sender");
                throw new BTSLBaseException("MCDListCreditTransferThread", methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION_TKING_TIME_TILL_VAL_S);
            }
            interfaceVO = null;
            ...
            if (con != null) {
				...
				if (mcomCon != null) {
					mcomCon.close("MCDListCreditTransferThread#processValidationRequest");
					mcomCon = null;
				}
                con = null;
            }
            ...
            if ((System.currentTimeMillis() - _p2pTransferVO.getRequestStartTime()) > interfaceVO.getValExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "MCDListCreditTransferThread[run]", _transferID,
                    _senderMSISDN, _senderNetworkCode, "Exception: System is taking more time till validation of reciever");
                throw new BTSLBaseException("MCDListCreditTransferThread", methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION_TKING_TIME_TILL_VAL_R);
            }
            interfaceVO = null;
            ...
            if ((System.currentTimeMillis() - _p2pTransferVO.getRequestStartTime()) > interfaceVO.getTopUpExpiryTime()) {
                ...
                throw new BTSLBaseException("MCDListCreditTransferThread", methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION_TKING_TIME_TILL_TOPUP);
            }
            interfaceVO = null;
            ...
            _log.error("MCDListCreditTransferThread[processValidationRequest]", "Getting BTSL Base Exception:" + be.getMessage());
            throw be;
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
            if (con != null) {
            ...
            _log.error("MCDListCreditTransferThread[processValidationRequest]", "Getting Exception:" + e.getMessage());
            if (BTSLUtil.isNullString(_receiverTransferItemVO.getTransferStatus()) || _receiverTransferItemVO.getTransferStatus().equals(InterfaceErrorCodesI.SUCCESS)) {
                _receiverTransferItemVO.setTransferStatus(PretupsErrorCodesI.REQUEST_NOT_APPLICABLE);
                _receiverTransferItemVO.setUpdateStatus(PretupsErrorCodesI.REQUEST_NOT_APPLICABLE);
                _senderTransferItemVO.setTransferStatus(PretupsErrorCodesI.REQUEST_NOT_APPLICABLE);
            ...
            throw new BTSLBaseException(this, methodName, "Error code: "+PretupsErrorCodesI.REQUEST_NOT_APPLICABLE);
        } finally {
			if (mcomCon != null) {
				mcomCon.close("MCDListCreditTransferThread#processValidationRequest");
				mcomCon = null;
    ...
    public void processTransfer(Connection p_con) throws BTSLBaseException {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "MCDListCreditTransferThread[processTransfer]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException("MCDListCreditTransferThread", methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        }
    }
    ...
    public void run() {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "MCDListCreditTransferThread[run]", _transferID,
                _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            ...
            try {
                ...
                try {
                    ...
                    _log.errorTrace(methodName, e);
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "MCDListCreditTransferThread[run]",
            ...
            if (con != null) {
				...
				if (mcomCon != null) {
					mcomCon.close("MCDListCreditTransferThread#run");
					mcomCon = null;
				}
                con = null;
            }
    ...
    public void populateServicePaymentInterfaceDetails(Connection p_con, String action) throws BTSLBaseException {
        ...
        if (!isSenderFound) {
            if (!_senderVO.isDefUserRegistration()) {
                throw new BTSLBaseException("MCDListCreditTransferThread", "populateServicePaymentInterfaceDetails",
            ...
            throw new BTSLBaseException("MCDListCreditTransferThread", "populateServicePaymentInterfaceDetails", PretupsErrorCodesI.P2P_NOTFOUND_PAYMENTINTERFACEMAPPING);
        }
        ...
        if ((!_receiverInterfaceInfoInDBFound && action.equals(PretupsI.INTERFACE_NETWORK_PREFIX_UPDATE_ACTION)) || action
            ...
            if (action.equals(PretupsI.INTERFACE_NETWORK_PREFIX_VALIDATION_ACTION) && !isReceiverFound && _performIntfceCatRoutingBeforeVal && _useAlternateCategory && !_interfaceCatRoutingDone) {
                ...
                if (_networkPrefixVO != null) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                        "MCDListCreditTransferThread[populateServicePaymentInterfaceDetails]", "", "", "",
                        "Series =" + _receiverVO.getMsisdnPrefix() + " Not Defined for Series type=" + _type + " But alternate Category Routing was required on interface");
        ...
        if (!isReceiverFound) {
            throw new BTSLBaseException("MCDListCreditTransferThread", "populateServicePaymentInterfaceDetails", PretupsErrorCodesI.P2P_NOTFOUND_SERVICEINTERFACEMAPPING);
        }
    }
    ...
    public void updateForSenderValidateResponse(String str) throws BTSLBaseException {
        ...
        if ((!InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(status) && isLDCCTest) || isRequired) {
            ...
            if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
                ...
                throw new BTSLBaseException("MCDListCreditTransferThread", methodName, _p2pTransferVO.getErrorCode(), 0, strArr, null);
            }
            _senderTransferItemVO.setTransferStatus(status);
        ...
        try {
            ...
            if (senderLoadStatus == 0) {
                ...
                if (recieverLoadStatus == 0) {
                    ...
                    if (_log.isDebugEnabled()) {
                        _log.debug("MCDListCreditTransferThread[checkTransactionLoad()]", "_transferID=" + _transferID + " Successfully through load");
                    }
                }
                // Request in Queue
                    ...
                    throw new BTSLBaseException("MCDListCreditTransferThread", "checkTransactionLoad()", PretupsErrorCodesI.REQUEST_IN_QUEUE, 0, strArr, null);
                }
                // Refuse the request
                else {
                    throw new BTSLBaseException("MCDListCreditTransferThread", "checkTransactionLoad()", PretupsErrorCodesI.REQUEST_REFUSE_FROM_INTLOAD);
                }
            }
            // Request in Queue
            ...
            _log.error("MCDListCreditTransferThread[checkTransactionLoad()]", "Refusing request getting Exception:" + be.getMessage());
            throw be;
        } catch (Exception e) {
            _log.errorTrace("checkTransactionLoad", e);
            throw new BTSLBaseException("MCDListCreditTransferThread", "checkTransactionLoad()", PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        }
    }
            ...
            if (PretupsI.USER_TYPE_SENDER.equals(p_userType)) {
                ...
                if (senderLoadStatus == 0) {
                    ...
                    // Refuse the request
                        ...
                        throw new BTSLBaseException("MCDListCreditTransferThread", methodName, PretupsErrorCodesI.REQUEST_REFUSE_FROM_INTLOAD);
                    }
                }
                // Request in Queue
                else if (senderLoadStatus == 1) {
                    final String strArr[] = { _receiverMSISDN, String.valueOf(_p2pTransferVO.getRequestedAmount()) };
                    throw new BTSLBaseException("MCDListCreditTransferThread", methodName, PretupsErrorCodesI.REQUEST_IN_QUEUE, 0, strArr, null);
                }
                // Refuse the request
                else {
                    throw new BTSLBaseException("MCDListCreditTransferThread", methodName, PretupsErrorCodesI.REQUEST_REFUSE_FROM_INTLOAD);
    ...
    public void processFromQueue(TransferVO p_transferVO) {
        ...
        try {
            ...
            if (_type.equals(PretupsI.INTERFACE_CATEGORY_BOTH)) {
                ...
                if (_serviceInterfaceRoutingVO != null) {
                    ...
                    _log.info(methodName, _requestIDStr,
                        "Service Interface Routing control Not defined, thus using default type=" + ((String) PreferenceCache.getSystemPreferenceValue(PreferenceI.TRSFR_DEF_SRVCTYPE)));
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "MCDListCreditTransferThread[processFromQueue]",
                        "", _senderMSISDN, _senderNetworkCode,
                        "Service Interface Routing control Not defined, thus using default type=" + ((String) PreferenceCache.getSystemPreferenceValue(PreferenceI.TRSFR_DEF_SRVCTYPE)));
                    _type = ((String) PreferenceCache.getSystemPreferenceValue(PreferenceI.TRSFR_DEF_SRVCTYPE));
                    // Changed on 27/05/07 for Service Type selector Mapping
                ...
                if (_serviceInterfaceRoutingVO != null) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "MCDListCreditTransferThread[processFromQueue]",
                        "", _senderMSISDN, _senderNetworkCode, "Service Interface Routing control Not defined, thus using default selector=" + _oldDefaultSelector);
                }
            }
			...
			if (mcomCon != null) {
				mcomCon.close("MCDListCreditTransferThread#processFromQueue");
				mcomCon = null;
			}
            con = null;
            ...
            if (_log.isDebugEnabled()) {
                _log.debug("MCDListCreditTransferThread[processFromQueue]", "_transferID=" + _transferID + " Successfully through load");
            }
            processValidationRequest();
            ...
            TransactionLog.log(_transferID, _requestIDStr, _requestVO.getFilteredMSISDN(), "", PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS, _p2pTransferVO
                .getSenderReturnMessage(), PretupsI.TXN_LOG_STATUS_FAIL, "Getting Code=" + _requestVO.getMessageCode());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "MCDListCreditTransferThread[processFromQueue]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
        } finally {
            try {
                if (mcomCon == null) {
    ...
    private void creditBackSenderForFailedTrans(CommonClient p_commonClient, boolean p_onlyDecreaseOnly) throws BTSLBaseException {
        ...
        try {
                ...
                if (((Boolean) (PreferenceCache.getSystemPreferenceValue(PreferenceI.P2P_SNDR_CREDIT_BACK_ALLOWED))).booleanValue()) {
                    if ((((Boolean) (PreferenceCache.getSystemPreferenceValue(PreferenceI.P2P_SNDR_CREDIT_BK_AMB_STATUS))).booleanValue() && _p2pTransferVO.getTransferStatus().equalsIgnoreCase(PretupsErrorCodesI.TXN_STATUS_AMBIGUOUS)) || _p2pTransferVO
                        ...
                        if (isCounterToBeDecreased) {
                            SubscriberBL.decreaseTransferOutCounts(con, _p2pTransferVO,PretupsI.P2P_MCD_LIST_SERVICE_TYPE);
                        }
                        ...
                        EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                            "MCDListCreditTransferThread[processFromQueue]", _transferID, _senderMSISDN, _senderNetworkCode,
                            "Credit back not required in case of Ambigous cases");
                    }
                } else {
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                        "MCDListCreditTransferThread[creditBackSenderForFailedTrans]", _transferID, _senderMSISDN, _senderNetworkCode,
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "MCDListCreditTransferThread[creditBackSenderForFailedTrans]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            TransactionLog.log(_transferID, _requestIDStr, _senderMSISDN, "", PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
			...
			if (mcomCon != null) {
				mcomCon.close("MCDListCreditTransferThread#creditBackSenderForFailedTrans");
				mcomCon = null;
			}
        }
    ...
    private void processValidationRequestInThread() throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _log.errorTrace(methodName, be);
            _log.error("MCDListCreditTransferThread[processValidationRequestInThread]", "Getting BTSL Base Exception:" + be.getMessage());
            TransactionLog.log(_transferID, _requestIDStr, _senderMSISDN, _senderNetworkCode, PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "MCDListCreditTransferThread[processValidationRequestInThread]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            TransactionLog.log(_transferID, _requestIDStr, _senderMSISDN, _senderNetworkCode, PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
            ...
            if (_transferID != null && !_transferDetailAdded) {
                ...
                try {
					...
					if (mcomCon != null) {
						mcomCon.close("MCDListCreditTransferThread#processValidationRequestInThread");
						mcomCon = null;
					}
                    con = null;
                }
    ...
    private boolean getInterfaceRoutingDetails(Connection p_con, String p_msisdn, long p_prefixID, String p_subscriberType, String p_networkCode, String p_serviceType, String p_interfaceCategory, String p_userType, String p_action) throws BTSLBaseException {
        ...
        try {
            if (subscriberRoutingControlVO != null) {
                    ...
                    if (p_interfaceCategory.equalsIgnoreCase(PretupsI.INTERFACE_CATEGORY_PRE)) {
                        ...
                        if (listValueVO != null) {
                            ...
                            try {
                                ...
                                // added by rahul.d to check service selector
                                // based check load of interface
                ...
                // based routing
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                    "MCDListCreditTransferThread[getInterfaceRoutingDetails]", _transferID, _senderMSISDN, _senderNetworkCode,
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "MCDListCreditTransferThread[getInterfaceRoutingDetails]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            isSuccess = false;
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        }
        if (_log.isDebugEnabled()) {
        ...
        try {
            if (altList != null && !altList.isEmpty()) {
                ...
                case 1: {
					...
					if (mcomCon != null) {
						mcomCon.close("MCDListCreditTransferThread#performSenderAlternateRouting");
						mcomCon = null;
					}
                    con=null;
                    ...
                    try {
                        ...
                        if (be.isKey() && InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(be.getMessageKey())) {
                            ...
                            try {
                                ...
                                _log.errorTrace(methodName, e);
                                throw new BTSLBaseException(this, methodName, "Exception in performing the sender alternate intreface routing controls Case 2");
                            }
                        } else {
                            throw be;
                        }
                        ...
                        _log.errorTrace(methodName, e);
                        throw new BTSLBaseException(this, methodName, "Exception in performing the sender alternate intreface routing");
                    }
                    break;
                }
                }
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "MCDListCreditTransferThread[performSenderAlternateRouting]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        } finally {
			if (mcomCon != null) {
				mcomCon.close("MCDListCreditTransferThread#performSenderAlternateRouting");
            ...
            try {
                if (LocaleMasterCache.getLocaleFromCodeDetails(p_languageCode) == null) {
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                        "MCDListCreditTransferThread[updateReceiverLocale]", _transferID, _receiverMSISDN, "",
    ...
    public void performAlternateCategoryRouting() throws BTSLBaseException {
        ...
        try {
            ...
            if (con != null) {
				...
				if (mcomCon != null) {
					mcomCon.close("MCDListCreditTransferThread#performAlternateCategoryRouting");
					mcomCon = null;
				}
                con = null;
            }
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "MCDListCreditTransferThread[performAlternateCategoryRouting]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        } finally {
            if (con != null) {
                try {
    ...
    public void populateAlternateInterfaceDetails(Connection p_con) throws BTSLBaseException {
        ...
        if (!_interfaceCatRoutingDone) {
            ...
            if (_networkPrefixVO != null) {
                ...
                _log.error(this, "Series Not Defined for Alternate Interface =" + _type + " For Series=" + _receiverVO.getMsisdnPrefix());
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                    "MCDListCreditTransferThread[populateAlternateInterfaceDetails]", "", "", "",
    ...
    private void performReceiverAlternateRouting(ArrayList altList, int p_source) throws BTSLBaseException {
        ...
        try {
            if (altList != null && !altList.isEmpty()) {
                ...
                case 1: {
                    ...
                    try {
                        ...
                        _log.errorTrace(methodName, e);
                        throw new BTSLBaseException(this, methodName, "Exception in performing the Interface routing for the subscriber MSISDN");
                    }
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "MCDListCreditTransferThread[performAlternateRouting]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        }
        if (_log.isDebugEnabled()) {
    ...
    public void receiverValidateResponse(String str, int p_attempt, int p_altSize, int p_source) throws BTSLBaseException {
        ...
        if (InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(status) && p_attempt == 1 && p_attempt < p_altSize) {
            ...
            if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
                ...
                strArr = new String[] { _receiverMSISDN, PretupsBL.getDisplayAmount(_p2pTransferVO.getRequestedAmount()), _transferID };
                throw new BTSLBaseException("MCDListCreditTransferThread", "receiverValidateResponse", PretupsErrorCodesI.P2P_SENDER_FAIL, 0, strArr, null);
            }
            _receiverTransferItemVO.setTransferStatus(status);
            _receiverVO.setTransactionStatus(PretupsErrorCodesI.TXN_STATUS_SUCCESS);
            _receiverTransferItemVO.setSubscriberType(_type);
    ...
    public void populateReceiverItemsDetails(HashMap p_map) throws BTSLBaseException {
        ...
        if (!BTSLUtil.isNullString((String) p_map.get("IN_TXN_ID"))) {
            try {
                ...
                _log.errorTrace(METHOD_NAME, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                    "MCDListCreditTransferThread[updateForReceiverValidateResponse]", _transferID, _senderMSISDN, _senderNetworkCode,
        ...
        if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
            ...
            strArr = new String[] { _receiverMSISDN, PretupsBL.getDisplayAmount(_p2pTransferVO.getRequestedAmount()), _transferID };
            if (InterfaceErrorCodesI.INTERFACE_CUSTOMER_RECHARGENOTALLOWED_P2P.equals(_receiverTransferItemVO.getValidationStatus())) {
                throw new BTSLBaseException("MCDListCreditTransferThread", "populateReceiverItemsDetails",
                    InterfaceErrorCodesI.INTERFACE_CUSTOMER_RECHARGENOTALLOWED_P2P + "_S", 0, strArr, null);
            } else {
                throw new BTSLBaseException("MCDListCreditTransferThread", "populateReceiverItemsDetails", _p2pTransferVO.getErrorCode(), 0, strArr, null);
            }
        }
        _receiverTransferItemVO.setTransferStatus(status);
        _receiverTransferItemVO.setSubscriberType(_type);
    ...
    private void setInterfaceDetails(long p_prefixID, String p_userType, ListValueVO p_listValueVO, boolean p_useInterfacePrefixVO, MSISDNPrefixInterfaceMappingVO p_MSISDNPrefixInterfaceMappingVO, ServiceSelectorInterfaceMappingVO p_serviceSelectorInterfaceMappingVO) throws BTSLBaseException {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "MCDListCreditTransferThread[setInterfaceDetails]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
    ...
    private void updateSubscriberRoutingDetails(String p_userType, String p_networkCode, String p_interfaceID, String p_externalID, String p_msisdn, String p_interfaceCategory, String p_userID, Date p_currentDate) throws BTSLBaseException {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "MCDListCreditTransferThread[updateSubscriberRoutingDetails]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, _requestIDStr, " Exiting ");
    ...
    public static synchronized void generateTransferID(TransferVO p_transferVO) throws BTSLBaseException {
        ...
        try {
            ...
            if (_transactionIDCounter == 0) {
                throw new BTSLBaseException("MCDListCreditTransferThread", methodName, PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
            transferID = _operatorUtil.formatMCDLP2PTransferID(p_transferVO, _transactionIDCounter);
            if (transferID == null) {
                throw new BTSLBaseException("MCDListCreditTransferThread", methodName, PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
    ...
    public void handleLDCCRequest() throws BTSLBaseException {
        ...
        try {
			...
			if (mcomCon != null) {
				mcomCon.close("MCDListCreditTransferThread#handleLDCCRequest");
				mcomCon = null;
			}
            con=null;
            requestStr = getSenderValidateStr();
    ...
    private void updateSubscriberAilternateRouting(String p_userType, String p_networkCode, String p_interfaceID, String p_externalID, String p_msisdn, String p_interfaceCategory, String p_userID, Date p_currentDate) throws BTSLBaseException {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "MCDListCreditTransferThread[updateSubscriberAilternateRouting]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, _requestIDStr, " Exiting ");
    ...
    private String getSenderFinalMessage(Locale p_senderLocale, String p_Msisdn, int p_succReq, int p_totalReq, boolean p_isSuccess) {
        ...
        if (p_isSuccess) {
            key = PretupsErrorCodesI.MCDL_SUCCESS_DEDICATED_ACC;
            messageArgArray = new String[] { String.valueOf(p_succReq), String.valueOf(p_totalReq) };
        } else {
            key = PretupsErrorCodesI.MCDL_FAIL_DEDICATED_ACC;
    ...
    private String getReceiverSuccessMessage() {
        ...
        if ("5".equals(_newDefaultSelector)) {
            key = PretupsErrorCodesI.P2P_MCDL_RECEIVER_SUCCESS_DEDICATED_ACC_MINUTES;
        } else {
            key = PretupsErrorCodesI.P2P_MCDL_RECEIVER_SUCCESS_DEDICATED_ACC_EGP;
        }
