...
public class O2CChannelUserStockDetailViewResponse extends BaseResponseMultiple{
...
public String toString() {
	...
	builder.append("O2CChannelUserStockDetailViewResponse [fromDate=").append(fromDate).append(", toDate=")
			.append(toDate).append(", totalCount=").append(totalCount).append(", totalValue=").append(totalValue)
			...
			.append(", transferList=").append(", additionalProperties=")
