 ...
 *                         ----------------------------------------------------
 *                         ---------------------------------------------
 *                         Ankit Z 16-Nov-2006 Initital Creation
 *                         ----------------------------------------------------
 *                         ---------------------------------------------
 * 
 */
...
public class LocaleMasterVO implements Serializable, Comparable {

    private static Log _log = LogFactory.getLog(LocaleMasterVO.class.getName());
