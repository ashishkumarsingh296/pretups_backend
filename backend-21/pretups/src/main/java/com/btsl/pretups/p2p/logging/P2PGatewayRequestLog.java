...
public class P2PGatewayRequestLog {
    ...
    private static String generateMessageString(RequestVO p_requestVO) {
        ...
        try {
            ...
            strBuff.append(" [Creation Date:" + BTSLDateUtil.getLocaleDateTimeFromDate(p_requestVO.getCreatedOn()) + "]");
            ...
            if (p_requestVO.getRequestGatewayCode() != null) {
                strBuff
                    .append(" [Other Info:" + p_requestVO.getRequestGatewayCode() + ",Msg Required=" + p_requestVO.isUnmarkSenderUnderProcess() + ", Flow Type=" + ((p_requestVO
                        .getMessageGatewayVO() == null) ? "" : p_requestVO.getMessageGatewayVO().getFlowType()) + " Resp Type=" + p_requestVO.getMsgResponseType() + " Req Content Type=" + p_requestVO
                        .getReqContentType() + "]");
            } else {
                strBuff
                    .append(" [Other Info: Msg Required=" + p_requestVO.isUnmarkSenderUnderProcess() + "Resp Type=" + p_requestVO.getMsgResponseType() + " Req Content Type=" + p_requestVO
                        .getReqContentType() + "]");
            }
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "P2PGatewayRequestLog[generateMessageString]", "",
                p_requestVO.getFilteredMSISDN(), "", "Not able to write in Request Log for Request ID:" + p_requestVO.getRequestID() + " and MSISDN:" + p_requestVO
