...
public class OBFasoUtil extends OperatorUtil{
		...
		public boolean validateTransactionPassword(ChannelUserVO p_channelUserVO, String p_password)throws BTSLBaseException
		{
			...
			try
			{
				if(p_channelUserVO!=null)
				{
					...
					throw new BTSLBaseException("OBFasoUtil", methodName, PretupsErrorCodesI.XML_ERROR_NO_SUCH_USER);
			...
			catch (Exception e)
			{
				...
				throw new BTSLBaseException("OBFasoUtil", methodName, PretupsErrorCodesI.ERROR_EXCEPTION);
			}
			finally
			{
				if(mcomCon != null){mcomCon.close("OBFasoUtil#validateTransactionPassword");mcomCon=null;}
