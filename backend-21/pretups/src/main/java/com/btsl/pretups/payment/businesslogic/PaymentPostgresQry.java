...
public class PaymentPostgresQry implements PaymentQry {
	@Override
	public String loadPaymentKeywordCacheQry(){
        ...
        strBuff.append(" FROM  ");
        strBuff.append(" payment_method_keyword PMK, interface_types IT ,interfaces I left outer join service_classes SC on (SC.interface_id=I.interface_id  AND SC.service_class_code=? AND SC.STATUS<>'N') ");
