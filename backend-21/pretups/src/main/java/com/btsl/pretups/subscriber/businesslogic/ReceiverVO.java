...
public class ReceiverVO extends SubscriberVO implements Serializable {
	...
	private boolean _mnpChecked=false;
	private long invalidPINcount=0;
    ...
    public void setListValueVO(ListValueVO valueVO) {
        _listValueVO = valueVO;
    }

    public boolean is_mnpChecked() {
        return _mnpChecked;
    }

    public void set_mnpChecked(boolean checked) {
        _mnpChecked = checked;
    }
}
