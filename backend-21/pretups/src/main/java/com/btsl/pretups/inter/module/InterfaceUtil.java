...
public class InterfaceUtil {
    ...
    public static long getSystemAmount(double p_validAmount, int p_multiplicationFactor) throws BTSLBaseException {
        ...
        long amount = 0;
        amount = Double.valueOf((p_validAmount * (double) p_multiplicationFactor)).longValue();
        if (_log.isDebugEnabled())
    ...
    public static void insertInDatabase(String p_txnType, HashMap p_requestMap) {
    	String methodName="insertInDatabase";
        if (_log.isDebugEnabled())
        ...
        try {
			...
			if (mcomCon != null) {
				mcomCon.close("InterfaceUtil#insertInDatabase");
				mcomCon = null;
			}
        }
        if (_log.isDebugEnabled())
    ...
    public static void updateInDatabase(String p_txnType, HashMap p_requestMap, String p_txnStatus) {
    	 final String methodName="updateInDatabase";
        Connection con = null;
        MComConnectionI mcomCon = null;
        try {
            InterfaceModuleDAO interfaceModuleDAO = new InterfaceModuleDAO();
			...
			if (mcomCon != null) {
				mcomCon.close("InterfaceUtil#updateInDatabase");
				mcomCon = null;
			}
        }
    }
    ...
    public static InterfaceModuleVO getVOFromMap(String txnType, HashMap _map, String p_status) {
    	String methodName="InterfaceModuleVO";
        if (_log.isDebugEnabled())
        ...
        try {
        	if(_map.get("OLD_EXPIRY_DATE") != null)
            interfaceModuleVO.setMsisdnPreviousExpiry(getDateFromDateString((String) _map.get("OLD_EXPIRY_DATE"), (String) PreferenceCache.getSystemPreferenceValue(PreferenceI.SYSTEM_DATE_FORMAT)));
        } catch (Exception e) {
        	 _log.error(methodName,e);
        }
        try {
        	if(_map.get("NEW_EXPIRY_DATE") != null)
            interfaceModuleVO.setMsisdnNewExpiry(getDateFromDateString((String) _map.get("NEW_EXPIRY_DATE"), (String) PreferenceCache.getSystemPreferenceValue(PreferenceI.SYSTEM_DATE_FORMAT)));
        } catch (Exception e) {
        	 _log.error(methodName,e);
        }
     ...
     * @throws Exception
     */
    public static String getSiemensTransDateTime(String p_format) throws BTSLBaseException {
        if (_log.isDebugEnabled())
     ...
     * @throws BTSLBaseException
     */
    public static double getINAmountFromSystemAmountToIN(double p_validAmount, double p_multiplicationFactor) throws BTSLBaseException {
        if (_log.isDebugEnabled())
    ...
    public static String getSystemAmountFromINAmount(String p_amountStr, double p_multiplicationFactor) throws BTSLBaseException {
        if (_log.isDebugEnabled())
    ...
    public static String getTrunncatedSystemAmountFromINAmount(String p_amountStr, double p_multiplicationFactor, int truncateAfterDec) throws BTSLBaseException {
        if (_log.isDebugEnabled())
     ...
     * @return String
     */
    public static String getErrorCodeFromMapping(Map p_map, String inErrorCode, String mapping) throws Exception {
        if (_log.isDebugEnabled())
    ...
    public static int getDifferenceInUtilDates(Date date1, Date date2) {
        ...
        int noOfDaysDiff = Long.valueOf(((dt1 - dt2) / (1000 * 60 * 60 * 24))).intValue();
        return noOfDaysDiff;
    ...
    public synchronized static String getINTxnID() throws BTSLBaseException {
        if (_log.isDebugEnabled())
	...
	public static String getSystemDataAmountFromINAmount(String pAmountStr,double pMultiplicationFactor , double pDivideFactor) throws BTSLBaseException
	{
		String methodName = "getSystemDataAmountFromINAmount";
	    if(_log.isDebugEnabled())
	    	_log.debug(methodName,"Entered p_amountStr:"+pAmountStr+" MultiplicationFactor "+pMultiplicationFactor+" Divide Factor : "+pDivideFactor);
	    long amountLong=0;
	    try
	    {
	        double amountDouble = Double.parseDouble(pAmountStr);
			
	        amountDouble =amountDouble*pMultiplicationFactor;
			amountDouble = amountDouble/pDivideFactor;
	        amountLong = Math.round(amountDouble);
	    }
	    catch(Exception e)
	    {
	    	 _log.error(methodName,"Exception e: "+e);
	        throw new BTSLBaseException("InterfaceUtil",methodName,InterfaceErrorCodesI.INTERFACE_HANDLER_EXCEPTION);
	    }
	    finally
	    {
	        if(_log.isDebugEnabled())
	        	_log.debug(methodName,"Exiting  amountLong:"+amountLong);
	    }
	    return  String.valueOf(amountLong);
	}
	...
	/**
	 * Used to convert the amount by multipling the amount with multiple factor(double)
	 * @param p_validAmount
	 * @param p_multiplicationFactor
	 * @return
	 * @throws BTSLBaseException
	 */
	public static double getINDataAmountFromSystemDataAmountToIN(double pValidAmount,double pMultiplicationFactor , double pDivideFactor) throws BTSLBaseException 
	{
		String methodName = "getINDataAmountFromSystemDataAmountToIN";
	    if(_log.isDebugEnabled()) 
	    	_log.debug(methodName,"Entered p_validAmount="+pValidAmount+"pMultiplicationFactor="+pMultiplicationFactor+" divideFactor "+pDivideFactor);
	    double amount=0;
	    try
	    {
			amount = pValidAmount*pDivideFactor;
	        amount=amount/pMultiplicationFactor;
	    ...
	    if(_log.isDebugEnabled())
	    	_log.debug(methodName,"Exiting amount:"+amount);
	    return  amount;
	}
