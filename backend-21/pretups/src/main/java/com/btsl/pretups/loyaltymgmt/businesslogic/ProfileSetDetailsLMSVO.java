...
public class ProfileSetDetailsLMSVO implements Serializable {
    ...
    private ArrayList _targetTypeList;
    ...
    public ProfileSetDetailsLMSVO() {
    }

    public ProfileSetDetailsLMSVO(
                    ProfileSetDetailsLMSVO profileSetDetailsVO) {
    ...
    public void setTargetTypeList(ArrayList typeList) {
        _targetTypeList = typeList;
    }
    ...
    public void setSetName(String val) {
        _setName = val;
    }
