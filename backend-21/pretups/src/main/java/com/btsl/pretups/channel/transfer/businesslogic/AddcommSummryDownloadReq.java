...
public class AddcommSummryDownloadReq {

	@JsonProperty("data")
	private AddcommSummryDownloadReqData data;
	@JsonIgnore
	private Map<String, Object> additionalProperties = new HashMap<String, Object>();

	@JsonProperty("data")
	public AddcommSummryDownloadReqData getData() {
		return data;
	}

	@JsonProperty("data")
	public void setData(AddcommSummryDownloadReqData data) {
		this.data = data;
	}
	...
	public class AddcommSummryDownloadReqData {
		...
		@Override
		public String toString() {
			return "AddcommSummryDownloadReqData [fromDate=" + fromDate + ", toDate=" + toDate + ", domain=" + domain + ", geography=" + geography + ", service=" + service
					+ ", fromMonthYear=" + fromMonthYear + ", toMonthYear=" + toMonthYear + "fileType=" + fileType + ", additionalProperties=" + additionalProperties + "]";
		}
