...
public class RegistrationControlVO implements Serializable {
    ...
    public String getKey() {
        final StringBuffer buffer = new StringBuffer(_networkCode);
        buffer.append("_");
    ...
    public boolean equalsRegistrationControlVO(RegistrationControlVO p_registrationControlVO) {
        boolean flag = false;
    ...
    public String differences(RegistrationControlVO p_controlVO) {
        ...
        final StringBuffer sbf = new StringBuffer(100);
