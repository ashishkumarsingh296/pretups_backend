...
/*
 * @# BatchO2CItemsVO.java
 * 
 * Created on Created by History
 * ------------------------------------------------------------------------------
 * --
 * June 22, 2010 Nand.sahu Initial creation
 * ------------------------------------------------------------------------------
 * --
...
public class BatchO2CItemsVO implements Serializable {
    ...
    private long _firstApprovedQuantity;
    private boolean _isSlabDefine;
    private long _secondApprQty;
    private boolean _commCalReqd = false;
    ...
    public String toString() {
        ...
        sbf.append(",_paymentType =" + _paymentType);
        sbf.append(",_userCategory =" + _userCategory);
        sbf.append(",_batchO2CItems =" + _batchO2CItems);
        sbf.append(",_payableAmount =" + _payableAmount);
        sbf.append(",_netPayableAmount =" + _netPayableAmount);
        sbf.append(",_firstApprovedQuantity =" + _firstApprovedQuantity);
        sbf.append(",_isSlabDefine =" + _isSlabDefine);
        return sbf.toString();
    }
    ...
    /**
     * @param isSlabDefine
     *            the isSlabDefine to set
     */
    public void setSlabDefine(boolean isSlabDefine) {
        _isSlabDefine = isSlabDefine;
    }
    ...
    /**
     * @return the firstApprovedQuantity
     */
    public long getFirstApprovedQuantity() {
        return _firstApprovedQuantity;
    }

    /**
     * @param firstApprovedQuantity
     *            the firstApprovedQuantity to set
     */
    public void setFirstApprovedQuantity(long firstApprovedQuantity) {
        _firstApprovedQuantity = firstApprovedQuantity;
    }

    /**
     * @return the secondApprQty
     */
    public long getSecondApprQty() {
        return _secondApprQty;
    }

    /**
     * @param secondApprQty
     *            the secondApprQty to set
     */
    public void setSecondApprQty(long secondApprQty) {
        _secondApprQty = secondApprQty;
    }

    /**
     * @return the commCalReqd
     */
    public boolean getCommCalReqd() {
        return _commCalReqd;
    }

    public boolean isCommCalReqd() {
        return _commCalReqd;
    }

    /**
     * @param commCalReqd
     *            the commCalReqd to set
     */
    public void setCommCalReqd(boolean commCalReqd) {
        _commCalReqd = commCalReqd;
    }

	public static BatchO2CItemsVO getInstance() {
		return new BatchO2CItemsVO();
	}
