...
public class LowthresholdDownloadReq {

    @JsonProperty("data")
    private LowThresholdDownloadReqData data;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("data")
    public LowThresholdDownloadReqData getData() {
        return data;
    }

    @JsonProperty("data")
    public void setData(LowThresholdDownloadReqData data) {
        this.data = data;
    }
    ...
    public class LowThresholdDownloadReqData {
		...
		@Override
		public String toString() {
			return "PassbookDownloadReqData [fromDate=" + fromDate + ", toDate=" + toDate + ", extnwcode=" + extnwcode + "fileType=" + fileType + ", additionalProperties=" + additionalProperties + "]";
		}
