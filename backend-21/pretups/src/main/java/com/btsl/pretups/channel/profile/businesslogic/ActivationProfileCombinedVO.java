...
public class ActivationProfileCombinedVO implements Serializable {

    private ProfileSetDetailsVO _profileSetDetailsVO;
    ...
    public void setSlabsList(ArrayList list) {
        this._slabsList = list;
    }

    public ProfileSetDetailsVO getProfileSetDetailsVO() {
        return _profileSetDetailsVO;
    }

    public void setProfileSetDetailsVO(ProfileSetDetailsVO setDetailsVO) {
    ...
    public void setAmountSlabsList(ArrayList slabsList) {
        this._amountSlabsList = slabsList;
    }
    ...
    public void setCountSlabsList(ArrayList slabsList) {
        this._countSlabsList = slabsList;
    }
