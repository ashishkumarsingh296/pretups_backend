 ...
 *                          ----------------------------------------------------
 *                          ---------------------------------------------
 *                          Puneet Raj Srivastava 10 OCT'10 Intial Creation
 *                          ----------------------------------------------------
 *                          --------------------------------------------
 */
public class UserMigrationVO {
    ...
    public String toString() {
        ...
        strBuff.append("User Msisdn=" + _fromUserMsisdn + ", ");
        strBuff.append("From User ID=" + _fromUserID + ", ");
        strBuff.append("From Parent Msisdn=" + _fromParentMsisdn + ", ");
        strBuff.append("User Login ID=" + _fromUserLoginID + ", ");
        strBuff.append("To Parent Msisdn=" + _toParentMsisdn + ", ");
        return strBuff.toString();
    }

    private int _lineNumber;

    public UserMigrationVO() {
    }
