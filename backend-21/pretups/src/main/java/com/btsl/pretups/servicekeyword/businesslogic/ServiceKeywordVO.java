...
public class ServiceKeywordVO implements Serializable {
    ...
    private String _serviceRequestParam = null;
    private String _gatewayRequestParam = null;
    ...
    public String getServiceRequestParam() {
        return _serviceRequestParam;
    }

    public void setServiceRequestParam(String requestParam) {
        _serviceRequestParam = requestParam;
    }

    public String getGatewayRequestParam() {
        return _gatewayRequestParam;
    }

    public void setGatewayRequestParam(String requestParam) {
        _gatewayRequestParam = requestParam;
    }
}
