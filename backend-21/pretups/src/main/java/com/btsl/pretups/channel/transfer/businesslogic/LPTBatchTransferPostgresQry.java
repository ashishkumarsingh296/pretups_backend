...
public class LPTBatchTransferPostgresQry implements LPTBatchTransferQry{
	@Override
	...
	public String loadBatchDetailsListQry() {
        ...
        strBuff.append(" left join users CNCL_USR on FBI.cancelled_by = CNCL_USR.user_id, categories C, users U left join users OWNU on U.owner_id = OWNU.user_id, ");
