...
public class C2CRecentUserBuyRequestParentVO {
	...
	C2CRecentTxnRequestMessage data;
	...
	@JsonProperty("data")
	public C2CRecentTxnRequestMessage getData() {
		return data;
	}

	public void setData(C2CRecentTxnRequestMessage data) {
		this.data = data;
	}
