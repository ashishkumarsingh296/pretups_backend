...
public class HandleUnsettledC2SCasesLog {
	
		
	private static Log _Filelogger = LogFactory.getLog(HandleUnsettledC2SCasesLog.class.getName());
	    
	private HandleUnsettledC2SCasesLog() {
