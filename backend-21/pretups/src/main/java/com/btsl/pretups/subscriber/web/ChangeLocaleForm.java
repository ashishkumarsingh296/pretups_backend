 ...
 * ------------------------------------------------------------------------------
 * --
 * Sep 20, 2005 Amit Ruwali Initial creation
 * ------------------------------------------------------------------------------
 * --
...
public class ChangeLocaleForm  {
     ...
     */
    public ArrayList getUserPhoneInfoList() {
     ...
     */
    public void setUserPhoneInfoList(ArrayList userPhoneInfoList) {
        _userPhoneInfoList = userPhoneInfoList;
    }
