...
/**
 * @(#)ScheduledPrepaidController.java
 ...
 *                                     ----------------------------------------
 *                                     ---------------
 *                                     Vikas Kumar May 2,2013 Initial Creation
 *                                     ----------------------------------------
 *                                     --
 *                                     ----------------------------------------
 *                                     --------------
...
public class ScheduledPrepaidController implements ServiceKeywordControllerI, Runnable {

    private static Log _log = LogFactory.getLog(ScheduledPrepaidController.class.getName());
    ...
    // required before
    // topup
    private boolean _senderTopupSuccessMessageRequired = false;
    ...
    public ScheduledPrepaidController() {
        _p2pTransferVO = new P2PTransferVO();
        _currentDate = new Date();
        if ("Y".equals(BTSLUtil.NullToString(Constants.getProperty("SC_P2P_REC_GEN_FAIL_MSG_REQD_V")))) {
            _recValidationFailMessageRequired = true;
        }
        if ("Y".equals(BTSLUtil.NullToString(Constants.getProperty("SC_P2P_REC_GEN_FAIL_MSG_REQD_T")))) {
            _recTopupFailMessageRequired = true;
        }
        if ("Y".equals(BTSLUtil.NullToString(Constants.getProperty("SC_P2P_SEN_MSG_REQD_T")))) {
            _senderTopupSuccessMessageRequired = true;
        }
    }
    ...
    static {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ScheduledPrepaidController[initialize]", "", "", "",
        ...
        try {
            ...
            if (_type.equals(PretupsI.INTERFACE_CATEGORY_BOTH)) {
                ...
                if (_serviceInterfaceRoutingVO != null) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "ScheduledPrepaidController[process]", "",
                ...
                if (_serviceInterfaceRoutingVO != null) {
                    ...
                    // _oldDefaultSelector=String.valueOf(((String) PreferenceCache.getSystemPreferenceValue(PreferenceI.P2P_TRANSFER_DEF_SELECTOR_CODE)));
                    // Changed on 27/05/07 for Service Type selector Mapping
                    final ServiceSelectorMappingVO serviceSelectorMappingVO = ServiceSelectorMappingCache.getDefaultSelectorForServiceType(_p2pTransferVO.getServiceType());
                    if (serviceSelectorMappingVO != null) {
                        _oldDefaultSelector = serviceSelectorMappingVO.getSelectorCode();
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "ScheduledPrepaidController[process]", "",
            ...
            if (!_receiverVO.getSubscriberType().equals(_type)) {
                ...
                if (_networkPrefixVO != null) {
                    ...
                    EventHandler
                        .handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "ScheduledPrepaidController[process]", "", "", "",
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                throw new BTSLBaseException("ScheduledPrepaidController", methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
            }
            ...
            if (((Boolean) PreferenceCache.getSystemPreferenceValue(PreferenceI.SKEY_REQUIRED)).booleanValue() && _senderVO.getSkeyRequired().equals(PretupsI.YES)) {
				...
				if (mcomCon != null) {
					mcomCon.close("ScheduledPrepaidController#process");
					mcomCon = null;
				}
                con = null;
            ...
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "ScheduledPrepaidController[process]", _transferID,
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ScheduledPrepaidController[process]", _transferID,
                _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            TransactionLog.log(_transferID, _requestIDStr, p_requestVO.getFilteredMSISDN(), "", PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
                _p2pTransferVO.getSenderReturnMessage(), PretupsI.TXN_LOG_STATUS_FAIL, "Getting Code=" + p_requestVO.getMessageCode());
            // Populate the P2PRequestDailyLog and log
    ...
    private void processSKeyGen(Connection p_con) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ScheduledPrepaidController[processSKeyGen]",
        ...
        try {
            ...
            try {
                ...
                if (!_senderVO.isDefUserRegistration() && _senderTransferItemVO.getValidationStatus().equals(InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND)) {
                    throw new BTSLBaseException("ScheduledPrepaidController", methodName, PretupsErrorCodesI.P2P_SENDER_ALREADY_REG_NOT_FOUND_IN_VAL, 0,
            ...
            if ((System.currentTimeMillis() - _p2pTransferVO.getRequestStartTime()) > interfaceVO.getValExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "ScheduledPrepaidController[run]", _transferID,
                    _senderMSISDN, _senderNetworkCode, "Exception: System is taking more time till validation of sender");
                throw new BTSLBaseException("ScheduledPrepaidController", methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION_TKING_TIME_TILL_VAL_S);
            }
            interfaceVO = null;
            ...
            if (con != null) {
				...
				if (mcomCon != null) {
					mcomCon.close("ScheduledPrepaidController#processValidationRequest");
					mcomCon = null;
				}
                con = null;
            }
            ...
            if ((System.currentTimeMillis() - _p2pTransferVO.getRequestStartTime()) > interfaceVO.getValExpiryTime()) {
                ...
                throw new BTSLBaseException("ScheduledPrepaidController", methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION_TKING_TIME_TILL_VAL_R);
            }
            interfaceVO = null;
            ...
            if (_senderVO.getSubscriberType().equals(PretupsI.SERIES_TYPE_POSTPAID)) {
                _p2pTransferVO.setSubService(ServiceInterfaceRoutingCache.getServiceInterfaceRoutingDetails(
                    _p2pTransferVO.getNetworkCode() + "_" + PretupsI.SERVICE_TYPE_P2PCREDITRECHARGE + "_" + _senderVO.getSubscriberType()).getInterfaceDefaultSelectortCode());
                _p2pTransferVO.setServiceType(PretupsI.SERVICE_TYPE_P2PCREDITRECHARGE);
            }
            if (_senderVO.getSubscriberType().equals(PretupsI.SERIES_TYPE_PREPAID)) {
                _p2pTransferVO.setSubService(ServiceInterfaceRoutingCache.getServiceInterfaceRoutingDetails(
                    _p2pTransferVO.getNetworkCode() + "_" + PretupsI.SERVICE_TYPE_P2PRECHARGE + "_" + _senderVO.getSubscriberType()).getInterfaceDefaultSelectortCode());
                _p2pTransferVO.setServiceType(PretupsI.SERVICE_TYPE_P2PRECHARGE);
            }
            ...
            _p2pTransferVO.setServiceType(PretupsI.SERVICE_TYPE_SCH_CREDIT_TRANSFER);
            ...
            SubscriberBL.increaseTransferOutCounts(con, _senderTransferItemVO.getServiceClass(), _p2pTransferVO,PretupsI.SERVICE_TYPE_SCH_CREDIT_TRANSFER);
            ...
            if ((System.currentTimeMillis() - _p2pTransferVO.getRequestStartTime()) > interfaceVO.getTopUpExpiryTime()) {
                ...
                throw new BTSLBaseException("ScheduledPrepaidController", "run", PretupsErrorCodesI.P2P_ERROR_EXCEPTION_TKING_TIME_TILL_TOPUP);
            }
            interfaceVO = null;
            ...
            _log.error("ScheduledPrepaidController[processValidationRequest]", "Getting BTSL Base Exception:" + be.getMessage());
            throw be;
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
            if (con != null) {
            ...
            _log.error("ScheduledPrepaidController[processValidationRequest]", "Getting Exception:" + e.getMessage());
            if (BTSLUtil.isNullString(_receiverTransferItemVO.getTransferStatus()) || _receiverTransferItemVO.getTransferStatus().equals(InterfaceErrorCodesI.SUCCESS)) {
                _receiverTransferItemVO.setTransferStatus(PretupsErrorCodesI.REQUEST_NOT_APPLICABLE);
                _receiverTransferItemVO.setUpdateStatus(PretupsErrorCodesI.REQUEST_NOT_APPLICABLE);
                _senderTransferItemVO.setTransferStatus(PretupsErrorCodesI.REQUEST_NOT_APPLICABLE);
    ...
    public void processTransfer(Connection p_con) throws BTSLBaseException {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ScheduledPrepaidController[processTransfer]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException("ScheduledPrepaidController", methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        }
    }
    ...
    public void run() {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ScheduledPrepaidController[run]", _transferID,
                _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            ...
            try {
                if (_p2pTransferVO.getTransferStatus().equals(PretupsErrorCodesI.TXN_STATUS_FAIL) && (_p2pTransferVO.getReceiverReturnMsg() == null || !((BTSLMessages) _p2pTransferVO
                    ...
                    final String schType = _p2pTransferVO.getRequestVO().getMcdScheduleType();
                    if (schType.equals(PretupsI.SCHEDULE_TYPE_WEEKLY_FILTER)) {
                        _p2pTransferVO.setReceiverReturnMsg(new BTSLMessages((PretupsErrorCodesI.P2P_RECEIVER_SMCD_FAIL_MESSAGE_KEY_W),
                            new String[] { _senderMSISDN, PretupsBL.getDisplayAmount(_p2pTransferVO.getRequestedAmount()) }));
                    }
                    if (schType.equals(PretupsI.SCHEDULE_TYPE_MONTHLY_FILTER)) {
                        _p2pTransferVO.setReceiverReturnMsg(new BTSLMessages((PretupsErrorCodesI.P2P_RECEIVER_SMCD_FAIL_MESSAGE_KEY_M),
                            new String[] { _senderMSISDN, PretupsBL.getDisplayAmount(_p2pTransferVO.getRequestedAmount()) }));
                    }
            ...
            if (con != null) {
				...
				if (mcomCon != null) {
					mcomCon.close("ScheduledPrepaidController#run");
					mcomCon = null;
				}
                con = null;
            }
            ...
            if (_senderTopupSuccessMessageRequired) {
                if (!_p2pTransferVO.getSenderMsisdn().equals(_p2pTransferVO.getReceiverMsisdn())) {
                    if (!BTSLUtil.isNullString(_p2pTransferVO.getSenderReturnMessage())) {
                        ;
                        ...
                        if (_senderVO.isActivateStatusReqd()) {
                            // TO DO Also update is required if PIN is other
                            // then Default PIN
    ...
    private String getReceiverFailMessage() {
        ...
        // String[]
        // messageArgArray={_senderMSISDN,_transferID,PretupsBL.getDisplayAmount(_p2pTransferVO.getRequestedAmount())};
        // return
        // BTSLUtil.getMessage(_receiverLocale,PretupsErrorCodesI.P2P_RECEIVER_FAIL_MESSAGE_KEY,messageArgArray);
        String[] messageArgArray = null;
        String key = null;
        final String schType = _p2pTransferVO.getRequestVO().getMcdScheduleType();
        if (schType.equals(PretupsI.SCHEDULE_TYPE_WEEKLY_FILTER)) {
            key = PretupsErrorCodesI.P2P_RECEIVER_SMCD_FAIL_MESSAGE_KEY_W;
            messageArgArray = new String[] { _senderMSISDN, PretupsBL.getDisplayAmount(_p2pTransferVO.getRequestedAmount()) };
        }
        if (schType.equals(PretupsI.SCHEDULE_TYPE_MONTHLY_FILTER)) {
            key = PretupsErrorCodesI.P2P_RECEIVER_SMCD_FAIL_MESSAGE_KEY_M;
            messageArgArray = new String[] { _senderMSISDN, PretupsBL.getDisplayAmount(_p2pTransferVO.getRequestedAmount()) };
        } else {
            key = PretupsErrorCodesI.P2P_RECEIVER_FAIL_MESSAGE_KEY;
            messageArgArray = new String[] { _senderMSISDN, _transferID, PretupsBL.getDisplayAmount(_p2pTransferVO.getRequestedAmount()) };
        }
    ...
    private String getReceiverSuccessMessage() {
        ...
        if (!"N".equals(_receiverPostBalanceAvailable)) {
            ...
            messageArgArray = new String[] { _transferID, PretupsBL.getDisplayAmount(_p2pTransferVO.getRequestedAmount()), PretupsBL.getDisplayAmount(_receiverTransferItemVO
                ...
                .valueOf(_p2pTransferVO.getReceiverBonus2Validity()), String.valueOf(_p2pTransferVO.getReceiverCreditBonusValidity()), _p2pTransferVO.getRequestVO()
                .getMcdNextScheduleDate() };
            if (_p2pTransferVO.getBonusTalkTimeValue() == 0) {
                ...
                // modified by harsh to change SMS push to receiver
                final String schType = _p2pTransferVO.getRequestVO().getMcdScheduleType();
                if (schType.equals(PretupsI.SCHEDULE_TYPE_WEEKLY_FILTER)) {
                    key = PretupsErrorCodesI.P2P_RECEIVER_SCT_SUCCESS_W;
                }
                if (schType.equals(PretupsI.SCHEDULE_TYPE_MONTHLY_FILTER)) {
                    key = PretupsErrorCodesI.P2P_RECEIVER_SCT_SUCCESS_M;
                }
            } else {
    ...
    public void populateServicePaymentInterfaceDetails(Connection p_con, String action) throws BTSLBaseException {
        ...
        if (!isSenderFound) {
            if (!_senderVO.isDefUserRegistration()) {
                throw new BTSLBaseException("ScheduledPrepaidController", "populateServicePaymentInterfaceDetails",
            ...
            throw new BTSLBaseException("ScheduledPrepaidController", "populateServicePaymentInterfaceDetails", PretupsErrorCodesI.P2P_NOTFOUND_PAYMENTINTERFACEMAPPING);
        }
            ...
            if (action.equals(PretupsI.INTERFACE_NETWORK_PREFIX_VALIDATION_ACTION) && !isReceiverFound && _performIntfceCatRoutingBeforeVal && _useAlternateCategory && !_interfaceCatRoutingDone) {
                ...
                if (_networkPrefixVO != null) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                        "ScheduledPrepaidController[populateServicePaymentInterfaceDetails]", "", "", "",
                        "Series =" + _receiverVO.getMsisdnPrefix() + " Not Defined for Series type=" + _type + " But alternate Category Routing was required on interface");
        ...
        if (!isReceiverFound) {
            throw new BTSLBaseException("ScheduledPrepaidController", "populateServicePaymentInterfaceDetails", PretupsErrorCodesI.P2P_NOTFOUND_SERVICEINTERFACEMAPPING);
        }
    }
    ...
    public String getReceiverCreditStr() {
        ...
        strBuff.append("&SERVICE_TYPE=" + _senderSubscriberType + "-" + _type);
        /*
         * if(String.valueOf(PretupsI.CHNL_SELECTOR_C_VALUE).equals(_requestVO.
         * getReqSelector())) {
         * strBuff.append("&ADJUST=Y");
         * }
         */
        strBuff.append("&ADJUST=N");
        try {
    ...
    public void updateForSenderValidateResponse(String str) throws BTSLBaseException {
        ...
        if ((!InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(status) && isLDCCTest) || isRequired) {
            ...
            if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
                ...
                throw new BTSLBaseException("ScheduledPrepaidController", methodName, _p2pTransferVO.getErrorCode(), 0, strArr, null);
            }
            _senderTransferItemVO.setTransferStatus(status);
        ...
        try {
            ...
            if (senderLoadStatus == 0) {
                ...
                if (recieverLoadStatus == 0) {
                    ...
                    if (_log.isDebugEnabled()) {
                        _log.debug("ScheduledPrepaidController[checkTransactionLoad]", "_transferID=" + _transferID + " Successfully through load");
                    }
                }
                // Request in Queue
                    ...
                    throw new BTSLBaseException("ScheduledPrepaidController", methodName, PretupsErrorCodesI.REQUEST_IN_QUEUE, 0, strArr, null);
                }
                // Refuse the request
                else {
                    throw new BTSLBaseException("ScheduledPrepaidController", methodName, PretupsErrorCodesI.REQUEST_REFUSE_FROM_INTLOAD);
                }
            }
            // Request in Queue
            ...
            _log.errorTrace(methodName, be);
            _log.error("ScheduledPrepaidController[checkTransactionLoad]", "Refusing request getting Exception:" + be.getMessage());
            throw be;
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
            throw new BTSLBaseException("ScheduledPrepaidController", methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
    ...
    public void processFromQueue(TransferVO p_transferVO) {
        ...
        try {
			...
			if (mcomCon != null) {
				mcomCon.close("ScheduledPrepaidController#processFromQueue");
				mcomCon = null;
			}
            con = null;
            ...
            if (_log.isDebugEnabled()) {
                _log.debug("ScheduledPrepaidController[processFromQueue]", "_transferID=" + _transferID + " Successfully through load");
            }
            processValidationRequest();
            ...
            try {
                ...
                _log.errorTrace(methodName, bex);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "ScheduledPrepaidController[processFromQueue]",
            ...
            TransactionLog.log(_transferID, _requestIDStr, _requestVO.getFilteredMSISDN(), "", PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS, _p2pTransferVO
                .getSenderReturnMessage(), PretupsI.TXN_LOG_STATUS_FAIL, "Getting Code=" + _requestVO.getMessageCode());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ScheduledPrepaidController[processFromQueue]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
        } finally {
            try {
                if (mcomCon == null) {
    ...
    private void creditBackSenderForFailedTrans(CommonClient p_commonClient, boolean p_onlyDecreaseOnly) throws BTSLBaseException {
        ...
        try {
                ...
                if (((Boolean) (PreferenceCache.getSystemPreferenceValue(PreferenceI.P2P_SNDR_CREDIT_BACK_ALLOWED))).booleanValue()) {
                    if ((((Boolean) (PreferenceCache.getSystemPreferenceValue(PreferenceI.P2P_SNDR_CREDIT_BK_AMB_STATUS))).booleanValue() && _p2pTransferVO.getTransferStatus().equalsIgnoreCase(PretupsErrorCodesI.TXN_STATUS_AMBIGUOUS)) || _p2pTransferVO
                        ...
                        if (isCounterToBeDecreased) {
                            SubscriberBL.decreaseTransferOutCounts(con, _p2pTransferVO,PretupsI.SERVICE_TYPE_SCH_CREDIT_TRANSFER);
                        }
                        ...
                        EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                            "ScheduledPrepaidController[processFromQueue]", _transferID, _senderMSISDN, _senderNetworkCode,
                            "Credit back not required in case of Ambigous cases");
                    }
                } else {
                    EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                        "ScheduledPrepaidController[creditBackSenderForFailedTrans]", _transferID, _senderMSISDN, _senderNetworkCode,
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ScheduledPrepaidController[creditBackSenderForFailedTrans]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            TransactionLog.log(_transferID, _requestIDStr, _senderMSISDN, "", PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
			...
			if (mcomCon != null) {
				mcomCon.close("ScheduledPrepaidController#creditBackSenderForFailedTrans");
				mcomCon = null;
			}
        }
    ...
    private void processValidationRequestInThread() throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _log.errorTrace(methodName, be);
            _log.error("ScheduledPrepaidController[processValidationRequestInThread]", "Getting BTSL Base Exception:" + be.getMessage());
            TransactionLog.log(_transferID, _requestIDStr, _senderMSISDN, _senderNetworkCode, PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
            ...
            if (_transferID != null && !_transferDetailAdded) {
                ...
                try {
                    ...
                    EventHandler.handle(EventIDI.DATABASE_CONECTION_PROBLEM, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                        "ScheduledPrepaidController[process]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
                } finally {
					if (mcomCon != null) {
						mcomCon.close("ScheduledPrepaidController#processValidationRequestInThread");
						mcomCon = null;
					}
                    con = null;
                }
    ...
    private boolean getInterfaceRoutingDetails(Connection p_con, String p_msisdn, long p_prefixID, String p_subscriberType, String p_networkCode, String p_serviceType, String p_interfaceCategory, String p_userType, String p_action) throws BTSLBaseException {
        ...
        try {
            if (subscriberRoutingControlVO != null) {
                ...
                // based routing
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                    "ScheduledPrepaidController[getInterfaceRoutingDetails]", _transferID, _senderMSISDN, _senderNetworkCode,
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ScheduledPrepaidController[getInterfaceRoutingDetails]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            isSuccess = false;
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        }
        if (_log.isDebugEnabled()) {
        ...
        try {
            if (altList != null && altList.size() > 0) {
                ...
                case 1: {
                    ...
                    setInterfaceDetails(_senderTransferItemVO.getPrefixID(), PretupsI.USER_TYPE_SENDER, listValueVO, false, null);
					...
					if (mcomCon != null) {
						mcomCon.close("ScheduledPrepaidController#performSenderAlternateRouting");
						mcomCon = null;
					}
                    con=null;
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ScheduledPrepaidController[performSenderAlternateRouting]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        } finally {
			if (mcomCon != null) {
				mcomCon.close("ScheduledPrepaidController#performSenderAlternateRouting");
            ...
            try {
                if (LocaleMasterCache.getLocaleFromCodeDetails(p_languageCode) == null) {
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                        "ScheduledPrepaidController[updateReceiverLocale]", _transferID, _receiverMSISDN, "",
    ...
    public void performAlternateCategoryRouting() throws BTSLBaseException {
        ...
        try {
            ...
            if (con != null) {
				...
				if (mcomCon != null) {
					mcomCon.close("ScheduledPrepaidController#performAlternateCategoryRouting");
					mcomCon = null;
				}
                con = null;
            }
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ScheduledPrepaidController[performAlternateCategoryRouting]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        } finally {
            if (con != null) {
                try {
    ...
    public void populateAlternateInterfaceDetails(Connection p_con) throws BTSLBaseException {
        ...
        if (!_interfaceCatRoutingDone) {
            ...
            if (_networkPrefixVO != null) {
                ...
                _log.error(this, "Series Not Defined for Alternate Interface =" + _type + " For Series=" + _receiverVO.getMsisdnPrefix());
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                    "ScheduledPrepaidController[populateAlternateInterfaceDetails]", "", "", "",
        ...
        try {
            if (altList != null && altList.size() > 0) {
                ...
                case 1: {
                    ...
                    setInterfaceDetails(_receiverTransferItemVO.getPrefixID(), PretupsI.USER_TYPE_RECEIVER, listValueVO, false, null);
                    ...
                    try {
                        ...
                        _log.errorTrace(methodName, e);
                        throw new BTSLBaseException(this, methodName, "Exception in performing the Interface routing for the subscriber MSISDN when alt size is 1.");
                    }
                ...
                case 2: {
                    ...
                    try {
                        ...
                        _log.errorTrace(methodName, e);
                        throw new BTSLBaseException(this, methodName, "Exception in performing the Interface routing for the subscriber MSISDN when alt size is 2.");
                    }
                    break;
                }
                }
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ScheduledPrepaidController[performAlternateRouting]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        }
        if (_log.isDebugEnabled()) {
    ...
    public void receiverValidateResponse(String str, int p_attempt, int p_altSize, int p_source) throws BTSLBaseException {
        ...
        if (InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(status) && p_attempt == 1 && p_attempt < p_altSize) {
            ...
            if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
                ...
                strArr = new String[] { _receiverMSISDN, PretupsBL.getDisplayAmount(_p2pTransferVO.getRequestedAmount()), _transferID };
                throw new BTSLBaseException("ScheduledPrepaidController", "receiverValidateResponse", PretupsErrorCodesI.P2P_SENDER_FAIL, 0, strArr, null);
            }
            _receiverTransferItemVO.setTransferStatus(status);
            _receiverVO.setTransactionStatus(PretupsErrorCodesI.TXN_STATUS_SUCCESS);
            _receiverTransferItemVO.setSubscriberType(_type);
    ...
    public void populateReceiverItemsDetails(HashMap p_map) throws BTSLBaseException {
        ...
        if (!BTSLUtil.isNullString((String) p_map.get("IN_TXN_ID"))) {
            try {
                ...
                _log.errorTrace(METHOD_NAME, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                    "ScheduledPrepaidController[updateForReceiverValidateResponse]", _transferID, _senderMSISDN, _senderNetworkCode,
        ...
        if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
            ...
            strArr = new String[] { _receiverMSISDN, PretupsBL.getDisplayAmount(_p2pTransferVO.getRequestedAmount()), _transferID };
            // throw new
            // BTSLBaseException("ScheduledPrepaidController","updateForReceiverValidateResponse",PretupsErrorCodesI.P2P_SENDER_FAIL,0,strArr,null);
            // throw new
            // BTSLBaseException("ScheduledPrepaidController","populateReceiverItemsDetails",_p2pTransferVO.getErrorCode(),0,strArr,null);
            if (InterfaceErrorCodesI.INTERFACE_CUSTOMER_RECHARGENOTALLOWED_P2P.equals(_receiverTransferItemVO.getValidationStatus())) {
                throw new BTSLBaseException("ScheduledPrepaidController", "populateReceiverItemsDetails",
                    InterfaceErrorCodesI.INTERFACE_CUSTOMER_RECHARGENOTALLOWED_P2P + "_S", 0, strArr, null);
            } else {
                throw new BTSLBaseException("ScheduledPrepaidController", "populateReceiverItemsDetails", _p2pTransferVO.getErrorCode(), 0, strArr, null);
            }
        }
        _receiverTransferItemVO.setTransferStatus(status);
        _receiverTransferItemVO.setSubscriberType(_type);
    ...
    private void setInterfaceDetails(long p_prefixID, String p_userType, ListValueVO p_listValueVO, boolean p_useInterfacePrefixVO, MSISDNPrefixInterfaceMappingVO p_MSISDNPrefixInterfaceMappingVO) throws BTSLBaseException {
        ...
        if (_log.isDebugEnabled()) {
            _log.debug(
                methodName,
                _requestIDStr,
                " Entered p_prefixID=" + p_prefixID + " p_listValueVO=" + p_listValueVO + " p_useInterfacePrefixVO=" + p_useInterfacePrefixVO + " p_MSISDNPrefixInterfaceMappingVO=" + p_MSISDNPrefixInterfaceMappingVO);
        }
        try {
            String interfaceID = null;
            String interfaceHandlerClass = null;
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "ScheduledPrepaidController[setInterfaceDetails]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
    ...
    private void updateSubscriberRoutingDetails(String p_userType, String p_networkCode, String p_interfaceID, String p_externalID, String p_msisdn, String p_interfaceCategory, String p_userID, Date p_currentDate) throws BTSLBaseException {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ScheduledPrepaidController[updateSubscriberRoutingDetails]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, _requestIDStr, " Exiting ");
    ...
    public static synchronized void generateTransferID(TransferVO p_transferVO) throws BTSLBaseException {
        ...
        try {
            ...
            if (_transactionIDCounter == 0) {
                throw new BTSLBaseException("ScheduledPrepaidController", methodName, PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
    ...
    public void handleLDCCRequest() throws BTSLBaseException {
        ...
        try {
            ...
            // NetworkInterfaceModuleVO
            // networkInterfaceModuleVOS=(NetworkInterfaceModuleVO)NetworkInterfaceModuleCache.getObject(_p2pTransferVO.getModule(),_senderNetworkCode,_p2pTransferVO.getPaymentMethodType());
            LoadController.decreaseResponseCounters(_transferID, PretupsErrorCodesI.TXN_STATUS_FAIL, LoadControllerI.SENDER_VAL_RESPONSE);
            LoadController.decreaseTransactionInterfaceLoad(_transferID, _p2pTransferVO.getNetworkCode(), LoadControllerI.DEC_LAST_TRANS_COUNT);
            ...
            try {
                ...
                setInterfaceDetails(_senderTransferItemVO.getPrefixID(), PretupsI.USER_TYPE_SENDER, listValueVO, true, interfaceMappingVO);
            } catch (BTSLBaseException be) {
                _log.errorTrace(methodName, be);
                throw be;
            }
			...
			if (mcomCon != null) {
				mcomCon.close("ScheduledPrepaidController#handleLDCCRequest");
				mcomCon = null;
			}
            con=null;
            requestStr = getSenderValidateStr();
    ...
    private void updateSubscriberAilternateRouting(String p_userType, String p_networkCode, String p_interfaceID, String p_externalID, String p_msisdn, String p_interfaceCategory, String p_userID, Date p_currentDate) throws BTSLBaseException {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "ScheduledPrepaidController[updateSubscriberAilternateRouting]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.P2P_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
                _log.debug(methodName, _requestIDStr, " Exiting ");
