 ...
 *
 */
public class NetworkSummaryOracleQry implements NetworkSummaryQry{
	...
	public StringBuilder loadNetworkSummaryDataListQry(){
		...
		selectQueryBuff.append(" WHERE TS.NETWORK_CODE=? AND N.NETWORK_CODE=TS.NETWORK_CODE AND C.CATEGORY_CODE=TS.CATEGORY AND ST.SERVICE_TYPE=TS.SERVICE_TYPE AND TS.SERVICE_TYPE=SSM.SERVICE_TYPE AND TS.SUB_SERVICE=SSM.SELECTOR_CODE AND TS.TRANS_DATE>=TO_DATE(?,'dd/mm/yy') AND TRANS_DATE<=LAST_DAY(TO_DATE(?,'dd/mm/yy'))");
