...
public class FOCBatchMasterVO implements Serializable {
    ...
    private FOCBatchItemsVO _focBatchItemsVO = null;
    ...
    // added bonus type for direct payout by Lohit
    private String _bonusType = null;

    // user life cycle
    private String _categoryCode = null;

    // ADDED BY GAURAV FOR WALLLET TYPE
    ...
    private String focOrCommPayout;

    public String getFocOrCommPayout() {
		return focOrCommPayout;
	}

	public void setFocOrCommPayout(String focOrCommPayout) {
		this.focOrCommPayout = focOrCommPayout;
	}
    ...
    public String toString() {
        ...
        sbf.append(",_focBatchItemsVO=" + _focBatchItemsVO);
    ...
    /**
     * @return Returns the fOCBatchItemsVO.
     */
    public FOCBatchItemsVO getFocBatchItemsVO() {
        return _focBatchItemsVO;
    }

    /**
     * @param batchItemsVO
     *            The fOCBatchItemsVO to set.
     */
    public void setFocBatchItemsVO(FOCBatchItemsVO batchItemsVO) {
        _focBatchItemsVO = batchItemsVO;
    }
