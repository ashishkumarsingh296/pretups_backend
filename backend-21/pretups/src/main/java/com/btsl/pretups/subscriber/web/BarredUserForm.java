 ...
 * Dec 20, 2009 vikram kumar modified for staff user change
 * FEB 21, 2011 BABU KUNWAR Added Validation method for
 * Remarks for Barring the user
 * ------------------------------------------------------------------------------
 * --
...
public class BarredUserForm  {
    ...
    // for barring staff user type
    // private String _loginId;
    // private String _tempMsisdn;
    // private boolean _isRemoveStaff=false; //if true then all staff will be
    // unbarred for that channel user
    private boolean _isSelfBarUnbar = false;
    private boolean _isOperatorUser = false;
    ...
    public int getViewBarredListSize() {
        if (_viewBarredList != null) {
            return _viewBarredList.size();
        }
        return 0;
    }
    ...
    public void flush() {
        ...
        _userTypeName = null;
        // added by vikram
        _isSelfBarUnbar = false;
    }

    // *************Validation Addition By Babu Kunwar Ends*********
    ...
    // added by vikram
    /**
     * @return the isOperatorUser
     */
    public boolean isOperatorUser() {
        return _isOperatorUser;
    }

    /**
     * @param isOperatorUser
     *            the isOperatorUser to set
     */
    public void setOperatorUser(boolean isOperatorUser) {
        _isOperatorUser = isOperatorUser;
    }

    /**
     * @return the isSelfBarUnbar
     */
    public boolean isSelfBarUnbar() {
        return _isSelfBarUnbar;
    }

    /**
     * @param isSelfBarUnbar
     *            the isSelfBarUnbar to set
     */
    public void setSelfBarUnbar(boolean isSelfBarUnbar) {
        _isSelfBarUnbar = isSelfBarUnbar;
    }
}
