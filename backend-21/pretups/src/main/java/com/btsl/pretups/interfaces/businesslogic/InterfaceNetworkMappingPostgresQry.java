...
public class InterfaceNetworkMappingPostgresQry implements InterfaceNetworkMappingQry {
	@Override
	public String loadInterfaceNetworkPrefixQry(){
        ...
        strBuff.append(" AND inpm.prefix_id = np.prefix_id::varchar order by interface_id ");
