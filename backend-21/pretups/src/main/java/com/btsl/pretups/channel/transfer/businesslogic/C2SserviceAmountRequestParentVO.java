...
public class C2SserviceAmountRequestParentVO {

	@JsonProperty("reqGatewayLoginId")
	private String reqGatewayLoginId;
	
	@JsonProperty("data")
	C2CTotalTrfRequestMessage data;
	...
	@JsonProperty("data")
	public C2CTotalTrfRequestMessage getData() {
		return data;
	}

	public void setData(C2CTotalTrfRequestMessage data) {
		this.data = data;
	}
	...
	public String toString() {
		return "C2SserviceAmountRequestParentVO [reqGatewayLoginId=" + reqGatewayLoginId + ", data=" + data
