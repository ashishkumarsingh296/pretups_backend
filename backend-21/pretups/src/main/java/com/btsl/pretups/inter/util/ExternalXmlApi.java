...
public abstract class ExternalXmlApi {
    ...
    protected abstract String parseRequest(int action, String requestStr) throws Exception;

    protected abstract String generateResponse(int action, HashMap map) throws Exception;
