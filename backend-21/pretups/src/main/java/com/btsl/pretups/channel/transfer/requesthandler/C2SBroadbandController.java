...
/**
 * @(#)C2SBroadbandController.java
 *                                 Name Date History
 *                                 --------------------------------------------
 *                                 ----------------------------
 *                                 Abhay 27/01/2009 Initial Creation
 *                                 --------------------------------------------
 *                                 ----------------------------
 *                                 Copyright (c) 2009 Bharti Telesoft Ltd.
 *                                 Controller class for handling the Channel to
 *                                 Broadband subscriber transfers
 */
...
public class C2SBroadbandController extends C2SBaseController implements ServiceKeywordControllerI, Runnable {
    private static Log _log = LogFactory.getLog(C2SBroadbandController.class.getName());
    ...
    static {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "C2SBroadbandController[initialize]", "", "", "",
                "Exception while loading the class at the call:" + e.getMessage());
        }
    }

    public C2SBroadbandController() {
        _c2sTransferVO = new C2STransferVO();
        _currentDate = new Date();
        if ("Y".equals(BTSLUtil.NullToString(Constants.getProperty("C2S_BROADBAND_REC_GEN_FAIL_MSG_REQD_V")))) {
            _recValidationFailMessageRequired = true;
        }
        if ("Y".equals(BTSLUtil.NullToString(Constants.getProperty("C2S_BROADBAND_REC_GEN_FAIL_MSG_REQD_T")))) {
            _recTopupFailMessageRequired = true;
        }
        _notAllowedSendMessGatw = BTSLUtil.NullToString(Constants.getProperty("C2S_BROADBAND_SEN_MSG_NOT_REQD_GW"));
        _notAllowedRecSendMessGatw = BTSLUtil.NullToString(Constants.getProperty("C2S_BROADBAND_REC_MSG_NOT_REQD_GW"));
    }
    ...
    public void process(RequestVO p_requestVO) {
        ...
        try {
            ...
            _operatorUtil.validateC2SBroadbandRechargeRequest(con, _c2sTransferVO, p_requestVO);
            ...
            if (!_receiverVO.getSubscriberType().equals(_type)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "C2SBroadbandController[process]", "", "", "",
            ...
            if (_senderMSISDN.equals(_receiverMSISDN) && !((Boolean) (PreferenceCache.getSystemPreferenceValue(PreferenceI.BROADBAND_RC_ALLOW_SELF_TOPUP))).booleanValue()) {
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                throw new BTSLBaseException("C2SBroadbandController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            }
            ...
            if(mcomCon != null){mcomCon.close("C2SBroadbandController#process");mcomCon=null;}
            con = null;
            ...
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "C2SBroadbandController[process]", _transferID,
            ...
            // raising alarm
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "C2SBroadbandController[process]", _transferID,
            ...
            if (con != null) {
                ...
                if(mcomCon != null){
                	mcomCon.close("C2SBroadbandController#process");
                	mcomCon=null;
                	}
                con = null;
            }// end if
    ...
    public void processTransfer(Connection p_con) throws BTSLBaseException {
        ...
        try {
            ...
            generateC2SBroadbandTransferID(_c2sTransferVO);
            _transferID = _c2sTransferVO.getTransferID();
            if (_log.isDebugEnabled()) {
                _log.debug("after generateC2SBroadbandTransferID method", "_transferID=" + _transferID);
            }
            _receiverVO.setLastTransferID(_transferID);
            ...
            _c2sTransferVO.setErrorCode(PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "C2SBroadbandController[processTransfer]", _transferID,
                _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException("C2SBroadbandController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        }
    }
        ...
        try {
            ...
            if (PretupsI.YES.equals(_c2sTransferVO.getDifferentialAllowedForService())) {
                try {
                    ...
                    _log.errorTrace(methodName, e);
                    throw new BTSLBaseException("C2SBroadbandController", "process", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
                }
				if (mcomCon != null) {
					mcomCon.close("C2SBroadbandController#run");
					mcomCon = null;
				}
                con = null;
                ...
                try {
                    ...
                    if (_log.isDebugEnabled()) {
                        ...
                        _log.debug("C2SBroadbandController",loggerValue );
                    }
                    _log.errorTrace(methodName, be);
                    loggerValue.setLength(0);
                	loggerValue.append("Exception:");
                	loggerValue.append(be.getMessage());
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "C2SBroadbandController[run]", _c2sTransferVO
        	...
        	loggerValue.append("Exception:");
        	loggerValue.append(e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "C2SBroadbandController[run]", _transferID,
                _senderMSISDN, _senderNetworkCode,  loggerValue.toString());
            ...
            try {
            	...
            	loggerValue.append(e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "C2SBroadbandController[run]", _transferID,
                    _senderMSISDN, _senderNetworkCode, loggerValue.toString());
            }// end catch
                ...
                if (_c2sTransferVO.getTransferStatus().equals(PretupsErrorCodesI.TXN_STATUS_SUCCESS)) {
                    ...
                    if (_c2sTransferVO.getReceiverReturnMsg() == null) {
                    	...
                    	final String message=getReceiverFailMessage( _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _senderPushMessageMsisdn, _channelUserVO
                                .getUserName(),null,_receiverLocale, PretupsErrorCodesI.C2S_BROADBAND_RECEIVER_FAIL_KEY,_requestVO.getRequestGatewayType());
    ...
    public void updateForReceiverValidateResponse(String str) throws BTSLBaseException {
        ...
        if (!InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(status) || isRequired) {
            ...
            if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
                ...
                // throw new
                // BTSLBaseException("C2SBroadbandController","updateForReceiverValidateResponse",PretupsErrorCodesI.C2S_RECEIVER_FAIL,0,strArr,null);
                // throw new
                // BTSLBaseException("C2SBroadbandController","updateForReceiverValidateResponse",_c2sTransferVO.getErrorCode(),0,strArr,null);
                if (InterfaceErrorCodesI.INTERFACE_CUSTOMER_RECHARGENOTALLOWED.equals(_receiverTransferItemVO.getValidationStatus())) {
                    throw new BTSLBaseException("C2SBroadbandController", methodName, InterfaceErrorCodesI.INTERFACE_CUSTOMER_RECHARGENOTALLOWED + "_S", 0, strArr, null);
                } else {
                    throw new BTSLBaseException("C2SBroadbandController", methodName, _c2sTransferVO.getErrorCode(), 0, strArr, null);
                }
            }
            _receiverTransferItemVO.setTransferStatus(status);
    ...
    public void populateServiceInterfaceDetails(Connection p_con, String action) throws BTSLBaseException {
        ...
        if (!isReceiverFound) {
            throw new BTSLBaseException("C2SBroadbandController", "populateServiceInterfaceDetails", PretupsErrorCodesI.C2S_ERROR_NOTFOUND_SERVICEINTERFACEMAPPING);
        }
    ...
    private void checkTransactionLoad() throws BTSLBaseException {
        ...
        try {
            ...
            if (recieverLoadStatus == 0) {
                ...
                if (_log.isDebugEnabled()) {
                    _log.debug("C2SBroadbandController[checkTransactionLoad]", "_transferID=" + _transferID + " Successfully through load");
                }
            }
            // Request in Queue
                ...
                throw new BTSLBaseException("C2SBroadbandController", methodName, PretupsErrorCodesI.REQUEST_IN_QUEUE, 0, strArr, null);
            }
            // Refuse the request
            else {
                throw new BTSLBaseException("C2SBroadbandController", methodName, PretupsErrorCodesI.REQUEST_REFUSE_FROM_INTLOAD);
            }
        } catch (BTSLBaseException be) {
            _log.error("C2SBroadbandController[checkTransactionLoad]", "Refusing request getting Exception:" + be.getMessage());
            throw be;
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
            throw new BTSLBaseException("C2SBroadbandController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
    ...
    private void processValidationRequest() throws BTSLBaseException,SQLException {
        ...
        try {
            ...
            if ((System.currentTimeMillis() - _c2sTransferVO.getRequestStartTime()) > interfaceVO.getValExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "C2SBroadbandController[processValidationRequest]",
                    _transferID, _senderMSISDN, _senderNetworkCode, "Exception: System is taking more time till validation");
                throw new BTSLBaseException("C2SBroadbandController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION_TKING_TIME_TILL_VAL);
            }
            ...
            if(mcomCon != null){
            	mcomCon.close("C2SBroadbandController#processValidationRequest");
            	mcomCon=null;
            	}
            con = null;
            ...
            if ((System.currentTimeMillis() - _c2sTransferVO.getRequestStartTime()) > interfaceVO.getTopUpExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "C2SBroadbandController[run]", _transferID,
                    _senderMSISDN, _senderNetworkCode, "Exception: System is taking more time till topup");
                throw new BTSLBaseException("C2SBroadbandController", "run", PretupsErrorCodesI.C2S_ERROR_EXCEPTION_TKING_TIME_TILL_TOPUP);
            }
            interfaceVO = null;
            ...
            _log.error("C2SBroadbandController[processValidationRequest]", "Getting BTSL Base Exception:" + be.getMessage());
            if (_transferDetailAdded) {
                if (mcomCon == null) {
                	mcomCon = new MComConnection();con=mcomCon.getConnection();
                }
    ...
    private String getReceiverSuccessMessage() {
        ...
        if (_c2sTransferVO.getReceiverTransferItemVO().isNumberBackAllowed()) {
            ...
            if (_c2sTransferVO.getBonusTalkTimeValue() == 0) {
                key = PretupsErrorCodesI.C2S_BROADBAND_RECEIVER_GET_NUMBER_BACK_SUCCESS;
            } else {
                key = PretupsErrorCodesI.C2S_BROADBAND_RECEIVER_GET_NUMBER_BACK_SUCCESS_WITH_BONUS;
            }
        }
        ...
        if (!"N".equals(_receiverPostBalanceAvailable)) {
            ...
            if (_c2sTransferVO.getBonusTalkTimeValue() == 0) {
                key = PretupsErrorCodesI.C2S_BROADBAND_RECEIVER_SUCCESS;
            } else {
                key = PretupsErrorCodesI.C2S_BROADBAND_RECEIVER_SUCCESS_WITH_BONUS;
            }
        } else {
            if (((Boolean) (PreferenceCache.getSystemPreferenceValue(PreferenceI.IS_SEPARATE_BONUS_REQUIRED))).booleanValue()) {
                _c2sTransferVO.setCalminusBonusvalue(_c2sTransferVO.getReceiverTransferValue() - _c2sTransferVO.getBonusTalkTimeValue());
            ...
            messageArgArray = new String[] { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getReceiverTransferValue()), _senderPushMessageMsisdn, PretupsBL
                ...
                .getReceiverBonus1Validity()), String.valueOf(_c2sTransferVO.getReceiverBonus2Validity()), String.valueOf(_c2sTransferVO.getReceiverCreditBonusValidity()), _receiverMSISDN };
            if (_c2sTransferVO.getBonusTalkTimeValue() == 0) {
                key = PretupsErrorCodesI.C2S_BROADBAND_RECEIVER_SUCCESS_WITHOUT_POSTBAL;
            } else {
                key = PretupsErrorCodesI.C2S_BROADBAND_RECEIVER_SUCCESS_WITHOUT_POSTBAL_WITH_BONUS;
            }
        }
    ...
    private String getSenderSuccessMessage() {
        ...
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.C2S_BROADBAND_SENDER_SUCCESS, messageArgArray);
    }
    ...
    private String getReceiverUnderProcessMessage() {
        // String[]
        // messageArgArray={_transferID,PretupsBL.getDisplayAmount(_c2sTransferVO.getReceiverTransferValue()),String.valueOf(_receiverTransferItemVO.getValidity()),PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()),_senderMSISDN,PretupsBL.getDisplayAmount(_c2sTransferVO.getReceiverAccessFee()),_channelUserVO.getUserName()};
        final String[] messageArgArray = { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getReceiverTransferValue()), String.valueOf(_receiverTransferItemVO
            ...
            .getReceiverAccessFee()), _channelUserVO.getUserName() };
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.C2S_BROADBAND_RECEIVER_UNDERPROCESS, messageArgArray, _requestVO.getRequestGatewayType());
    }
    ...
    private String getSenderUnderProcessMessage() {
        ...
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.C2S_BROADBAND_SENDER_UNDERPROCESS, messageArgArray);
    }
    ...
    private String getSndrUPMsgBeforeValidation() {
        ...
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.C2S_BROADBAND_SENDER_UNDERPROCESS_B4VAL, messageArgArray);
    }

    private String getReceiverAmbigousMessage() {
        // String[]
        // messageArgArray={_transferID,PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()),_senderMSISDN,_channelUserVO.getUserName()};
        final String[] messageArgArray = { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _senderPushMessageMsisdn, _channelUserVO
            .getUserName() };
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.C2S_BROADBAND_RECEIVER_AMBIGOUS_KEY, messageArgArray, _requestVO.getRequestGatewayType());
    }
    ...
    private void processValidationRequestInThread() throws BTSLBaseException, Exception {
        ...
        try {
        	...
        	loggerValue.append(be.getMessage());
            _log.error("C2SBroadbandController[processValidationRequestInThread]",  loggerValue );
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "C2SBroadbandController[processValidationRequestInThread]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            TransactionLog.log(_transferID, _requestIDStr, _receiverMSISDN, _receiverVO.getNetworkCode(), PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
                "Exception while performing Validation in thread", PretupsI.TXN_LOG_STATUS_FAIL,  loggerValue.toString() );
            ...
            if (_transferID != null && !_transferDetailAdded) {
                ...
                try {
                    ...
                    EventHandler.handle(EventIDI.DATABASE_CONECTION_PROBLEM, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                        "C2SBroadbandController[processValidationRequestInThread]", _transferID, _senderMSISDN, _senderNetworkCode,  loggerValue.toString());
                } finally {
                	if(mcomCon != null){mcomCon.close("C2SBroadbandController#processValidationRequestInThread");mcomCon=null;}
                    con = null;
                }
            }
            if (_log.isDebugEnabled()) {
    ...
    private boolean getInterfaceRoutingDetails(Connection p_con, String p_msisdn, long p_prefixID, String p_subscriberType, String p_networkCode, String p_serviceType, String p_interfaceCategory, String p_userType, String p_action) throws BTSLBaseException {
        ...
        try {
            ...
            if (subscriberRoutingControlVO != null) {
                ...
                // based routing
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "C2SBroadbandController[getInterfaceRoutingDetails]",
        	...
        	loggerValue.append("Exception:" );
        	loggerValue.append(e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "C2SBroadbandController[getInterfaceRoutingDetails]",
    ...
    private void performAlternateRouting(ArrayList altList) throws BTSLBaseException {
        ...
        try {
            ...
            loggerValue.append("Exception:");
            loggerValue.append(e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "C2SBroadbandController[performAlternateRouting]",
                _transferID, _senderMSISDN, _senderNetworkCode, loggerValue.toString() );
    ...
    public void receiverValidateResponse(String str, int p_attempt, int p_altSize) throws BTSLBaseException {
        ...
        if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
            ...
            _senderTransferItemVO.setTransferStatus(PretupsErrorCodesI.REQUEST_NOT_APPLICABLE);
            strArr = new String[] { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()) };
            throw new BTSLBaseException("C2SBroadbandController", "updateForReceiverValidateResponse", PretupsErrorCodesI.C2S_RECEIVER_FAIL, 0, strArr, null);
        }
    ...
    public void processFromQueue(TransferVO p_transferVO) {
        ...
        try {
			...
			if (mcomCon != null) {
				mcomCon.close("C2SBroadbandController#processFromQueue");
				mcomCon = null;
			}
            con = null;
            ...
            if (_log.isDebugEnabled()) {
                ...
                _log.debug("C2SBroadbandController[processFromQueue]", loggerValue );
            }
            ...
            try {
                if (mcomCon == null && _receiverVO != null && _receiverVO.isUnmarkRequestStatus()) { // getting
                	mcomCon = new MComConnection();con=mcomCon.getConnection();
            	...
            	loggerValue.append("Leaving Reciever Unmarked Base Exception:");
            	loggerValue.append( bex.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "C2SBroadbandController[processFromQueue]",
                    _transferID, _senderMSISDN, _senderNetworkCode,  loggerValue.toString());
            } catch (Exception e) {
                _log.errorTrace(methodName, e);
            ...
            loggerValue.append("Exception:" );
            loggerValue.append(e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "C2SBroadbandController[processFromQueue]",
                _transferID, _senderMSISDN, _senderNetworkCode, loggerValue.toString() );
            TransactionLog.log(_transferID, _requestVO.getRequestIDStr(), _requestVO.getFilteredMSISDN(), "", PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
                _c2sTransferVO.getSenderReturnMessage(), PretupsI.TXN_LOG_STATUS_FAIL, "Getting Code=" + _requestVO.getMessageCode());
        } finally {
     ...
     * @return
     */
    private static synchronized void generateC2SBroadbandTransferID(TransferVO p_transferVO) {
        final String methodName = "generateC2SBroadbandTransferID";
        ...
        try {
            ...
            if (_transactionIDCounter == 0) {
                throw new BTSLBaseException("C2SBroadbandController", methodName, PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
            transferID = _operatorUtil.formatBroadbandRCTransferID(p_transferVO, _transactionIDCounter);
            if (transferID == null) {
                throw new BTSLBaseException("C2SBroadbandController", methodName, PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
