/*
 * @# PostPaidFixedAmountController
 * This class is the controller class of the Channel user Module.
 * This class is used for PostPaid bill payment service.
 * 
 * Created on Created by History
 * ------------------------------------------------------------------------------
 * --
 * March 28, 2006 Ankit Zindal Initial creation
 * Aug 10,2006 Abhijit Modification for ID=SUBTYPVALRECLMT
 * Nov 20,2006 Ankit Zindal ChangeID=LOCALEMASTER
 * 
 * ------------------------------------------------------------------------------
 * --
...
public class PostPaidFixedAmountController implements ServiceKeywordControllerI, Runnable {
    private static Log _log = LogFactory.getLog(PostPaidFixedAmountController.class.getName());
    ...
    public PostPaidFixedAmountController() {
         ...
         */
        if ("Y".equals(BTSLUtil.NullToString(Constants.getProperty("BILLPAY_REC_GEN_FAIL_MSG_REQD_V")))) {
            _recValidationFailMessageRequired = true;
        }
        if ("Y".equals(BTSLUtil.NullToString(Constants.getProperty("BILLPAY_REC_GEN_FAIL_MSG_REQD_T")))) {
    ...
    public void process(RequestVO p_requestVO) {
        ...
        try {
            ...
            String reqAmount = null;
            boolean isValidAmount = true;
            if (p_requestVO.getRequestGatewayType().equals(Constants.getProperty("GATEWAYTYPES_MIN_DENOMINATION_ALLOWED"))) {
                reqAmount = new Long(_c2sTransferVO.getRequestedAmount()).toString();
            } else {
                reqAmount = PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount());
            }
            isValidAmount = isValidSelctorAmount((p_requestVO.getServiceType() + ":" + p_requestVO.getReqSelector()), ServiceSelectorMappingCache
                .loadSelectorDropDownForCardGroupPPEL(), reqAmount);
            if (!isValidAmount) {
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                throw new BTSLBaseException("PostPaidFixedAmountController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            }
            ...
            if (((Boolean) PreferenceCache.getSystemPreferenceValue(PreferenceI.SKEY_REQUIRED)).booleanValue()) {
				...
				if (mcomCon != null) {
					mcomCon.close("PostPaidFixedAmountController#process");
					mcomCon = null;
				}
                con = null;
            ...
            // raising alarm
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "PostPaidFixedAmountController[process]", _transferID,
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "PostPaidFixedAmountController[process]",
    ...
    private void processSKeyGen(Connection p_con) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "PostPaidFixedAmountController[processSKeyGen]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException("PostPaidFixedAmountController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
    ...
    public void processTransfer(Connection p_con) throws BTSLBaseException {
        ...
        try {
            ...
            _c2sTransferVO.setErrorCode(PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "PostPaidFixedAmountController[processTransfer]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException("PostPaidFixedAmountController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
        ...
        try {
            ...
            if (PretupsI.YES.equals(_c2sTransferVO.getDifferentialAllowedForService())) {
                try {
                    ...
                    _log.errorTrace(methodName, e);
                    throw new BTSLBaseException("PostPaidFixedAmountController", "process", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
                }
				if (mcomCon != null) {
					mcomCon.close("PostPaidFixedAmountController#run");
					mcomCon = null;
				}
                con = null;
                ...
                try {
                    ...
                    _log.errorTrace(methodName, be);
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "PostPaidFixedAmountController[run]",
            ...
            if (_log.isDebugEnabled()) {
                _log.debug("PostPaidFixedAmountController",
                    "For _transferID=" + _transferID + " Diff applicable=" + _c2sTransferVO.getDifferentialApplicable() + " Diff Given=" + _c2sTransferVO
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "{PostPaidFixedAmountController[run]", _transferID,
                _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "PostPaidFixedAmountController[run]", _transferID,
        ...
        if (!InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(status) || isRequired) {
            ...
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                    "PostPaidFixedAmountController[updateForReceiverValidateResponse]", _transferID, _senderMSISDN, _senderNetworkCode,
            ...
            if (!InterfaceErrorCodesI.SUCCESS.equals(status)) {
                ...
                throw new BTSLBaseException("PostPaidFixedAmountController", methodName, _c2sTransferVO.getErrorCode(), 0, strArr, null);
            }
            try {
    ...
    public void updateForReceiverCreditResponse(String str) throws BTSLBaseException {
        ...
        if (!BTSLUtil.isNullString((String) map.get("IN_TXN_ID"))) {
            try {
                ...
                _log.errorTrace(methodName, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                    "PostPaidFixedAmountController[updateForReceiverCreditResponse]", _transferID, _senderMSISDN, _senderNetworkCode,
                    "Exception while parsing for interface txn ID , Exception:" + e.getMessage());
            }
        }
    ...
    public void populateServiceInterfaceDetails(Connection p_con, String action) throws BTSLBaseException {
        ...
        if (!isReceiverFound) {
            throw new BTSLBaseException("PostPaidFixedAmountController", "populateServiceInterfaceDetails", PretupsErrorCodesI.C2S_ERROR_NOTFOUND_SERVICEINTERFACEMAPPING);
        }
    }
    ...
    private void checkTransactionLoad() throws BTSLBaseException {
        ...
        try {
            ...
            if (recieverLoadStatus == 0) {
                ...
                if (_log.isDebugEnabled()) {
                    _log.debug("PostPaidFixedAmountController[checkTransactionLoad]", "_transferID=" + _transferID + " Successfully through load");
                }
            }
            // Request in Queue
                ...
                throw new BTSLBaseException("PostPaidFixedAmountController", methodName, PretupsErrorCodesI.REQUEST_IN_QUEUE, 0, strArr, null);
            }
            // Refuse the request
            else {
                throw new BTSLBaseException("PostPaidFixedAmountController", methodName, PretupsErrorCodesI.REQUEST_REFUSE_FROM_INTLOAD);
            }
        } catch (BTSLBaseException be) {
            _log.error("PostPaidFixedAmountController[checkTransactionLoad]", "Refusing request getting Exception:" + be.getMessage());
            throw be;
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
            throw new BTSLBaseException("PostPaidFixedAmountController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        ...
        try {
            ...
            if ((System.currentTimeMillis() - _c2sTransferVO.getRequestStartTime()) > interfaceVO.getValExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                    "PostPaidFixedAmountController[processValidationRequest]", _transferID, _senderMSISDN, _senderNetworkCode,
                    "Exception: System is taking more time till validation");
                throw new BTSLBaseException("PostPaidFixedAmountController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION_TKING_TIME_TILL_VAL);
            }
			...
			if (mcomCon != null) {
				mcomCon.close("PostPaidFixedAmountController#processValidationRequest");
				mcomCon = null;
			}
            con = null;
            ...
            if ((System.currentTimeMillis() - _c2sTransferVO.getRequestStartTime()) > interfaceVO.getTopUpExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "PostPaidFixedAmountController[run]", _transferID,
                    _senderMSISDN, _senderNetworkCode, "Exception: System is taking more time till topup");
                throw new BTSLBaseException("PostPaidFixedAmountController", "run", PretupsErrorCodesI.C2S_ERROR_EXCEPTION_TKING_TIME_TILL_TOPUP);
            }
            interfaceVO = null;
            ...
            _log.error("PostPaidFixedAmountController[processValidationRequest]", "Getting BTSL Base Exception:" + be.getMessage());
            if (_transferDetailAdded) {
                if (mcomCon == null) {
					mcomCon = new MComConnection();
					con = mcomCon.getConnection();
    ...
    private String getReceiverSuccessMessage() {
        ...
        key = PretupsErrorCodesI.C2S_RECEIVER_SUCCESS_BILLPAY;
    ...
    private String getSenderSuccessMessage() {
        ...
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.C2S_SENDER_SUCCESS_BILLPAY, messageArgArray);
    }
    ...
    private String getReceiverUnderProcessMessage() {
        ...
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.C2S_RECEIVER_UNDERPROCESS_BILLPAY, messageArgArray, _requestVO.getRequestGatewayType());
    }
    ...
    private String getSenderUnderProcessMessage() {
        ...
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.C2S_SENDER_UNDERPROCESS_BILLPAY, messageArgArray);
    }
    ...
    private String getReceiverAmbigousMessage() {
        final String[] messageArgArray = { _senderPushMessageMsisdn, _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _channelUserVO
            .getUserName(), _requestVO.getPosUserMSISDN() };
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.C2S_RECEIVER_AMBIGOUS_KEY_BILLPAY, messageArgArray, _requestVO.getRequestGatewayType());
    }

    private String getReceiverFailMessage() {
        final String[] messageArgArray = { _senderPushMessageMsisdn, _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _channelUserVO
            .getUserName(), _requestVO.getPosUserMSISDN() };
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.C2S_RECEIVER_FAIL_KEY_BILLPAY, messageArgArray, _requestVO.getRequestGatewayType());
    }
    ...
    private void processValidationRequestInThread() throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _log.error("PostPaidFixedAmountController[processValidationRequestInThread]", "Getting BTSL Base Exception:" + be.getMessage());
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "PostPaidFixedAmountController[processValidationRequestInThread]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            TransactionLog.log(_transferID, _requestIDStr, _receiverMSISDN, _receiverVO.getNetworkCode(), PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
            ...
            if (_transferID != null) {
                ...
                try {
                    ...
                    if(mcomCon != null){mcomCon.close("PostPaidFixedAmountController#processValidationRequestInThread");mcomCon=null;}
                    con=null;
                    _log.errorTrace(methodName, be);
                } catch (Exception e) {
                    if (con != null) {
					...
					if (mcomCon != null) {
						mcomCon.close("PostPaidFixedAmountController#processValidationRequestInThread");
						mcomCon = null;
					}
                    con=null;
                    _log.errorTrace(methodName, e);
    ...
    private void addEntryInTransfers(Connection p_con) {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "PostPaidFixedAmountController[addEntryInTransfers]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            if (!_isCounterDecreased && _decreaseTransactionCounts) {
                LoadController.decreaseTransactionLoad(_transferID, _senderNetworkCode, LoadControllerI.DEC_LAST_TRANS_COUNT);
                _isCounterDecreased = true;
    ...
    private boolean getInterfaceRoutingDetails(Connection p_con, String p_msisdn, long p_prefixID, String p_subscriberType, String p_networkCode, String p_serviceType, String p_interfaceCategory, String p_userType, String p_action) throws BTSLBaseException {
        ...
        try {
            ...
            if (subscriberRoutingControlVO != null) {
                                ...
                                try {
                                    ...
                                    EventHandler
                                        .handle(
                                            ...
                                            EventStatusI.RAISED,
                                            EventLevelI.MAJOR,
                                            "PostPaidFixedAmountController[getInterfaceRoutingDetails]",
                                            _transferID,
                                            _receiverMSISDN,
                                            "",
                ...
                // based routing
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                    "PostPaidFixedAmountController[getInterfaceRoutingDetails]", _transferID, _senderMSISDN, _senderNetworkCode,
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "PostPaidFixedAmountController[getInterfaceRoutingDetails]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            isSuccess = false;
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        }
        if (_log.isDebugEnabled()) {
    ...
    private void performAlternateRouting(ArrayList altList) throws BTSLBaseException {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "PostPaidFixedAmountController[performAlternateRouting]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        }
    }
    ...
    public void receiverValidateResponse(String str, int p_attempt, int p_altSize) throws BTSLBaseException {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                "PostPaidFixedAmountController[receiverValidateResponse]", _transferID, _senderMSISDN, _senderNetworkCode,
                "Exception while parsing for interface txn ID , Exception:" + e.getMessage());
        }
        // }
        ...
        if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
            ...
            throw new BTSLBaseException("PostPaidFixedAmountController", methodName, PretupsErrorCodesI.C2S_RECEIVER_FAIL_BILLPAY, 0, strArr, null);
        }
        try {
            _receiverTransferItemVO.setPreviousBalance(Long.parseLong((String) map.get("INTERFACE_PREV_BALANCE")));
        } catch (Exception e) {
    ...
    public void processFromQueue(TransferVO p_transferVO) {
        ...
        try {
            ...
            if(mcomCon != null){mcomCon.close("PostPaidFixedAmountController#processFromQueue");mcomCon=null;}
            con = null;

            if (_log.isDebugEnabled()) {
                _log.debug("PostPaidFixedAmountController[processFromQueue]", "_transferID=" + _transferID + " Successfully through load");
            }
			...
			if (mcomCon != null) {
				mcomCon.close("PostPaidFixedAmountController#processFromQueue");
				mcomCon = null;
			}
            con = null;
            _log.errorTrace(methodName, e);
            ...
            // raising alarm
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "PostPaidFixedAmountController[processFromQueue]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            // logging in the transaction log
            TransactionLog.log(_transferID, _requestVO.getRequestIDStr(), _requestVO.getFilteredMSISDN(), "", PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
                _c2sTransferVO.getSenderReturnMessage(), PretupsI.TXN_LOG_STATUS_FAIL, "Getting Code=" + _requestVO.getMessageCode());
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "PostPaidFixedAmountController[processFromQueue]",
                    _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            }
        ...
        if (!BTSLUtil.isNullString(p_languageCode)) {
            try {
                if (LocaleMasterCache.getLocaleFromCodeDetails(p_languageCode) == null) {
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                        "PostPaidFixedAmountController[updateReceiverLocale]", _transferID, _receiverMSISDN, "",
    ...
    private static synchronized void generatePostPaidBillPmtTransferID(TransferVO p_transferVO) {
        ...
        try {
            ...
            if (_transactionIDCounter == 0) {
                throw new BTSLBaseException("PostPaidFixedAmountController", methodName, PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
    ...
    public boolean isValidSelctorAmount(String p_code, ArrayList p_list, String p_amount) {

        if (_log.isDebugEnabled()) {
            _log.debug("isValidSelctorAmount", "Entered: p_code=" + p_code + ", p_amount=" + p_amount + ", p_list=" + p_list);
        }
        ListValueVO vo = null;
        boolean flag = true;
        String key = null;
        ...
        if (p_list != null && !p_list.isEmpty()) {
            for (int i = 0, j = p_list.size(); i < j; i++) {
                ...
                arr = vo.getValue().split(":");
                key = arr[0] + ":" + arr[1];
                if (key.equalsIgnoreCase(p_code)) {
                    final String value = vo.getValue();
                    if ("false".equalsIgnoreCase((value.split(":")[3])) && !(value.split(":")[2]).equalsIgnoreCase(p_amount)) {
                        flag = false;
                    }
                    break;
                }
        ...
        if (_log.isDebugEnabled()) {
            _log.debug("isValidSelctorAmount", "Exited: flag=" + flag + ", vo=" + vo);
        }
        return flag;
    }
}
