...
public class CardGroupSetPostgresQry implements CardGroupSetQry{
	@Override
	public String loadCardGroupVersionCacheQry(){
        ...
        qry.append("WHERE  cdme.applicable_from<=CURRENT_TIMESTAMP AND cdme.card_group_set_id=cgs.card_group_set_id) OR cgsv.applicable_from >=CURRENT_TIMESTAMP) ");
