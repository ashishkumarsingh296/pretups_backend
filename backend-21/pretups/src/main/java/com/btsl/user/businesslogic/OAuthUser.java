...
public class OAuthUser {
	...
	public OAuthUserData getData() {
		return data;
	}

	public void setData(OAuthUserData data) {
		this.data = data;
	}
	...
	public String toString() {
		return "OAuthUser [loginId=" + BTSLUtil.maskParam(loginId) + ", msisdn=" + msisdn + ", password=" + BTSLUtil.maskParam(password) + ", pin=" + BTSLUtil.maskParam(pin)
				+ ", reqGatewayType=" + reqGatewayType + ", reqGatewayCode=" + reqGatewayCode + ", reqGatewayLoginId="
				+ reqGatewayLoginId + ", reqGatewayPassword=" + BTSLUtil.maskParam(reqGatewayPassword) + ", servicePort=" + servicePort
