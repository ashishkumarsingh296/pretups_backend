...
public class UserMigrRollbackLog {
    private static Log _log = LogFactory.getFactory().getInstance(UserMigrRollbackLog.class.getName());

    /**
	 * to ensure no class instantiation 
	 */
    private UserMigrRollbackLog() {
        
    }
    public static void log(String p_info1, String p_info3) {
        final String METHOD_NAME = "log";
        try {
            StringBuffer strBuff = new StringBuffer();
            strBuff.append(p_info1 + " " + p_info3);
