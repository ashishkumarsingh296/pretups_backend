...
public class MComExternalDBConnection implements MComConnectionI{
	public static final String method_name="MComExternalDBConnection";
	public static final Log log = LogFactory.getLog(MComExternalDBConnection.class.getName());
	
	private boolean dirty;
	private Connection connection;

	public MComExternalDBConnection()  throws BTSLBaseException{
		this.dirty = true;
		this.connection = OracleUtil.getExternalDBConnection();
	}
	public MComExternalDBConnection(boolean flag)  throws BTSLBaseException{
		this.dirty = flag;
		this.connection = OracleUtil.getExternalDBConnection();
	}
