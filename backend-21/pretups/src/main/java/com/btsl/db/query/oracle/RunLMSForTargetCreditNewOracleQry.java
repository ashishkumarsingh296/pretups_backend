...
public class RunLMSForTargetCreditNewOracleQry implements RunLMSForTargetCreditNewQry {
	...
	public String loadRefTargetProfileQry() {
		...
		selectQueryBuffer.append(" FROM profile_details pd, profile_set ps, profile_set_version psv, channel_users cu, users u, user_phones up, products p, user_oth_profiles uop ");
		...
		selectQueryBuffer.append(" and TRUNC(psv.applicable_to) >=? "); // Plus 1 added to provide the bonus if weekly/monthly profile created
