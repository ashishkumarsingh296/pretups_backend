...
public class HourlyCountDetailAlertOracleQry implements HourlyCountDetailAlertQry{
	...
	public String transactionDetailIfC2SModule(SimpleDateFormat formatter,SimpleDateFormat formatter1,Calendar p_now, Calendar working ) {
        ...
        queryC2STrans
            .append(" SUM(CASE WHEN TRANSFER_STATUS='206' AND transfer_date_time >= (to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))-1/24) AND transfer_date_time < (to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))) THEN 1 ELSE 0 END) failed_hour_count, ");
        queryC2STrans
            .append(" SUM(CASE WHEN TRANSFER_STATUS='200' AND transfer_date_time >= (to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))-1/24) AND transfer_date_time < (to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))) THEN 1 ELSE 0 END) success_hour_count, ");
        queryC2STrans
            .append(" SUM(CASE WHEN (TRANSFER_STATUS='200' OR TRANSFER_STATUS='206') AND transfer_date_time >= (to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))-1/24) AND transfer_date_time < (to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))) THEN 1 ELSE 0 END) total_hour_count, ");
        queryC2STrans
            .append(" SUM(CASE WHEN (TRANSFER_STATUS='200' OR TRANSFER_STATUS='206') AND transfer_date_time >= (to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))-1/24) AND transfer_date_time < (to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))) THEN TRANSFER_VALUE ELSE 0 END) total_hour_amount, ");
        queryC2STrans
            .append(" SUM(CASE WHEN TRANSFER_STATUS='206' AND transfer_date_time < (to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))) THEN 1 ELSE 0 END) failed_day_count, ");
        queryC2STrans
            .append(" SUM(CASE WHEN TRANSFER_STATUS='200' AND transfer_date_time < (to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))) THEN 1 ELSE 0 END) success_day_count, ");
        queryC2STrans
            .append(" SUM(CASE WHEN (TRANSFER_STATUS='200' OR TRANSFER_STATUS='206') AND transfer_date_time < (to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))) THEN 1 ELSE 0 END) total_day_count, ");
        queryC2STrans
            .append(" SUM(CASE WHEN (TRANSFER_STATUS='200' OR TRANSFER_STATUS='206') AND transfer_date_time < (to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))) THEN TRANSFER_VALUE ELSE 0 END) total_day_amount ");
        ...
        queryC2STrans
            .append(" and transfer_date_time<(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am')-(TO_CHAR(to_date('" + formatter
                .format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'mi')/(24*60))-(TO_CHAR(to_date('" + formatter.format(p_now.getTime()) + "','dd/MM/yyyy HH:mi:ss am'),'ss')/(24*60*60))) ");
