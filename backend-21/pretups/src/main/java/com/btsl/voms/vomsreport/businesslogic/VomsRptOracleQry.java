...
public class VomsRptOracleQry implements VomsRptQry {
...
public PreparedStatement getSoldVCCardQuery(Connection con, VomsReportForm vomsReportForm) {
	...
	if (_log.isDebugEnabled()) {
		_log.debug(methodName, " Entered with  : From date " + vomsReportForm.getFromDate() + " To date " + vomsReportForm.getToDate());
	}
