...
public class VomsVoucherVO implements Serializable {
	...
	private Date newExpiryDate = null;
	 private String total_failure = null;
	
	 public String get_voucherType() {
		return _voucherType;
	}

	public void set_voucherType(String _voucherType) {
		this._voucherType = _voucherType;
	}

	public String getTotal_failure() {
		return total_failure;
	}

	public void setTotal_failure(String total_failure) {
		this.total_failure = total_failure;
	}
	...
	private String total_success = null;
	...
	public void setGeneratedDateOn(Date generatedOn) {
		this.generatedOn = generatedOn;
	}
	private Date enabledDateOn;
	public void setEnabledDateOn(Date enabledDateOn) {
		this.enabledDateOn = enabledDateOn;
	}

	public Date getEnabledDateOn() {
        return enabledDateOn;
    }
	...
	public void setUserNetworkCode(String userNetworkCode) {
		this.userNetworkCode = userNetworkCode;
	}
    ...
    public void setMRP(double p_mrp) {
        _mrp = p_mrp;
    }
    ...
    public String toString() {
        ...
        sbf.append("_serialNo=" + _serialNo + ", ");
        sbf.append("_pinNo=" + _pinNo + ", ");
        sbf.append("_expiryDate=" + _expiryDate + ", ");
        sbf.append("_serialNo=" + _serialNo + ", ");
        sbf.append("_mrp=" + _mrp + ", ");
        sbf.append("_voucherStatus=" + _voucherStatus + ", ");
        sbf.append("_expiryDateStr=" + _expiryDateStr + ", ");
        sbf.append("_mrp=" + _mrp + ", ");
        sbf.append("_consumedOnStr=" + _consumedOnStr + ", ");
        sbf.append("_newExpiryDate=" + newExpiryDate + ", ");
        sbf.append("_expiryChangeReason=" + expiryChangeReason + ", ");
        sbf.append("_voucherType=" + _voucherType + ", ");
        sbf.append("_userNetworkCode=" + userNetworkCode + ", ");
        sbf.append("_fromSerialNo=" + _fromSerialNo + ", ");
        sbf.append("_toSerialNo=" + _toSerialNo + ", ");
        sbf.append("_info1=" + info1 + ", ");
        sbf.append("_info2=" + info2 + ", ");
        sbf.append("_info3=" + info3 + ", ");
        sbf.append("_info4=" + info4 + ", ");
        sbf.append("_info5=" + info5 + ", ");
        sbf.append("_masterSerialNo=" + masterSerialNo + ", ");
        sbf.append("_bundleId=" + bundleId + ", ");
        sbf.append("_masterRetailPrice=" + masterRetailPrice + " ");
        return sbf.toString();
    }
    ...
    public String get_fromSerialNo() {
        return _fromSerialNo;
    }

    public void set_fromSerialNo(String serialNo) {
        _fromSerialNo = serialNo;
    }

    public long get_totalVouchers() {
        return _totalVouchers;
    }

    public void set_totalVouchers(long vouchers) {
	...
	/**
     * @return Returns the fileBatchNo.
     */
    ...
    /**
     * @param fileBatchNo
     *            The fileBatchNo to set.
     */
    public void setFileBatchNo(String fileBatchNo) {
    	_fileBatchNo = fileBatchNo;
    }
	...
	public long getMasterSerialNo() {
		return masterSerialNo;
	}
	public void setMasterSerialNo(long masterSerialNo) {
	...
	public double getMasterRetailPrice() {
		return masterRetailPrice;
	}
	public void setMasterRetailPrice(double masterRetailPrice) {
		this.masterRetailPrice = masterRetailPrice;
	}
