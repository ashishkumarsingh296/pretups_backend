...
public class PGPUtil {
	...
	public static PGPPublicKey readPublicKey(InputStream in)
		...
		System.out.println("keyyyyyyyy" + key.getValidDays());
		return key;
...

	{
		...
		System.out.println("secret ley" + pgpSecKey);
...

	{
		...
		while (sKey == null && it.hasNext()) {
			...
			System.out.println("secret ley" + sKey);
...

	{
		...
		try{
		System.out.println("keyyyyyyyyyyy" + encKey + "filename" + fileName);
		Security.addProvider(new BouncyCastleProvider());
		...
		org.bouncycastle.openpgp.PGPUtil.writeFileToLiteralData(comData
				.open(bOut), PGPLiteralData.BINARY, new File(fileName));
