...
public class DTHRechargeController implements ServiceKeywordControllerI, Runnable {

    private static Log _log = LogFactory.getLog(DTHRechargeController.class.getName());
    ...
    static {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DTHRechargeController[initialize]", "", "", "",
    ...
    public void process(RequestVO p_requestVO) {
        ...
        try {
            ...
            _operatorUtil.validateDTHRechargeRequest(con, _c2sTransferVO, p_requestVO);
            ...
            if (!_receiverVO.getSubscriberType().equals(_type)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "DTHRechargeController[process]", "", "", "",
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                throw new BTSLBaseException("DTHRechargeController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            }
            ...
            if (((Boolean) PreferenceCache.getSystemPreferenceValue(PreferenceI.SKEY_REQUIRED)).booleanValue()) {
				...
				if (mcomCon != null) {
					mcomCon.close("DTHRechargeController#process");
					mcomCon = null;
				}
                con = null;
            ...
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "DTHRechargeController[process]", _transferID,
            ...
            if (_recValidationFailMessageRequired) {
                ...
                if (_c2sTransferVO.getReceiverReturnMsg() == null || !((BTSLMessages) _c2sTransferVO.getReceiverReturnMsg()).isKey()) {
                    ...
                    if (_transferID != null) {
                        _c2sTransferVO.setReceiverReturnMsg(new BTSLMessages(PretupsErrorCodesI.DTH_RECEIVER_FAIL, new String[] { String.valueOf(_transferID), PretupsBL
        	...
        	loggerValue.append( e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DTHRechargeController[process]", _transferID,
                _senderMSISDN, _senderNetworkCode, loggerValue.toString());
            ...
            if (con != null) {
                ...
                if(mcomCon != null){mcomCon.close("DTHRechargeController#process");mcomCon=null;}
                con = null;
            }// end if
    ...
    private void processSKeyGen(Connection p_con) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DTHRechargeController[processSKeyGen]", _transferID,
    ...
    public void processTransfer(Connection p_con) throws BTSLBaseException {
        ...
        try {
            ...
            _c2sTransferVO.setErrorCode(PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DTHRechargeController[processTransfer]", _transferID,
                _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException("DTHRechargeController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        }
    }
        ...
        try {
            ...
            if ((!_senderNetworkCode.equals(_receiverNetworkCode)) && (((Boolean) (PreferenceCache.getSystemPreferenceValue(PreferenceI.ALLOW_ROAM_ADDCOMM))).booleanValue())) {
                try {
                    ...
                    _log.errorTrace(methodName, e);
                    throw new BTSLBaseException("DTHRechargeController", "process", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
                }
                if(mcomCon != null){mcomCon.close("DTHRechargeController#run");mcomCon=null;}
                con = null;
                ...
                try {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "DTHRechargeController[run]", _c2sTransferVO
            ...
            if ((_senderNetworkCode.equals(_receiverNetworkCode)) || ((!_senderNetworkCode.equals(_receiverNetworkCode)) && (!((Boolean) (PreferenceCache.getSystemPreferenceValue(PreferenceI.ALLOW_ROAM_ADDCOMM))).booleanValue()))) {
                ...
                if (PretupsI.YES.equals(_c2sTransferVO.getDifferentialAllowedForService())) {
                     ...
                     * channel user when they do first
                     * recharge for any subscriber. IN will provide information
                     * to about subscriber first recharge.
                     */
                    ...
                    if (giveBonus) {
                        ...
                        try {
                            ...
                            EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "DTHRechargeController[run]",
                ...
                if (_c2sTransferVO.getTransferStatus().equals(PretupsErrorCodesI.TXN_STATUS_SUCCESS)) {
                    ...
                    try {
                        ...
                        if (sosvo != null) {
                            ...
                            _log.error(this, "DTHRechargeController", methodName + " No record found in database for this number :" + _receiverTransferItemVO.getMsisdn());
                            // throw new
                            // BTSLBaseException("DTHRechargeController","run",PretupsErrorCodesI.SOS_ERROR_EXCEPTION);
                        }
                    } catch (BTSLBaseException be) {
                        _log.errorTrace(methodName, be);
                        _log.error(
                            this,
                            "DTHRechargeController",
                            "run BTSLBaseException:" + "Transaction ID: " + sosvo.getTransactionID() + "Msisdn" + _receiverTransferItemVO.getMsisdn() + "Getting Exception while processing LMB request :" + be
                                .getMessage());
                    } catch (Exception e) {
                        _log.errorTrace(methodName, e);
                        _log.error(this, "DTHRechargeController", "run Exception:" + "Transaction ID: " + sosvo.getTransactionID() + "Msisdn" + _receiverTransferItemVO
            ...
            if (_log.isDebugEnabled()) {
                _log.debug("DTHRechargeController",
                    "For _transferID=" + _transferID + " Diff applicable=" + _c2sTransferVO.getDifferentialApplicable() + " Diff Given=" + _c2sTransferVO
                        .getDifferentialGiven());
            }
        }// end try
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DTHRechargeController[run]", _transferID,
                _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "DTHRechargeController[run]", _transferID,
    ...
    public void updateForReceiverValidateResponse(String str) throws BTSLBaseException {
        ...
        if (!InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(status) || isRequired) {
            ...
            if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
                ...
                // throw new
                // BTSLBaseException("DTHRechargeController","updateForReceiverValidateResponse",PretupsErrorCodesI.DTH_RECEIVER_FAIL,0,strArr,null);
                // throw new
                // BTSLBaseException("DTHRechargeController","updateForReceiverValidateResponse",_c2sTransferVO.getErrorCode(),0,strArr,null);
                if (InterfaceErrorCodesI.INTERFACE_CUSTOMER_RECHARGENOTALLOWED.equals(_receiverTransferItemVO.getValidationStatus())) {
                    throw new BTSLBaseException("DTHRechargeController", methodName, InterfaceErrorCodesI.INTERFACE_CUSTOMER_RECHARGENOTALLOWED + "_S", 0, strArr, null);
                } else {
                    throw new BTSLBaseException("DTHRechargeController", methodName, _c2sTransferVO.getErrorCode(), 0, strArr, null);
                }
            }
            _receiverTransferItemVO.setTransferStatus(status);
    ...
    public void updateForReceiverCreditResponse(String str) throws BTSLBaseException {
        ...
        if (BTSLUtil.isNullString(status) || (!status.equals(InterfaceErrorCodesI.SUCCESS) && !status.equals(InterfaceErrorCodesI.AMBIGOUS))) {
            ...
            strArr = new String[] { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()) };
            // throw new
            // BTSLBaseException(this,"updateForReceiverValidateResponse",PretupsErrorCodesI.DTH_RECEIVER_FAIL,0,strArr,null);
             ...
             * map.get("INTERFACE_POST_BALANCE")));}catch(Exception e){};
             */
        ...
        ;
    	try{_requestVO.setNewExpiryDate(BTSLUtil.formatDateFromOnetoAnother((String)map.get("NEW_EXPIRY_DATE"),"ddMMyyyyHHmmss", "dd/MM/yyyy HH:mm:ss"));}catch(Exception e){};
    ...
    public void populateServiceInterfaceDetails(Connection p_con, String action) throws BTSLBaseException {
        ...
        if (!isReceiverFound) {
            throw new BTSLBaseException("DTHRechargeController", "populateServiceInterfaceDetails", PretupsErrorCodesI.C2S_ERROR_NOTFOUND_SERVICEINTERFACEMAPPING);
        }
    ...
    private void checkTransactionLoad() throws BTSLBaseException {
        ...
        try {
            ...
            if (recieverLoadStatus == 0) {
                ...
                if (_log.isDebugEnabled()) {
                    _log.debug("DTHRechargeController[checkTransactionLoad]", "_transferID=" + _transferID + " Successfully through load");
                }
            }
            // Request in Queue
                ...
                throw new BTSLBaseException("DTHRechargeController", methodName, PretupsErrorCodesI.REQUEST_IN_QUEUE, 0, strArr, null);
            }
            // Refuse the request
            else {
                throw new BTSLBaseException("DTHRechargeController", methodName, PretupsErrorCodesI.REQUEST_REFUSE_FROM_INTLOAD);
            }
        } catch (BTSLBaseException be) {
        	loggerValue.setLength(0);
        	loggerValue.append("Refusing request getting Exception:");
        	loggerValue.append(be.getMessage());
            _log.error("DTHRechargeController[checkTransactionLoad]",  loggerValue );
            throw be;
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
            throw new BTSLBaseException("DTHRechargeController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
    ...
    private void processValidationRequest() throws BTSLBaseException,SQLException{
        ...
        try {
            ...
            if ((System.currentTimeMillis() - _c2sTransferVO.getRequestStartTime()) > interfaceVO.getValExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "DTHRechargeController[processValidationRequest]",
                    _transferID, _senderMSISDN, _senderNetworkCode, "Exception: System is taking more time till validation");
                throw new BTSLBaseException("DTHRechargeController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION_TKING_TIME_TILL_VAL);
            }
			...
			if (mcomCon != null) {
				mcomCon.close("DTHRechargeController#processValidationRequest");
				mcomCon = null;
			}
            con = null;
            ...
            if ((System.currentTimeMillis() - _c2sTransferVO.getRequestStartTime()) > interfaceVO.getTopUpExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "DTHRechargeController[run]", _transferID,
                    _senderMSISDN, _senderNetworkCode, "Exception: System is taking more time till topup");
                throw new BTSLBaseException("DTHRechargeController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION_TKING_TIME_TILL_TOPUP);
            }
            interfaceVO = null;
        	...
        	loggerValue.append(be.getMessage());
            _log.error("DTHRechargeController[processValidationRequest]", loggerValue );
            if (_transferDetailAdded) {
                if (mcomCon == null) {
                	mcomCon = new MComConnection();con=mcomCon.getConnection();
                }
        	...
        	if(mcomCon != null){mcomCon.close("DTHRechargeController#processValidationRequest");mcomCon=null;}
            con = null;
        }
    }
    ...
    private String getReceiverSuccessMessage() {
        ...
        if (!("N".equals(_c2sTransferVO.getBoth()) && "N".equals(_c2sTransferVO.getOnline()))) {
            ...
            messageArgArray = new String[] { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getReceiverTransferValue()), String.valueOf(_receiverTransferItemVO
                ...
                .getPostBalance()) };
            key = PretupsErrorCodesI.DTH_IMPLICIT_MSG;
        } else {
            // For Get NUMBER BACK Service
            if (_c2sTransferVO.getReceiverTransferItemVO().isNumberBackAllowed()) {
                ...
                if (!_receiverTransferItemVO.getPostValidationStatus().equals(InterfaceErrorCodesI.SUCCESS)) {
                    if ((_c2sTransferVO.getBonusTalkTimeValue() == 0)) {
                        key = PretupsErrorCodesI.DTH_RECEIVER_SUCCESS_WITHOUT_POSTBAL;// return
                        // BTSLUtil.getMessage(_receiverLocale,PretupsErrorCodesI.C2S_RECEIVER_SUCCESS_WITHOUT_POSTBAL,messageArgArray);
                    } else {
                        key = PretupsErrorCodesI.DTH_RECEIVER_SUCCESS_WITHOUT_POSTBAL_WITH_BONUS;
                    }
                } else {
                    if ((_c2sTransferVO.getBonusTalkTimeValue() == 0)) {
                        key = PretupsErrorCodesI.DTH_RECEIVER_SUCCESS;// return
                        // BTSLUtil.getMessage(_receiverLocale,PretupsErrorCodesI.C2S_RECEIVER_SUCCESS_WITHOUT_POSTBAL,messageArgArray);
                    } else {
                        key = PretupsErrorCodesI.DTH_RECEIVER_SUCCESS_WITH_BONUS;
                    }
                }
            }
        ...
        if (!BTSLUtil.isNullString(_receiverTransferItemVO.getChangedBundleCodes()) && _receiverTransferItemVO.getChangedBundleCodes().length() > 0) {
            ...
            key = PretupsErrorCodesI.DTH_RECEIVER_SUCCESS_ALL_BALANCES;
        }
    ...
    private String getSenderSuccessMessage() {
        ...
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.DTH_SENDER_SUCCESS, messageArgArray);
    }
    ...
    private String getReceiverUnderProcessMessage() {
        ...
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.DTH_RECEIVER_UNDERPROCESS, messageArgArray, _requestVO.getRequestGatewayType());
    }
    ...
    private String getSenderUnderProcessMessage() {
        ...
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.DTH_SENDER_UNDERPROCESS, messageArgArray);
    }
    ...
    private String getSndrUPMsgBeforeValidation() {
        final String[] messageArgArray = { _receiverMSISDN, _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _receiverTransferItemVO
            .getSelectorName() };
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.DTH_SENDER_UNDERPROCESS_B4VAL, messageArgArray);
    }
    ...
    private String getReceiverAmbigousMessage() {
        ...
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.DTH_RECEIVER_AMBIGOUS_KEY, messageArgArray, _requestVO.getRequestGatewayType());
    }

    private String getReceiverFailMessage() {
        final String[] messageArgArray = { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _senderPushMessageMsisdn, _channelUserVO
            .getUserName(), _requestVO.getPosUserMSISDN(), _receiverTransferItemVO.getSelectorName() };
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.DTH_RECEIVER_FAIL_KEY, messageArgArray, _requestVO.getRequestGatewayType());
    }
    ...
    private void setReceiverTransferItemVO() {
        ...
        _receiverTransferItemVO.setTransferStatus(PretupsErrorCodesI.DTH_RECEIVER_UNDERPROCESS_SUCCESS);
    }
    ...
    private void updateSenderForFailedTransaction(Connection p_con) throws BTSLBaseException {
        ...
        try {
            ...
            if (_requestVO.getMessageGatewayVO().getFlowType().equals(PretupsI.MSG_GATEWAY_FLOW_TYPE_REQUEST)) {
                ...
                _requestVO.setMessageCode(PretupsErrorCodesI.DTH_SENDER_CREDIT_SUCCESS);
            }
    ...
    private void processValidationRequestInThread() throws BTSLBaseException, Exception {
        ...
        try {
        	...
        	loggerValue.append("Getting BTSL Base Exception:");
        	loggerValue.append(be.getMessage());
            _log.error("DTHRechargeController[processValidationRequestInThread]",  loggerValue);
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "DTHRechargeController[processValidationRequestInThread]", _transferID, _senderMSISDN, _senderNetworkCode,  loggerValue.toString() );
            TransactionLog.log(_transferID, _requestIDStr, _receiverMSISDN, _receiverVO.getNetworkCode(), PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
            ...
            if (_transferID != null && !_transferDetailAdded) {
                ...
                try {
                    ...
                    if(mcomCon != null){mcomCon.close("DTHRechargeController#processValidationRequestInThread");mcomCon=null;}
                    con=null;
                    _log.errorTrace(methodName, be);
                } catch (Exception e) {
                    if (con != null) {
    ...
    private boolean getInterfaceRoutingDetails(Connection p_con, String p_msisdn, long p_prefixID, String p_subscriberType, String p_networkCode, String p_serviceType, String p_interfaceCategory, String p_userType, String p_action) throws BTSLBaseException {
        ...
        try {
            ...
            if (subscriberRoutingControlVO != null) {
                ...
                // based routing
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "DTHRechargeController[getInterfaceRoutingDetails]",
        	...
        	loggerValue.append("Exception:");
        	loggerValue.append(e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DTHRechargeController[getInterfaceRoutingDetails]",
    ...
    private void performAlternateRouting(ArrayList altList) throws BTSLBaseException {
        ...
        try {
        	...
        	loggerValue.append("Exception:");
        	loggerValue.append( e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DTHRechargeController[performAlternateRouting]",
                _transferID, _senderMSISDN, _senderNetworkCode,  loggerValue.toString());
    ...
    public void receiverValidateResponse(String str, int p_attempt, int p_altSize) throws BTSLBaseException {
        ...
        if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
            ...
            throw new BTSLBaseException("DTHRechargeController", "updateForReceiverValidateResponse", PretupsErrorCodesI.DTH_RECEIVER_FAIL, 0, strArr, null);
        }
    ...
    public void processFromQueue(TransferVO p_transferVO) {
        ...
        try {
			...
			if (mcomCon != null) {
				mcomCon.close("DTHRechargeController#processFromQueue");
				mcomCon = null;
			}
            con = null;
            ...
            if (_log.isDebugEnabled()) {
                ...
                _log.debug("DTHRechargeController[processFromQueue]", loggerValue );
            }
            _processedFromQueue = true;

            processValidationRequest();
            // Set under process message for the sender and reciever
            p_transferVO.setMessageCode(PretupsErrorCodesI.DTH_SENDER_UNDERPROCESS_SUCCESS);
            ...
            try {
            	...
            	loggerValue.append( "Leaving Reciever Unmarked Base Exception:");
            	loggerValue.append(bex.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "DTHRechargeController[processFromQueue]",
                    _transferID, _senderMSISDN, _senderNetworkCode, loggerValue.toString() );
            } catch (Exception e) {
                _log.errorTrace(methodName, e);
                loggerValue.setLength(0);
        	...
        	if(mcomCon != null){mcomCon.close("DTHRechargeController#processFromQueue");mcomCon=null;}
            con = null;
            _log.errorTrace(methodName, e);
            try {
                if (_receiverVO != null && _receiverVO.isUnmarkRequestStatus()) {
        	...
        	loggerValue.append("Exception:");
        	loggerValue.append( e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DTHRechargeController[processFromQueue]", _transferID,
                _senderMSISDN, _senderNetworkCode,  loggerValue.toString());
            // logging in the transaction log
            TransactionLog.log(_transferID, _requestVO.getRequestIDStr(), _requestVO.getFilteredMSISDN(), "", PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
                _c2sTransferVO.getSenderReturnMessage(), PretupsI.TXN_LOG_STATUS_FAIL, "Getting Code=" + _requestVO.getMessageCode());
            ...
            try {
            	...
            	loggerValue.append("Exception:" );
            	loggerValue.append( e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DTHRechargeController[processFromQueue]",
                    _transferID, _senderMSISDN, _senderNetworkCode, loggerValue.toString());
            }
        ...
        if (!BTSLUtil.isNullString(p_languageCode)) {
            try {
                if (LocaleMasterCache.getLocaleFromCodeDetails(p_languageCode) == null) {
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "DTHRechargeController[updateReceiverLocale]",
    ...
    private static synchronized void generateC2STransferID(TransferVO p_transferVO) {
        ...
        try {
            ...
            if (_transactionIDCounter == 0) {
                throw new BTSLBaseException("DTHRechargeController", "formatTransferID", PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
            transferID = _operatorUtil.formatTransferID(p_transferVO, _transactionIDCounter, "T");
            if (transferID == null) {
                throw new BTSLBaseException("DTHRechargeController", "formatTransferID", PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
    ...
    private String getSenderParentSuccessMessage() {
        ...
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.DTH_PARENT_SUCCESS, messageArgArray);
    }
}
