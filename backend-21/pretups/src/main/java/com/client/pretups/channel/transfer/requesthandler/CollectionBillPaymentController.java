/**
 * @(#)CollectionBillPaymentController.java
 *                                          Name Date History
 *                                          ------------------------------------
 *                                          ------------------------------------
...
public class CollectionBillPaymentController implements ServiceKeywordControllerI, Runnable {
    private static Log _log = LogFactory.getLog(CollectionBillPaymentController.class.getName());
    ...
    static {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "CollectionBillPaymentController[initialize]", "", "",
                "", "Exception while loading the class at the call:" + e.getMessage());
        }
    }

    public CollectionBillPaymentController() {
    ...
    public void process(RequestVO p_requestVO) {
        ...
        try {
            ...
            _operatorUtil.validateCollectionBillpaymentRequest(con, _c2sTransferVO, p_requestVO);
            ...
            if (!_receiverVO.getSubscriberType().equals(_type)) {
                ...
                if (_networkPrefixVO != null) {
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "CollectionBillPaymentController[process]", "",
                        "", "",
            ...
            try {
               mcomCon.partialCommit();
                ...
                _log.errorTrace(methodName, e);
                throw new BTSLBaseException("CollectionBillPaymentController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            }
            ...
            if (((Boolean) PreferenceCache.getSystemPreferenceValue(PreferenceI.SKEY_REQUIRED)).booleanValue()) {
                ...
                if(mcomCon != null)
                {
                	mcomCon.close("CollectionBillPaymentController#process");
                	mcomCon=null;
                	}
                con = null;
            ...
            // raising alarm
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "CollectionBillPaymentController[process]",
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "CollectionBillPaymentController[process]",
                    _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            }
    ...
    private void generateCollVaiable(RequestVO p_requestvo) {
        ...
        final String methodName = "generateCollVaiable";
        try {
    ...
    synchronized public String generatePIN(String chars, int passLength) throws BTSLBaseException {
        final String methodName = "generatePIN";
        ...
        try {
            ...
            temp = null;
            _log.errorTrace(methodName, e);
            throw new BTSLBaseException("Exception In generating PIN");
        }
        if (_log.isDebugEnabled()) {
    ...
    private void processSKeyGen(Connection p_con) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "CollectionBillPaymentController[processSKeyGen]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException("CollectionBillPaymentController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
    ...
    public void processTransfer(Connection p_con) throws BTSLBaseException {
        ...
        try {
            ...
            generateBillPmtTransferID(_c2sTransferVO);
            ...
            _c2sTransferVO.setErrorCode(PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "CollectionBillPaymentController[processTransfer]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException("CollectionBillPaymentController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        } finally {
            if (_log.isDebugEnabled()) {
    ...
    public void run() {
        ...
        try {
            ...
            try {
                ...
                // Validating the receiver Limits and updating it
                PretupsBL.validateRecieverLimits(con, _c2sTransferVO, PretupsI.TRANS_STAGE_AFTER_INTOP, PretupsI.C2S_MODULE);
                throw new BTSLBaseException("CollectionBillPaymentController", methodName, "");
            ...
            if (PretupsI.YES.equals(_c2sTransferVO.getDifferentialAllowedForService())) {
                try {
                  mcomCon.finalCommit();
                    ...
                    _log.errorTrace(methodName, e);
                    throw new BTSLBaseException("CollectionBillPaymentController", "process", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
                }
                if(mcomCon != null)
                {
                	mcomCon.close("CollectionBillPaymentController#run");
                	mcomCon=null;
                	}
                con = null;
                ...
                try {
                    ...
                    if (_log.isDebugEnabled()) {
                        _log.debug(
                            "CollectionBillPaymentController",
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "CollectionBillPaymentController[run]",
            ...
            if (_log.isDebugEnabled()) {
                _log.debug("CollectionBillPaymentController",
                    "For _transferID=" + _transferID + " Diff applicable=" + _c2sTransferVO.getDifferentialApplicable() + " Diff Given=" + _c2sTransferVO
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "{CollectionBillPaymentController[run]", _transferID,
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "CollectionBillPaymentController[run]", _transferID,
        ...
        if (!InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(status) || isRequired) {
            ...
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                    "CollectionBillPaymentController[updateForReceiverValidateResponse]", _transferID, _senderMSISDN, _senderNetworkCode,
            ...
            if (!InterfaceErrorCodesI.SUCCESS.equals(status)) {
                ...
                throw new BTSLBaseException("CollectionBillPaymentController", methodName, _c2sTransferVO.getErrorCode(), 0, strArr, null);
            }

            if (BTSLUtil.isStringContain(ClaroCollEnqWSI.RESPONSE_NOBILLPAY_SUCCESS, (String) map.get("INTERFACE_STATUS"))) {
                _c2sTransferVO.setErrorCode(PretupsErrorCodesI.C2S_RECEIVER_BILLPAY_NOTFOUND);
                _receiverVO.setTransactionStatus(PretupsErrorCodesI.TXN_STATUS_FAIL);
                _receiverTransferItemVO.setTransferStatus(PretupsErrorCodesI.C2S_RECEIVER_BILLPAY_NOTFOUND);
                _senderTransferItemVO.setValidationStatus(PretupsErrorCodesI.TXN_STATUS_SUCCESS);
                _senderTransferItemVO.setTransferStatus(PretupsErrorCodesI.TXN_STATUS_FAIL);
                strArr = new String[] { _receiverMSISDN, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _transferID };
                throw new BTSLBaseException("CollectionBillPaymentController", methodName, _c2sTransferVO.getErrorCode(), 0, strArr, null);
            }
            ...
            _requestVO.setInvoiceno((String) map.get("INVOICE_NUMBER"));
    ...
    public void updateForReceiverCreditResponse(String str) throws BTSLBaseException {
        ...
        if (!BTSLUtil.isNullString((String) map.get("IN_TXN_ID"))) {
            try {
                ...
                _log.errorTrace(methodName, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                    "CollectionBillPaymentController[updateForReceiverCreditResponse]", _transferID, _senderMSISDN, _senderNetworkCode,
                    "Exception while parsing for interface txn ID , Exception:" + e.getMessage());
            }
        }
    ...
    public void populateServiceInterfaceDetails(Connection p_con, String action) throws BTSLBaseException {
        ...
        if (!isReceiverFound) {
            throw new BTSLBaseException("CollectionBillPaymentController", "populateServiceInterfaceDetails", PretupsErrorCodesI.C2S_ERROR_NOTFOUND_SERVICEINTERFACEMAPPING);
        }
    }
    ...
    private void checkTransactionLoad() throws BTSLBaseException {
        ...
        try {
            ...
            if (recieverLoadStatus == 0) {
                ...
                if (_log.isDebugEnabled()) {
                    _log.debug("CollectionBillPaymentController[checkTransactionLoad]", "_transferID=" + _transferID + " Successfully through load");
                }
            }
            // Request in Queue
                ...
                throw new BTSLBaseException("CollectionBillPaymentController", methodName, PretupsErrorCodesI.REQUEST_IN_QUEUE, 0, strArr, null);
            }
            // Refuse the request
            else {
                throw new BTSLBaseException("CollectionBillPaymentController", methodName, PretupsErrorCodesI.REQUEST_REFUSE_FROM_INTLOAD);
            }
        } catch (BTSLBaseException be) {
            _log.error("CollectionBillPaymentController[checkTransactionLoad]", "Refusing request getting Exception:" + be.getMessage());
            throw be;
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
            throw new BTSLBaseException("CollectionBillPaymentController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        ...
        try {
            ...
            if ((System.currentTimeMillis() - _c2sTransferVO.getRequestStartTime()) > interfaceVO.getValExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                    "CollectionBillPaymentController[processValidationRequest]", _transferID, _senderMSISDN, _senderNetworkCode,
                    "Exception: System is taking more time till validation");
                throw new BTSLBaseException("CollectionBillPaymentController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION_TKING_TIME_TILL_VAL);
            }
            ...
            if(mcomCon != null)
            {
            	mcomCon.close("CollectionBillPaymentController#processValidationRequest");
            	mcomCon=null;
            	}
            con = null;
            ...
            if ((System.currentTimeMillis() - _c2sTransferVO.getRequestStartTime()) > interfaceVO.getTopUpExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "CollectionBillPaymentController[run]", _transferID,
                    _senderMSISDN, _senderNetworkCode, "Exception: System is taking more time till topup");
                throw new BTSLBaseException("CollectionBillPaymentController", "run", PretupsErrorCodesI.C2S_ERROR_EXCEPTION_TKING_TIME_TILL_TOPUP);
            }
            interfaceVO = null;
            ...
            if (_recValidationFailMessageRequired) {
                if (_c2sTransferVO.getReceiverReturnMsg() == null || !((BTSLMessages) _c2sTransferVO.getReceiverReturnMsg()).isKey()) {
                    if (!be.getMessageKey().equalsIgnoreCase(PretupsErrorCodesI.C2S_RECEIVER_BILLPAY_NOTFOUND)) {
                        _c2sTransferVO.setReceiverReturnMsg(new BTSLMessages(PretupsErrorCodesI.C2S_RECEIVER_FAIL_COLLECTION, new String[] { PretupsBL
                            .getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _senderPushMessageMsisdn, String.valueOf(_transferID) }));
                    } else {
                        _c2sTransferVO.setReceiverReturnMsg(new BTSLMessages(be.getMessageKey(), be.getArgs()));
            ...
            _log.error("CollectionBillPaymentController[processValidationRequest]", "Getting BTSL Base Exception:" + be.getMessage());
            if (_transferDetailAdded) {
                if (mcomCon == null) {
                    mcomCon = new MComConnection();
                    con=mcomCon.getConnection();
    ...
    private String getReceiverCommonString() {
        ...
        try {
            final Format formatter = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss");
    ...
    private String getReceiverSuccessMessage() {
        ...
        messageArgArray = new String[] { PretupsBL.getDisplayAmount(_c2sTransferVO.getReceiverTransferValue()), _senderPushMessageMsisdn, _transferID, _c2sTransferVO
            ...
            .getReceiverCreditBonusValidity()), _requestVO.getPosUserMSISDN() ,_receiverMSISDN};
        key = PretupsErrorCodesI.C2S_RECEIVER_SUCCESS_COLLECTIONBILLPAYMENT;
    ...
    private String getSenderSuccessMessage() {
        ...
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.C2S_SENDER_SUCCESS_COLLECTIONBILLPAYMENT, messageArgArray);
    ...
    private String getReceiverUnderProcessMessage() {
        ...
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.C2S_RECEIVER_UNDERPROCESS_COLLECTIONBILLPAYMENT, messageArgArray, _requestVO.getRequestGatewayType());
    ...
    private String getSenderUnderProcessMessage() {
        ...
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.C2S_SENDER_UNDERPROCESS_COLLECTIONBILLPAYMENT, messageArgArray);
    }
    ...
    private String getSndrUPMsgBeforeValidation() {
        ...
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.C2S_SENDER_UNDERPROCESS_B4VAL_COLLECTIONBILLPAYMENT, messageArgArray);
    ...
    private String getReceiverAmbigousMessage() {
        ...
        final String[] messageArgArray = { _senderPushMessageMsisdn, _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _channelUserVO
            .getUserName(), _requestVO.getPosUserMSISDN() };
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.C2S_RECEIVER_AMBIGOUS_KEY_COLLECTIONBILLPAYMENT, messageArgArray, _requestVO.getRequestGatewayType());
    ...
    private String getReceiverFailMessage() {
        ...
        final String[] messageArgArray = { _senderPushMessageMsisdn, _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _channelUserVO
            .getUserName(), _requestVO.getPosUserMSISDN() };
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.C2S_RECEIVER_FAIL_KEY_COLLECTIONBILLPAYMENT, messageArgArray, _requestVO.getRequestGatewayType());
    ...
    private void processValidationRequestInThread() throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _log.error("CollectionBillPaymentController[processValidationRequestInThread]", "Getting BTSL Base Exception:" + be.getMessage());
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "CollectionBillPaymentController[processValidationRequestInThread]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            TransactionLog.log(_transferID, _requestIDStr, _receiverMSISDN, _receiverVO.getNetworkCode(), PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
            ...
            if (_transferID != null) {
                ...
                try {
                    ...
                    if(mcomCon != null)
                    {
                    	mcomCon.close("CollectionBillPaymentController#processValidationRequestInThread");
                    	mcomCon=null;
                    	}
                    con=null;
                    _log.errorTrace(methodName, be);
    ...
    private void addEntryInTransfers(Connection p_con) {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "CollectionBillPaymentController[addEntryInTransfers]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            if (!_isCounterDecreased && _decreaseTransactionCounts) {
                LoadController.decreaseTransactionLoad(_transferID, _senderNetworkCode, LoadControllerI.DEC_LAST_TRANS_COUNT);
                _isCounterDecreased = true;
    ...
    private boolean getInterfaceRoutingDetails(Connection p_con, String p_msisdn, long p_prefixID, String p_subscriberType, String p_networkCode, String p_serviceType, String p_interfaceCategory, String p_userType, String p_action) throws BTSLBaseException {
        ...
        try {
            ...
            if (subscriberRoutingControlVO != null) {
                                ...
                                try {
                                    ...
                                    EventHandler
                                        .handle(
                                            ...
                                            EventStatusI.RAISED,
                                            EventLevelI.MAJOR,
                                            "CollectionBillPaymentController[getInterfaceRoutingDetails]",
                                            _transferID,
                                            _receiverMSISDN,
                                            "",
                ...
                // based routing
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO,
                    "CollectionBillPaymentController[getInterfaceRoutingDetails]", _transferID, _senderMSISDN, _senderNetworkCode,
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "CollectionBillPaymentController[getInterfaceRoutingDetails]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            isSuccess = false;
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        }
        if (_log.isDebugEnabled()) {
    ...
    private void performAlternateRouting(ArrayList altList) throws BTSLBaseException {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "CollectionBillPaymentController[performAlternateRouting]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        }
    }
    ...
    public void receiverValidateResponse(String str, int p_attempt, int p_altSize) throws BTSLBaseException {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                "CollectionBillPaymentController[receiverValidateResponse]", _transferID, _senderMSISDN, _senderNetworkCode,
                "Exception while parsing for interface txn ID , Exception:" + e.getMessage());
        }
        ...
        if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
            ...
            throw new BTSLBaseException("CollectionBillPaymentController", methodName, PretupsErrorCodesI.C2S_RECEIVER_FAIL_COLLECTION, 0, strArr, null);
        }
        try {
            _receiverTransferItemVO.setPreviousBalance(Long.parseLong((String) map.get("INTERFACE_PREV_BALANCE")));
        } catch (Exception e) {
    ...
    public void processFromQueue(TransferVO p_transferVO) {
        ...
        try {
            ...
            if(mcomCon != null)
            {
            	mcomCon.close("CollectionBillPaymentController#processFromQueue");
            	mcomCon=null;
            	}
            con = null;

            if (_log.isDebugEnabled()) {
                _log.debug("CollectionBillPaymentController[processFromQueue]", "_transferID=" + _transferID + " Successfully through load");
            }
            ...
            // raising alarm
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "CollectionBillPaymentController[processFromQueue]",
                _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            // logging in the transaction log
            TransactionLog.log(_transferID, _requestVO.getRequestIDStr(), _requestVO.getFilteredMSISDN(), "", PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
                _c2sTransferVO.getSenderReturnMessage(), PretupsI.TXN_LOG_STATUS_FAIL, "Getting Code=" + _requestVO.getMessageCode());
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "CollectionBillPaymentController[processFromQueue]",
                    _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            }
            ...
            if (con != null) {
                ...
                if(mcomCon != null)
                {
                	mcomCon.close("CollectionBillPaymentController#Com@processFromQueue");
                	mcomCon=null;
                	}
                con = null;
            }// end if
        ...
        if (!BTSLUtil.isNullString(p_languageCode)) {
            try {
                if (LocaleMasterCache.getLocaleFromCodeDetails(p_languageCode) == null) {
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR,
                        "CollectionBillPaymentController[updateReceiverLocale]", _transferID, _receiverMSISDN, "",
     ...
     * throw new BTSLBaseException("CollectionBillPaymentController",
    ...
    private static synchronized void generateBillPmtTransferID(TransferVO p_transferVO) {
        final String methodName = "generateBillPmtTransferID";
        String transferID = null;
        ...
        try {
            ...
            if (_transactionIDCounter == 0) {
                throw new BTSLBaseException("CollectionBillPaymentController", methodName, PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
