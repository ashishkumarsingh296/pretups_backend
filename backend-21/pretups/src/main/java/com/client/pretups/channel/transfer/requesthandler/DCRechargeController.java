...
/**
 * @(#)DCPrepaidController.java
 *                              Name Date History
 *                              ------------------------------------------------
 *                              ------------------------
 *                              Vipan Kumar 15/11/2013 Initial Creation
 *                              ------------------------------------------------
 *                              ------------------------
 *                              Copyright (c) 2013 Mahindra Comviva Ltd.
...
public class DCRechargeController implements ServiceKeywordControllerI, Runnable {
    private static Log _log = LogFactory.getLog(DCRechargeController.class.getName());
    ...
    static {
        ...
        try {
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DCRechargeController[initialize]", "", "", "",
                "Exception while loading the class at the call:" + e.getMessage());
        }
    }

    public DCRechargeController() {
    ...
    public void process(RequestVO p_requestVO) {
        ...
        try {
            ...
            if (_c2sTransferVO.getRequestedAmount() == 0) {
                ...
                try {
                    final SelectorAmountMappingVO amountMappingVO = new SelectorAmountMappingDAO().loadSelectorAmountDetails(con, _serviceType, p_requestVO.getReqSelector());

                    if (amountMappingVO != null) {
                        PretupsBL.validateAmount(_c2sTransferVO, amountMappingVO.getAmountStr());
                    } else {
                        throw new BTSLBaseException(this, methodName, PretupsErrorCodesI.DC_ERROR_INVALID_AMOUNT);
                    }
            ...
            if (!_receiverVO.getSubscriberType().equals(_type)) {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "DCRechargeController[process]", "", "", "",
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                throw new BTSLBaseException("DCRechargeController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            }
            ...
            if (((Boolean) PreferenceCache.getSystemPreferenceValue(PreferenceI.SKEY_REQUIRED)).booleanValue()) {
                ...
                if(mcomCon != null){mcomCon.close("DCRechargeController#process");mcomCon=null;}
                con = null;
            ...
            try {
                ...
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "DCRechargeController[process]", _transferID,
            ...
            if (_recValidationFailMessageRequired) {
                ...
                if (_c2sTransferVO.getReceiverReturnMsg() == null || !((BTSLMessages) _c2sTransferVO.getReceiverReturnMsg()).isKey()) {
                    ...
                    if (_transferID != null) {
                        _c2sTransferVO.setReceiverReturnMsg(new BTSLMessages(PretupsErrorCodesI.DC_RECEIVER_FAIL, new String[] { String.valueOf(_transferID), PretupsBL
                            .getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _receiverTransferItemVO.getSelectorName() }));
                    } else {
        	...
        	loggerValue.append(e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DCRechargeController[process]", _transferID,
                _senderMSISDN, _senderNetworkCode,  loggerValue.toString() );
    ...
    private void processSKeyGen(Connection p_con) throws BTSLBaseException, Exception {
        ...
        try {
            ...
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DCRechargeController[processSKeyGen]", _transferID,
    ...
    public void processTransfer(Connection p_con) throws BTSLBaseException {
        ...
        try {
            ...
            _c2sTransferVO.setErrorCode(PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
            _log.errorTrace(methodName, e);
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DCRechargeController[processTransfer]", _transferID,
                _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            throw new BTSLBaseException("DCRechargeController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
        }
    }
    ...
    public void run() {
        ...
        try {
            ...
            // TransactionLog.log(_transferID,_requestIDStr,_receiverMSISDN,_receiverVO.getNetworkCode(),PretupsI.TXN_LOG_REQTYPE_INT,PretupsI.TXN_LOG_TXNSTAGE_PROCESS,"Transaction
            // Success",PretupsI.TXN_LOG_STATUS_SUCCESS,"Transfer
            // Status="+_c2sTransferVO.getTransferStatus());
            ...
            if ((!_senderNetworkCode.equals(_receiverNetworkCode)) && (((Boolean) (PreferenceCache.getSystemPreferenceValue(PreferenceI.ALLOW_ROAM_ADDCOMM))).booleanValue())) {
                try {
                    ...
                    _log.errorTrace(methodName, e);
                    throw new BTSLBaseException("DCRechargeController", "process", PretupsErrorCodesI.C2S_ERROR_EXCEPTION);
                }
                if(mcomCon != null){mcomCon.close("DCRechargeController#run");mcomCon=null;}
                con = null;
                ...
                try {
                    ...
                    if (_log.isDebugEnabled()) {
                        _log.debug(
                            "DCRechargeController",
                            "For _transferID=" + _transferID + " roam commission applicable=" + _c2sTransferVO.getDifferentialApplicable() + " roam commission Given=" + _c2sTransferVO
                    ...
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "DCRechargeController[run]", _c2sTransferVO
            ...
            if ((_senderNetworkCode.equals(_receiverNetworkCode)) || ((!_senderNetworkCode.equals(_receiverNetworkCode)) && (!((Boolean) (PreferenceCache.getSystemPreferenceValue(PreferenceI.ALLOW_ROAM_ADDCOMM))).booleanValue()))) {
                ...
                if (PretupsI.YES.equals(_c2sTransferVO.getDifferentialAllowedForService())) {
					...
					if (mcomCon != null) {
						mcomCon.close("DCRechargeController#run");
						mcomCon = null;
					}
                    con = null;

                    /**
                     * OTN like to provide a special type of commission to
                     * channel user when they do first recharge for any
                     * subscriber. IN will provide information to about
                     * subscriber first recharge.
                     */
                    boolean giveBonus = true;

                    if (((Boolean) (PreferenceCache.getSystemPreferenceValue(PreferenceI.ACTIVATION_FIRST_REC_APP))).booleanValue()) {
                    ...
                    if (giveBonus) {
                        ...
                        try {
                            ...
                            EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "DCRechargeController[run]",
            ...
            // TransactionLog.log(_transferID,_requestIDStr,_senderMSISDN,_senderNetworkCode,PretupsI.TXN_LOG_REQTYPE_INT,PretupsI.TXN_LOG_TXNSTAGE_PROCESS,"After
            // Differential
            // Calculation",PretupsI.TXN_LOG_STATUS_SUCCESS,"Transfer
            // Status="+_c2sTransferVO.getTransferStatus()+" Differential
            // Appl="+_c2sTransferVO.getDifferentialApplicable()+" Diff
            // Given="+_c2sTransferVO.getDifferentialGiven());
                ...
                if (_c2sTransferVO.getTransferStatus().equals(PretupsErrorCodesI.TXN_STATUS_SUCCESS)) {
                    ...
                    try {
                        ...
                        if (sosvo != null) {
                            ...
                            _log.error(this, "DCRechargeController", methodName + " No record found in database for this number :" + _receiverTransferItemVO.getMsisdn());
                            // throw new
                            // BTSLBaseException("DCRechargeController","run",PretupsErrorCodesI.SOS_ERROR_EXCEPTION);
                        }
                    } catch (BTSLBaseException be) {
                        _log.errorTrace(methodName, be);
                        _log.error(this, "DCRechargeController", "run BTSLBaseException:" + "Transaction ID: " + sosvo.getTransactionID() + "Msisdn" + _receiverTransferItemVO
                            .getMsisdn() + "Getting Exception while processing LMB request :" + be.getMessage());
                    } catch (Exception e) {
                        _log.errorTrace(methodName, e);
                        _log.error(this, "DCRechargeController", "run Exception:" + "Transaction ID: " + sosvo.getTransactionID() + "Msisdn" + _receiverTransferItemVO
            ...
            if (_log.isDebugEnabled()) {
                _log.debug("DCRechargeController",
                    "For _transferID=" + _transferID + " Diff applicable=" + _c2sTransferVO.getDifferentialApplicable() + " Diff Given=" + _c2sTransferVO
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DCRechargeController[run]", _transferID,
                _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            ...
            try {
                ...
                _log.errorTrace(methodName, e);
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "DCRechargeController[run]", _transferID,
            ...
            if (!BTSLUtil.isStringIn(_c2sTransferVO.getRequestGatewayCode(), _notAllowedSendMessGatw)) {
                ...
                if (btslMessages != null) {
                    ...
                    // Specific to tunisia send common success message through
                    // USSD
    ...
    public void updateForReceiverValidateResponse(String str) throws BTSLBaseException {
        ...
        if (!InterfaceErrorCodesI.INTERFACE_MSISDN_NOT_FOUND.equals(status) || isRequired) {
            ...
            if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
                ...
                // throw new
                // BTSLBaseException("DCRechargeController","updateForReceiverValidateResponse",PretupsErrorCodesI.DC_RECEIVER_FAIL,0,strArr,null);
                // throw new
                // BTSLBaseException("DCRechargeController","updateForReceiverValidateResponse",_c2sTransferVO.getErrorCode(),0,strArr,null);
                if (InterfaceErrorCodesI.INTERFACE_CUSTOMER_RECHARGENOTALLOWED.equals(_receiverTransferItemVO.getValidationStatus())) {
                    throw new BTSLBaseException("DCRechargeController", methodName, InterfaceErrorCodesI.INTERFACE_CUSTOMER_RECHARGENOTALLOWED + "_S", 0, strArr, null);
                } else {
                    throw new BTSLBaseException("DCRechargeController", methodName, _c2sTransferVO.getErrorCode(), 0, strArr, null);
                }
            }
            _receiverTransferItemVO.setTransferStatus(status);
    ...
    public void updateForReceiverCreditResponse(String str) throws BTSLBaseException {
        ...
        if (BTSLUtil.isNullString(status) || (!status.equals(InterfaceErrorCodesI.SUCCESS) && !status.equals(InterfaceErrorCodesI.AMBIGOUS))) {
            ...
            strArr = new String[] { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()) };
            // throw new
            // BTSLBaseException(this,"updateForReceiverValidateResponse",PretupsErrorCodesI.DC_RECEIVER_FAIL,0,strArr,null);
            ...
            /*
             * try{_receiverTransferItemVO.setNewExpiry(BTSLUtil.
             ...
             * e){};
             * try{_receiverTransferItemVO.setPostBalance(Long.parseLong((String)
             * map.get("INTERFACE_POST_BALANCE")));}catch(Exception
             * e){};
             */
        ...
        try {
            _c2sTransferVO.setNewExpiry(BTSLUtil.getDateFromDateString((String) map.get("NEW_EXPIRY_DATE"), "ddMMyyyy"));
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
        }
        try {
            _c2sTransferVO.setNewGraceDate(BTSLUtil.getDateFromDateString((String) map.get("NEW_GRACE_DATE"), "ddMMyyyy"));
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
        }
        try {
            _c2sTransferVO.setPostBalance(Long.parseLong((String) map.get("INTERFACE_POST_BALANCE")));
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
        }
        ...
        if (BTSLUtil.isNullString(_c2sTransferVO.getNewPromoBalance())) {
            ...
            // try{_receiverTransferItemVO.setNewPromoBalance(Long.parseLong((String)map.get("INTERFACE_PROMO_POST_BALANCE")));}catch(Exception
            // e){};
        } else {
            new_promoBalance = (String) map.get("INTERFACE_PROMO_POST_BALANCE");
            if (!BTSLUtil.isNullString(new_promoBalance)) {
        ...
        // try{_receiverTransferItemVO.setNewPromoExpiry(BTSLUtil.getDateFromDateString((String)map.get("NEW_PROMO_EXPIRY_DATE"),"ddMMyyyy"));}catch(Exception
        // e){};
        try {
        ...
        try {
            _c2sTransferVO.setPostCreditCoreValidity(BTSLUtil.getDateFromDateString((String) map.get("POSTCRE_NEW_EXPIRY_DATE"), "ddMMyyyy"));
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
        }
        try {
        ...
        try {
            _c2sTransferVO.setPostCreditPromoValidity(BTSLUtil.getDateFromDateString((String) map.get("POSTCRE_NEW_PROMO_EXPIRY_DATE"), "ddMMyyyy"));
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
        }
        try {
    ...
    public void populateServiceInterfaceDetails(Connection p_con, String action) throws BTSLBaseException {
        ...
        if (!isReceiverFound) {
            throw new BTSLBaseException("DCRechargeController", "populateServiceInterfaceDetails", PretupsErrorCodesI.C2S_ERROR_NOTFOUND_SERVICEINTERFACEMAPPING);
        }
    ...
    private void checkTransactionLoad() throws BTSLBaseException {
        ...
        try {
            ...
            if (recieverLoadStatus == 0) {
                ...
                if (_log.isDebugEnabled()) {
                    _log.debug("DCRechargeController[checkTransactionLoad]", "_transferID=" + _transferID + " Successfully through load");
                }
            }
            // Request in Queue
                ...
                throw new BTSLBaseException("DCRechargeController", methodName, PretupsErrorCodesI.REQUEST_IN_QUEUE, 0, strArr, null);
            }
            // Refuse the request
            else {
                throw new BTSLBaseException("DCRechargeController", methodName, PretupsErrorCodesI.REQUEST_REFUSE_FROM_INTLOAD);
            }
        } catch (BTSLBaseException be) {
            _log.error("DCRechargeController[checkTransactionLoad]", "Refusing request getting Exception:" + be.getMessage());
    ...
    private void processValidationRequest() throws BTSLBaseException, SQLException {
        ...
        try {
             ...
             * rate step. Now Moldova will support single currency. Previously
             * conversion rate was required to support multiple currency for
             * moldova. //Change the receiver amount for multiplication factor
             * interface wise. try { //get the conversion value for receiver
             ...
             * if(_log.isDebugEnabled())
             * _log.debug("processValidationRequest","_receiverConversionFactor:
             * "+_receiverConversionFactor+"
             * c2sTransferVO.getConvertedRequestedAmount()
             * :"+_c2sTransferVO.getConvertedRequestedAmount()); }
             * catch(BTSLBaseException be) { throw be; } catch(Exception e) {
             * throw e; }
             */
            ...
            try {
                ...
                // TransactionLog.log(_transferID,_requestIDStr,_receiverMSISDN,_receiverVO.getNetworkCode(),PretupsI.TXN_LOG_REQTYPE_INT,PretupsI.TXN_LOG_TXNSTAGE_PROCESS,"Transaction
                // Failed",PretupsI.TXN_LOG_STATUS_FAIL,"Getting
                ...
                LoadController.decreaseResponseCounters(_transferID, _receiverVO.getTransactionStatus(), LoadControllerI.SENDER_VAL_RESPONSE);
                // TransactionLog.log(_transferID,_requestIDStr,_receiverMSISDN,_receiverVO.getNetworkCode(),PretupsI.TXN_LOG_REQTYPE_INT,PretupsI.TXN_LOG_TXNSTAGE_PROCESS,"Transaction
                // Failed",PretupsI.TXN_LOG_STATUS_FAIL,_receiverVO.getInterfaceResponseCode());
            ...
            if ((System.currentTimeMillis() - _c2sTransferVO.getRequestStartTime()) > interfaceVO.getValExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "DCRechargeController[processValidationRequest]",
                    _transferID, _senderMSISDN, _senderNetworkCode, "Exception: System is taking more time till validation");
                throw new BTSLBaseException("DCRechargeController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION_TKING_TIME_TILL_VAL);
            }
             ...
             * rate step. Now Moldova will support single currency. Previously
             * conversion rate was required to support multiple currency for
             * moldova. //set the receiver values after conversion factor.
             * //reset the receiver value after conversion (devide by conversion
             * factor) setReceiverConversionFactor();
             */
            // End of single currency request change
            ...
            if(mcomCon != null){mcomCon.close("DCRechargeController#processValidationRequest");mcomCon=null;}
            con = null;
            ...
            if ((System.currentTimeMillis() - _c2sTransferVO.getRequestStartTime()) > interfaceVO.getTopUpExpiryTime()) {
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "DCRechargeController[run]", _transferID,
                    _senderMSISDN, _senderNetworkCode, "Exception: System is taking more time till topup");
                throw new BTSLBaseException("DCRechargeController", methodName, PretupsErrorCodesI.C2S_ERROR_EXCEPTION_TKING_TIME_TILL_TOPUP);
            }
            interfaceVO = null;
            ...
            _log.error("DCRechargeController[processValidationRequest]",  loggerValue);
            if (_transferDetailAdded) {
                if (mcomCon == null) {
                	mcomCon = new MComConnection();con=mcomCon.getConnection();
                }
    ...
    public String getReceiverCreditStr() {
        ...
        try {
            previous_balance = (Long.parseLong(_c2sTransferVO.getPreviousPromoBalance()));
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
        }
        try {
            _previousPromoExpiry = (BTSLUtil.getDateFromDateString(_c2sTransferVO.getPreviousPromoExpiry(), "ddMMyyyy"));
        } catch (Exception e) {
            _log.errorTrace(methodName, e);
        }
    ...
    private String getReceiverSuccessMessage() {
        ...
        if (!("N".equals(_c2sTransferVO.getBoth()) && "N".equals(_c2sTransferVO.getOnline()))) {
            ...
            messageArgArray = new String[] { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getReceiverTransferValue()), String.valueOf(_receiverTransferItemVO
                ...
                .getReceiverAccessFee()), _c2sTransferVO.getSubService(), _channelUserVO.getUserName(), String.valueOf((long) _c2sTransferVO.getReceiverBonus1()), String
                .valueOf((long) _c2sTransferVO.getReceiverBonus2()), PretupsBL.getDisplayAmount(_c2sTransferVO.getBonusTalkTimeValue()), PretupsBL
                ...
                .getPostBalance()) };
            key = PretupsErrorCodesI.DC_IMPLICIT_MSG;
        } else {
            // For Get NUMBER BACK Service
            if (_c2sTransferVO.getReceiverTransferItemVO().isNumberBackAllowed()) {
                ...
                messageArgArray = new String[] { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getReceiverTransferValue()), String.valueOf(_receiverTransferItemVO
                    ...
                    .getSelectorName(), _requestVO.getPosUserMSISDN() };
                /*
                 * if(_c2sTransferVO.getBonusTalkTimeValue()==0)
                 * key=PretupsErrorCodesI.C2S_RECEIVER_GET_NUMBER_BACK_SUCCESS;
                 * else
                 * key=PretupsErrorCodesI.
                 * C2S_RECEIVER_GET_NUMBER_BACK_SUCCESS_WITH_BONUS;
                 */
                if (!_receiverTransferItemVO.getPostValidationStatus().equals(InterfaceErrorCodesI.SUCCESS)) {
                    if ((_c2sTransferVO.getBonusTalkTimeValue() == 0)) {
                        key = PretupsErrorCodesI.DC_RECEIVER_SUCCESS_WITHOUT_POSTBAL;// return
                        // BTSLUtil.getMessage(_receiverLocale,PretupsErrorCodesI.C2S_RECEIVER_SUCCESS_WITHOUT_POSTBAL,messageArgArray);
                    } else {
                        key = PretupsErrorCodesI.DC_RECEIVER_SUCCESS_WITHOUT_POSTBAL_WITH_BONUS;
                    }
                } else {
                    if ((_c2sTransferVO.getBonusTalkTimeValue() == 0)) {
                        key = PretupsErrorCodesI.DC_RECEIVER_SUCCESS;// return
                        // BTSLUtil.getMessage(_receiverLocale,PretupsErrorCodesI.C2S_RECEIVER_SUCCESS_WITHOUT_POSTBAL,messageArgArray);
                    } else {
                        key = PretupsErrorCodesI.DC_RECEIVER_SUCCESS_WITH_BONUS;
                    }
                }
            }
            ...
            if (!PretupsI.NO.equals(_receiverPostBalanceAvailable)) {
                ...
                messageArgArray = new String[] { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getReceiverTransferValue()), String.valueOf(_receiverTransferItemVO
                    ...
                    .getUserName(), String.valueOf((long) _c2sTransferVO.getReceiverBonus1()), String.valueOf((long) _c2sTransferVO.getReceiverBonus2()), PretupsBL
                    ...
                    .getSelectorName(), _requestVO.getPosUserMSISDN(), _c2sTransferVO.getBonusSummaryMessageSting() };
                // messageArgArray=new
        ...
        if (!BTSLUtil.isNullString(_receiverTransferItemVO.getChangedBundleCodes()) && _receiverTransferItemVO.getChangedBundleCodes().length() > 0) {
            ...
            key = PretupsErrorCodesI.DC_RECEIVER_SUCCESS_ALL_BALANCES;
        }
    ...
    private String getSenderSuccessMessage() {
        ...
        final String[] messageArgArray = { _requestVO.getSid(), _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getTransferValue()), PretupsBL
            ...
            .getReceiverAccessFee()), _c2sTransferVO.getSubService(), _receiverTransferItemVO.getSelectorName() };
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.DC_SENDER_SUCCESS, messageArgArray);
    }
    ...
    private String getReceiverUnderProcessMessage() {
        final String[] messageArgArray = { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getReceiverTransferValue()), String.valueOf(_receiverTransferItemVO
            ...
            .getReceiverAccessFee()), _channelUserVO.getUserName(), _requestVO.getPosUserMSISDN(), _receiverTransferItemVO.getSelectorName() };
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.DC_RECEIVER_UNDERPROCESS, messageArgArray, _requestVO.getRequestGatewayType());
    }
    ...
    private String getSenderUnderProcessMessage() {
        ...
        final String[] messageArgArray = { _requestVO.getSid(), _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), String
            .valueOf(_receiverTransferItemVO.getValidity()), PretupsBL.getDisplayAmount(_senderTransferItemVO.getPostBalance()), _receiverTransferItemVO.getSelectorName() };
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.DC_SENDER_UNDERPROCESS, messageArgArray);
    }
    ...
    private String getSndrUPMsgBeforeValidation() {
        final String[] messageArgArray = { _receiverMSISDN, _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _receiverTransferItemVO
            .getSelectorName() };
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.DC_SENDER_UNDERPROCESS_B4VAL, messageArgArray);
    }
    ...
    private String getReceiverAmbigousMessage() {
        final String[] messageArgArray = { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _senderPushMessageMsisdn, _channelUserVO
            .getUserName(), _requestVO.getPosUserMSISDN(), _receiverTransferItemVO.getSelectorName() };
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.DC_RECEIVER_AMBIGOUS_KEY, messageArgArray, _requestVO.getRequestGatewayType());
    }

    private String getReceiverFailMessage() {
        final String[] messageArgArray = { _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _senderPushMessageMsisdn, _channelUserVO
            .getUserName(), _requestVO.getPosUserMSISDN(), _receiverTransferItemVO.getSelectorName() };
        return BTSLUtil.getMessage(_receiverLocale, PretupsErrorCodesI.DC_RECEIVER_FAIL_KEY, messageArgArray, _requestVO.getRequestGatewayType());
    }
    ...
    private void setReceiverTransferItemVO() {
        ...
        _receiverTransferItemVO.setTransferStatus(PretupsErrorCodesI.DC_RECEIVER_UNDERPROCESS_SUCCESS);
    }
        ...
        try {
            ...
            if (_requestVO.getMessageGatewayVO().getFlowType().equals(PretupsI.MSG_GATEWAY_FLOW_TYPE_REQUEST)) {
                ...
                final String[] messageArgArray = { _c2sTransferVO.getReceiverMsisdn(), PretupsBL.getDisplayAmount(_c2sTransferVO.getRequestedAmount()), _c2sTransferVO
                    .getTransferID(), PretupsBL.getDisplayAmount(_userBalancesVO.getBalance()), _receiverTransferItemVO.getSelectorName() };
                _requestVO.setMessageArguments(messageArgArray);
                _requestVO.setMessageCode(PretupsErrorCodesI.DC_SENDER_CREDIT_SUCCESS);
            }
    ...
    private void processValidationRequestInThread() throws BTSLBaseException, Exception {
        ...
        try {
        	...
        	loggerValue.append("Getting BTSL Base Exception:");
        	loggerValue.append(be.getMessage());
            _log.error("DCRechargeController[processValidationRequestInThread]",  loggerValue );
            ...
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                "DCRechargeController[processValidationRequestInThread]", _transferID, _senderMSISDN, _senderNetworkCode,  loggerValue.toString());
            TransactionLog.log(_transferID, _requestIDStr, _receiverMSISDN, _receiverVO.getNetworkCode(), PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
            ...
            if (_transferID != null && !_transferDetailAdded) {
                ...
                try {
                    ...
                    if(mcomCon != null){mcomCon.close("DCRechargeController#processValidationRequestInThread");mcomCon=null;}
                    con=null;
                    _log.errorTrace(methodName, be);
                } catch (Exception e) {
                    if (con != null) {
                    ...
                    EventHandler.handle(EventIDI.DATABASE_CONECTION_PROBLEM, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL,
                        "DCRechargeController[processValidationRequestInThread]", _transferID, _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
                } finally {
                	if(mcomCon != null){mcomCon.close("DCRechargeController#processValidationRequestInThread");mcomCon=null;}
                    con = null;
                }
    ...
    private boolean getInterfaceRoutingDetails(Connection p_con, String p_msisdn, long p_prefixID, String p_subscriberType, String p_networkCode, String p_serviceType, String p_interfaceCategory, String p_userType, String p_action) throws BTSLBaseException {
        ...
        try {
            ...
            if (subscriberRoutingControlVO != null) {
                if (subscriberRoutingControlVO.isDatabaseCheckBool()) {
                    ...
                    // date 15/05/06
                         ...
                         * MSISDNPrefixInterfaceMappingCache.getObject(p_prefixID
                         * ,
                         * p_subscriberType,p_action); interfaceID =
                         * interfaceMappingVO.getInterfaceID();
                         ...
                         * message else language 2 //Changed on 15/05/06 for
                         * CR00020 (Gurjeet Singh Bedi)
                ...
                // based routing
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.INFO, "DCRechargeController[getInterfaceRoutingDetails]",
        	...
        	loggerValue.append("Exception:" );
        	loggerValue.append( e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DCRechargeController[getInterfaceRoutingDetails]",
    ...
    private void performAlternateRouting(ArrayList altList) throws BTSLBaseException {
        ...
        try {
        	...
        	loggerValue.append("Exception:");
        	loggerValue.append( e.getMessage());
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DCRechargeController[performAlternateRouting]",
                _transferID, _senderMSISDN, _senderNetworkCode,  loggerValue.toString());
    ...
    public void receiverValidateResponse(String str, int p_attempt, int p_altSize) throws BTSLBaseException {
        ...
        if (BTSLUtil.isNullString(status) || !status.equals(InterfaceErrorCodesI.SUCCESS)) {
            ...
            throw new BTSLBaseException("DCRechargeController", "updateForReceiverValidateResponse", PretupsErrorCodesI.DC_RECEIVER_FAIL, 0, strArr, null);
        }
    ...
    public void processFromQueue(TransferVO p_transferVO) {
       ...
       StringBuilder loggerValue= new StringBuilder(); 
        ...
        try {
            ...
            if(mcomCon != null){mcomCon.close("DCRechargeController#processFromQueue");mcomCon=null;}
            con = null;

            if (_log.isDebugEnabled()) {
                _log.debug("DCRechargeController[processFromQueue]", "_transferID=" + _transferID + " Successfully through load");
            }
            _processedFromQueue = true;

            processValidationRequest();
            // Set under process message for the sender and reciever
            p_transferVO.setMessageCode(PretupsErrorCodesI.DC_SENDER_UNDERPROCESS_SUCCESS);
            ...
            _log.errorTrace(methodName, be);
			if (mcomCon != null) {
				mcomCon.close("DCRechargeController#processFromQueue");
				mcomCon = null;
			}
            con = null;
            try {
            	...
            	loggerValue.append("Leaving Reciever Unmarked Base Exception:" );
            	loggerValue.append( bex.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "DCRechargeController[processFromQueue]",
                    _transferID, _senderMSISDN, _senderNetworkCode, loggerValue.toString());
            } catch (Exception e) {
                _log.errorTrace(methodName, e);
                loggerValue.setLength(0);
            ...
            // raising alarm
            EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DCRechargeController[processFromQueue]", _transferID,
                _senderMSISDN, _senderNetworkCode, "Exception:" + e.getMessage());
            // logging in the transaction log
            TransactionLog.log(_transferID, _requestVO.getRequestIDStr(), _requestVO.getFilteredMSISDN(), "", PretupsI.TXN_LOG_REQTYPE_RES, PretupsI.TXN_LOG_TXNSTAGE_PROCESS,
                _c2sTransferVO.getSenderReturnMessage(), PretupsI.TXN_LOG_STATUS_FAIL, "Getting Code=" + _requestVO.getMessageCode());
            ...
            try {
            	...
            	loggerValue.append("Exception:");
            	loggerValue.append(e.getMessage());
                EventHandler.handle(EventIDI.SYSTEM_ERROR, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.FATAL, "DCRechargeController[processFromQueue]",
                    _transferID, _senderMSISDN, _senderNetworkCode,  loggerValue.toString() );
            }
        ...
        if (!BTSLUtil.isNullString(p_languageCode)) {
            try {
                if (LocaleMasterCache.getLocaleFromCodeDetails(p_languageCode) == null) {
                    EventHandler.handle(EventIDI.SYSTEM_INFO, EventComponentI.SYSTEM, EventStatusI.RAISED, EventLevelI.MAJOR, "DCRechargeController[updateReceiverLocale]",
    ...
    private static synchronized void generateC2STransferID(TransferVO p_transferVO) {
        ...
        try {
            ...
            if (_transactionIDCounter == 0) {
                throw new BTSLBaseException("DCRechargeController", "formatTransferID", PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
            transferID = _operatorUtil.formatTransferID(p_transferVO, _transactionIDCounter, "D");
            if (transferID == null) {
                throw new BTSLBaseException("DCRechargeController", "formatTransferID", PretupsErrorCodesI.NOT_GENERATE_TRASNFERID);
            }
            p_transferVO.setTransferID(transferID);
        } catch (Exception e) {
            _log.errorTrace("generateC2STransferID", e);
        }
    }
    ...
    private String getSenderParentSuccessMessage() {
        ...
        final String[] messageArgArray = { _requestVO.getSid(), _transferID, PretupsBL.getDisplayAmount(_c2sTransferVO.getTransferValue()), PretupsBL
            .getDisplayAmount(_senderTransferItemVO.getPostBalance()), String.valueOf(_receiverTransferItemVO.getValidity()), PretupsBL
            .getDisplayAmount(_receiverTransferItemVO.getPostBalance()), String.valueOf(_receiverTransferItemVO.getNewGraceDate()), PretupsBL.getDisplayAmount(_c2sTransferVO
            .getReceiverAccessFee()), _c2sTransferVO.getSubService(), _requestVO.getSenderLoginID(), _receiverTransferItemVO.getSelectorName() };
        return BTSLUtil.getMessage(_senderLocale, PretupsErrorCodesI.DC_PARENT_SUCCESS, messageArgArray);
    }
}
