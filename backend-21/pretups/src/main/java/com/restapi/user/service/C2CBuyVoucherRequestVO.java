...
public class C2CBuyVoucherRequestVO {
    ...
    @JsonProperty("data")
    public Databuyvcr getDatabuyvcr() {
        return data;
    }

    @JsonProperty("data")
    public void setDatabuyvcr(Databuyvcr data) {
        this.data = data;
    }
...
class Databuyvcr {
    ...
    private List<VoucherDetailBuy> voucherDetails = null;
    ...
    @JsonProperty("voucherDetails")
    public List<VoucherDetailBuy> getVoucherDetails() {
        return voucherDetails;
    }

    @JsonProperty("voucherDetails")
    public void setVoucherDetails(List<VoucherDetailBuy> voucherDetails) {
 ...
 class VoucherDetailBuy {
    ...
    @io.swagger.v3.oas.annotations.media.Schema(example = "10", required = true/* , defaultValue = "" */)
    @JsonProperty("quantity")
    ...
    public String toString() {
        ...
        return (sb.append("language1").append(denomination)
        		.append("paymentinstcode = ").append(quantity)
