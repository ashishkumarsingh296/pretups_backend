...
@Setter
@ToString
public class ModifyCommissionProfileRequestVO {
	
	//different for modify
		private String selectCommProfileSetID;
	    private String oldApplicableFromDate;
	    private String oldApplicableFromHour;
	    private String selectCommProifleVersionID = null;
	    

	//for commissionProfileSetVO -> general details for modify commission profile
