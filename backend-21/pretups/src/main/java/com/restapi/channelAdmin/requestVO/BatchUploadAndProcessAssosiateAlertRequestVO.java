...
public class BatchUploadAndProcessAssosiateAlertRequestVO {
	
	@io.swagger.v3.oas.annotations.media.Schema(example = "text/csv", required = true, description="File Type(csv, xls, xlsx")
