...
public class MvdDetails extends OAuthUserData{
	...
	@JsonProperty("qty")
	@io.swagger.v3.oas.annotations.media.Schema(example = "10", required = true/* , defaultValue = "" */, description= "Quantity")
	...
	@JsonProperty("extrefnum")
	@io.swagger.v3.oas.annotations.media.Schema(example = "1432", required = true/* , defaultValue = "" */, description ="extrefnum")
