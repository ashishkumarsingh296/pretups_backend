...
public class InstanceLoadVO extends LoadVO implements Serializable {
    ...
    public String toString() {
        String temp = "Instance ID=" + _instanceID + " Host Address=" + _hostAddress + " Host Port=" + _hostPort + " Instance Load Status=" + _instanceLoadStatus + " Instance Memory Txn Count=" + _instanceMemoryTxnCount + "Instance Last Memory Txn No:" + _instanceLastMemoryTxnNo + " Instance Type=" + _instanceType + "Show OAM Status" + _showOamlogs + "Show SMSC Status" + _showSmscStatus;
