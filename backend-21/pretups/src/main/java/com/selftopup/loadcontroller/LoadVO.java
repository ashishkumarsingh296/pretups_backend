...
public class LoadVO implements Serializable {
    ...
    public String toString() {
        return ("Transaction Load=" + _transactionLoad + " Current Transaction Load=" + _currentTransactionLoad + " Receiver Current Transaction Load=" + _receiverCurrentTransactionLoad + " _requestTimeoutSec=" + _requestTimeoutSec + " _defualtTPS=" + _defualtTPS + "_currentTPS=" + _currentTPS + " No Of Request in Same Sec=" + _noOfRequestSameSec + " Previous Second=" + _previousSecond + " Recieved Count=" + _recievedCount + " Request Count=" + _requestCount + " Total Refused Count=" + _totalRefusedCount + " First Request Count=" + _firstRequestCount + " _minimumProcessTime=" + _minimumProcessTime);
    }
    ...
    public void setLastInitializationTime(Date lastInitializationTime) {
        _lastInitializationTime = lastInitializationTime;
    }
