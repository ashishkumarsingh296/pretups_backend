...
@Override
    public String toString() {
   	 ...
   	 sbf.append(" _moduleCode=").append(_moduleCode);
   	 sbf.append(" _gatewayType=").append(_gatewayType);
   	 sbf.append(" Service Type=").append(_serviceType);
   	 sbf.append(" _seqNo=").append(_seqNo);
   	 sbf.append(" _recievedCount=").append(_recievedCount);
   	 sbf.append(" _successCount=").append(_successCount);
   	 sbf.append(" _failCount=").append(_failCount);
   	sbf.append(" _underProcessCount=").append(_underProcessCount);
   	sbf.append(" _othersFailCount=").append(_othersFailCount);
   	sbf.append(" _otherNetworkReqCount=").append(_otherNetworkReqCount);
   	sbf.append(" _lastRequestID=").append(_lastRequestID);
