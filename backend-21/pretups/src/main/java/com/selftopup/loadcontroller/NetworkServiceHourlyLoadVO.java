...
public class NetworkServiceHourlyLoadVO implements Serializable, Comparable {
    ...
    public String toString() {
        String temp = "Instance ID=" + _instanceID + " Network Code=" + _networkCode + " _moduleCode=" + _moduleCode + " _gatewayType=" + _gatewayType + " Service Type=" + _serviceType + " _seqNo=" + _seqNo + " _recievedCount=" + _recievedCount + " _successCount=" + _successCount + " _failCount=" + _failCount + " _otherNetworkReqCount=" + _otherNetworkReqCount;
        return temp;
    }
