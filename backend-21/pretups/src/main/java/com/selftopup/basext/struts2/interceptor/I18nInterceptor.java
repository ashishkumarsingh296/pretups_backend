 ...
 * for the user's session. This is very useful for applications that require
 * multi-lingual support and want the user to
 ...
 * <b>foo.action?request_locale=en_US</b>, then the locale for US English is
 ...
 * <b>request_locale</b></li>
 * 
 * <li>attributeName (optional) - the name of the session key to store the
 * selected locale. By default this is <b>WW_TRANS_I18N_LOCALE</b></li>
 * 
 * </ul>
 * 
...
public class I18nInterceptor extends AbstractInterceptor {
	 ...
	 * 
	 */
    private static final long serialVersionUID = -6667337265515975766L;
    ...
    public String intercept(ActionInvocation invocation) throws Exception {
        ...
        if (requested_locale != null) {
            locale = (requested_locale instanceof Locale) ? (Locale) requested_locale : LocalizedTextUtil.localeFromString(requested_locale.toString(), null);
            httpsession.setAttribute(attributeName, (Locale) locale);
        } else {
            locale = (Locale) httpsession.getAttribute(attributeName);
