 ...
 * Looks for a hidden identification field that specifies the original value of
 * the checkbox.
 * If the checkbox isn't submitted, insert it into the parameters as if it was
 * with the value
 * of 'false'.
    ...
    public String intercept(ActionInvocation ai) throws Exception {
        ...
        for (Iterator<Map.Entry<String, Object>> iterator = entries.iterator(); iterator.hasNext();) {
            ...
            if (key.startsWith("__checkbox_")) {
                ...
                // LOG.debug("Bypassing automatic checkbox detection due to multiple checkboxes of the same name: #0",
                // name);
                // }
                // continue;
                // }
