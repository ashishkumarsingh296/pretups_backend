...
public class PaymentMethodKeywordVO implements Serializable {
    ...
    public String toString() {
        ...
        sbf.append(" _paymentKeyword  " + _paymentKeyword);
        sbf.append(" _paymentMethodType  " + _paymentMethodType);
        sbf.append(" _serviceType  " + _serviceType);
        sbf.append(" _networkCode  " + _networkCode);
        sbf.append(" _useDefaultInterface  " + _useDefaultInterface);
        sbf.append(" _defaultInterfaceID  " + _defaultInterfaceID);
        sbf.append(" _externalID " + _externalID);
        sbf.append(" _status " + _status);
        sbf.append(" _lang1Message " + _lang1Message);
        sbf.append(" _lang2Message " + _lang2Message);
