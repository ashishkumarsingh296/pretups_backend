...
public class PaymentMethodCache {
    ...
    public static void loadPaymentMethodCacheOnStartUp() {

        if (_log.isDebugEnabled()) {
            _log.debug("loadPaymentMethodCacheOnStartUp()", "entered");
        }

        _paymentMethodMap = loadPaymentMethod();

        if (_log.isDebugEnabled()) {
            _log.debug("loadPaymentMethodCacheOnStartUp()", "exited");
        }
     ...
     * @return Hashmap
     */
    private static HashMap loadPaymentMethod() {

        if (_log.isDebugEnabled()) {
            _log.debug("loadPaymentMethod()", "entered");
        }
        ...
        try {
            ...
            if (_log.isDebugEnabled()) {
                _log.debug("loadPaymentMethod() ", e);
            }
        }

        if (_log.isDebugEnabled()) {
            _log.debug("loadPaymentMethod()", "exited " + map.size());
        }
    ...
    public static void updatePaymentMethod() {
        if (_log.isDebugEnabled()) {
            _log.debug("updatePaymentMethod()", " Entered");
        }
        ...
        if (_log.isDebugEnabled()) {
            _log.debug("updatePaymentMethod()", "exited :: size is " + _paymentMethodMap.size());
        }
    }
