...
public class ComverseTestClient {
    ...
    public static void sendRequesttoIN(HashMap p_requestMap) {
        if (_log.isDebugEnabled())
            _log.debug("ComverseTestClient.sendRequesttoIN()", "Entered...");
        // System.out.println("ComverseTestClient.sendRequesttoIN() Entered...");

        ComverseINHandler inHandler = new ComverseINHandler();
        try {
        ...
        if (_log.isDebugEnabled())
            _log.debug("ComverseTestClient.sendRequesttoIN()", "Exited...");
