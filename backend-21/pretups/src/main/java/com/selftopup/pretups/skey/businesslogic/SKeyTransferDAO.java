package com.selftopup.pretups.skey.businesslogic;
...
public class SKeyTransferDAO {
    ...
    public SKeyTransferVO loadSKeyTransferDetails(Connection p_con, String p_msisdn) throws BTSLBaseException {
        final String methodName = "loadSKeyTransferDetails";
        ...
        try {
            ...
            if (_log.isDebugEnabled())
                _log.debug(methodName, "Exiting sKeyTransferVO:" + sKeyTransferVO);
        }// end of finally
    }
    ...
    public int deleteSkeyTransferDetails(Connection p_con, SKeyTransferVO p_skeyTransferVO) throws BTSLBaseException {
        ...
        try {
            ...
            if (deleteCount != 0) {
                ...
                if (addCount <= 0)
                    throw new BTSLBaseException("PretupsBL", "generateSKey", SelfTopUpErrorCodesI.SKEY_NOTADDHISTORY);
            }
