...
public class TransferVO implements Serializable {
    ...
    private String _cardReferenceNo = null;
    ...
    public String toString() {
        ...
        sbf.append(",_cardGroupCode =" + _cardGroupCode);
        ...
        sbf.append(",_messageCode =" + _messageCode);
        ...
        sbf.append(",_receiverTransferValue =" + _receiverTransferValue);
        sbf.append(",_receiverValidity =" + _receiverValidity);
        sbf.append(",_requestedAmount =" + _requestedAmount);
        sbf.append(",_senderTransferValue =" + _senderTransferValue);
        sbf.append(",_subService =" + _subService);
        sbf.append(",_senderTransferItemVO =" + _senderTransferItemVO);
        sbf.append(",_receiverTransferItemVO =" + _receiverTransferItemVO);
        sbf.append(",_transferID =" + _transferID);
        sbf.append(",_transferCategory =" + _transferCategory);
        sbf.append(",_receiverSubscriberType =" + _receiverSubscriberType);
        sbf.append(",_transferStatus =" + _transferStatus);
        sbf.append(", _transferValueStr =" + _transferValueStr);
        sbf.append(",_transferItemList =" + _transferItemList);
        sbf.append(",_paymentMethodKeywordVO =" + _paymentMethodKeywordVO);
        sbf.append(",_lastTransferId =" + _lastTransferId);
        sbf.append(", _receiverBonus1 =" + _receiverBonus1);
        sbf.append(", _receiverBonus2 =" + _receiverBonus2);
        sbf.append(",_bonusTalkTimeValue=" + _bonusTalkTimeValue);
        sbf.append(",_calminusBonusvalue=" + _calminusBonusvalue);
        sbf.append(",_status=" + _status);
        sbf.append(", _receiverCreditBonusValidity =" + _receiverCreditBonusValidity);
        sbf.append(", _onLine =" + _online);
        sbf.append(", _both =" + _both);
        sbf.append(", _extCreditIntfceType" + _extCreditIntfceType);
        sbf.append(", _senderConvFactor=" + _senderConvFactor);
        sbf.append(", _receiverConvFactor=" + _receiverConvFactor);
        // Added for bonus bundles
        sbf.append(", _bonusBundleIdS=" + _bonusBundleIdS);
        sbf.append(", _bonusBundleValidities=" + _bonusBundleValidities);
        sbf.append(",  _bonusBundleValues=" + _bonusBundleValues);
        sbf.append(", _bonusBundleTypes=" + _bonusBundleTypes);
        sbf.append(", _selectorBundleId=" + _selectorBundleId);
        sbf.append(", _selectorBundleType=" + _selectorBundleType);
        sbf.append(", _selectorCode=" + _selectorCode);
        sbf.append(", _bonusSummarySting=" + _bonusSummarySting);
        sbf.append(", _bonusSummaryMessageSting=" + _bonusSummaryMessageSting);
        sbf.append(", _lmbCreditUpdateStatus =" + _lmbCreditUpdateStatus);
        // added by nilesh:: for MRP block time
        sbf.append(", _lastServiceType =" + _lastServiceType);
        sbf.append(", _inPromo =" + _inPromo);
        sbf.append(", _cosRequired =" + _cosRequired);
        return sbf.toString();
    }
    ...
    public String getValidityDateToBeSetAsString() {
        try {
            return BTSLUtil.getDateTimeStringFromDate(_validityDateToBeSet);
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public String getCardReferenceNo() {
        return _cardReferenceNo;
    }

    public void setCardReferenceNo(String cardReferenceNo) {
        _cardReferenceNo = cardReferenceNo;
    }
}