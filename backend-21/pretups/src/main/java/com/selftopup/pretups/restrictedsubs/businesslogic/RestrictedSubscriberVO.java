...
public class RestrictedSubscriberVO extends SubscriberVO {
    ...
    public String toString() {
        ...
        sb.append(" _subscriberID=" + _subscriberID);
        sb.append(", _channelUserID=" + _channelUserID);
        sb.append(",_channelUserCategory=" + _channelUserCategory);
        sb.append(", _ownerID=" + _ownerID);
        sb.append(", _employeeCode=" + _employeeCode);
        sb.append(", _employeeName=" + _employeeName);
        sb.append(", _amount=" + _amount);
        sb.append(",_minTxnAmount=" + _minTxnAmount);
        sb.append(",_maxTxnAmount=" + _maxTxnAmount);
        sb.append(",_monthlyLimit=" + _monthlyLimit);
        sb.append(",_blackListStatus=" + _blackListStatus);
        sb.append(",_remarks=" + _remarks);
        sb.append(",_approvedBy=" + _approvedBy);
        sb.append(",_approvedOn=" + _approvedOn);
        sb.append(",_associatedBy=" + _associatedBy);
        sb.append(",_associationDate=" + _associationDate);
        sb.append(",_totalTxnCount=" + _totalTxnCount);
        sb.append(",_checkBoxVal=" + _checkBoxVal);
        sb.append(",_lineNumber=" + _lineNumber);
        sb.append(",_errorCode=" + _errorCode);
        sb.append(",_failCount=" + _failCount);
        sb.append(",_subscriberType=" + _subscriberType);
        sb.append(",_language=" + _language);
        sb.append(",_country=" + _country);
        sb.append(",_blackListedStatus=" + _blackListedStatus);
        sb.append(",_languageCode" + _languageCode);
        sb.append(",_subscriberDomainCode=" + _subscriberDomainCode);
        sb.append(",_rechargeThroughParent=" + _rechargeThroughParent);
        sb.append(",_cp2pPayerStatus=" + _cp2pPayerStatus);
        sb.append(",_cp2pWithInList=" + _cp2pWithInList);
        sb.append(",_cp2pListLevel" + _cp2pListLevel);
        return sb.toString();
    }
