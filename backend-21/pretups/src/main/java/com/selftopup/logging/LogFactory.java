...
public abstract class LogFactory {
    ...
    public static LogFactory getFactory() throws LogConfigurationException {
        ...
        try {
            String factoryClass = System.getProperty("com.selftopup.logging.LogFactory");
        ...
        if (factory == null)
            try {
                InputStream is = getResourceAsStream(contextClassLoader, "META-INF/services/com.selftopup.logging.LogFactory");
                if (is != null) {
                    BufferedReader rd;
                    try {
        ...
        if (factory == null && props != null) {
            String factoryClass = props.getProperty("com.selftopup.logging.LogFactory");
            if (factoryClass != null)
                factory = newFactory(factoryClass, contextClassLoader);
        }
        if (factory == null)
            factory = newFactory("com.selftopup.logging.impl.LogFactoryImpl", (com.selftopup.logging.LogFactory.class).getClassLoader());
        if (factory != null) {
    ...
    protected static ClassLoader getContextClassLoader() throws LogConfigurationException {
        ...
        try {
            ...
            classLoader = (com.selftopup.logging.LogFactory.class).getClassLoader();
        }
        return classLoader;
    }
                ...
                try {
                    if (classLoader != null)
                        try {
                            ...
                            if (classLoader == (com.selftopup.logging.LogFactory.class).getClassLoader())
                                throw ex;
                    ...
                    if (logFactoryClass != null && !(com.selftopup.logging.LogFactory.class).isAssignableFrom(logFactoryClass))
    ...
    public static final String FACTORY_PROPERTY = "com.selftopup.logging.LogFactory";
    public static final String FACTORY_DEFAULT = "com.selftopup.logging.impl.LogFactoryImpl";
    public static final String FACTORY_PROPERTIES = "commons-logging.properties";
    protected static final String SERVICE_ID = "META-INF/services/com.selftopup.logging.LogFactory";
