...
import com.selftopup.user.businesslogic.UserPhoneVO;
...
public class UserVO implements Serializable {
    ...
    private ArrayList _geographicalAreaList;
     ...
     */
    public ArrayList getGeographicalAreaList() {
     ...
     */
    public void setGeographicalAreaList(ArrayList geographicalAreaList) {
    ...
    public String getRequetedOnAsString() {
        if (_modifiedOn != null)
            try {
                return BTSLUtil.getDateTimeStringFromDate(_modifiedOn);
