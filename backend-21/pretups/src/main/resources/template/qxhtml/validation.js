...
function addError(e, errorText) {
    try {
        ...
        td.align = "center";
        td.valign = "top";
        td.colSpan = document.getElementsByName("tablecolspan").item(0).value;
        td.setAttribute("class", "tabcenter");
        td.setAttribute("className", "tabcenter"); //ie hack cause ie does not support setAttribute
