...
java com/selftopup/pretups/processes/SelfTopUpMisDataProcessing  $CATALINA_HOME/webapps/selftopup/WEB-INF/classes/configfiles/selftopup/Constants.props $CATALINA_HOME/webapps/selftopup/WEB-INF/classes/configfiles/selftopup/LogConfig.props
