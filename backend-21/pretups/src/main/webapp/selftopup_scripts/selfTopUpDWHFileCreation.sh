...
JAVA_HOME=$HOME/PRETUPS_SELF_TOPUP; export JAVA_HOME
CATALINA_HOME=$HOME/tomcat7_self_topup; export CATALINA_HOME
...
java com/selftopup/pretups/processes/SelfTopUPDWHFileCreation  $CATALINA_HOME/webapps/selftopup/WEB-INF/classes/configfiles/selftopup/Constants.props $CATALINA_HOME/webapps/selftopup/WEB-INF/classes/configfiles/selftopup/LogConfig.props
cd $CATALINA_HOME/webapps/DWH_Final_Data
