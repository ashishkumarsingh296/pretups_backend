...
java com/selftopup/pretups/processes/ScheduledSelfTopUpAlertProcess  $CATALINA_HOME/webapps/selftopup/WEB-INF/classes/configfiles/selftopup/Constants.props $CATALINA_HOME/webapps/selftopup/WEB-INF/classes/configfiles/selftopup/LogConfig.props
