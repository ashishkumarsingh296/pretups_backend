...
java com/selftopup/pretups/p2p/subscriber/processes/ScheduleSelfTopUpProcess  $CATALINA_HOME/webapps/selftopup/WEB-INF/classes/configfiles/selftopup/Constants.props $CATALINA_HOME/webapps/selftopup/WEB-INF/classes/configfiles/selftopup/LogConfig.props
