...
java -classpath pretupsCore.jar:$CLASSPATH com/btsl/pretups/processes/DailyC2SRoamRechargeReport  $CATALINA_HOME/conf/pretups/Constants.props $CATALINA_HOME/conf/pretups/LogConfig.props