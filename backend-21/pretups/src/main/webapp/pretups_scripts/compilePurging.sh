...
echo compiling btsl.purging
javac -d $PRETUPS_HOME/WEB-INF/classes/ com/btsl/purgings/*.java

echo "[`date`]: Compile Purging  from node [`uname -n`]" >> /pretupsvar/pretups_cronLogs/scripts.log
else
