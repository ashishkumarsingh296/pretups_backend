...
#java com/btsl/pretups/processes/HourlyCountDetailAlert $CATALINA_HOME/webapps/pretups/WEB-INF/classes/configfiles/Constants.props $CATALINA_HOME/webapps/pretups/WEB-INF/classes/configfiles/LogConfig.props BOTH

cd $CATALINA_HOME/webapps/pretups/WEB-INF/lib/
java -classpath pretupsCore.jar:$JAVA_HOME/lib/tools.jar:$JAVA_HOME/lib/dt.jar:$CLASSPATH com/btsl/pretups/processes/HourlyCountDetailAlert $CATALINA_HOME/conf/pretups/Constants.props $CATALINA_HOME/conf/pretups/LogConfig.props BOTH

echo "[`date`]: C2SMisData Processing  from node [`uname -n`]" >> /pretupsvar/pretups_cronLogs/scripts.log
else
