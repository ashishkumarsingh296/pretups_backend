...
#javac com/btsl/purging/NetworkStockTxnArchiving.java
#cd $CATALINA_HOME/webapps/pretups/WEB-INF/classes/
#java com/btsl/purging/NetworkStockTransactionArchiving $CATALINA_HOME/webapps/pretups/WEB-INF/classes/configfiles/Constants.props $CATALINA_HOME/webapps/pretups/WEB-INF/classes/configfiles/LogConfig.props

cd $CATALINA_HOME/webapps/pretups/WEB-INF/lib/
java -classpath pretupsCore.jar:$JAVA_HOME/lib/tools.jar:$JAVA_HOME/lib/dt.jar:$CLASSPATH com/btsl/purging/NetworkStockTransactionArchiving $CATALINA_HOME/conf/pretups/Constants.props $CATALINA_HOME/conf/pretups/LogConfig.props


echo "[`date`]: NetworkStockTxnArchiving java - from node [`uname -n`]" >> /pretupsvar/pretups_cronLogs/scripts.log
else
