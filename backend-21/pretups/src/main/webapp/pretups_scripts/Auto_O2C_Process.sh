...
JAVA_OPTS="+XX:HeapDumpOnCtrlBreak -XX:+UseConcMarkSweepGC -XX:+HeapDumpOnOutOfMemoryError"; export JAVA_OPTS;
...
#java com/btsl/voms/voucher/businesslogic/AutoO2CProcess $CATALINA_HOME/webapps/pretups/WEB-INF/classes/configfiles/Constants.props $CATALINA_HOME/webapps/pretups/WEB-INF/classes/configfiles/ProcessLogConfig.props

cd $CATALINA_HOME/webapps/pretups/WEB-INF/lib/

java -classpath pretupsCore.jar:$CLASSPATH com/btsl/pretups/processes/AutoO2CProcess $CATALINA_HOME/conf/pretups/Constants.props $CATALINA_HOME/conf/pretups/LogConfig.props
