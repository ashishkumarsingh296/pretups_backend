...
java com/selftopup/pretups/p2p/subscriber/processes/SelfTopUPDWHFileCreation  $CATALINA_HOME/conf/pretups/Constants.props $CATALINA_HOME/webapps/selftopup/WEB-INF/classes/configfiles/selftopup/ProcessLogConfig.props
