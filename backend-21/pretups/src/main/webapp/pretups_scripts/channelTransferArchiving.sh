...
#java com/btsl/purging/ChannelTransferArchiving $CATALINA_HOME/webapps/pretups/WEB-INF/classes/configfiles/Constants.props $CATALINA_HOME/webapps/pretups/WEB-INF/classes/configfiles/LogConfig.props

cd $CATALINA_HOME/webapps/pretups/WEB-INF/lib/
java -classpath pretupsCore.jar:$CLASSPATH com/btsl/purging/ChannelTransferArchiving $CATALINA_HOME/conf/pretups/Constants.props $CATALINA_HOME/conf/pretups/LogConfig.props


echo "[`date`]: ChannelTransferArchiving from node [`uname -n`]" >> /pretupsvar/pretups_cronLogs/scripts.log
else
