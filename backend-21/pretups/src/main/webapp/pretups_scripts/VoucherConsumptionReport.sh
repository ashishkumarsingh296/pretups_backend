...
java -classpath pretupsCore.jar:$CLASSPATH com/btsl/voms/voucher/businesslogic/VoucherConsumptionReportGenerator $CATALINA_HOME/conf/pretups/Constants.props $CATALINA_HOME/conf/pretups/LogConfig.props