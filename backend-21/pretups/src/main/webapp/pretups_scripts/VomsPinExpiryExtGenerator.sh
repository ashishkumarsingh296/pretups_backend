...
java -classpath pretupsCore.jar:$CLASSPATH com/btsl/voms/voucher/businesslogic/VomsPinExpiryExtGenerator $CATALINA_HOME/conf/pretups/Constants.props $CATALINA_HOME/conf/pretups/LogConfig.props