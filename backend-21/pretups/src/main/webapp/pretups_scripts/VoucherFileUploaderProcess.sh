...
java -classpath pretupsCore.jar:$JAVA_HOME/lib/tools.jar:$JAVA_HOME/lib/dt.jar:$CLASSPATH com/btsl/voms/vomsprocesses/businesslogic/MobinilVoucherFileProcessor $CATALINA_HOME/conf/pretups/Constants.props $CATALINA_HOME/webapps/pretups/WEB-INF/classes/configfiles/ProcessLogConfig.props
