...
until [ $count -gt 3 ]
do
echo "                  Testing WEB - $WEB1 from `uname -n`"
echo 
echo "                  System will do the Ping Test with Ferma IN - $WEB1"
echo
ping -w20 $WEB1 > resultWEB1.txt
...
sleep 10
clear 
date >> result$WEB1.txt
cat resultWEB1.txt >> result$WEB1.txt
count=$count+1
done
