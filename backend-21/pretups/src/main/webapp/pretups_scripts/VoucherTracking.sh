...
java -classpath pretupsCore.jar:$CLASSPATH com/btsl/voms/voucher/businesslogic/NLevelVDetailedReportGenerator $CATALINA_HOME/conf/pretups/Constants.props $CATALINA_HOME/conf/pretups/LogConfig.props